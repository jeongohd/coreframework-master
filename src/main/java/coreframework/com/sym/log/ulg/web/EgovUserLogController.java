package coreframework.com.sym.log.ulg.web;

import java.util.HashMap;

import coreframework.com.sym.log.ulg.service.EgovUserLogService;
import coreframework.com.sym.log.ulg.service.UserLog;
...
public class EgovUserLogController {
	 ...
	 * @throws Exception
	 */
	@IncludedInfo(name="사용로그관리", listUrl= "/sym/log/ulg/SelectUserLogList.cm", order = 1040 ,gid = 60)
	@RequestMapping(value="/sym/log/ulg/SelectUserLogList.cm")
	public String selectUserLogInf(@ModelAttribute("searchVO") UserLog userLog,
		...
		return "coreframework/com/sym/log/ulg/EgovUserLogList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/ulg/SelectUserLogDetail.cm")
	public String selectUserLog(@ModelAttribute("searchVO") UserLog userLog,
		...
		return "coreframework/com/sym/log/ulg/EgovUserLogDetail";
	}
