package coreframework.com.sym.log.plg.web;

import java.util.Map;

import coreframework.com.cmm.annotation.IncludedInfo;
import coreframework.com.sym.log.plg.service.EgovPrivacyLogService;
import coreframework.com.sym.log.plg.service.PrivacyLog;
...
public class EgovPrivacyLogController {
	 ...
	 * @throws Exception
	 */
	@IncludedInfo(name="개인정보조회로그관리", listUrl="/sym/log/plg/SelectPrivacyLogList.cm", order = 1085 ,gid = 60)
	@RequestMapping(value="/sym/log/plg/SelectPrivacyLogList.cm")
	public String selectPrivacyLogList(@ModelAttribute("searchVO") PrivacyLog privacyLog,
		...
		return "coreframework/com/sym/log/plg/EgovPrivacyLogList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/plg/SelectPrivacyLogDetail.cm")
	public String selectWebLog(@ModelAttribute("searchVO") PrivacyLog privacyLog,
		...
		return "coreframework/com/sym/log/plg/EgovPrivacyLogDetail";
	}
