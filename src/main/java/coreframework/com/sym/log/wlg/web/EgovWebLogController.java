package coreframework.com.sym.log.wlg.web;

import java.util.HashMap;

import coreframework.com.sym.log.wlg.service.EgovWebLogService;
import coreframework.com.sym.log.wlg.service.WebLog;
...
public class EgovWebLogController {
	 ...
	 * @throws Exception
	 */
	@IncludedInfo(name="웹로그관리", listUrl="/sym/log/wlg/SelectWebLogList.cm", order = 1070 ,gid = 60)
	@RequestMapping(value="/sym/log/wlg/SelectWebLogList.cm")
	public String selectWebLogInf(@ModelAttribute("searchVO") WebLog webLog,
		...
		return "coreframework/com/sym/log/wlg/EgovWebLogList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/wlg/SelectWebLogDetail.cm")
	public String selectWebLog(@ModelAttribute("searchVO") WebLog webLog,
		...
		return "coreframework/com/sym/log/wlg/EgovWebLogDetail";
	}
