package coreframework.com.sym.log.clg.web;

import java.util.HashMap;

import coreframework.com.sym.log.clg.service.EgovLoginLogService;
import coreframework.com.sym.log.clg.service.LoginLog;
...
public class EgovLoginLogController {
	...
	@RequestMapping(value="/sym/log/clg/SelectLoginLogList.cm")
	public String selectLoginLogInf(@ModelAttribute("searchVO") LoginLog loginLog,
		...
		return "coreframework/com/sym/log/clg/EgovLoginLogList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/clg/SelectLoginLogDetail.cm")
	public String selectLoginLog(@ModelAttribute("searchVO") LoginLog loginLog,
		...
		return "coreframework/com/sym/log/clg/EgovLoginLogDetail";
	}
