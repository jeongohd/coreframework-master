package coreframework.com.sym.log.lgm.web;

import coreframework.com.cmm.annotation.IncludedInfo;
import coreframework.com.sym.log.lgm.service.CoreSysLogService;
...
/**
 * @Class Name : CoreSysLogController.java
...
@Controller
public class CoreSysLogController {

	private static final Logger LOGGER = LoggerFactory.getLogger(CoreSysLogController.class);
	@Resource(name="CoreSysLogService")
	private CoreSysLogService sysLogService;
	 ...
	 * @throws Exception
	 */
	@IncludedInfo(name="로그관리", listUrl="/sym/log/lgm/coreSysLogList.cm", order = 1030 ,gid = 60)
	@RequestMapping(value="/sym/log/lgm/coreSysLogList.cm")
	public String selectSysLogInf(@ModelAttribute("searchVO") SysLog sysLog,
		...
		return "coreframework/com/sym/log/lgm/CoreSysLogList";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/lgm/coreSysLog.cm")
	public String selectSysLog(@ModelAttribute("searchVO") SysLog sysLog,
		...
		return "coreframework/com/sym/log/lgm/CoreSysLogDetail";
	}
}
