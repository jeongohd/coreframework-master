package coreframework.com.sym.log.slg.web;
...
import coreframework.com.sym.log.slg.service.EgovSysHistoryService;
import coreframework.com.sym.log.slg.service.SysHistory;
import coreframework.com.sym.log.slg.service.SysHistoryVO;
...
public class EgovSysHistoryController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/slg/InsertSysHistory.cm")
	public String insertSysHistory(
		...
		if (bindingResult.hasErrors()) {
			...
			return "coreframework/com/sym/log/slg/EgovSysHistRegist";
		}
		...
		status.setComplete();
		return "forward:/sym/log/slg/SelectSysHistoryList.cm";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/slg/AddSysHistory.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/slg/UpdateSysHistory.cm")
	public String updateSysHistory(
		...
		if (bindingResult.hasErrors()) {
			...
			List<?> _result = cmmUseService.selectCmmCodeDetail(vo);
			model.addAttribute("resultList", _result);
			return "coreframework/com/sym/log/slg/EgovSysHistUpdt";
		}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/slg/ModifySysHistory.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/slg/DeleteSysHistory.cm")
	 ...
	 * @throws Exception
	 */
	@IncludedInfo(name="시스템이력관리", listUrl="/sym/log/slg/SelectSysHistoryList.cm", order = 1060 ,gid = 60)
	@RequestMapping(value="/sym/log/slg/SelectSysHistoryList.cm")
	public String selectSysHistoryList(@ModelAttribute("searchVO") SysHistoryVO historyVO,
		...
		return "coreframework/com/sym/log/slg/EgovSysHistList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/log/slg/InqireSysHistory.cm")
	public String selectSysHistory(@ModelAttribute("searchVO") SysHistoryVO historyVO,
		...
		return "coreframework/com/sym/log/slg/EgovSysHistInqire";
	}
