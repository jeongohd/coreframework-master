package coreframework.com.sym.cal.web;
...
import coreframework.com.sym.cal.service.EgovCalRestdeManageService;
import coreframework.com.sym.cal.service.Restde;
import coreframework.com.sym.cal.service.RestdeVO;
...
public class EgovCalRestdeManageController {
	 ...
	 * 달력 메인창을 호출한다.
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovNormalCalPopup"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/cal/callCalPopup.cm")
 	public String callCalendar (ModelMap model
 			) throws Exception {
		return "coreframework/com/sym/cal/EgovCalPopup";
	}
	...
	@RequestMapping(value="/sym/cal/callCal.cm")
 	public String callCal (Restde restde, BindingResult bindingResult
		...
		if(bindingResult.hasErrors()){
			...
			return "coreframework/com/cmm/error/dataAccessFailure";
		...
		return "coreframework/com/sym/cal/EgovCalendar";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/cal/EgovNormalCalPopup.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovNormalCalendar"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/cal/EgovselectNormalCalendar.cm")
	 ...
	 * 행정달력 팝업 메인창을 호출한다.
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovAdministCalPopup"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/cal/EgovAdministCalPopup.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovAdministCalendar"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/cal/EgovselectAdministCalendar.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovNormalDayCalendar"
	 * @throws Exception
	 */
	@SuppressWarnings("static-access")
	@RequestMapping(value="/sym/cal/EgovNormalDayCalendar.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovNormalWeekCalendar"
	 * @throws Exception
	 */
	@SuppressWarnings("static-access")
	@RequestMapping(value="/sym/cal/EgovNormalWeekCalendar.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovNormalMonthCalendar"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/cal/EgovNormalMonthCalendar.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovNormalYearCalendar"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/cal/EgovNormalYearCalendar.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovAdministDayCalendar"
	 * @throws Exception
	 */
	@SuppressWarnings("static-access")
	@RequestMapping(value="/sym/cal/EgovAdministDayCalendar.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovAdministWeekCalendar"
	 * @throws Exception
	 */
	@SuppressWarnings("static-access")
	@RequestMapping(value="/sym/cal/EgovAdministWeekCalendar.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovAdministMonthCalendar"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/cal/EgovAdministMonthCalendar.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "coreframework/com/sym/cal/EgovAdministYearCalendar"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/cal/EgovAdministYearCalendar.cm")
	 ...
	 * @param restde
	 * @param model
	 * @return "forward:/sym/cal/EgovRestdeList.cm"
	 * @throws Exception
	 */
    @RequestMapping(value="/sym/cal/EgovRestdeRemove.cm")
     ...
     * @param bindingResult
     * @param model
     * @return "coreframework/com/sym/cal/EgovRestdeRegist"
     * @throws Exception
     */
    @RequestMapping(value="/sym/cal/EgovRestdeRegist.cm")
     ...
     * @param restde
     * @param model
     * @return "coreframework/com/sym/cal/EgovRestdeDetail"
     * @throws Exception
     */
	@RequestMapping(value="/sym/cal/EgovRestdeDetail.cm")
     ...
     * @param searchVO
     * @param model
     * @return "coreframework/com/sym/cal/EgovRestdeList"
     * @throws Exception
     */
	@IncludedInfo(name="공휴일관리(달력)", listUrl="/sym/cal/EgovRestdeList.cm", order = 1300 ,gid = 90)
    @RequestMapping(value="/sym/cal/EgovRestdeList.cm")
     ...
     * @param commandMap
     * @param model
     * @return "coreframework/com/sym/cal/EgovRestdeModify"
     * @throws Exception
     */
    @RequestMapping(value="/sym/cal/EgovRestdeModify.cm")
