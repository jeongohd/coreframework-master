package coreframework.com.sym.sym.srv.web;
...
import coreframework.com.sym.sym.srv.service.EgovServerService;
import coreframework.com.sym.sym.srv.service.Server;
import coreframework.com.sym.sym.srv.service.ServerEqpmn;
import coreframework.com.sym.sym.srv.service.ServerEqpmnRelate;
import coreframework.com.sym.sym.srv.service.ServerEqpmnRelateVO;
import coreframework.com.sym.sym.srv.service.ServerEqpmnVO;
import coreframework.com.sym.sym.srv.service.ServerVO;
...
public class EgovServerController {
	 ...
	 * @return String
	 */
    @RequestMapping(value="/sym/sym/srv/selectServerEqpmnListView.cm")
	public String selectServerEqpmnListView() throws Exception {
		return "coreframework/com/sym/sym/srv/EgovServerEqpmnList";
	}
    ...
    @RequestMapping(value="/sym/sym/srv/selectServerEqpmnList.cm")
	 ...
	 * @param serverEqpmnVO
	 */
    @RequestMapping(value="/sym/sym/srv/getServerEqpmn.cm")
	public String selectServerEqpmn(@RequestParam("serverEqpmnId") String serverEqpmnId,
		...
		return "coreframework/com/sym/sym/srv/EgovServerEqpmnDetail";
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/sym/sym/srv/addViewServerEqpmn.cm")
	public String insertViewServerEqpmn(@ModelAttribute("serverEqpmnVO") ServerEqpmnVO serverEqpmnVO,
    	...
    	return "coreframework/com/sym/sym/srv/EgovServerEqpmnRegist";
	}
	 ...
	 * @param serverEqpmn
	 */
    @RequestMapping(value="/sym/sym/srv/addServerEqpmn.cm")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/sym/sym/srv/updtViewServerEqpmn.cm")
	public String updateViewServerEqpmn(@RequestParam("serverEqpmnId") String serverEqpmnId,
		...
		model.addAttribute("serverEqpmn", egovServerService.selectServerEqpmn(serverEqpmnVO));
		model.addAttribute("message", coreMessageSource.getMessage("success.common.select"));
    	return "coreframework/com/sym/sym/srv/EgovServerEqpmnUpdt";
	}
	 ...
	 * @param serverEqpmn
	 */
    @RequestMapping(value="/sym/sym/srv/updtServerEqpmn.cm")
	public String updateServerEqpmn(@ModelAttribute("serverEqpmn") ServerEqpmn serverEqpmn,
		...
		if (bindingResult.hasErrors()) {
			...
			return "forward:/sym/sym/srv/getServerEqpmn.cm";
		}
	}
	 ...
	 * @param serverEqpmn
	 */
    @RequestMapping(value="/sym/sym/srv/removeServerEqpmn.cm")
	public String deleteServerEqpmn(@RequestParam("serverEqpmnId") String serverEqpmnId,
		...
		return "forward:/sym/sym/srv/selectServerEqpmnList.cm";
	}
	 ...
	 * @return String
	 */
    @RequestMapping(value="/sym/sym/srv/selectServerListView.cm")
	public String selectServerListView() throws Exception {
		return "coreframework/com/sym/sym/srv/EgovServerList";
	}
    ...
    @RequestMapping(value="/sym/sym/srv/selectServerList.cm")
	 ...
	 * @param serverVO
	 */
    @RequestMapping(value="/sym/sym/srv/getServer.cm")
	public String selectServer(@RequestParam("serverId") String serverId,
		...
		return "coreframework/com/sym/sym/srv/EgovServerDetail";
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/sym/sym/srv/addViewServer.cm")
	public String insertViewServer(@ModelAttribute("serverVO") ServerVO serverVO,
    	...
    	return "coreframework/com/sym/sym/srv/EgovServerRegist";
	}
	 ...
	 * @param server
	 */
    @RequestMapping(value="/sym/sym/srv/addServer.cm")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/sym/sym/srv/updtViewServer.cm")
	public String updateViewServer(@RequestParam("serverId") String serverId,
		...
		model.addAttribute("cmmCodeDetailList", getCmmCodeDetailList(new ComDefaultCodeVO(),"COM064"));
		model.addAttribute("message", coreMessageSource.getMessage("success.common.select"));
    	return "coreframework/com/sym/sym/srv/EgovServerUpdt";
	}
	 ...
	 * @param server
	 */
    @RequestMapping(value="/sym/sym/srv/updtServer.cm")
	public String updateServer(@ModelAttribute("server") Server server,
		...
		if (bindingResult.hasErrors()) {
    		...
    		return "coreframework/com/sym/sym/srv/EgovServerUpdt";
	   	    ...
	   	    status.setComplete();
			model.addAttribute("message", coreMessageSource.getMessage("success.common.update"));
			return "forward:/sym/sym/srv/getServer.cm";
		}
	}
	 ...
	 * @param server
	 */
    @RequestMapping(value="/sym/sym/srv/removeServer.cm")
	public String deleteServer(@RequestParam("serverId") String serverId,
		...
		model.addAttribute("message", coreMessageSource.getMessage("success.common.delete"));
		return "forward:/sym/sym/srv/selectServerList.cm";
	}
	 ...
	 */
    @RequestMapping(value="/sym/sym/srv/selectServerEqpmnRelateList.cm")
	public String selectServerEqpmnRelateList(@RequestParam("strServerId") String strServerId,
		...
		return "coreframework/com/sym/sym/srv/EgovServerEqpmnRelateRegist";
	}
	 ...
	 */
    @RequestMapping(value="/sym/sym/srv/saveServerEqpmnRelate.cm")
	public String saveServerEqpmnRelate(@RequestParam("serverId") String serverId,
        ...
        status.setComplete();
        model.addAttribute("message", coreMessageSource.getMessage("success.common.insert"));
		return "forward:/sym/sym/srv/selectServerEqpmnRelateList.cm";
	}
