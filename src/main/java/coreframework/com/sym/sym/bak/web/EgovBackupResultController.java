...
import coreframework.com.sym.sym.bak.service.EgovBackupResultService;
import coreframework.com.cmm.CoreMessageSource;
import coreframework.com.cmm.annotation.IncludedInfo;
import coreframework.com.sym.sym.bak.service.BackupResult;
...
public class EgovBackupResultController {
	 ...
	 */
    @RequestMapping("/sym/sym/bak/deleteBackupResult.cm")
	public String deleteBackupResult(BackupResult backupResult, ModelMap model)
	  throws Exception{
    	...
    	return "forward:/sym/sym/bak/getBackupResultList.cm";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/sym/bak/getBackupResult.cm")
	public String selectBackupResult(@ModelAttribute("searchVO")BackupResult backupResult, ModelMap model)
	  throws Exception{
		...
		return "coreframework/com/sym/sym/bak/EgovBackupResultDetail";
	}
	...
	@RequestMapping("/sym/sym/bak/getBackupResultList.cm")
	public String selectBackupResultList(@ModelAttribute("searchVO")BackupResult searchVO, ModelMap model)
	  throws Exception{
		...
		return "coreframework/com/sym/sym/bak/EgovBackupResultList";
	}
