package coreframework.com.sym.sym.bak.web;
...
import coreframework.com.sym.sym.bak.service.BackupOpert;
import coreframework.com.sym.sym.bak.service.BackupScheduler;
import coreframework.com.sym.sym.bak.service.EgovBackupOpertService;
import coreframework.com.sym.sym.bak.validation.BackupOpertValidator;
...
public class EgovBackupOpertController {
	 ...
	 */
    @RequestMapping("/sym/sym/bak/deleteBackupOpert.cm")
	public String deleteBackupOpert(BackupOpert backupOpert, ModelMap model)
	  throws Exception{
    	...
    	return "forward:/sym/sym/bak/getBackupOpertList.cm";
	}
	 ...
	 * @exception Exception Exception
	 */
    @RequestMapping("/sym/sym/bak/addBackupOpert.cm")
	  ...
	  throws Exception{
		...
		backupOpertValidator.validate(backupOpert, bindingResult);
	  	if (bindingResult.hasErrors()){
	  		referenceData(model);
	  		return "coreframework/com/sym/sym/bak/EgovBackupOpertRegist";
			}else{
	 ...
	 * @exception Exception Exception
	 */
    @RequestMapping("/sym/sym/bak/getBackupOpert.cm")
	public String selectBackupOpert(@ModelAttribute("searchVO")BackupOpert backupOpert, ModelMap model)
	  throws Exception{
		...
		return "coreframework/com/sym/sym/bak/EgovBackupOpertDetail";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/sym/bak/getBackupOpertForRegist.cm")
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/sym/bak/getBackupOpertForUpdate.cm")
	public String selectBackupOpertForUpdate(@ModelAttribute("searchVO")BackupOpert backupOpert, ModelMap model)
	  throws Exception{
        ...
        return "coreframework/com/sym/sym/bak/EgovBackupOpertUpdt";
	}
	...
	@RequestMapping("/sym/sym/bak/getBackupOpertList.cm")
	public String selectBackupOpertList(@ModelAttribute("searchVO")BackupOpert searchVO, ModelMap model)
	  throws Exception{
		...
		return "coreframework/com/sym/sym/bak/EgovBackupOpertList";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/sym/bak/updateBackupOpert.cm")
