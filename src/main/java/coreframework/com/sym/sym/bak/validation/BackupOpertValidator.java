package coreframework.com.sym.sym.bak.validation;
...
public class BackupOpertValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		...
		dir = new File(CoreWebUtil.filePathBlackList(srcDir));
		try {
			if (!dir.exists()) {
		...
		//KISA 보안약점 조치 (2018-10-29, 윤창원)
		dir = new File(CoreWebUtil.filePathBlackList(EgovStringUtil.isNullToString(backupOpert.getBackupStreDrctry())));
		try {
			if (!dir.exists()) {
