package coreframework.com.sym.mnu.mpm.service;

import coreframework.com.cmm.ComDefaultVO;
import coreframework.com.sym.mnu.mpm.mapper.CoreMenuManageMapper;
...
@Service("CoreMenuManageService")
public class CoreMenuManageService extends EgovAbstractMapper {

	private static final Logger LOGGER = LoggerFactory.getLogger(CoreMenuManageService.class);
...
//	private MenuManageDAO menuManageDAO;
	...
	@Resource(name = "CoreMenuManageMapper")
	private CoreMenuManageMapper coreMenuManageMapper;
	/**
	 * 메뉴 상세정보를 조회
	...
	public MenuManageVO selectMenuManage(ComDefaultVO vo) throws Exception {
		return coreMenuManageMapper.selectMenuManage(vo);
	}
	...
	public List<?> selectMenuManageList(ComDefaultVO vo) throws Exception {
		return coreMenuManageMapper.selectMenuManageList(vo);
	}
	...
	public int selectMenuManageListTotCnt(ComDefaultVO vo) throws Exception {
		return coreMenuManageMapper.selectMenuManageListTotCnt(vo);
	}
	...
	public int selectUpperMenuNoByPk(MenuManageVO vo) throws Exception {
		return coreMenuManageMapper.selectUpperMenuNoByPk(vo);
	}
	...
	public int selectMenuNoByPk(MenuManageVO vo) throws Exception {
		return coreMenuManageMapper.selectMenuNoByPk(vo);
	}
	...
	public void insertMenuManage(MenuManageVO vo) throws Exception {
		coreMenuManageMapper.insertMenuManage(vo);
	}
	...
	public void updateMenuManage(MenuManageVO vo) throws Exception {
		coreMenuManageMapper.updateMenuManage(vo);
	}
	...
	public void deleteMenuManage(MenuManageVO vo) throws Exception {
		coreMenuManageMapper.deleteMenuManage(vo);
	}
	...
	public List<?> selectMenuList() throws Exception {
		return coreMenuManageMapper.selectMenuList();
	}
	...
	public List<?> selectMainMenuHead(MenuManageVO vo) throws Exception {
		return coreMenuManageMapper.selectMainMenuHead(vo);
	}
	...
	public List<?> selectMainMenuLeft(MenuManageVO vo) throws Exception {
		return coreMenuManageMapper.selectMainMenuLeft(vo);
	}
	...
	public String selectLastMenuURL(int iMenuNo, String sUniqId) throws Exception {
		...
		return coreMenuManageMapper.selectLastMenuURL(vo);
	}
	...
	private int selectLastMenuNoChk(int iMenuNo, String sUniqId) throws Exception {
		...
		int chkMenuNo = 0;
		int cntMenuNo = 0;
		cntMenuNo = coreMenuManageMapper.selectLastMenuNoCnt(vo);
		if (cntMenuNo > 0) {
			chkMenuNo = coreMenuManageMapper.selectLastMenuNo(vo);
		} else {
			chkMenuNo = -1;
		}
		return chkMenuNo;
	...
	private String bndeRegist(InputStream inputStream) throws Exception {
		...
		try {
			...
			*/
			...
			if (coreProgrmManageMapper.selectProgrmListTotCnt_S() > 0) {
				return requestValue = "99";
			} //프로그램목록테이블 데이타 존재오류.
			if (coreMenuManageMapper.selectMenuListTotCnt() > 0) {
				return requestValue = "99";
			} //메뉴정보테이블 데이타 존재오류.
	...
	private boolean deleteAllMenuList() throws Exception {
		return coreMenuManageMapper.deleteAllMenuList();
	}
	...
	private boolean deleteAllProgrm() throws Exception {
		coreProgrmManageMapper.deleteAllProgrm();
		return true;
	}
	...
	private boolean deleteAllProgrmDtls() throws Exception {
		coreProgrmManageMapper.deleteAllProgrmDtls();
		return true;
	}
}