package coreframework.com.sym.mnu.mpm.mapper;
...
@Mapper("CoreMenuManageMapper")
@Repository
public interface CoreMenuManageMapper {
	...
	int selectMenuListTotCnt() throws Exception;

	boolean deleteAllMenuList() throws Exception;
}