package coreframework.com.sym.mnu.stm.web;
...
import coreframework.com.sym.mnu.stm.service.EgovSiteMapngService;
import coreframework.com.sym.mnu.stm.service.SiteMapngVO;
...
public class EgovSiteMapngController {
    ...
    @RequestMapping(value="/sym/mnu/stm/EgovSiteMapng.cm")
    public String selectSiteMapng(
    	...
    	if(resultVO == null){
    		model.addAttribute("resultMsg", coreMessageSource.getMessage("comSymMnuStm.siteMapng.validate.siteMap"));
    		return "coreframework/com/sym/mnu/stm/EgovSiteMapng";
    	}
