package coreframework.com.sym.mnu.mcm.web;
...
import coreframework.com.sym.mnu.mcm.service.EgovMenuCreateManageService;
import coreframework.com.sym.mnu.mcm.service.MenuCreatVO;
import coreframework.com.sym.mnu.mcm.service.MenuSiteMapVO;
...
public class EgovMenuCreateManageController {
	...
	@RequestMapping(value = "/sym/mnu/mcm/EgovMenuCreatManageSelect.cm")
	public String selectMenuCreatManagList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		if (searchVO.getSearchKeyword() != null && !searchVO.getSearchKeyword().equals("")) {
			...
			if (IDcnt == 0) {
				resultMsg = coreMessageSource.getMessage("info.nodata.msg");
			} else {
				// AuthorCode 검색
		...
		*/
		...
		return "coreframework/com/sym/mnu/mcm/EgovMenuCreatManage";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/EgovMenuCreatSelect.cm")
	public String selectMenuCreatList(@ModelAttribute("menuCreatVO") MenuCreatVO menuCreatVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/sym/mnu/mcm/EgovMenuCreat";
	}
	 ...
	 *            String
	 * @return 출력페이지정보 등록처리시 "forward:/sym/mnu/mcm/EgovMenuCreatSelect.cm"
	 * @exception Exception
	 */
	@RequestMapping("/sym/mnu/mcm/EgovMenuCreatInsert.cm")
	public String insertMenuCreatList(@RequestParam("checkedAuthorForInsert") String checkedAuthorForInsert, @RequestParam("checkedMenuNoForInsert") String checkedMenuNoForInsert,
		...
		model.addAttribute("resultMsg", resultMsg);
		return "forward:/sym/mnu/mcm/EgovMenuCreatSelect.cm";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/EgovMenuCreatSiteMapSelect.cm")
	public String selectMenuCreatSiteMap(@ModelAttribute("menuSiteMapVO") MenuSiteMapVO menuSiteMapVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/sym/mnu/mcm/EgovMenuCreatSiteMap";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/EgovMenuCreatSiteMapInsert.cm")
	public String selectMenuCreatSiteMapInsert(@ModelAttribute("menuSiteMapVO") MenuSiteMapVO menuSiteMapVO, @RequestParam("valueHtml") String valueHtml, ModelMap model
		...
		menuSiteMapVO.setBndeFilePath("/html/coreframework/com/sym/mnu/mcm/");
		 ...
		 * menuSiteMapVO
		 * .setTmp_rootPath("D:/coreframework/workspace/egovcmm/src/main/webapp"
		 * ); }else{menuSiteMapVO.setTmp_rootPath(
		 * "/product/jeus/webhome/was_com/coreframework-com-1_0/coreframework-com-1_0_war___"
		 * ); }
		 */
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/sym/mnu/mcm/EgovSiteMap.cm")
	public String selectSiteMap(@ModelAttribute("menuCreatVO") MenuSiteMapVO menuSiteMapVO, ModelMap model) throws Exception {
		...
		model.addAttribute("resultVO", menuSiteMapVO);
		return "coreframework/com/sym/mnu/mcm/EgovSiteMap";
	}
