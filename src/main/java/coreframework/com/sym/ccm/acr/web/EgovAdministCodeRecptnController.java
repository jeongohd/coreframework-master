package coreframework.com.sym.ccm.acr.web;

import java.util.List;
import java.util.Map;

import coreframework.com.sym.ccm.acr.service.AdministCodeRecptn;
import coreframework.com.sym.ccm.acr.service.AdministCodeRecptnVO;
import coreframework.com.sym.ccm.acr.service.EgovAdministCodeRecptnService;
...
public class EgovAdministCodeRecptnController {
	 ...
	 * @throws Exception
	 */
    @RequestMapping(value="/sym/ccm/acr/addAdministCode.cm")
	public String insertAdministCodeRecptn (AdministCodeRecptn administCodeRecptn
    	...
    	if   (sCmd.equals("")) {
    		...
    		return "coreframework/com/sym/ccm/acr/EgovAdministCodeRegist_TEST";
    	} else {
	        return "forward:/sym/ccm/acr/getAdministCodeRecptnList.cm";
    	}
    }
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/ccm/acr/getAdministCodeDetail.cm")
 	public String selectAdministCodeDetail (@ModelAttribute("administCode") AdministCodeRecptn administCode
		...
		return "coreframework/com/sym/ccm/acr/EgovAdministCodeDetail";
	}
     ...
     * @throws Exception
     */
	@IncludedInfo(name="행정코드관리", listUrl="/sym/ccm/acr/getAdministCodeRecptnList.cm", order = 1010 ,gid = 60)
    @RequestMapping(value="/sym/ccm/acr/getAdministCodeRecptnList.cm")
	public String selectAdministCodeRecptnList (@ModelAttribute("searchVO") AdministCodeRecptnVO searchVO
        ...
        return "coreframework/com/sym/ccm/acr/EgovAdministCodeRecptnList";
	}
     ...
     * @throws Exception
     */
    @RequestMapping(value="/sym/ccm/acr/getAdministCodeRecptnMainList.cm")
	public String selectAdministCodeRecptnMainList (@ModelAttribute("searchVO") AdministCodeRecptnVO searchVO
        ...
        return "coreframework/com/sym/ccm/acr/EgovAdministCodeRecptnMainList";
	}
