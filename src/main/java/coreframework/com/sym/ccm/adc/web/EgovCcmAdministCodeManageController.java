package coreframework.com.sym.ccm.adc.web;

import java.util.List;
import java.util.Map;

import coreframework.com.sym.ccm.adc.service.AdministCode;
import coreframework.com.sym.ccm.adc.service.AdministCodeVO;
import coreframework.com.sym.ccm.adc.service.EgovCcmAdministCodeManageService;
...
public class EgovCcmAdministCodeManageController {
	 ...
	 * @param administCode
	 * @param model
	 * @return "forward:/sym/ccm/adc/EgovCcmAdministCodeList.cm"
	 * @throws Exception
	 */
    @RequestMapping(value="/sym/ccm/adc/EgovCcmAdministCodeRemove.cm")
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/sym/ccm/adc/EgovCcmAdministCodeRegist"
	 * @throws Exception
	 */
    @RequestMapping(value="/sym/ccm/adc/EgovCcmAdministCodeRegist.cm")
	 ...
	 * @param administCode
	 * @param model
	 * @return "coreframework/com/sym/ccm/adc/EgovCcmAdministCodeDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/ccm/adc/EgovCcmAdministCodeDetail.cm")
     ...
     * @param searchVO
     * @param model
     * @return "coreframework/com/sym/ccm/adc/EgovCcmAdministCodeList"
     * @throws Exception
     */
	@IncludedInfo(name="행정코드관리", order = 1010  ,gid = 60)
    @RequestMapping(value="/sym/ccm/adc/EgovCcmAdministCodeList.cm")
	 ...
	 * 일반달력 팝업 메인창을 호출한다.
	 * @param model
	 * @return "coreframework/com/sym/ccm/adc/EgovCcmAdministCodePopup"
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/ccm/adc/EgovCcmAdministCodePopup.cm")
     ...
     * @param searchVO
     * @param model
     * @return "coreframework/com/sym/ccm/adc/EgovCcmAdministCode"
     * @throws Exception
     */
    @RequestMapping(value="/sym/ccm/adc/EgovCcmAdministCode.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/sym/ccm/adc/EgovCcmAdministCodeModify"
	 * @throws Exception
	 */
    @RequestMapping(value="/sym/ccm/adc/EgovCcmAdministCodeModify.cm")
