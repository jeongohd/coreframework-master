package coreframework.com.sym.ccm.zip.web;
...
import coreframework.com.sym.ccm.zip.service.Zip;
...
import coreframework.com.sym.ccm.zip.service.EgovCcmRdnmadZipManageService;
import coreframework.com.sym.ccm.zip.service.EgovCcmZipManageService;
import coreframework.com.sym.ccm.zip.service.ZipVO;
...
public class EgovCcmZipManageController {
	 ...
	 * @param model
	 * @return "coreframework/com/sym/ccm/zip/EgovCcmZipSearchPopup"
	 * @throws Exception
	 */
	@RequestMapping(value = "/sym/ccm/zip/EgovCcmZipSearchPopup.cm")
	 ...
	 * @param searchVO
	 * @param model
	 * @return "coreframework/com/sym/ccm/zip/EgovCcmZipSearchList"
	 * @throws Exception
	 */
	@RequestMapping(value = "/sym/ccm/zip/EgovCcmZipSearchList.cm")
	 ...
	 * @param zip
	 * @param model
	 * @return "forward:/sym/ccm/zip/EgovCcmZipList.cm"
	 * @throws Exception
	 */
	@RequestMapping(value = "/sym/ccm/zip/EgovCcmZipRemove.cm")
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/sym/ccm/zip/EgovCcmZipRegist"
	 * @throws Exception
	 */
	@RequestMapping(value = "/sym/ccm/zip/EgovCcmZipRegist.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/sym/ccm/zip/EgovCcmExcelZipRegist"
	 * @throws Exception
	 */
	@RequestMapping(value = "/sym/ccm/zip/EgovCcmExcelZipRegist.cm")
	 ...
	 * @param zip
	 * @param model
	 * @return "coreframework/com/sym/ccm/zip/EgovCcmZipDetail"
	 * @throws Exception
	 */
	@RequestMapping(value = "/sym/ccm/zip/EgovCcmZipDetail.cm")
	 ...
	 * @param searchVO
	 * @param model
	 * @return "coreframework/com/sym/ccm/zip/EgovCcmZipList"
	 * @throws Exception
	 */
	@IncludedInfo(name = "우편번호관리", listUrl = "/sym/ccm/zip/EgovCcmZipList.cm", order = 1000, gid = 50)
	@RequestMapping(value = "/sym/ccm/zip/EgovCcmZipList.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/sym/ccm/zip/EgovCcmZipModify"
	 * @throws Exception
	 */
	@RequestMapping(value = "/sym/ccm/zip/EgovCcmZipModify.cm")
	 ...
	 * @return
	 */
	@RequestMapping(value = "/sym/ccm/zip/EgovAdressPop.cm")
	public String selectAddPop() {
		return "coreframework/com/sym/ccm/zip/EgovAdressPop";
	}
}