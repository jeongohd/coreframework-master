package coreframework.com.sym.ccm.icr.web;

import java.util.List;
import java.util.Map;

import coreframework.com.sym.ccm.icr.service.EgovInsttCodeRecptnService;
import coreframework.com.sym.ccm.icr.service.InsttCodeRecptnVO;
...
import coreframework.com.sym.ccm.icr.service.InsttCodeRecptn;
...
public class EgovInsttCodeRecptnController {
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/sym/ccm/icr/EgovInsttCodeRegist_TEST"
	 * @return "forward:/sym/ccm/icr/getInsttCodeRecptnList.cm"
	 * @throws Exception
	 */
    @RequestMapping(value="/sym/ccm/icr/addInsttCode.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/sym/ccm/icr/getInsttCodeDetail.cm")
 	public String selectInsttCodeDetail (@ModelAttribute("insttCode") InsttCodeRecptn insttCode
		...
		return "coreframework/com/sym/ccm/icr/EgovInsttCodeDetail";
	}
     ...
     * @param searchVO
     * @param model
     * @return "coreframework/com/sym/ccm/icr/EgovInsttCodeRecptnList"
     * @throws Exception
     */
	@IncludedInfo(name="기관코드수신", listUrl="/sym/ccm/icr/getInsttCodeRecptnList.cm", order = 1020 ,gid = 60)
    @RequestMapping(value="/sym/ccm/icr/getInsttCodeRecptnList.cm")
     ...
     * @param searchVO
     * @param model
     * @return "coreframework/com/cmm/sym/ccm/EgovCcmInsttCodeList"
     * @throws Exception
     */
    @RequestMapping(value="/sym/ccm/icr/getInsttCodeRecptnMainList.cm")
	public String selectInsttCodeRecptnMainList (@ModelAttribute("searchVO") InsttCodeRecptnVO searchVO
        ...
        return "coreframework/com/sym/ccm/icr/EgovInsttCodeRecptnMainList";
	}
