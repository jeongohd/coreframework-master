...
import coreframework.com.sym.bat.service.BatchSchdul;
import coreframework.com.sym.bat.service.BatchScheduler;
import coreframework.com.sym.bat.service.EgovBatchSchdulService;
...
public class EgovBatchSchdulController {
	 ...
	 */
	@RequestMapping("/sym/bat/deleteBatchSchdul.cm")
	public String deleteBatchSchdul(BatchSchdul batchSchdul, ModelMap model) throws Exception {
		...
		return "forward:/sym/bat/getBatchSchdulList.cm";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/bat/addBatchSchdul.cm")
	public String insertBatchSchdul(BatchSchdul batchSchdul, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		if (bindingResult.hasErrors()) {
			referenceData(model);
			return "coreframework/com/sym/bat/EgovBatchSchdulRegist";
		} else {
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/bat/getBatchSchdul.cm")
	public String selectBatchSchdul(@ModelAttribute("searchVO") BatchSchdul batchSchdul, ModelMap model) throws Exception {
		...
		return "coreframework/com/sym/bat/EgovBatchSchdulDetail";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/bat/getBatchSchdulForRegist.cm")
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/bat/getBatchSchdulForUpdate.cm")
	public String selectBatchSchdulForUpdate(@ModelAttribute("searchVO") BatchSchdul batchSchdul, ModelMap model) throws Exception {
		...
		return "coreframework/com/sym/bat/EgovBatchSchdulUpdt";
	}
	...
	@IncludedInfo(name = "스케줄처리", listUrl = "/sym/bat/getBatchSchdulList.cm", order = 1140, gid = 60)
	@RequestMapping("/sym/bat/getBatchSchdulList.cm")
	public String selectBatchSchdulList(@ModelAttribute("searchVO") BatchSchdul searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/sym/bat/EgovBatchSchdulList";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/bat/updateBatchSchdul.cm")
