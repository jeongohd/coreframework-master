...
import coreframework.com.sym.bat.service.BatchResult;
import coreframework.com.sym.bat.service.EgovBatchResultService;
...
public class EgovBatchResultController {
	 ...
	 */
	@RequestMapping("/sym/bat/deleteBatchResult.cm")
	public String deleteBatchResult(BatchResult batchResult, ModelMap model) throws Exception {
		...
		return "forward:/sym/bat/getBatchResultList.cm";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/sym/bat/getBatchResult.cm")
	public String selectBatchResult(@ModelAttribute("searchVO") BatchResult batchResult, ModelMap model) throws Exception {
		...
		return "coreframework/com/sym/bat/EgovBatchResultDetail";
	}
	...
	@IncludedInfo(name = "배치결과관리", listUrl = "/sym/bat/getBatchResultList.cm", order = 1130, gid = 60)
	@RequestMapping("/sym/bat/getBatchResultList.cm")
	public String selectBatchResultList(@ModelAttribute("searchVO") BatchResult searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/sym/bat/EgovBatchResultList";
	}
