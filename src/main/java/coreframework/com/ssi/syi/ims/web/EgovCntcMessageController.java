package coreframework.com.ssi.syi.ims.web;
...
import coreframework.com.ssi.syi.ims.service.CntcMessageItem;
...
import coreframework.com.ssi.syi.ims.service.CntcMessage;
import coreframework.com.ssi.syi.ims.service.CntcMessageItemVO;
...
public class EgovCntcMessageController {
	 ...
	 * @param cntcMessage
	 * @param model
	 * @return "forward:/ssi/syi/ims/EgovCcmAdministCodeList.cm"
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/ims/removeCntcMessage.cm")
	public String deleteCntcMessage (CntcMessage cntcMessage
			, ModelMap model
			) throws Exception {
    	cntcMessageService.deleteCntcMessage(cntcMessage);
        return "forward:/ssi/syi/ims/getCntcMessageList.cm";
	}
	 ...
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/ims/removeCntcMessageItem.cm")
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/ssi/syi/ims/EgovCcmCntcMessageRegist"
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/ims/addCntcMessage.cm")
	public String insertCntcMessage (@ModelAttribute("cntcMessage") CntcMessage cntcMessage
    	...
    	if   (sCmd.equals("")) {
            ...
            return "coreframework/com/ssi/syi/ims/EgovCntcMessageRegist";
	 ...
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/ims/addCntcMessageItem.cm")
	public String insertCntcMessageItem (@ModelAttribute("cntcMessageItem") CntcMessageItem cntcMessageItem
    	...
    	if   (sCmd.equals("")) {
            ...
            return "coreframework/com/ssi/syi/ims/EgovCntcMessageItemRegist";
    	} else if (sCmd.equals("Regist")) {
	        ...
	        return "forward:/ssi/syi/ims/getCntcMessageDetail.cm";
    	} else {
	        return "forward:/ssi/syi/ims/getCntcMessageDetail.cm";
    	}
    }
	 ...
	 * @param cntcMessage
	 * @param model
	 * @return "coreframework/com/ssi/syi/ims/EgovCcmCntcMessageDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/ssi/syi/ims/getCntcMessageDetail.cm")
 	public String selectCntcMessageDetail (@ModelAttribute("cntcMessage") CntcMessage cntcMessage
		...
		return "coreframework/com/ssi/syi/ims/EgovCntcMessageDetail";
	}
     ...
     * @param searchVO
     * @param model
     * @return "coreframework/com/ssi/syi/ims/EgovCcmCntcMessageList"
     * @throws Exception
     */
	@IncludedInfo(name="연계메시지관리", listUrl="/ssi/syi/ims/getCntcMessageList.cm", order = 1230,gid = 70)
    @RequestMapping(value="/ssi/syi/ims/getCntcMessageList.cm")
	public String selectCntcMessageList (@ModelAttribute("searchVO") CntcMessageVO searchVO
        ...
        return "coreframework/com/ssi/syi/ims/EgovCntcMessageList";
	}
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/ssi/syi/ims/EgovCcmAdministCodeModify"
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/ims/updateCntcMessage.cm")
	public String updateCntcMessage (@ModelAttribute("cntcMessage") CntcMessage cntcMessage
    	...
    	if (sCmd.equals("")) {
    		...
    		return "coreframework/com/ssi/syi/ims/EgovCntcMessageUpdt";
	 ...
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/ims/updateCntcMessageItem.cm")
	public String updateCntcMessageItem (@ModelAttribute("cntcMessageItem") CntcMessageItem cntcMessageItem
    	...
    	if (sCmd.equals("")) {
    		...
    		return "coreframework/com/ssi/syi/ims/EgovCntcMessageItemUpdt";
    	} else if (sCmd.equals("Modify")) {
            beanValidator.validate(cntcMessageItem, bindingResult);
    		if (bindingResult.hasErrors()){
    			// 연계메시지 리스트박스 데이터
