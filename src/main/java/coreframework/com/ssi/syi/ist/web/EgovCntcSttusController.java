package coreframework.com.ssi.syi.ist.web;

import java.util.List;
import java.util.Map;

import coreframework.com.ssi.syi.ist.service.CntcSttus;
import coreframework.com.ssi.syi.ist.service.CntcSttusVO;
import coreframework.com.ssi.syi.ist.service.EgovCntcSttusService;
...
public class EgovCntcSttusController {
	 ...
	 * @param CntcSttus
	 * @param model
	 * @return "coreframework/com/cmm/sym/ccm/EgovCcmCntcSttusDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/ssi/syi/ist/getCntcSttusDetail.cm")
 	public String selectCntcSttusLogDetail (CntcSttus CntcSttus
		...
		return "coreframework/com/ssi/syi/ist/EgovCntcSttusDetail";
	}
     ...
     * @param searchVO
     * @param model
     * @return "coreframework/com/cmm/sym/ccm/EgovCcmCntcSttusList"
     * @throws Exception
     */
	@IncludedInfo(name="연계현황관리", listUrl="/ssi/syi/ist/getCntcSttusList.cm", order = 1220,gid = 70)
    @RequestMapping(value="/ssi/syi/ist/getCntcSttusList.cm")
	public String selectCntcSttusLogList (@ModelAttribute("searchVO") CntcSttusVO searchVO
        ...
        return "coreframework/com/ssi/syi/ist/EgovCntcSttusList";
	}
