package coreframework.com.ssi.syi.sim.web;
...
import coreframework.com.ssi.syi.sim.service.EgovSystemCntcService;
import coreframework.com.ssi.syi.sim.service.SystemCntc;
import coreframework.com.ssi.syi.sim.service.SystemCntcVO;
...
public class EgovSystemCntcController {
	 ...
	 * @param systemCntc
	 * @param model
	 * @return "forward:/ssi/syi/sim/EgovCcmAdministCodeList.cm"
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/sim/removeSystemCntc.cm")
	public String deleteSystemCntc (SystemCntc systemCntc
			, ModelMap model
			) throws Exception {
    	systemCntcService.deleteSystemCntc(systemCntc);
        return "forward:/ssi/syi/sim/getSystemCntcList.cm";
	}
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/ssi/syi/sim/EgovCcmSystemCntcRegist"
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/sim/addSystemCntc.cm")
	public String insertSystemCntc (@ModelAttribute("systemCntc") SystemCntc systemCntc
    	...
    	if   (sCmd.equals("")) {
            ...
            return "coreframework/com/ssi/syi/sim/EgovSystemCntcRegist";
	 ...
	 * @param systemCntc
	 * @param model
	 * @return "coreframework/com/ssi/syi/sim/EgovCcmSystemCntcDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/ssi/syi/sim/getSystemCntcDetail.cm")
 	public String selectSystemCntcDetail (SystemCntc systemCntc
    	...
    	String selfUri = "/ssi/syi/sim/getSystemCntcDetail.cm";
		...
		return "coreframework/com/ssi/syi/sim/EgovSystemCntcDetail";
	}
     ...
     * @param searchVO
     * @param model
     * @return "coreframework/com/ssi/syi/sim/EgovCcmSystemCntcList"
     * @throws Exception
     */
	@IncludedInfo(name="시스템연계관리", listUrl="/ssi/syi/sim/getSystemCntcList.cm", order = 1210,gid = 70)
    @RequestMapping(value="/ssi/syi/sim/getSystemCntcList.cm")
	public String selectSystemCntcList (@ModelAttribute("searchVO") SystemCntcVO searchVO
    	...
    	String selfUri = "/ssi/syi/sim/getSystemCntcList.cm";
        model.addAttribute("selfUri", selfUri);
        ...
        return "coreframework/com/ssi/syi/sim/EgovSystemCntcList";
	}
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/ssi/syi/sim/EgovCcmAdministCodeModify"
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/sim/updateSystemCntc.cm")
	public String updateSystemCntc (@ModelAttribute("systemCntc") SystemCntc systemCntc
    	...
    	if (sCmd.equals("")) {
    		...
    		return "coreframework/com/ssi/syi/sim/EgovSystemCntcUpdt";
	 ...
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/scm/getConfirmSystemCntcList.cm")
    //@RequestMapping(value="/ssi/syi/sim/getSystemCntcList.cm")
	public String selectConfirmSystemCntcList (@ModelAttribute("searchVO") SystemCntcVO searchVO
    	...
    	String selfUri = "/ssi/syi/scm/getConfirmSystemCntcList.cm";
        model.addAttribute("selfUri", selfUri);
	 ...
	 * @throws Exception
	 */
    @RequestMapping(value="/ssi/syi/scm/getConfirmSystemCntcDetail.cm")
	//@RequestMapping(value="/ssi/syi/sim/getSystemCntcDetail.cm")
 	public String selectConfirmSystemCntcDetail (SystemCntc systemCntc
    	...
    	String selfUri = "/ssi/syi/scm/getConfirmSystemCntcDetail.cm";
        model.addAttribute("selfUri", selfUri);
