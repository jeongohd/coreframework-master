package coreframework.com.ssi.syi.iis.web;
...
import coreframework.com.ssi.syi.ims.service.CntcMessageVO;
import coreframework.com.ssi.syi.ims.service.EgovCntcMessageService;
...
import coreframework.com.ssi.syi.iis.service.CntcInstt;
import coreframework.com.ssi.syi.iis.service.CntcInsttVO;
import coreframework.com.ssi.syi.iis.service.CntcService;
import coreframework.com.ssi.syi.iis.service.CntcServiceVO;
import coreframework.com.ssi.syi.iis.service.CntcSystem;
import coreframework.com.ssi.syi.iis.service.CntcSystemVO;
import coreframework.com.ssi.syi.iis.service.EgovCntcInsttService;
...
public class EgovCntcInsttController {
	 ...
	 * @param cntcInstt
	 * @param model
	 * @return "forward:/ssi/syi/iis/EgovCcmAdministCodeList.cm"
	 * @throws Exception
	 */
	@RequestMapping(value = "/ssi/syi/iis/removeCntcInstt.cm")
	public String deleteCntcInstt(CntcInstt cntcInstt, ModelMap model) throws Exception {
		...
		return "forward:/ssi/syi/iis/getCntcInsttList.cm";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/ssi/syi/iis/removeCntcSystem.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/ssi/syi/iis/removeCntcService.cm")
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/ssi/syi/iis/EgovCntcInsttRegist"
	 * @throws Exception
	 */
	@RequestMapping(value = "/ssi/syi/iis/addCntcInstt.cm")
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/ssi/syi/iis/EgovCntcSystemRegist"
	 * @throws Exception
	 */
	@RequestMapping(value = "/ssi/syi/iis/addCntcSystem.cm")
	public String insertCntcSystem(@ModelAttribute("cntcSystem") CntcSystem cntcSystem, BindingResult bindingResult, @RequestParam Map<?, ?> commandMap, ModelMap model)
		...
		if (sCmd.equals("")) {
			...
			return "forward:/ssi/syi/iis/getCntcInsttDetail.cm";
		} else {
			return "forward:/ssi/syi/iis/getCntcInsttDetail.cm";
		}
	}
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/ssi/syi/iis/EgovCntcServiceRegist"
	 * @throws Exception
	 */
	@RequestMapping(value = "/ssi/syi/iis/addCntcService.cm")
	 ...
	 * @param cntcInstt
	 * @param model
	 * @return "coreframework/com/ssi/syi/iis/EgovCcmCntcInsttDetail"
	 * @throws Exception
	 */
	@RequestMapping(value = "/ssi/syi/iis/getCntcInsttDetail.cm")
	public String selectCntcInsttDetail(@ModelAttribute("cntcInstt") CntcInstt cntcInstt, @ModelAttribute("cntcSystemVO") CntcSystemVO cntcSystemVO,
		...
		return "coreframework/com/ssi/syi/iis/EgovCntcInsttDetail";
	}
	 ...
	 * @param searchVO
	 * @param model
	 * @return "coreframework/com/ssi/syi/iis/EgovCntcInsttList"
	 * @throws Exception
	 */
	@IncludedInfo(name = "연계기관관리", listUrl = "/ssi/syi/iis/getCntcInsttList.cm", order = 1240, gid = 70)
	@RequestMapping(value = "/ssi/syi/iis/getCntcInsttList.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/ssi/syi/iis/EgovCntcInsttUpdt"
	 * @throws Exception
	 */
	@RequestMapping(value = "/ssi/syi/iis/updateCntcInstt.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/ssi/syi/iis/EgovCntcSystemModify"
	 * @throws Exception
	 */
	@RequestMapping(value = "/ssi/syi/iis/updateCntcSystem.cm")
	public String updateCntcSystem(@ModelAttribute("cntcSystem") CntcSystem cntcSystem, BindingResult bindingResult, @RequestParam Map<?, ?> commandMap, ModelMap model)
		...
		if (sCmd.equals("")) {
			...
			return "coreframework/com/ssi/syi/iis/EgovCntcSystemUpdt";
		} else if (sCmd.equals("Modify")) {
			beanValidator.validate(cntcSystem, bindingResult);
			if (bindingResult.hasErrors()) {
				// 연계기관 리스트박스 데이터
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/ssi/syi/iis/EgovCntcServiceModify"
	 * @throws Exception
	 */
	@RequestMapping(value = "/ssi/syi/iis/updateCntcService.cm")
	public String updateCntcService(@ModelAttribute("cntcService") CntcService cntcService, BindingResult bindingResult, @RequestParam Map<?, ?> commandMap, ModelMap model)
		...
		if (sCmd.equals("")) {
			...
			return "coreframework/com/ssi/syi/iis/EgovCntcServiceUpdt";
		} else if (sCmd.equals("Modify")) {
			beanValidator.validate(cntcService, bindingResult);
			if (bindingResult.hasErrors()) {
				// 연계기관 리스트박스 데이터
