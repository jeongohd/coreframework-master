package coreframework.com.sec.rnc.service;
...
public class EgovTimedSocket
{
	...
	{
		if (!CoreWebUtil.isIPAddress(ihost)) {	// 2011.10.25 보안점검 후속조치
	...
	static class SocketAction extends Thread
	{
		...
		public String getThreadInetAddr()
		{
			if (threadInetAddr == null) {
				...
				if (!CoreWebUtil.isIPAddress(threadInetAddr.getHostAddress())) {	// 2011.10.25 보안점검 후속조치
