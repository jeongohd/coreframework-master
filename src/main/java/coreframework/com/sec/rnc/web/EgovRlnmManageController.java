package coreframework.com.sec.rnc.web;
...
import coreframework.com.sec.rnc.service.EgovRlnmManageService;
...
public class EgovRlnmManageController {
	 ...
	 * 실명인증확인화면 호출(주민번호)
	 * @param model 모델
	 * @return "coreframework/com/uss/umt/EgovStplatCnfirm"
	 * @exception Exception
	 */
	@RequestMapping("/sec/rnc/EgovRlnmCnfirm.cm")
...
//			return "coreframework/com/sec/rnc/EgovRlnmCnfirm";
//		}
//
//		try {
...
//		}
		...
		if (nextUrlWhitelist.contains(nextUrl) == false) {
			...
			nextUrl= "coreframework/com/cmm/coreError";
		}
		
		// 안전한 경로 문자열로 조치
		nextUrl = CoreWebUtil.filePathBlackList(nextUrl);
...
//		return "coreframework/com/sec/rnc/EgovRlnmCnfirm";
	 ...
	 * @exception Exception
	 */
	@RequestMapping("/sec/rnc/EgovRlnmPinCnfirm.cm")
	public String rlnmPinCnfirm(Model model, @RequestParam Map<String, Object> commandMap, HttpServletRequest request) throws Exception {
		...
		return "coreframework/com/sec/rnc/EgovRlnmPinCnfirm";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping("/sec/rnc/EgovGPinCall.cm")
	public String gpinCall(Model model, @RequestParam Map<String, Object> commandMap) throws Exception {
		...
		return "coreframework/com/sec/rnc/gpin/Sample-AuthRequest";
	}

	/**
	 * validato rule dynamic Javascript
	 */
	@RequestMapping("/sec/rnc/validator.cm")
	public String validate() {
		return "coreframework/com/cmm/validator";
	}

	/**
	 * JSP 호출작업만 처리하는 공통 함수
	 */
	@RequestMapping(value = "/sec/rnc/CorePageLink.cm")
	public String moveToPage(@RequestParam("link") String linkPage) {
		...
		if (link == null || link.equals("")) {
			link = "coreframework/com/cmm/coreError";
		}
		...
		// 안전한 경로 문자열로 조치
		link = CoreWebUtil.filePathBlackList(link);
