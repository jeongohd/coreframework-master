package coreframework.com.sec.pki.web;
...
public class EgovCryptoController {
     ...
     * @return
     */
	@IncludedInfo(name="암호화/복호화", listUrl="/sec/pki/EgovCryptoInfo.cm", order = 2200 ,gid = 90)
    @RequestMapping(value="/sec/pki/EgovCryptoInfo.cm")
    public String displayCryptoInfo( @RequestParam Map<?, ?> commandMap,
    	...
    	return "coreframework/com/sec/pki/EgovCryptoInfo";
    }
