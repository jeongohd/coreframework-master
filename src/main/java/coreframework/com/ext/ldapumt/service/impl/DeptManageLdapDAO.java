 ...
 * @author 전우성(슈퍼개발자K3)
 */
package coreframework.com.ext.ldapumt.service.impl;
...
public class DeptManageLdapDAO extends OrgManageLdapDAO {
	...
	public List<Object> selectDeptManageSubList(String dn) throws Exception {
		...
		try {
			ucorgList = ldapTemplate.search(CoreWebUtil.removeLDAPInjectionRisk(dn), filter,
	...
	public boolean hasChildren(String dn) throws NamingException {
		...
		NamingEnumeration<SearchResult> n = ctx.search(CoreWebUtil.removeLDAPInjectionRisk(dn), filter, control);//2022.01 Potential LDAP Injection
