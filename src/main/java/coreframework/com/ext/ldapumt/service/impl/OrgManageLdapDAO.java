...
import coreframework.com.ext.ldapumt.service.LdapObject;
...
public class OrgManageLdapDAO extends EgovComAbstractDAO {
	...
	protected LdapObject selectOrgManageByDn(String dn, @SuppressWarnings("rawtypes") Class lookupClass) {
		...
		vo = (LdapObject) ldapTemplate.lookup(CoreWebUtil.removeLDAPInjectionRisk(dn), new ObjectMapper<Object>(lookupClass));//2022.01 Potential LDAP Injection
