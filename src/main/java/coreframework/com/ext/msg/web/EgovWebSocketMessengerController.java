 ...
 * @author 이영지(슈퍼개발자K3)
 */
package coreframework.com.ext.msg.web;
...
public class EgovWebSocketMessengerController {
	...
	@RequestMapping(value="/cop/msg/websocketMessengerView.cm")
	public String websocketMessengerView(HttpSession session, ModelMap model) {
		...
		return "coreframework/com/ext/msg/EgovMessenger";
	}
	 ...
	 * @return view name
	 */
	@RequestMapping(value="/cop/msg/websocketMessengerMain.cm")
	public String websocketMessengerMain(HttpSession session, ModelMap model) {
		model.addAttribute("loginVO", session.getAttribute("loginVO"));
		return "coreframework/com/ext/msg/EgovMessengerMain";
	}
	 ...
	 * @return view name
	 */
	@RequestMapping(value="/cop/msg/websocketMessengePopup.cm")
	public String websocketMessengePopup(@RequestParam(value="roomId") String roomId,
		...
		return "coreframework/com/ext/msg/popup/chatPopupBubble";
	}
}
