 ...
 * @author 이기하(슈퍼개발자K3)
 */
package coreframework.com.ext.oauth.service.impl;
...
public class CoreSignupServiceImpl extends EgovAbstractServiceImpl implements EgovSignupService {
...
//	private MberManageDAO mberManageDAO;
	...
	public String signup(UserProfile profile, WebRequest request, String key) throws Exception {
		...
		if (coreMberManageMapper.selectMber(key) == null) {
			...
			result = coreMberManageMapper.insertMber(mberManageVO);
