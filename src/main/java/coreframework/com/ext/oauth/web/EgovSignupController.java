 ...
 * @author 이기하(슈퍼개발자K3)
 */
package coreframework.com.ext.oauth.web;
...
import coreframework.com.ext.oauth.service.EgovSignupService;
import coreframework.com.ext.oauth.service.OAuthConfig;
import coreframework.com.ext.oauth.service.OAuthLogin;
import coreframework.com.ext.oauth.service.OAuthUniversalUser;
import coreframework.com.ext.oauth.service.OAuthVO;
...
public class EgovSignupController {
	...
	public String login(Model model) throws Exception {
		...
		return "coreframework/com/uat/uia/EgovLoginUsrOauth";
	}
	...
	public String oauthLoginCallback(@PathVariable String oauthService,
		...
		return "coreframework/com/uat/uia/EgovLoginUsrOauthResult";
	}
