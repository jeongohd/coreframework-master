...
public class EgovDoubleSubmitHelper {
	...
	public final static String SESSION_TOKEN_KEY = "coreframework.double.submit.preventer.session.key";
	
	public final static String PARAMETER_NAME = "coreframework.double.submit.preventer.parameter.name";
