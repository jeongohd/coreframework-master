		...
		for (Closeable resource : resources) {
			if (resource != null) {
				try {
					...
					CoreBasicLogger.ignore("Occurred IOException to close resource is ingored!!");
				} catch (Exception ignore) {
					CoreBasicLogger.ignore("Occurred Exception to close resource is ingored!!");
				}
			}
		}
	}
			...
			if (object != null) {
				if (object instanceof ResultSet) {
					try {
						...
						CoreBasicLogger.ignore("Occurred SQLException to close resource is ingored!!");
					} catch (Exception ignore) {
						CoreBasicLogger.ignore("Occurred Exception to close resource is ingored!!");
					}
	...
	public static void closeSocketObjects(Socket socket, ServerSocket server) {
		if (socket != null) {
			try {
				...
				CoreBasicLogger.ignore("Occurred Exception to shutdown ouput is ignored!!");
			}
			...
			try {
				...
				CoreBasicLogger.ignore("Occurred Exception to close resource is ignored!!");
			}
		}
