package coreframework.com.cmm.web;
...
import coreframework.com.cmm.IncludedCompInfoVO;
...
@Controller
public class CoreComIndexController implements ApplicationContextAware, InitializingBean {

	private ApplicationContext applicationContext;

	private static final Logger LOGGER = LoggerFactory.getLogger(CoreComIndexController.class);
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
		...
		LOGGER.info("CoreComIndexController setApplicationContext method has called!");
	}
	...
	@RequestMapping("/index.cm")
	public String index(ModelMap model) {

		return "coreframework/com/cmm/CoreUnitMain";
	}

	@RequestMapping("/main.cm")
	public String main(ModelMap model) {

		return "coreframework/layout/main";
	}

	@RequestMapping("/indexApi.cm")
	public String indexApi(ModelMap model) {
		return "coreframework/layout/LayoutIdx";
	}

	@RequestMapping("/CoreTop.cm")
	public String top() {
		return "coreframework/com/cmm/CoreUnitTop";
	}

	@RequestMapping("/CoreBottom.cm")
	public String bottom() {
		return "coreframework/com/cmm/CoreUnitBottom";
	}

	@RequestMapping("/CoreContent.cm")
	public String setContent(ModelMap model) throws Exception {
		...
		return "coreframework/com/cmm/CoreUnitContent";
	}

	@RequestMapping("/coreLeft.cm")
	public String setLeftMenu(ModelMap model) throws JsonProcessingException {
		...
		/*
		 * CoreLoginController가 AOP Proxy되는 바람에 클래스를 reflection으로 가져올 수 없음
		 */
		try {
			Class<?> loginController = Class.forName("coreframework.com.uat.uia.web.CoreLoginController");
			...
			LOGGER.error("No coreframework.com.uat.uia.web.CoreLoginController!!");
		}
		...
		model.addAttribute("resultListJson", new CoreUtil().modelToJson(map.values()));



		LOGGER.debug("CoreComIndexController index is called ");

		return "coreframework/com/cmm/CoreUnitLeft";
	}
	...
	// csrfAccessDeniedUrl="/egovCSRFAccessDenied.cm"
	@RequestMapping("/egovCSRFAccessDenied.cm")
	public String egovCSRFAccessDenied() {
		return "coreframework/com/cmm/error/csrfAccessDenied";
	}
}
