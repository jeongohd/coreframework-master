...
public class CoreComCrossSiteHndlr extends BodyTagSupport {
    ...
    public static void main(String[] args) throws IOException
    {
    	...
    	CoreComCrossSiteHndlr egovComCrossSiteHndlr = new CoreComCrossSiteHndlr();
