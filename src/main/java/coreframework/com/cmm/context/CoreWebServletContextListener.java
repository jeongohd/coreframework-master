package coreframework.com.cmm.context;
...
/**
 * CoreWebServletContextListener 클래스
 * <Notice>
...
public class CoreWebServletContextListener implements ServletContextListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(CoreWebServletContextListener.class);

    public CoreWebServletContextListener(){
