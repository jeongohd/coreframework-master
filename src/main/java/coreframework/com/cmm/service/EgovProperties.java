package coreframework.com.cmm.service;
...
public class EgovProperties {
	...
	//프로퍼티 파일의 물리적 위치
	//public static final String GLOBALS_PROPERTIES_FILE = System.getProperty("user.home") + FILE_SEPARATOR + "coreProps" +FILE_SEPARATOR + "globals.properties";
	...
	//public static final String RELATIVE_PATH_PREFIX = EgovProperties.class.getProtectionDomain().getCodeSource().getLocation().getPath().substring(0,EgovProperties.class.getProtectionDomain().getCodeSource().getLocation().getPath().indexOf("WEB-INF/classes/")+"WEB-INF/classes/".length())+"coreframework/";

	public static final String GLOBALS_PROPERTIES_FILE = RELATIVE_PATH_PREFIX + "coreProps" + FILE_SEPARATOR
		+ "globals.properties";
	...
	public static String getPathProperty(String keyName) {
		...
		return RELATIVE_PATH_PREFIX + "coreProps" + FILE_SEPARATOR + getProperty(keyName);
	}
	...
	public static String getPathProperty(String fileName, String keyName) {
		return RELATIVE_PATH_PREFIX + "coreProps" + FILE_SEPARATOR + getProperty(fileName, keyName);
	}
	...
	public static ArrayList<Map<String, String>> loadPropertyFile(String property) {
		...
		if (Files.exists(Paths.get(CoreWebUtil.filePathBlackList(src)))) { //2022.01 Potential Path Traversal
	...
	private static Properties loadPropertiesFromFile(String fileName) {
		...
		try (FileInputStream fis = new FileInputStream(CoreWebUtil.filePathBlackList(fileName));
