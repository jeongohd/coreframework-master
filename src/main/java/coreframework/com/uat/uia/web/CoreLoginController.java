package coreframework.com.uat.uia.web;
...
public class CoreLoginController {
	...
	/** log */
	private static final Logger LOGGER = LoggerFactory.getLogger(CoreLoginController.class);
	 ...
	 * @exception Exception
	 */
	@IncludedInfo(name = "로그인", listUrl = "/uat/uia/coreLoginUsr.cm", order = 10, gid = 10)
	@RequestMapping(value = "/uat/uia/coreLoginUsr.cm")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/actionLogin.cm")
	public String actionLogin(@ModelAttribute("loginVO") LoginVO loginVO, HttpServletRequest request, ModelMap model) throws Exception {
		...
		if (resultVO != null && resultVO.getId() != null && !resultVO.getId().equals("")) {
			...
			return "redirect:/uat/uia/actionMain.cm";
			//return "redirect:/index.cm";
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/actionCrtfctLogin.cm")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/actionMain.cm")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/actionLogout.cm")
	public String actionLogout(HttpServletRequest request, ModelMap model) throws Exception {

		/*String userIp = CoreClntInfo.getClntIP(request);
		...
		return "redirect:/CoreContent.cm";
		//return "redirect:/";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/egovIdPasswordSearch.cm")
	public String idPasswordSearchView(ModelMap model) throws Exception {
		...
		return "coreframework/com/uat/uia/CoreIdPasswordSearch";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/egovGpkiIssu.cm")
	public String gpkiIssuView(ModelMap model) throws Exception {
		return "coreframework/com/uat/uia/CoreGpkiIssu";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/searchId.cm")
	public String searchId(@ModelAttribute("loginVO") LoginVO loginVO, ModelMap model) throws Exception {
		...
		if (resultVO != null && resultVO.getId() != null && !resultVO.getId().equals("")) {
			...
			return "coreframework/com/uat/uia/CoreIdPasswordResult";
		} else {
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/searchPassword.cm")
	 ...
	 * 최초 한번만 실행하여, 암호화데이터를 CoreGpkiVariables.js의 ServerCert에 넣는다.
	 * @return String
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/getEncodingData.cm")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/CoreGpkiRegist.cm")
	public String gpkiRegistView(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		/*
		// 브라우저 이름을 받기위한 처리
		String webKind = CoreClntInfo.getClntWebKind(request);
		...
		try {
		    ...
		    return "coreframework/com/uat/uia/CoreGpkiRegist";
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uat/uia/actionGpkiRegist.cm")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value="/uat/uia/refreshSessionTimeout.cm")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value="/uat/uia/noticeExpirePwd.cm")
	public String noticeExpirePwd(@RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
		...
		return "coreframework/com/uat/uia/CoreExpirePwd";
	}
