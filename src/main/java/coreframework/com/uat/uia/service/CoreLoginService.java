package coreframework.com.uat.uia.service;
...
import coreframework.com.cop.ems.service.SndngMailVO;
import coreframework.com.uat.uia.mapper.CoreLoginMapper;
import coreframework.com.utl.fcc.service.EgovNumberUtil;
...
public class CoreLoginService extends EgovAbstractMapper{

//    @Resource(name="loginDAO")
//    private LoginDAO loginDAO;

	@Resource(name = "CoreLoginMapper")
	private CoreLoginMapper coreLoginMapper;
	...
	public LoginVO actionLoginByEsntlId(LoginVO vo) throws Exception {
    	...
    	LoginVO loginVO = coreLoginMapper.actionLoginByEsntlId(vo);
	...
	public LoginVO actionLogin(LoginVO vo) throws Exception {
    	...
    	LoginVO loginVO = coreLoginMapper.actionLogin(vo);
	...
	public LoginVO actionCrtfctLogin(LoginVO vo) throws Exception {
    	...
    	// 1. DN값으로 ID, PW를 조회한다.
    	LoginVO loginVO = coreLoginMapper.actionCrtfctLogin(vo);
	...
	public LoginVO searchId(LoginVO vo) throws Exception {
    	...
    	LoginVO loginVO = coreLoginMapper.searchId(vo);
	...
	public boolean searchPassword(LoginVO vo) throws Exception {
    	...
    	LoginVO loginVO = coreLoginMapper.searchPassword(vo);
    	...
    	coreLoginMapper.updatePassword(pwVO);
    ...
    public Map<?,?> selectLoginIncorrect(LoginVO vo) throws Exception{
    	return coreLoginMapper.selectLoginIncorrect(vo);
    }
    ...
    public String processLoginIncorrect(LoginVO vo, Map<?,?> mapLockUserInfo) throws Exception{
		...
		//패드워드 인증시
			...
			if("USR".equals(vo.getUserSe())) coreLoginMapper.updateLoginIncorrectUSR(mapParam);
			else if("ENT".equals(vo.getUserSe())) coreLoginMapper.updateLoginIncorrectENT(mapParam);
			else if("GNR".equals(vo.getUserSe())) coreLoginMapper.updateLoginIncorrectGNR(mapParam);
    		sRtnCode = "E";
        //패드워드 비인증시
    	}else if(!"Y".equals(((String)mapLockUserInfo.get("lockAt")))){
    		//LOCK 설정
    		if( Integer.parseInt(String.valueOf(mapLockUserInfo.get("lockCnt")))+1 >= coreLoginConfig.getLockCount() ){
	...
	public int selectPassedDayChangePWD(LoginVO vo) throws Exception {
		return coreLoginMapper.selectPassedDayChangePWD(vo);
	}
	...
	public LoginVO onepassLogin(String id) throws Exception {
    	LoginVO loginVO = coreLoginMapper.onepassLogin(id);
    	return loginVO;
    }
