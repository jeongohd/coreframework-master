package coreframework.com.uat.uia.mapper;
 ...
 *  </pre>EgovLoginService
 */

@Mapper("CoreLoginMapper")
@Repository
public interface CoreLoginMapper {
	...
	void updateLoginIncorrect(Map<String, String> mapParam);

	void updateLoginIncorrectUSR(Map<String, String> mapParam);

	void updateLoginIncorrectENT(Map<String, String> mapParam);

	void updateLoginIncorrectGNR(Map<String, String> mapParam);
}
