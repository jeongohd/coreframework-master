package coreframework.com.sts.cst.web;

import java.util.List;

import coreframework.com.sts.cst.service.EgovConectStatsService;
...
/*	@Resource(name="CoreCmmUseService")
	 ...
	 * @exception Exception
	 */
    @IncludedInfo(name="접속통계", listUrl="/sts/cst/selectConectStats.cm", order = 140 ,gid = 30)
    @RequestMapping(value="/sts/cst/selectConectStats.cm")
	public String selectUserStats(@ModelAttribute("statsVO") StatsVO statsVO,
        ...
        return "coreframework/com/sts/cst/EgovConectStats";
	}
}