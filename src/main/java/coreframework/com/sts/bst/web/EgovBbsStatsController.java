package coreframework.com.sts.bst.web;

import java.util.List;

import coreframework.com.sts.bst.service.EgovBbsStatsService;
...
public class EgovBbsStatsController {
	 ...
	 * @exception Exception
	 */
    @IncludedInfo(name="게시물통계", listUrl="/sts/bst/selectBbsStats.cm", order = 120 ,gid = 30)
    @RequestMapping(value="/sts/bst/selectBbsStats.cm")
	public String selectBbsStats(@ModelAttribute("statsVO") StatsVO statsVO,
        ...
        return "coreframework/com/sts/bst/EgovBbsStats";
	}
}