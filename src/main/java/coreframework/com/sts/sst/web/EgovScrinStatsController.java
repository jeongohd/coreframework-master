package coreframework.com.sts.sst.web;

import coreframework.com.cmm.annotation.IncludedInfo;
import coreframework.com.sts.com.StatsVO;
import coreframework.com.sts.sst.service.EgovScrinStatsService;
...
public class EgovScrinStatsController {
    ...
    private CoreMenuManageService menuManageService;
	 ...
	 * @exception Exception
	 */
    @IncludedInfo(name="화면통계", listUrl="/sts/sst/selectScrinStats.cm", order = 150 ,gid = 30)
    @RequestMapping(value="/sts/sst/selectScrinStats.cm")
	public String selectUserStats(@ModelAttribute("statsVO") StatsVO statsVO,
        ...
        return "coreframework/com/sts/sst/EgovScrinStats";
	}
}