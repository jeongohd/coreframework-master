package coreframework.com.cop.cmt.web;
...
public class EgovArticleCommentController {
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/selectArticleCommentList.cm")
    public String selectArticleCommentList(@ModelAttribute("searchVO") CommentVO commentVO, ModelMap model) throws Exception {
		...
		if (!commentVO.getCommentNo().equals("")) {
		    return "forward:/cop/cmt/updateArticleCommentView.cm";
		}
...
//		commentVO.setSubPageSize(propertyService.getInt("pageSize"));
		...
		return "coreframework/com/cop/cmt/EgovArticleCommentList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/insertArticleComment.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/deleteArticleComment.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/updateArticleCommentView.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmt/updateArticleComment.cm")
