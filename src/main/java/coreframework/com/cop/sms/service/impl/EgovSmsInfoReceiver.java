...
public class EgovSmsInfoReceiver extends EgovAbstractServiceImpl implements SMEListener {
	...
	public void close() {
		try {
			...
			CoreBasicLogger.ignore("Receiver close error");
		}
		...
		try {
			...
			CoreBasicLogger.ignore("Session Receiver close error");
		}
		...
		try {
			...
			CoreBasicLogger.ignore("Connection Receiver close error");
		}
	}
	...
	/*public static void mainExample(String[] args) {
		...
		try {
			...
			CoreBasicLogger.ignore("InterruptedException", ie);
		} finally {
			receiver.close();
		}
	}*/
