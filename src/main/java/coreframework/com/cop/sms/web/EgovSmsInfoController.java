package coreframework.com.cop.sms.web;
...
import coreframework.com.cop.sms.service.EgovSmsInfoService;
import coreframework.com.cop.sms.service.Sms;
import coreframework.com.cop.sms.service.SmsVO;
...
public class EgovSmsInfoController {
	...
	@RequestMapping("/cop/sms/selectSmsList.cm")
	public String selectSmsList(@ModelAttribute("searchVO") SmsVO smsVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/sms/EgovSmsInfoList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/cop/sms/addSms.cm")
	public String addSms(@ModelAttribute("searchVO") SmsVO smsVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/sms/EgovSmsInfoRegist";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/cop/sms/insertSms.cm")
	public String insertSms(@ModelAttribute("searchVO") SmsVO smsVO, @ModelAttribute("sms") Sms sms, BindingResult bindingResult, SessionStatus status, ModelMap model)
		...
		*/
		...
		return "forward:/cop/sms/selectSmsList.cm";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/cop/sms/selectSms.cm")
	public String selectSms(@ModelAttribute("searchVO") SmsVO smsVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/sms/EgovSmsInfoDetail";
	}
}
