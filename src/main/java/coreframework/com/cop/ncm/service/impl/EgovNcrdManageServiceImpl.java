package coreframework.com.cop.ncm.service.impl;
...
public class EgovNcrdManageServiceImpl extends EgovAbstractServiceImpl implements EgovNcrdManageService {
     ...
     * 명함 정보를 삭제한다.
     * 
     * @see coreframework.com.cop.ncm.num.service.EgovNcrdManageService#deleteNcrdItem(coreframework.com.cop.ncm.num.service.NameCard)
     */
     ...
     * 
     * @see coreframework.com.cop.ncm.num.service.EgovNcrdManageService#insertNcrdItem(coreframework.com.cop.ncm.num.service.NameCard)
     */
     ...
     * 명함사용자 정보를 등록한다.
     * 
     * @see coreframework.com.cop.ncm.num.service.EgovNcrdManageService#insertNcrdUseInf(coreframework.com.cop.ncm.num.service.NameCardUser)
     */
     ...
     * 
     * @see coreframework.com.cop.ncm.num.service.EgovNcrdManageService#selectNcrdItem(coreframework.com.cop.ncm.num.service.NameCard)
     */
     ...
     * 명함 정보에 대한 목록을 조회한다.
     * 
     * @see coreframework.com.cop.ncm.num.service.EgovNcrdManageService#selectNcrdItems(coreframework.com.cop.ncm.num.service.NameCard)
     */
     ...
     * 
     * @see coreframework.com.cop.ncm.num.service.EgovNcrdManageService#selectNcrdUseInf(coreframework.com.cop.ncm.num.service.NameCardUser)
     */
     ...
     * 명함 정보를 수정한다.
     * 
     * @see coreframework.com.cop.ncm.num.service.EgovNcrdManageService#updateNcrdItem(coreframework.com.cop.ncm.num.service.NameCard)
     */
     ...
     * 명함사용자 정보를 수정한다.
     * 
     * @see coreframework.com.cop.ncm.num.service.EgovNcrdManageService#updateNcrdUseInf(coreframework.com.cop.ncm.num.service.NameCardUser)
     */
     ...
     * 
     * @see coreframework.com.cop.ncm.num.service.EgovNcrdManageService#selectMyNcrdItems(coreframework.com.cop.ncm.num.service.NameCard)
     */
