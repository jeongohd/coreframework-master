package coreframework.com.cop.cmy.web;
...
import coreframework.com.cop.cmy.service.CommunityVO;
import coreframework.com.cop.cmy.service.EgovCommuManageService;
...
import coreframework.com.cop.cmy.service.CommunityUser;
import coreframework.com.cop.cmy.service.CommunityUserVO;
import coreframework.com.cop.cmy.service.EgovCommuBBSMasterService;
import coreframework.com.cop.cmy.service.EgovCommuMasterService;
...
public class EgovCommuManageController {
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/cmmntyMain.cm")
...
//		String tmplatCours = cmmntyService.selectCmmntyTemplat(cmmntyVO);
		...
		if ("".equals(tmplatCours) || tmplatCours == null) {
		    tmplatCours = "coreframework/com/cop/tpl/EgovCmmntyBaseTmpl";
		}
		...
		return "coreframework/com/cop/cmy/EgovCommuMain";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/cmmntyMainContents.cm")
    public String selectCmmntyMainContents(@ModelAttribute("searchVO") CommunityVO cmmntyVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/cmy/EgovCmmntyBaseTmplContents";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/insertCommuUserBySelf.cm")
    public String insertCmmntyUserBySelf(@ModelAttribute("cmmntyUser") CommunityUser cmmntyUser, ModelMap model) throws Exception {
		...
		if (isAuthenticated) {
		    ...
		    if (!retVal.equals("EXIST")) {
				...
				retVal = coreMessageSource.getMessage("comCopCmy.commuMain.joinMember.info.success"); //가입신청이 정상처리되었습니다.
		    } else {
		    	
		    	retVal = coreMessageSource.getMessage("comCopCmy.commuMain.joinMember.info.fail"); //이미 가입처리가 되어 있습니다.
		    }
		    ////-------------------------------------------
		}
		...
		return "redirect:/cop/cmy/cmmntyMain.cm";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/deleteCommuUserBySelf.cm")
    public String deleteCmmntyUserBySelf(@ModelAttribute("cmmntyUser") CommunityUserVO cmmntyUserVO, ModelMap model) throws Exception {
		...
		if(isAuthenticated && !isCommuAdmin) {
			...
			resultMsg = coreMessageSource.getMessage("comCopCmy.commuMain.deleteMember.info.success"); //탈퇴신청이 정상처리되었습니다.
		} else {
			resultMsg = coreMessageSource.getMessage("comCopCmy.commuMain.deleteMember.info.admin"); //관리자는 탈퇴할수 없습니다.
		}
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/selectCommuUserList.cm")
    public String selectCommuUserList(@ModelAttribute("searchVO") CommunityUserVO cmmntyUserVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/cmy/EgovCommuUserList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/insertCommuUser.cm")
    public String insertCommuUser(@ModelAttribute("searchVO") CommunityUserVO cmmntyUserVO, ModelMap model) throws Exception {
		...
		return "forward:/cop/cmy/selectCommuUserList.cm";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/deleteCommuUser.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/insertCommuUserAdmin.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/deleteCommuUserAdmin.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/previewCmmntyMainPage.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/previewCmmntyMainContents.cm")
    public String previewCmmntyMainContents(@ModelAttribute("searchVO") CommunityVO cmmntyVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/tpl/EgovCmmntyBaseTmplContents";
    }
