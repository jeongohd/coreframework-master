...
import coreframework.com.cop.cmy.service.Community;
...
public class EgovCommuMasterController {
    ...
    @RequestMapping("/cop/cmy/selectCommuMasterList.cm")
	...
	return "coreframework/com/cop/cmy/EgovCommuMasterList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/insertCommuMasterView.cm")
	...
	return "coreframework/com/cop/cmy/EgovCommuMasterRegist";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/insertCommuMaster.cm")
    public String insertCommuMaster(@ModelAttribute("searchVO") CommunityVO cmmntyVO, @ModelAttribute("commuMaster") Community community,
		...
		return "forward:/cop/cmy/selectCommuMasterList.cm";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/selectCommuMasterDetail.cm")
    public String selectCommuMasterDetail(@ModelAttribute("searchVO") CommunityVO cmmntyVO, ModelMap model, HttpServletRequest request) throws Exception {
		...
		// 제공 URL 
		//-----------------------
		result.setProvdUrl(request.getContextPath()+ "/cop/cmy/CommuMainPage.cm?cmmntyId=" + result.getCmmntyId());
		////---------------------
	
		model.addAttribute("result", result);
	
		return "coreframework/com/cop/cmy/EgovCommuMasterDetail";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/updateCommuMasterView.cm")
    public String updateCommuMasterView(@ModelAttribute("searchVO") CommunityVO cmmntyVO, ModelMap model)
		...
		return "coreframework/com/cop/cmy/EgovCommuMasterUpdt";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/updateCommuMaster.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/deleteCommuMaster.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/cmy/selectCommuMasterListPortlet.cm")
	...
	return "coreframework/com/cop/cmy/EgovCommuMasterListPortlet";
    }
}
