package coreframework.com.cop.com.web;

import java.util.Map;

import coreframework.com.cop.com.service.EgovUserInfManageService;
import coreframework.com.cop.com.service.UserInfVO;
...
public class EgovCopUserInfController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/cop/com/selectUserList.cm")
	public String selectUserList(@ModelAttribute("searchVO") UserInfVO userVO, @RequestParam Map<String, Object> commandMap, ModelMap model) throws Exception {
		...
		String returnUrl = "coreframework/com/cop/com/EgovUserList";
		
		if ("Y".equals(popFlag)) {
			returnUrl = "coreframework/com/cop/com/EgovUserListPop";
		}
