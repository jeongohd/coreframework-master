...
import coreframework.com.cop.bbs.service.BoardMaster;
import coreframework.com.cop.bbs.service.BoardMasterVO;
import coreframework.com.cop.bbs.service.EgovBBSMasterService;
import coreframework.com.cop.bbs.service.Blog;
import coreframework.com.cop.bbs.service.BlogUser;
import coreframework.com.cop.bbs.service.BlogVO;
...
public class EgovBBSMasterServiceImpl extends EgovAbstractServiceImpl implements EgovBBSMasterService {
	...
	public BoardMasterVO selectBBSMasterInf(BoardMasterVO boardMasterVO) throws Exception {
    	...
    	if(CoreComponentChecker.hasComponent("EgovBBSCommentService") || CoreComponentChecker.hasComponent("EgovBBSSatisfactionService")){//2011.09.15
