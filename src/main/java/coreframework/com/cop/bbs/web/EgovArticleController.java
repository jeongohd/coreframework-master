...
import coreframework.com.cop.cmt.service.EgovArticleCommentService;
...
public class EgovArticleController {
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/selectArticleList.cm")
    public String selectArticleList(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if(master.getBbsTyCode().equals("BBST03")){
			return "forward:/cop/bbs/selectGuestArticleList.cm";
		}
		...
		if (master.getTmplatCours() == null || master.getTmplatCours().equals("")) {
		    master.setTmplatCours("/css/coreframework/com/cop/tpl/egovBaseTemplate.css");
		}
		////-----------------------------
		...
		return "coreframework/com/cop/bbs/EgovArticleList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/selectArticleDetail.cm")
    public String selectArticleDetail(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if(!EgovStringUtil.isEmpty(vo.getSecretAt()) && vo.getSecretAt().equals("Y") && !((user == null || user.getUniqId() == null) ? "" : user.getUniqId()).equals(vo.getFrstRegisterId()))
			return"forward:/cop/bbs/selectArticleList.cm";
		...
		if (masterVo.getTmplatCours() == null || masterVo.getTmplatCours().equals("")) {
		    masterVo.setTmplatCours("/css/coreframework/com/cop/tpl/egovBaseTemplate.css");
		}
		...
		return "coreframework/com/cop/bbs/EgovArticleDetail";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/insertArticleView.cm")
    public String insertArticleView(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if (bdMstr.getTmplatCours() == null || bdMstr.getTmplatCours().equals("")) {
		    bdMstr.setTmplatCours("/css/coreframework/com/cop/tpl/egovBaseTemplate.css");
		}
		...
		return "coreframework/com/cop/bbs/EgovArticleRegist";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/insertArticle.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/replyArticleView.cm")
    public String addReplyBoardArticle(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		if(boardVO.getBlogAt().equals("chkBlog")){
			return "coreframework/com/cop/bbs/EgovArticleBlogReply";
		}else{
			return "coreframework/com/cop/bbs/EgovArticleReply";
		}
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/replyArticle.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/updateArticleView.cm")
    public String updateArticleView(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, ModelMap model)
		...
		if (bmvo.getTmplatCours() == null || bmvo.getTmplatCours().equals("")) {
		    bmvo.setTmplatCours("/css/coreframework/com/cop/tpl/egovBaseTemplate.css");
		}
		...
		if(boardVO.getBlogAt().equals("chkBlog")){
			return "coreframework/com/cop/bbs/EgovArticleBlogUpdt";
		}else{
			return "coreframework/com/cop/bbs/EgovArticleUpdt";
		}
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/updateArticle.cm")
    public String updateBoardArticle(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	CoreXssChecker.checkerUserXss(multiRequest, vo.getFrstRegisterId());
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/deleteArticle.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/selectGuestArticleList.cm")
    public String selectGuestArticleList(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/bbs/EgovGuestArticleList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/insertGuestArticle.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/deleteGuestArticle.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/updateGuestArticleView.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/updateGuestArticle.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/selectArticleBlogList.cm")
    public String selectArticleBlogList(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/bbs/EgovArticleBlogList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/selectArticleBlogDetail.cm")
    public ModelAndView selectArticleBlogDetail(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		//비밀글은 작성자만 볼수 있음 
		if(!EgovStringUtil.isEmpty(vo.getSecretAt()) && vo.getSecretAt().equals("Y") && !((user == null || user.getUniqId() == null) ? "" : user.getUniqId()).equals(vo.getFrstRegisterId()))
		mav.setViewName("forward:/cop/bbs/selectArticleList.cm");
		return mav;
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/selectArticleBlogDetailCn.cm")
    public ModelAndView selectArticleBlogDetailCn(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("commentVO") CommentVO commentVO, ModelMap model) throws Exception {
		...
		if (!commentVO.getCommentNo().equals("")) {
			mav.setViewName ("forward:/cop/cmt/updateArticleCommentView.cm");
		}
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/selectBlogListManager.cm")
    public String selectBlogMasterList(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "coreframework/com/cop/bbs/EgovBlogListManager";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/previewBoardList.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/bbs/previewBlogMainPage.cm")
    public String previewBlogMainPage(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		// 안전한 경로 문자열로 조치
		tmplatCours = CoreWebUtil.filePathBlackList(tmplatCours);
