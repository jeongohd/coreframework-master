package coreframework.com.cop.smt.dsm.web;
...
import coreframework.com.cop.smt.dsm.service.DiaryManageVO;
import coreframework.com.cop.smt.dsm.service.EgovDiaryManageService;
...
public class EgovDiaryManageController {
	...
	@RequestMapping(value="/cop/smt/dsm/EgovDiaryManageList.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/cop/smt/dsm/EgovDiaryManageDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/dsm/EgovDiaryManageDetail.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/cop/smt/dsm/EgovDiaryManageDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if(sCmd.equals("del")){
			egovDiaryManageService.deleteDiaryManage(diaryManageVO);
			sLocationUrl = "redirect:/cop/smt/dsm/EgovDiaryManageList.cm";
		}else{
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/cop/smt/dsm/EgovDiaryManageModify"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/cop/smt/dsm/EgovDiaryManageModify.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/cop/smt/dsm/EgovDiaryManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/cop/smt/dsm/EgovDiaryManageModifyActor"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/dsm/EgovDiaryManageModifyActor.cm")
	 ...
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/cop/smt/dsm/EgovDiaryManageRegist.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/cop/smt/dsm/EgovDiaryManageRegist";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/cop/smt/dsm/DiaryManageRegistActor"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/dsm/EgovDiaryManageRegistActor.cm")
