package coreframework.com.cop.smt.sam.web;

import java.util.List;
import java.util.Map;

import coreframework.com.cmm.CoreMessageSource;
import coreframework.com.cop.smt.sam.service.EgovAllSchdulManageService;
...
public class EgovAllSchdulManageController {
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/qrm/EgovAllSchdulManageList"
	 * @throws Exception
	 */
    @SuppressWarnings("unused")
	@IncludedInfo(name="전체일정관리", order = 350 ,gid = 40)
	@RequestMapping(value="/cop/smt/sam/EgovAllSchdulManageList.cm")
    ...
    throws Exception {
		...
		return "coreframework/com/cop/smt/sam/EgovAllSchdulManageList";
	}
