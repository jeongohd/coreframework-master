package coreframework.com.cop.smt.sdm.web;
...
import coreframework.com.cop.smt.sdm.service.DeptSchdulManageVO;
import coreframework.com.cop.smt.sdm.service.EgovDeptSchdulManageService;
...
public class EgovDeptSchdulManageController {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cop/smt/EgovMain.cm")
    public String egovMain(ModelMap model) throws Exception {
    	return "coreframework/com/cop/smt/sdm/EgovMain";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cop/smt/EgovLeft.cm")
    public String egovLeft(ModelMap model) throws Exception {
    	return "coreframework/com/cop/smt/sdm/EgovLeft";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageAuthorGroupPopup.cm")
    ...
    throws Exception {
    	...
    	return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageAuthorGroupPopup";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageEmpLyrPopup.cm")
    ...
    throws Exception {
    	...
    	return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageEmpLyrPopup";
    }
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageMainList"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageMainList.cm")
    ...
    throws Exception {
    	...
    	return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageMainList";
	 ...
	 * @param model
	 * @return "coreframework/com/cop/smt/dsm/EgovDiaryManageList"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageListPopup.cm")
    ...
    throws Exception {
		...
		return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageListPopup";
	}
	 ...
	 * @param deptSchdulManageVO
	 * @param model
	 * @return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageDailyList"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageDailyList.cm")
	 ...
	 * @param deptSchdulManageVO
	 * @param model
	 * @return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageWeekList"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageWeekList.cm")
	 ...
	 * @param deptSchdulManageVO
	 * @param model
	 * @return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageMonthList"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageMonthList.cm")
	 ...
	 * @param deptSchdulManageVO
	 * @param model
	 * @return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="부서일정관리", order = 320 ,gid = 40)
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageList.cm")
	public String egovDeptSchdulManageList(
			@ModelAttribute("searchVO") ComDefaultVO searchVO,
			@RequestParam Map<?, ?> commandMap,
			DeptSchdulManageVO deptSchdulManageVO,
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageDetail.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if(sCmd.equals("del")){
			egovDeptSchdulManageService.deleteDeptSchdulManage(deptSchdulManageVO);
			sLocationUrl = "redirect:/cop/smt/sdm/EgovDeptSchdulManageList.cm";
		}else{
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageModify"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageModify.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageModify";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageModifyActor.cm")
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageRegist"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageRegist.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/cop/smt/sdm/EgovDeptSchdulManageRegist";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sdm/EgovDeptSchdulManageRegistActor.cm")
