package coreframework.com.cop.smt.mrm.web;
...
import coreframework.com.cop.smt.mrm.service.EgovMemoReprtService;
import coreframework.com.cop.smt.mrm.service.MemoReprt;
import coreframework.com.cop.smt.mrm.service.MemoReprtVO;
import coreframework.com.cop.smt.mrm.service.ReportrVO;
...
public class EgovMemoReprtController {
	 ...
	 * @param reportrVO
	 */
	@RequestMapping("/cop/smt/mrm/selectReportrList.cm")
	public String selectReportrList(@ModelAttribute("searchVO") ReportrVO reportrVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/mrm/EgovReportrList";
	}
    ...
    @RequestMapping("/cop/smt/mrm/selectMemoReprtList.cm")
	public String selectMemoReprtList(@ModelAttribute("searchVO") MemoReprtVO memoReprtVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/mrm/EgovMemoReprtList";
	}
	 ...
	 * @param model
	 */
    @RequestMapping("/cop/smt/mrm/selectMemoReprt.cm")
	public String selectMemoReprt(@ModelAttribute("memoReprtVO") MemoReprtVO memoReprtVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/mrm/EgovMemoReprtDetail";
	}
	 ...
	 * @param model
	 */
    @RequestMapping("/cop/smt/mrm/addMemoReprt.cm")
	public String addMemoReprt(@ModelAttribute("memoReprtVO") MemoReprtVO memoReprtVO, BindingResult bindingResult, ModelMap model) throws Exception{
    	String sLocationUrl = "coreframework/com/cop/smt/mrm/EgovMemoReprtRegist";
	 ...
	 * @param model
	 */
    @RequestMapping("/cop/smt/mrm/modifyMemoReprt.cm")
	public String modifyMemoReprt(@ModelAttribute("memoReprtVO") MemoReprtVO memoReprtVO, BindingResult bindingResult, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/mrm/EgovMemoReprtUpdt";
	}
	 ...
	 * @param model
	 */
    @RequestMapping("/cop/smt/mrm/updateMemoReprt.cm")
	public String updateMemoReprt(final MultipartHttpServletRequest multiRequest, @RequestParam Map<?, ?> commandMap, @ModelAttribute("memoReprtVO") MemoReprtVO memoReprtVO, BindingResult bindingResult, ModelMap model) throws Exception{
		...
		return "forward:/cop/smt/mrm/selectMemoReprtList.cm";
	}
	...
	@RequestMapping("/cop/smt/mrm/updateMemoReprtDrctMatter.cm")
	 ...
	 * @param model
	 */
    @RequestMapping("/cop/smt/mrm/insertMemoReprt.cm")
	public String insertMemoReprt(final MultipartHttpServletRequest multiRequest, @ModelAttribute("memoReprtVO") MemoReprtVO memoReprtVO, BindingResult bindingResult, ModelMap model) throws Exception{
    	...
    	sLocationUrl = "forward:/cop/smt/mrm/selectMemoReprtList.cm";
	 ...
	 * @param model
	 */
    @RequestMapping("/cop/smt/mrm/deleteMemoReprt.cm")
