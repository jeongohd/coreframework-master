package coreframework.com.cop.smt.djm.web;
...
import coreframework.com.cmm.service.*;
import coreframework.com.cmm.util.CoreUserDetailsHelper;
import coreframework.com.cop.smt.djm.service.DeptJob;
import coreframework.com.cop.smt.djm.service.DeptJobVO;
import coreframework.com.cop.smt.djm.service.EgovDeptJobService;
...
import coreframework.com.cop.smt.djm.service.ChargerVO;
import coreframework.com.cop.smt.djm.service.DeptJobBx;
import coreframework.com.cop.smt.djm.service.DeptJobBxVO;
import coreframework.com.cop.smt.djm.service.DeptVO;
...
public class EgovDeptJobController {
	 ...
	 * @param chargerVO
	 */
	@RequestMapping("/cop/smt/djm/selectChargerList.cm")
	public String selectChargerList(@ModelAttribute("searchVO") ChargerVO chargerVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/djm/EgovChargerList";
	}
	 ...
	 * @param deptVO
	 */
	@RequestMapping("/cop/smt/djm/selectDeptListPopup.cm")
	public String selectDeptListPopup(@ModelAttribute("searchVO") DeptVO deptVO, ModelMap model) throws Exception{
		return "coreframework/com/cop/smt/djm/EgovDeptListPopup";
	}
	 ...
	 * @param deptVO
	 */
	@RequestMapping("/cop/smt/djm/selectDeptList.cm")
	public String selectDeptList(@ModelAttribute("searchVO") DeptVO deptVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/djm/EgovDeptList";
	}
	...
	@RequestMapping("/cop/smt/djm/selectDeptJobBxList.cm")
	public String selectDeptJobBxList(@ModelAttribute("searchVO") DeptJobBxVO deptJobBxVO, ModelMap model) throws Exception{
		//LoginVO user = (LoginVO)CoreUserDetailsHelper.getAuthenticatedUser();
		String sLocationUrl = "coreframework/com/cop/smt/djm/EgovDeptJobBxList";

		if(deptJobBxVO.getPopupCnd() != null && !deptJobBxVO.getPopupCnd().equals("")) sLocationUrl = "coreframework/com/cop/smt/djm/EgovDeptJobBxListS";
	 ...
	 * @param deptJobBxVO
	 */
//	@RequestMapping("/cop/smt/djm/selectDeptJobBx.cm")
...
//
//		return "coreframework/com/cop/smt/djm/EgovDeptJobBxDetail";
//	}
	 ...
	 * @param DeptJobBx
	 */
	@RequestMapping("/cop/smt/djm/addDeptJobBx.cm")
	public String addDeptJobBx(
			@ModelAttribute("deptJobBxVO") DeptJobBxVO deptJobBxVO,
			ModelMap model) throws Exception{
		String sLocationUrl = "coreframework/com/cop/smt/djm/EgovDeptJobBxRegist";
	 ...
	 * @param DeptJobBx
	 */
	@RequestMapping("/cop/smt/djm/getDeptJobBxOrdr.cm")
	public String getDeptJobBxOrdr(
		...
		if(request.getHeader("Referer").indexOf("addDeptJobBx.cm") < 0){
			sLocationUrl = "coreframework/com/cop/smt/djm/EgovDeptJobBxUpdt";
		}
	 ...
	 * @param DeptJobBx
	 */
	@RequestMapping("/cop/smt/djm/modifyDeptJobBx.cm")
	public String modifyDeptJobBx(@ModelAttribute("deptJobBxVO") DeptJobBxVO deptJobBxVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/djm/EgovDeptJobBxUpdt";
	}
	 ...
	 * @param deptJobBxVO
	 */
	@RequestMapping("/cop/smt/djm/updateDeptJobBx.cm")
	public String updateDeptJobBx(@ModelAttribute("deptJobBxVO") DeptJobBxVO deptJobBxVO, BindingResult bindingResult, ModelMap model) throws Exception{
		...
		return "forward:/cop/smt/djm/selectDeptJobBxList.cm";
	}
	 ...
	 * @param deptJobBx
	 */
	@RequestMapping("/cop/smt/djm/updateDeptJobBxOrdr.cm")
	 ...
	 * @param deptJobBxVO
	 */
	@RequestMapping("/cop/smt/djm/insertDeptJobBx.cm")
	public String insertDeptJobBx(@ModelAttribute("deptJobBxVO") DeptJobBxVO deptJobBxVO, BindingResult bindingResult, ModelMap model) throws Exception{
		...
		if(deptJobService.selectDeptJobBxCheck(deptJobBxVO) > 0){
			...
			sLocationUrl = "forward:/cop/smt/djm/addDeptJobBx.cm";
		}else{
			deptJobService.insertDeptJobBx(deptJobBxVO);
	    	sLocationUrl = "forward:/cop/smt/djm/selectDeptJobBxList.cm";
		}
		return sLocationUrl;
	}
	 ...
	 * @param DeptJobBx
	 */
	@RequestMapping("/cop/smt/djm/deleteDeptJobBx.cm")
	...
	@RequestMapping("/cop/smt/djm/selectDeptJobList.cm")
	public String selectDeptJobList(@ModelAttribute("searchVO") DeptJobVO deptJobVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/djm/EgovDeptJobList";
	}
	 ...
	 * @param deptJob
	 */
	@RequestMapping("/cop/smt/djm/addDeptJob.cm")
	public String addDeptJob(@ModelAttribute("deptJobVO") DeptJobVO deptJobVO, ModelMap model) throws Exception{
		String sLocationUrl = "coreframework/com/cop/smt/djm/EgovDeptJobRegist";
	 ...
	 * @param deptJob
	 */
	@RequestMapping("/cop/smt/djm/modifyDeptJob.cm")
	public String modifyDeptJob(@ModelAttribute("deptJobVO") DeptJobVO deptJobVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/djm/EgovDeptJobUpdt";
	}
	 ...
	 * @param deptJobVO
	 */
	@RequestMapping("/cop/smt/djm/selectDeptJob.cm")
	public String selectDeptJob(@ModelAttribute("deptJobVO") DeptJobVO deptJobVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/djm/EgovDeptJobDetail";
	}
	 ...
	 * @param deptJob
	 */
	@RequestMapping("/cop/smt/djm/updateDeptJob.cm")
	public String updateDeptJob(final MultipartHttpServletRequest multiRequest, @RequestParam Map<String, Object> commandMap, @ModelAttribute("deptJobVO") DeptJobVO deptJobVO, BindingResult bindingResult, ModelMap model) throws Exception{
		...
		return "forward:/cop/smt/djm/selectDeptJobList.cm";
	}
	 ...
	 * @param deptJob
	 */
	@RequestMapping("/cop/smt/djm/insertDeptJob.cm")
	public String insertDeptJob(final MultipartHttpServletRequest multiRequest, @ModelAttribute("deptJobVO") DeptJobVO deptJobVO, BindingResult bindingResult, ModelMap model) throws Exception{
    	...
    	sLocationUrl = "forward:/cop/smt/djm/selectDeptJobList.cm";
	 ...
	 * @param deptJob
	 */
	@RequestMapping("/cop/smt/djm/deleteDeptJob.cm")
