package coreframework.com.cop.smt.lsm.web;
...
import coreframework.com.cop.smt.lsm.service.*;
...
public class EgovLeaderSchdulController {
	 ...
	 * @param emplyrVO
	 */
	@RequestMapping("/cop/smt/lsm/selectEmplyrList.cm")
	public String selectEmplyrList(@ModelAttribute("searchVO") EmplyrVO emplyrVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/lsm/EgovEmplyrList";
	}
	...
	* @param LeaderSchdulVO
	...
	@RequestMapping(value="/cop/smt/lsm/usr/selectLeaderSchdulList.cm")
	public String selectLeaderSchdulList(@ModelAttribute("leaderSchdulVO") LeaderSchdulVO leaderSchdulVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/lsm/EgovLeaderSchdulList";
	}
	 ...
	 * @param leaderSchdulVO
	 */
	@RequestMapping(value="/cop/smt/lsm/usr/selectLeaderSchdulMonthList.cm")
	public String selectLeaderSchdulMonthList(@ModelAttribute("searchVO") LeaderSchdulVO leaderSchdulVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/lsm/EgovLeaderSchdulMonthList";
	}
	 ...
	 * @param leaderSchdulVO
	 */
	@RequestMapping(value="/cop/smt/lsm/usr/selectLeaderSchdulWeekList.cm")
	public String selectLeaderSchdulWeekList(@ModelAttribute("searchVO") LeaderSchdulVO leaderSchdulVO, ModelMap model) throws Exception{
		...
		****************************************************************** */
		...
		return "coreframework/com/cop/smt/lsm/EgovLeaderSchdulWeekList";
	}
	 ...
	 * @param leaderSchdulVO
	 */
	@RequestMapping(value="/cop/smt/lsm/usr/selectLeaderSchdulDailyList.cm")
	public String selectLeaderSchdulDailyList(@ModelAttribute("searchVO") LeaderSchdulVO leaderSchdulVO, ModelMap model) throws Exception{
		...
		****************************************************************** */
		...
		return "coreframework/com/cop/smt/lsm/EgovLeaderSchdulDailyList";
	}
	 ...
	 * @param leaderSchdulVO
	 */
	@RequestMapping(value="/cop/smt/lsm/usr/selectLeaderSchdul.cm")
	public String selectLeaderSchdul(@ModelAttribute("leaderSchdulVO") LeaderSchdulVO leaderSchdulVO,  ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/lsm/EgovLeaderSchdulDetail";
	}
	 ...
	 * @param leaderSchdulVO
	 */
	@RequestMapping(value="/cop/smt/lsm/mng/modifyLeaderSchdul.cm")
	public String modifyLeaderSchdul(@ModelAttribute("leaderSchdulVO") LeaderSchdulVO leaderSchdulVO,  ModelMap model) throws Exception{
		...
		String sLocationUrl = "coreframework/com/cop/smt/lsm/EgovLeaderSchdulModify";
     ...
     * @throws Exception
     */
	@RequestMapping(value="/cop/smt/lsm/mng/addLeaderSchdul.cm")
	public String addLeaderSchdul(
			@ModelAttribute("leaderSchdulVO") LeaderSchdulVO leaderSchdulVO, 
			BindingResult bindingResult,
    		ModelMap model)
	throws Exception {
		String sLocationUrl = "coreframework/com/cop/smt/lsm/EgovLeaderSchdulRegist";
	 ...
	 * @param leaderSchdul
	 */
	@RequestMapping(value="/cop/smt/lsm/mng/insertLeaderSchdul.cm")
	public String insertLeaderSchdul(@ModelAttribute("leaderSchdulVO") LeaderSchdulVO leaderSchdulVO,  
    	...
    	sLocationUrl = "forward:/cop/smt/lsm/usr/selectLeaderSchdulList.cm";
	 ...
	 * @param leaderSchdul
	 */
	@RequestMapping(value="/cop/smt/lsm/mng/updateLeaderSchdul.cm")
	 ...
	 * @param leaderSchdul
	 */
	@RequestMapping(value="/cop/smt/lsm/mng/deleteLeaderSchdul.cm")
	public String deleteLeaderSchdul(@ModelAttribute("leaderSchdulVO") LeaderSchdulVO leaderSchdulVO, ModelMap model) throws Exception{
		...
		return "forward:/cop/smt/lsm/usr/selectLeaderSchdulList.cm";
	}
	 ...
	 * @param leaderSttusVO
	 */
	@RequestMapping("/cop/smt/lsm/usr/selectLeaderSttusList.cm")
	public String selectLeaderSttusListView(@ModelAttribute("searchVO") LeaderSttusVO leaderSttusVO, ModelMap model) throws Exception{
		//LoginVO user = (LoginVO)CoreUserDetailsHelper.getAuthenticatedUser();
		String sLocationUrl = "coreframework/com/cop/smt/lsm/EgovLeaderSttusListView";
		
		boolean po = false;
		List<String> authenticated = CoreUserDetailsHelper.getAuthorities();
		...
		if(po){
			return "forward:/cop/smt/lsm/mng/selectLeaderSttusList.cm";
		}
	 ...
	 * @param leaderSttusVO
	 */
	@RequestMapping("/cop/smt/lsm/mng/selectLeaderSttusList.cm")
	public String selectLeaderSttusList(@ModelAttribute("searchVO") LeaderSttusVO leaderSttusVO, ModelMap model) throws Exception{
		//LoginVO user = (LoginVO)CoreUserDetailsHelper.getAuthenticatedUser();
		String sLocationUrl = "coreframework/com/cop/smt/lsm/EgovLeaderSttusList";
	 ...
	 * @param LeaderSttus
	 */
	@RequestMapping("/cop/smt/lsm/mng/addLeaderSttus.cm")
	public String addLeaderSttus(
			@ModelAttribute("leaderSttusVO") LeaderSttusVO leaderSttusVO,
			ModelMap model) throws Exception{
		String sLocationUrl = "coreframework/com/cop/smt/lsm/EgovLeaderSttusRegist";
	 ...
	 * @param LeaderSttus
	 */
	@RequestMapping("/cop/smt/lsm/mng/modifyLeaderSttus.cm")
	public String modifyLeaderSttus(@ModelAttribute("leaderSttusVO") LeaderSttusVO leaderSttusVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/lsm/EgovLeaderSttusUpdt";
	}
	 ...
	 * @param leaderSttusVO
	 */
	@RequestMapping("/cop/smt/lsm/mng/updateLeaderSttus.cm")
	 ...
	 * @param leaderSttusVO
	 */
	@RequestMapping("/cop/smt/lsm/mng/insertLeaderSttus.cm")
	public String insertLeaderSttus(@ModelAttribute("leaderSttusVO") LeaderSttusVO leaderSttusVO, BindingResult bindingResult, ModelMap model) throws Exception{
		...
		if(leaderSchdulService.selectLeaderSttusCheck(leaderSttusVO) > 0){
			...
			sLocationUrl = "forward:/cop/smt/lsm/mng/addLeaderSttus.cm";
		}else{
			leaderSchdulService.insertLeaderSttus(leaderSttusVO);
	    	sLocationUrl = "forward:/cop/smt/lsm/mng/selectLeaderSttusList.cm";
		}
		return sLocationUrl;
	}
	 ...
	 * @param LeaderSttus
	 */
	@RequestMapping("/cop/smt/lsm/mng/deleteLeaderSttus.cm")
