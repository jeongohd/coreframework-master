package coreframework.com.cop.smt.mtm.web;
...
import coreframework.com.cop.smt.mtm.service.EgovMemoTodoService;
import coreframework.com.cop.smt.mtm.service.MemoTodo;
import coreframework.com.cop.smt.mtm.service.MemoTodoVO;
...
public class EgovMemoTodoController {
    ...
    @RequestMapping("/cop/smt/mtm/selectMemoTodoList.cm")
	public String selectMemoTodoList(@ModelAttribute("searchVO") MemoTodoVO memoTodoVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/mtm/EgovMemoTodoList";
	}
	 ...
	 * @param memoTodoVO
	 */
    @RequestMapping("/cop/smt/mtm/selectMemoTodo.cm")
	public String selectMemoTodo(@ModelAttribute("memoTodoVO") MemoTodoVO memoTodoVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/mtm/EgovMemoTodoDetail";
	}
	 ...
	 * @param memoTodo
	 */
    @RequestMapping("/cop/smt/mtm/addMemoTodo.cm")
	public String addMemoTodo(@ModelAttribute("memoTodoVO") MemoTodoVO memoTodoVO, BindingResult bindingResult, ModelMap model) throws Exception{
    	String sLocationUrl = "coreframework/com/cop/smt/mtm/EgovMemoTodoRegist";
	 ...
	 * @param memoTodo
	 */
    @RequestMapping("/cop/smt/mtm/modifyMemoTodo.cm")
	public String modifyMemoTodo(@ModelAttribute("memoTodoVO") MemoTodoVO memoTodoVO, BindingResult bindingResult, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/mtm/EgovMemoTodoUpdt";
	}
	 ...
	 * @param memoTodo
	 */
    @RequestMapping("/cop/smt/mtm/updateMemoTodo.cm")
	public String updateMemoTodo(@ModelAttribute("memoTodoVO") MemoTodoVO memoTodoVO, BindingResult bindingResult, ModelMap model) throws Exception{
		...
		return "forward:/cop/smt/mtm/selectMemoTodoList.cm";
	}
	 ...
	 * @param memoTodo
	 */
    @RequestMapping("/cop/smt/mtm/insertMemoTodo.cm")
	public String insertMemoTodo(@ModelAttribute("memoTodoVO") MemoTodoVO memoTodoVO, BindingResult bindingResult, ModelMap model) throws Exception{
    	...
    	sLocationUrl = "forward:/cop/smt/mtm/selectMemoTodoList.cm";
	 ...
	 * @param memoTodo
	 */
    @RequestMapping("/cop/smt/mtm/deleteMemoTodo.cm")
	 ...
	 * @param memoTodoVO
	 */
    @RequestMapping("/cop/smt/mtm/selectMemoTodoListToday.cm")
	public String selectMemoTodoListToday(@ModelAttribute("searchVO") MemoTodoVO memoTodoVO, ModelMap model) throws Exception{
		...
		return "coreframework/com/cop/smt/mtm/EgovMemoTodoListToday";
	}
