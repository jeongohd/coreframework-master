package coreframework.com.cop.smt.sim.web;
...
import coreframework.com.cmm.*;
import coreframework.com.cmm.util.CoreUserDetailsHelper;
import coreframework.com.cop.smt.sim.service.EgovIndvdlSchdulManageService;
import coreframework.com.cop.smt.sim.service.IndvdlSchdulManageVO;
...
public class EgovIndvdlSchdulManageController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sim/EgovIndvdlSchdulManageMainList.cm")
	 ...
	 * @param model
	 * @return "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageDailyList"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sim/EgovIndvdlSchdulManageDailyList.cm")
	 ...
	 * @param indvdlSchdulManageVO
	 * @param model
	 * @return "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageWeekList"
	 * @throws Exception
	 */
	@SuppressWarnings({ "rawtypes", "unused", "unchecked" })
	@RequestMapping(value="/cop/smt/sim/EgovIndvdlSchdulManageWeekList.cm")
	 ...
	 * @param indvdlSchdulManageVO
	 * @param model
	 * @return "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageMonthList"
	 * @throws Exception
	 */
	@SuppressWarnings({ "rawtypes", "unused" })
	@RequestMapping(value="/cop/smt/sim/EgovIndvdlSchdulManageMonthList.cm")
	 ...
	 * @param indvdlSchdulManageVO
	 * @param model
	 * @return "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="일정관리", order = 330 ,gid = 40)
	@RequestMapping(value="/cop/smt/sim/EgovIndvdlSchdulManageList.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sim/EgovIndvdlSchdulManageDetail.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if(sCmd.equals("del")){
			egovIndvdlSchdulManageService.deleteIndvdlSchdulManage(indvdlSchdulManageVO);
			sLocationUrl = "redirect:/cop/smt/sim/EgovIndvdlSchdulManageList.cm";
		}else{
	        ...
	        if(CoreComponentChecker.hasComponent("egovDiaryManageService")){
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageModify"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/cop/smt/sim/EgovIndvdlSchdulManageModify.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageModifyActor"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sim/EgovIndvdlSchdulManageModifyActor.cm")
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageRegist"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sim/EgovIndvdlSchdulManageRegist.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageRegist";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/cop/smt/sim/EgovIndvdlSchdulManageRegistActor"
	 * @throws Exception
	 */
	@RequestMapping(value="/cop/smt/sim/EgovIndvdlSchdulManageRegistActor.cm")
