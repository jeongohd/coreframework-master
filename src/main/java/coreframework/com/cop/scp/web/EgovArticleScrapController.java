package coreframework.com.cop.scp.web;
...
import coreframework.com.cop.scp.service.EgovArticleScrapService;
import coreframework.com.cop.scp.service.Scrap;
import coreframework.com.cop.scp.service.ScrapVO;
...
public class EgovArticleScrapController {
    ...
    @RequestMapping("/cop/scp/selectArticleScrapList.cm")
    public String selectArticleScrapList(@ModelAttribute("searchVO") ScrapVO scrapVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/scp/EgovArticleScrapList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/scp/selectArticleScrapDetail.cm")
    public String selectArticleScrapDetail(@ModelAttribute("searchVO") ScrapVO scrapVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/scp/EgovArticleScrapDetail";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/scp/insertArticleScrapView.cm")
    public String insertArticleScrapView(@ModelAttribute("searchVO") ScrapVO scrapVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/scp/EgovArticleScrapRegist";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/scp/insertArticleScrap.cm")
    public String insertArticleScrap(@ModelAttribute("searchVO") ScrapVO scrapVO, @ModelAttribute("scrap") Scrap scrap,
		...
		return "forward:/cop/scp/selectArticleScrapList.cm";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/scp/deleteArticleScrap.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/scp/updateArticleScrapView.cm")
    public String updateArticleScrapView(@ModelAttribute("searchVO") ScrapVO scrapVO, @ModelAttribute("scrap") Scrap scrap, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/scp/EgovArticleScrapUpdt";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/cop/scp/updateArticleScrap.cm")
...
//     * @throws Exception
//     */
//    @RequestMapping("/cop/scp/selectScrapMainList.cm")
...
//	model.addAttribute("resultCnt", map.get("resultCnt"));
//
//	return "coreframework/com/cop/scp/EgovScrapMainList";
//    }
