...
import coreframework.com.cop.ems.service.EgovSndngMailDtlsService;
...
public class EgovSndngMailDtlsController {
	...
	@RequestMapping(value = "/cop/ems/selectSndngMailList.cm")
	public String selectSndngMailList(@ModelAttribute("searchVO") ComDefaultVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/ems/EgovMailDtls";
	}
	 ...
	 * @exception
	 */
	@RequestMapping(value = "/cop/ems/deleteSndngMailList.cm")
