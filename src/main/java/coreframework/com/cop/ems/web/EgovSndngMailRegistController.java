...
public class EgovSndngMailRegistController {
	...
	@RequestMapping(value = "/cop/ems/insertSndngMailView.cm")
	public String insertSndngMailView(@ModelAttribute("sndngMailVO") SndngMailVO sndngMailVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/cop/ems/EgovMailRegist";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/cop/ems/insertSndngMail.cm")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/cop/ems/backSndngMailRegist.cm")
