package coreframework.com.utl.sys.rsc.web;

import coreframework.com.cmm.CoreMessageSource;
import coreframework.com.cmm.annotation.IncludedInfo;
import coreframework.com.utl.sys.rsc.service.EgovLoginSesionCeckUtil;
...
public class EgovLoginSesionController {
	...
	@RequestMapping(value="/utl/sys/rsc/loginSessionView.cm")
	public String checkLoginSessionView() throws Exception {
		return "coreframework/com/utl/sys/rsc/EgovLoginSesionCheck";
	}
	 ...
	 * @return String
	 */
	@RequestMapping(value="/utl/sys/rsc/checkLloginSession.cm")
