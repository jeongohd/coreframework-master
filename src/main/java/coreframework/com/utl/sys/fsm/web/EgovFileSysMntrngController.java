package coreframework.com.utl.sys.fsm.web;
...
import coreframework.com.utl.sys.fsm.service.EgovFileSysMntrngService;
import coreframework.com.utl.sys.fsm.service.FileSysMntrng;
import coreframework.com.utl.sys.fsm.service.FileSysMntrngLogVO;
import coreframework.com.utl.sys.fsm.service.FileSysMntrngVO;
import coreframework.com.utl.sys.fsm.service.FileSystemChecker;
...
public class EgovFileSysMntrngController {
	...
	@RequestMapping("/utl/sys/fsm/selectFileSysMntrngList.cm")
	public String selectFileSysMntrngList(@ModelAttribute("searchVO") FileSysMntrngVO fileSysMntrngVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/utl/sys/fsm/EgovFileSysMntrngList";
	}
	 ...
	 * @param fileSysMntrngVO
	 */
	@RequestMapping("/utl/sys/fsm/addFileSysMntrng.cm")
	public String addFileSysMntrng(@ModelAttribute("fileSysMntrngVO") FileSysMntrngVO fileSysMntrngVO, BindingResult bindingResult, ModelMap model) throws Exception {
		String sLocationUrl = "coreframework/com/utl/sys/fsm/EgovFileSysMntrngRegist";
	 ...
	 * @param fileSysMntrngVO
	 */
	@RequestMapping("/utl/sys/fsm/modifyFileSysMntrng.cm")
	public String modifyFileSysMntrng(@ModelAttribute("fileSysMntrngVO") FileSysMntrngVO fileSysMntrngVO, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		return "coreframework/com/utl/sys/fsm/EgovFileSysMntrngUpdt";
	}
	 ...
	 * @param fileSysMntrngVO
	 */
	@RequestMapping("/utl/sys/fsm/selectFileSysMntrng.cm")
	public String selectFileSysMntrng(@ModelAttribute("ntwrkSvcMntrngVO") FileSysMntrngVO fileSysMntrngVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/utl/sys/fsm/EgovFileSysMntrngDetail";
	}
	 ...
	 * @param fileSysMntrng
	 */
	@RequestMapping("/utl/sys/fsm/updateFileSysMntrng.cm")
	public String updateFileSysMntrng(@ModelAttribute("fileSysMntrngVO") FileSysMntrngVO fileSysMntrngVO, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		return "forward:/utl/sys/fsm/selectFileSysMntrngList.cm";
	}
	 ...
	 * @param fileSysMntrng
	 */
	@RequestMapping("/utl/sys/fsm/insertFileSysMntrng.cm")
	public String insertFileSysMntrng(@ModelAttribute("fileSysMntrngVO") FileSysMntrngVO fileSysMntrngVO, BindingResult bindingResult, ModelMap model) throws Exception {
		...
		sLocationUrl = "forward:/utl/sys/fsm/selectFileSysMntrngList.cm";
	 ...
	 * @param fileSysMntrng
	 */
	@RequestMapping("/utl/sys/fsm/deleteFileSysMntrng.cm")
	 ...
	 * @param fileSysMntrng
	 */
	@RequestMapping("/utl/sys/fsm/selectFileSysMg.cm")
	public String selectFileSysMg(@ModelAttribute("fileSysMntrngVO") FileSysMntrngVO fileSysMntrngVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/utl/sys/fsm/EgovFileSysMntrngRegist";
	}
	 ...
	 */
	@RequestMapping("/utl/sys/fsm/selectFileSysMntrngLogList.cm")
	public String selectFileSysMntrngLogList(@ModelAttribute("searchVO") FileSysMntrngLogVO fileSysMntrngLogVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/utl/sys/fsm/EgovFileSysMntrngLogList";
	}
	 ...
	 * @param fileSysMntrngLogVO
	 */
	@RequestMapping("/utl/sys/fsm/selectFileSysMntrngLog.cm")
	public String selectFileSysMntrngLog(@ModelAttribute("fileSysMntrngLogVO") FileSysMntrngLogVO fileSysMntrngLogVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/utl/sys/fsm/EgovFileSysMntrngLogDetail";
	}
