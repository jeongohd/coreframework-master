package coreframework.com.utl.sys.fsm.service;
...
public class FileSystemUtils {
	...
	private List<String> performCommand(String[] cmdAttribs, int max) throws IOException {
		...
		// http://bugs.sun.com/bugdatabase/view_bug.cm?bug_id=4784692
		// http://bugs.sun.com/bugdatabase/view_bug.cm?bug_id=4801027
