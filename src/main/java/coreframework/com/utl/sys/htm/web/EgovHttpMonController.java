package coreframework.com.utl.sys.htm.web;
...
import coreframework.com.utl.sys.htm.service.EgovHttpMonService;
import coreframework.com.utl.sys.htm.service.HttpMon;
import coreframework.com.utl.sys.htm.service.HttpMonLog;
...
import coreframework.com.utl.sys.htm.service.HttpMntrngChecker;
import coreframework.com.utl.sys.htm.service.HttpMonLogVO;
import coreframework.com.utl.sys.htm.service.HttpMonVO;
...
public class EgovHttpMonController {
    ...
    @RequestMapping(value="/utl/sys/htm/EgovComUtlHttpMonList.cm")
	public String selectHttpMonList (@ModelAttribute("loginVO") LoginVO loginVO
        ...
        return "coreframework/com/utl/sys/htm/EgovComUtlHttpMonList";
	}
	 ...
	 * @param httpMonVO
	 */
	@RequestMapping(value="/utl/sys/htm/EgovComUtlHttpMonDetail.cm")
 	public String selectHttpMonDetail (@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/utl/sys/htm/EgovComUtlHttpMonDetail";
	}
	 ...
	 * @param siteUrl
	 */
    @RequestMapping(value="/utl/sys/htm/EgovComUtlHttpMonRegist.cm")
	public String insertHttpMon (
    	...
    	if   (httpMon.getWebKind() == null
    		...
    		return "coreframework/com/utl/sys/htm/EgovComUtlHttpMonRegist";
    	}
        ...
        return "forward:/utl/sys/htm/EgovComUtlHttpMonList.cm";
    }
	 ...
	 * @param siteUrl
	 */
    @RequestMapping(value="/utl/sys/htm/EgovComUtlHttpMonModify.cm")
	public String updateHttpMon (@ModelAttribute("loginVO") LoginVO loginVO
    	...
    	if (sCmd.equals("")) {
    		...
    		return "coreframework/com/utl/sys/htm/EgovComUtlHttpMonModify";
	 ...
	 * @param siteUrl
	 */
    @RequestMapping(value="/utl/sys/htm/EgovComUtlHttpMonRemove.cm")
	 ...
	 * @param httpSttusCd
	 */
    @RequestMapping("/utl/sys/htm/selectHttpMonSttus.cm")
	 ...
	 * @param httpMonVO
	 */
    @RequestMapping(value="/utl/sys/htm/EgovComUtlHttpMonLogList.cm")
	public String selectHttpMonLogList (@ModelAttribute("loginVO") LoginVO loginVO
        ...
        return "coreframework/com/utl/sys/htm/EgovComUtlHttpMonLogList";
	 ...
	 * @param httpMonVO
	 */
	@RequestMapping(value="/utl/sys/htm/EgovComUtlHttpMonDetailLog.cm")
 	public String selectHttpMonDetailLog (@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/utl/sys/htm/EgovComUtlHttpMonDetailLog";
	}
