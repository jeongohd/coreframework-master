package coreframework.com.utl.sys.trm.web;
...
import coreframework.com.utl.sys.trm.service.CntcVO;
import coreframework.com.utl.sys.trm.service.EgovTrsmrcvMntrngService;
import coreframework.com.utl.sys.trm.service.TrsmrcvMntrng;
import coreframework.com.utl.sys.trm.service.TrsmrcvMntrngLog;
...
public class EgovTrsmrcvMntrngController {
	 ...
	 */
    @RequestMapping("/utl/sys/trm/deleteTrsmrcvMntrng.cm")
	public String deleteTrsmrcvMntrng(@ModelAttribute("searchVO") TrsmrcvMntrng trsmrcvMntrng, ModelMap model)
	  throws Exception{
    	...
    	return "forward:/utl/sys/trm/getTrsmrcvMntrngList.cm";
	}
	 ...
	 * @exception Exception Exception
	 */
    @RequestMapping("/utl/sys/trm/addTrsmrcvMntrng.cm")
	public String insertTrsmrcvMntrng(TrsmrcvMntrng trsmrcvMntrng, BindingResult bindingResult, ModelMap model)
	  throws Exception{
    	...
    	if (bindingResult.hasErrors()){
    		...
    		return "coreframework/com/utl/sys/trm/EgovTrsmrcvMntrngRegist";
		}else{
    		//아이디 설정
	 ...
	 * @exception Exception Exception
	 */
    @RequestMapping("/utl/sys/trm/getTrsmrcvMntrng.cm")
	public String selectTrsmrcvMntrng(@ModelAttribute("searchVO") TrsmrcvMntrng trsmrcvMntrng, ModelMap model)
      ...
      return "coreframework/com/utl/sys/trm/EgovTrsmrcvMntrngDetail";
	 ...
	 * @exception Exception Exception
	 */
    @RequestMapping("/utl/sys/trm/getTrsmrcvMntrngLog.cm")
	public String selectTrsmrcvMntrngLog(@ModelAttribute("searchVO") TrsmrcvMntrngLog trsmrcvMntrngLog, ModelMap model)
      ...
      return "coreframework/com/utl/sys/trm/EgovTrsmrcvMntrngLogDetail";
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/utl/sys/trm/getTrsmrcvMntrngForRegist.cm")
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/utl/sys/trm/getTrsmrcvMntrngForUpdate.cm")
	public String selectTrsmrcvMntrngForUpdate(@ModelAttribute("searchVO") TrsmrcvMntrng trsmrcvMntrng, ModelMap model)
      ...
      return "coreframework/com/utl/sys/trm/EgovTrsmrcvMntrngUpdt";
	...
	@RequestMapping("/utl/sys/trm/getTrsmrcvMntrngList.cm")
	public String selectTrsmrcvMntrngList(@ModelAttribute("searchVO") TrsmrcvMntrng searchVO, ModelMap model)
	  throws Exception{
		...
		return "coreframework/com/utl/sys/trm/EgovTrsmrcvMntrngList";
	}
	 ...
	 */
	@SuppressWarnings("unused")
	@RequestMapping("/utl/sys/trm/getTrsmrcvMntrngLogList.cm")
	public String selectTrsmrcvMntrngLogList(@ModelAttribute("searchVO") TrsmrcvMntrngLog searchVO, ModelMap model)
	  throws Exception{
		...
		return "coreframework/com/utl/sys/trm/EgovTrsmrcvMntrngLogList";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/utl/sys/trm/updateTrsmrcvMntrng.cm")
	 ...
	 */
	@SuppressWarnings("unused")
	@RequestMapping("/utl/sys/trm/getCntcList.cm")
	public String selectCntcList(@ModelAttribute("searchVO") CntcVO searchVO, ModelMap model)
	  throws Exception {
		...
		return "coreframework/com/utl/sys/trm/EgovCntcListPopup";
	}
	/**
	 * 연계정보 조회팝업을 실행한다.
	 * @return 리턴URL
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/utl/sys/trm/getCntcListPopup.cm")
	public String openPopupWindow(@ModelAttribute("searchVO") CntcVO searchVO, ModelMap model)
	  throws Exception{
		return "coreframework/com/utl/sys/trm/EgovCntcListPopupFrame";
	}
