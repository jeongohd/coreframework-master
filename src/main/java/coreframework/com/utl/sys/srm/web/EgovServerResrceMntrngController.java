package coreframework.com.utl.sys.srm.web;
...
import coreframework.com.utl.sys.srm.service.EgovServerResrceMntrngService;
import coreframework.com.utl.sys.srm.service.ServerResrceMntrngVO;
...
public class EgovServerResrceMntrngController {
	...
	@RequestMapping(value="/utl/sys/srm/selectMntrngServerList.cm")
	public String selectMntrngServerList(@ModelAttribute("serverResrceMntrngVO") ServerResrceMntrngVO serverResrceMntrngVO,
		...
		return "coreframework/com/utl/sys/srm/EgovMntrngServerList";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/utl/sys/srm/selectServerResrceMntrngListView.cm")
	public String selectServerResrceMntrngListView(@ModelAttribute("pmServerResrceMntrng") ServerResrceMntrngVO pmServerResrceMntrng, 
		...
		return "coreframework/com/utl/sys/srm/EgovServerResrceMntrngList";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/utl/sys/srm/selectServerResrceMntrngList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/utl/sys/srm/getServerResrceMntrng.cm")
	public String selectServerResrceMntrng(@RequestParam("logId") String logId,
		...
		return "coreframework/com/utl/sys/srm/EgovServerResrceMntrngDetail";
	}
