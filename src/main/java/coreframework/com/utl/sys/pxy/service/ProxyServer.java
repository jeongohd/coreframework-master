package coreframework.com.utl.sys.pxy.service;
...
import coreframework.com.utl.sys.pxy.service.impl.ProxySvcDAO;
		...
		try {
			while (runningThread) {
				...
				if (client.isConnected()) {
					...
					String svcIp = CoreWebUtil.filePathBlackList(getSvcIp());
	...
	public void insertProxyLog() {
		...
		try {
			...
			if (client.getInetAddress() != null) {
				if (!CoreWebUtil.isIPAddress((client.getInetAddress().getHostAddress()))) {
