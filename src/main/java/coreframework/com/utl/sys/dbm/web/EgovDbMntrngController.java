package coreframework.com.utl.sys.dbm.web;
...
import coreframework.com.utl.sys.dbm.service.DbMntrng;
import coreframework.com.utl.sys.dbm.service.DbMntrngLog;
import coreframework.com.utl.sys.dbm.service.EgovDbMntrngService;
...
public class EgovDbMntrngController {
	 ...
	 */
    @RequestMapping("/utl/sys/dbm/deleteDbMntrng.cm")
	public String deleteDbMntrng(DbMntrng dbMntrng, ModelMap model)
	  throws Exception{
    	...
    	return "forward:/utl/sys/dbm/getDbMntrngList.cm";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/utl/sys/dbm/addDbMntrng.cm")
	public String insertDbMntrng(DbMntrng dbMntrng, BindingResult bindingResult, ModelMap model)
	  throws Exception{
    	...
    	if (bindingResult.hasErrors()){
    		...
    		return "coreframework/com/utl/sys/dbm/EgovDbMntrngRegist";
		}else{
    		//아이디 설정
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/utl/sys/dbm/getDbMntrng.cm")
	public String selectDbMntrng(@ModelAttribute("searchVO")DbMntrng dbMntrng, ModelMap model)
	  throws Exception{
        ...
        return "coreframework/com/utl/sys/dbm/EgovDbMntrngDetail";
	}
	...
	@RequestMapping("/utl/sys/dbm/getDbMntrngLog.cm")
	public String selectDbMntrngLog(@ModelAttribute("searchVO")DbMntrngLog dbMntrngLog, ModelMap model)
	  throws Exception{
        ...
        return "coreframework/com/utl/sys/dbm/EgovDbMntrngLogDetail";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/utl/sys/dbm/getDbMntrngForRegist.cm")
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/utl/sys/dbm/getDbMntrngForUpdate.cm")
	public String selectDbMntrngForUpdate(@ModelAttribute("searchVO") DbMntrng dbMntrng, ModelMap model)
      ...
      return "coreframework/com/utl/sys/dbm/EgovDbMntrngUpdt";
	}
	...
	@RequestMapping("/utl/sys/dbm/getDbMntrngList.cm")
	public String selectDbMntrngList(@ModelAttribute("searchVO") DbMntrng searchVO, ModelMap model)
	  throws Exception{
		...
		return "coreframework/com/utl/sys/dbm/EgovDbMntrngList";
	}
	 ...
	 */
	@SuppressWarnings("unused")
	@RequestMapping("/utl/sys/dbm/getDbMntrngLogList.cm")
	public String selectDbMntrngLogList(@ModelAttribute("searchVO") DbMntrngLog searchVO, ModelMap model)
	  throws Exception{
		...
		return "coreframework/com/utl/sys/dbm/EgovDbMntrngLogList";
	}
	 ...
	 * @exception Exception Exception
	 */
	@RequestMapping("/utl/sys/dbm/updateDbMntrng.cm")
