package coreframework.com.utl.pao.web;
...
import coreframework.com.utl.pao.service.PrntngOutptVO;
...
import coreframework.com.utl.pao.service.EgovPrntngOutpt;
...
public class EgovErncslController extends HttpServlet {
	 ...
	 * @see
	*/
	@RequestMapping(value = "/utl/pao/EgovErncsl.cm")
