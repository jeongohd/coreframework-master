package coreframework.com.utl.jso.web;
...
public class EgovUtlJsonController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/utl/jso/EgovUtlJsonInquire.cm",method = RequestMethod.GET)
    public String selectUtlJsonInquire()  throws Exception {
        return "coreframework/com/utl/jso/EgovUtlJsonInquire";
    }
    
    @RequestMapping(value="/utl/jso/EgovUtlJsonInquire.cm",method = RequestMethod.POST)
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/utl/jso/EgovUtlJsonMultiInquire.cm",method = RequestMethod.GET)
    public String selectUtlJsonMultiInquire(@RequestParam Map<?, ?> commandMap)  throws Exception {    	
        return "coreframework/com/utl/jso/EgovUtlJsonMultiInquire";
    }
    @RequestMapping(value="/utl/jso/EgovUtlJsonMultiInquire.cm",method = RequestMethod.POST)
