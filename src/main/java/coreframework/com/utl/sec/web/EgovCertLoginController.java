package coreframework.com.utl.sec.web;

import coreframework.com.utl.sec.service.EgovCertInfoUtil;
...
public class EgovCertLoginController {
     ...
     * @throws Exception
     */
    @RequestMapping("/utl/sec/certVar.cm")
	...
	if (typeInfo.equalsIgnoreCase("login")) {
		startPage = "/utl/sec/certLogin.cm";
	} else if (typeInfo.equalsIgnoreCase("regist")) {
		startPage = "/utl/sec/certInfoPopup.cm";
	} else {
	    startPage = "/utl/sec/certLogin.cm";
	}
	...
	return "coreframework/com/utl/sec/EgovCertVar";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/utl/sec/certInstall.cm")
	...
	return "coreframework/com/utl/sec/EgovCertInstall";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/utl/sec/certSetup.cm")
    public String certSetup() throws Exception {
	return "coreframework/com/utl/sec/EgovCertSetup";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/utl/sec/certInfoPopup.cm")
    public String certInfoPopup(Model model) throws Exception {

	return "coreframework/com/utl/sec/EgovCertInfoPopup";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/utl/sec/certLogin.cm", method=RequestMethod.GET)
    public String certLogin() throws Exception {

	return "coreframework/com/utl/sec/EgovCertLogin";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/utl/sec/certLogin.cm", method=RequestMethod.POST)
	...
	return "coreframework/com/utl/sec/EgovCertLoginConfirm";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/utl/sec/certLoginInfo.cm")
    public String certLoginPopup() throws Exception {

	return "coreframework/com/utl/sec/EgovCertLoginInfo";
    }
}
