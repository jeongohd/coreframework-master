package coreframework.com.dam.mgm.web;
...
import coreframework.com.dam.mgm.service.EgovKnoManagementService;
import coreframework.com.dam.mgm.service.KnoManagement;
import coreframework.com.dam.mgm.service.KnoManagementVO;
...
public class EgovKnoManagementController {
	 ...
	 */
    @IncludedInfo(name="지식정보관리", listUrl="/dam/mgm/EgovComDamManagementList.cm", order = 1280 ,gid = 80)
	@RequestMapping(value="/dam/mgm/EgovComDamManagementList.cm")
	public String selectKnoManagementList(@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/dam/mgm/EgovComDamManagementList";
	}
	 ...
	 * @param KnoManagementVO
	 */
	@RequestMapping(value="/dam/mgm/EgovComDamManagement.cm")
	public String selectKnoManagement(
		...
		return "coreframework/com/dam/mgm/EgovComDamManagementDetail";
	}
	 ...
	 * @param knoNm
	 */
	@RequestMapping(value="/dam/mgm/EgovComDamManagementModify.cm")
	public String  updateKnoManagement(
		...
		if (sCmd.equals("")) {
			...
			return "coreframework/com/dam/mgm/EgovComDamManagementModify";
			...
			return "forward:/dam/mgm/EgovComDamManagementList.cm";
		} else {
			return "forward:/dam/mgm/EgovComDamManagementList.cm";
		}
	}
