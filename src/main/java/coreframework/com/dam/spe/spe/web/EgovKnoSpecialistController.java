package coreframework.com.dam.spe.spe.web;
...
import coreframework.com.dam.spe.spe.service.EgovKnoSpecialistService;
import coreframework.com.dam.spe.spe.service.KnoSpecialist;
import coreframework.com.dam.spe.spe.service.KnoSpecialistVO;
...
public class EgovKnoSpecialistController {
	 ...
	 */
    @IncludedInfo(name="지식전문가관리", listUrl="/dam/spe/spe/EgovComDamSpecialistList.cm", order = 1270,gid = 80)
	@RequestMapping(value="/dam/spe/spe/EgovComDamSpecialistList.cm")
	public String selectKnoSpecialistList(@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/dam/spe/spe/EgovComDamSpecialistList";
	}
	 ...
	 */
	@RequestMapping(value="/dam/spe/spe/EgovComDamSpecialist.cm")
	public String selectKnoSpecialist(@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/dam/spe/spe/EgovComDamSpecialistDetail";
	}
	 ...
	 * @param speNm
	 */
	@RequestMapping(value="/dam/spe/spe/EgovComDamSpecialistRegist.cm")
	public String insertKnoSpecialist(
		...
		if (knoSpecialist.getSpeId() == null
			...
			return "coreframework/com/dam/spe/spe/EgovComDamSpecialistRegist";
			...
			return "forward:/dam/spe/spe/EgovComDamSpecialistList.cm";
	 ...
	 * @param speNm
	 */
	@RequestMapping(value="/dam/spe/spe/EgovComDamSpecialistModify.cm")
	public String updateKnoSpecialist(@ModelAttribute("speId") KnoSpecialist knoSpecialist
		...
		if (sCmd.equals("")) {
			...
			return "coreframework/com/dam/spe/spe/EgovComDamSpecialistModify";
	 ...
	 * @param speNm
	 */
	@RequestMapping(value="/dam/spe/spe/EgovComDamSpecialistRemove.cm")
