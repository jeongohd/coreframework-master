package coreframework.com.dam.per.web;
...
import coreframework.com.dam.per.service.EgovKnoPersonalService;
import coreframework.com.dam.per.service.KnoPersonal;
import coreframework.com.dam.per.service.KnoPersonalVO;
...
public class EgovKnoPersonalController {
	 ...
	 * @param KnoPersonalVO
	 */
    @IncludedInfo(name="개인지식관리", listUrl="/dam/per/EgovComDamPersonalList.cm", order = 1250,gid = 80)
	@RequestMapping(value="/dam/per/EgovComDamPersonalList.cm")
	public String selectKnoPersonalList(
		...
		return "coreframework/com/dam/per/EgovComDamPersonalList";
	}
	 ...
	 * @param KnoPersonalVO
	 */
	@RequestMapping(value="/dam/per/EgovComDamPersonal.cm")
	public String selectKnoPersonal(@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/dam/per/EgovComDamPersonalDetail";
	}
	 ...
	 * @param KnoNm
	 */
	@RequestMapping(value="/dam/per/EgovComDamPersonalRegistView.cm")
	public String insertKnoPersonalView(
		...
		if (knoPersonal.getKnoId() == null
			...
			return "coreframework/com/dam/per/EgovComDamPersonalRegist";
			...
			return "forward:/dam/per/EgovComDamPersonalList.cm";
		} else {
			return "forward:/dam/per/EgovComDamPersonalList.cm";
		}
	 ...
	 * @param KnoNm
	 */
	@RequestMapping(value="/dam/per/EgovComDamPersonalRegist.cm")
	public String insertKnoPersonal(
		...
		String sLocationUrl = "coreframework/com/dam/per/EgovComDamPersonalRegist";
	 ...
	 * @param KnoNm
	 */
	@RequestMapping(value="/dam/per/EgovComDamPersonalModifyView.cm")
	public String updateKnoPersonalView(@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/dam/per/EgovComDamPersonalModify";
	}
	...
	@RequestMapping(value="/dam/per/EgovComDamPersonalModify.cm")
	public String updateKnoPersonal(
		...
		String sLocationUrl = "coreframework/com/dam/per/EgovComDamPersonalModify";
		...
		if (sCmd.equals("Modify")) {
			...
			****************************************************************** */
            ...
            sLocationUrl = "forward:/dam/per/EgovComDamPersonalList.cm";
		} else {
            //수정정보 불러오기
	 ...
	 * @param KnoNm
	 */
	@RequestMapping(value="/dam/per/EgovComDamPersonalRemove.cm")
