package coreframework.com.dam.map.tea.web;
...
import coreframework.com.dam.map.tea.service.MapTeam;
...
public class EgovMapTeamController {
	 ...
	 * @param MapTeamVO
	 */
	@IncludedInfo(name="지식맵관리(조직)", listUrl="/dam/map/tea/EgovComDamMapTeamList.cm", order = 1261 ,gid = 80)
	@RequestMapping(value="/dam/map/tea/EgovComDamMapTeamList.cm")
	public String selectMapTeamList(@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/dam/map/tea/EgovComDamMapTeamList";
	}
	 ...
	 * @param MapTeamVO
	 */
	@RequestMapping(value="/dam/map/tea/EgovComDamMapTeamDetail.cm")
	public String selectMapTeamDetail(@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/dam/map/tea/EgovComDamMapTeamDetail";
	}
	 ...
	 * @param mapTeam
	 */
	@RequestMapping(value="/dam/map/tea/EgovComDamMapTeamRegist.cm")
	public String insertMapTeam(@ModelAttribute("loginVO") LoginVO loginVO
		...
		if (mapTeam.getOrgnztNm() == null
			...
			return "coreframework/com/dam/map/tea/EgovComDamMapTeamRegist";
		}
		...
		return "forward:/dam/map/tea/EgovComDamMapTeamList.cm";
	}
	 ...
	 * @param mapTeam
	 */
	@RequestMapping(value="/dam/map/tea/EgovComDamMapTeamModify.cm")
	public String updateMapTeam(@ModelAttribute("loginVO") LoginVO loginVO
		...
		if (sCmd.equals("")) {
			...
			return "coreframework/com/dam/map/tea/EgovComDamMapTeamModify";
	 ...
	 * @param orgnztNm
	 */
	@RequestMapping(value="/dam/map/tea/EgovComDamMapTeamRemove.cm")
