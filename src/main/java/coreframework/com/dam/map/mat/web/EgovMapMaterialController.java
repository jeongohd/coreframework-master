package coreframework.com.dam.map.mat.web;
...
public class EgovMapMaterialController {
	 ...
	 * @param MapMaterialVO
	 */
	@IncludedInfo(name="지식맵관리(유형)", listUrl="/dam/map/mat/EgovComDamMapMaterialList.cm", order = 1260 ,gid = 80)
	@RequestMapping(value="/dam/map/mat/EgovComDamMapMaterialList.cm")
	public String selectMapMaterialList(@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/dam/map/mat/EgovComDamMapMaterialList";
	}
	 ...
	 * @param MapMaterialVO
	 */
	@RequestMapping(value="/dam/map/mat/EgovComDamMapMaterial.cm")
	public String selectMapMaterial(@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/dam/map/mat/EgovComDamMapMaterialDetail";
	}
	 ...
	 * @param MapMaterialVO
	 */
	@RequestMapping(value="/dam/map/mat/EgovComDamMapMaterialRegist.cm")
	public String insertMapMaterial(@ModelAttribute("loginVO") LoginVO loginVO
		...
		if (mapMaterial.getKnoTypeCd() == null
			...
			return "coreframework/com/dam/map/mat/EgovComDamMapMaterialRegist";
		}
		...
		return "forward:/dam/map/mat/EgovComDamMapMaterialList.cm";
	}
	 ...
	 * @param MapMaterialVO
	 */
	@RequestMapping(value="/dam/map/mat/EgovComDamMapMaterialModify.cm")
	public String updateMapMaterial(@ModelAttribute("loginVO") LoginVO loginVO
		...
		if (sCmd.equals("")) {
			...
			return "coreframework/com/dam/map/mat/EgovComDamMapMaterialModify";
	 ...
	 * @param MapMaterialVO
	 */
	@RequestMapping(value="/dam/map/mat/EgovComDamMapMaterialRemove.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/dam/map/mat/EgovKnoTypeCdCheckAjax.cm")
