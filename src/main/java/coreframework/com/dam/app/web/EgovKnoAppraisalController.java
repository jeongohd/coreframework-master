package coreframework.com.dam.app.web;
...
import coreframework.com.dam.app.service.EgovKnoAppraisalService;
import coreframework.com.dam.app.service.KnoAppraisal;
import coreframework.com.dam.app.service.KnoAppraisalVO;
...
public class EgovKnoAppraisalController {
	 ...
	 */
    @IncludedInfo(name="지식평가관리", listUrl="/dam/app/EgovComDamAppraisalList.cm", order = 1290 ,gid = 80)
	@RequestMapping(value="/dam/app/EgovComDamAppraisalList.cm")
	public String selectKnoAppraisalList(
		...
		return "coreframework/com/dam/app/EgovComDamAppraisalList";
	}
	 ...
	 * @param KnoAppraisalVO
	 */
	@RequestMapping(value="/dam/app/EgovComDamAppraisal.cm")
	public String selectKnoAppraisal(@ModelAttribute("loginVO") LoginVO loginVO
		...
		return "coreframework/com/dam/app/EgovComDamAppraisalDetail";
	}
	 ...
	 * @param knoAps
	 */
	//@RequestMapping(value="/dam/app/EgovComDamAppraisalRegist.cm")
	//public String insertKnoAppraisal(knoAps knoAps){
	//	return "coreframework/com/";
	//}
	 ...
	 * @param knoAps
	 */
	@RequestMapping(value="/dam/app/EgovComDamAppraisalModify.cm")
	public String updateKnoAppraisal(@ModelAttribute("knoId") KnoAppraisal knoAppraisal
		...
		if (sCmd.equals("")) {
			...
			return "coreframework/com/dam/app/EgovComDamAppraisalModify";
			...
			return "forward:/dam/app/EgovComDamAppraisalList.cm";
		} else {
			return "forward:/dam/app/EgovComDamAppraisalList.cm";
		}
	}
