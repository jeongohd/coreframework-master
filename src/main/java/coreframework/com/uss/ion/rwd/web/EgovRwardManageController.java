package coreframework.com.uss.ion.rwd.web;
...
import coreframework.com.uss.ion.rwd.service.EgovRwardManageService;
import coreframework.com.uss.ion.rwd.service.RwardManage;
import coreframework.com.uss.ion.rwd.service.RwardManageVO;
...
public class EgovRwardManageController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/uss/ion/rwd/EgovRwardManageListView.cm")
    public String selectRwardManageListView(/*@ModelAttribute("vcatnManageVO") VcatnManageVO vcatnManageVO,*/ // 2011.8.16 수정분
        ...
        return "coreframework/com/uss/ion/rwd/EgovRwardManageList";
    }
    ...
    @RequestMapping(value="/uss/ion/rwd/selectRwardManageList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/rwd/EgovRwardManageDetail.cm")
	 public String selectRwardManage(   @ModelAttribute("rwardManage") RwardManage rwardManage,
		...
		if(sCmd.equals("updt")){
			...
			return "coreframework/com/uss/ion/rwd/EgovRwardUpdt";
		}else{
			return "coreframework/com/uss/ion/rwd/EgovRwardDetail";
		}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/rwd/EgovRwardRegist.cm")
	 public String insertViewRwardManage(@ModelAttribute("rwardManage")   RwardManage   rwardManage,
		...
		rwardCdCodeList = cmmUseService.selectCmmCodeDetail(vo);
        model.addAttribute("rwardCodeList",    rwardCdCodeList);
    	return "coreframework/com/uss/ion/rwd/EgovRwardRegist";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/uss/ion/rwd/insertRwardManage.cm")
	 public String insertRwardManage(final MultipartHttpServletRequest multiRequest,
    	...
    	if (bindingResult.hasErrors()) {
	    	...
	    	return "forward:/uss/ion/rwd/selectRwardManageList.cm";
	...
	@RequestMapping(value="/uss/ion/rwd/updtRwardManage.cm")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/rwd/deleteRwardManage.cm")
    ...
    @RequestMapping(value="/uss/ion/rwd/EgovRwardConfmList.cm")
	 public String selectRwardManageConfmList(@ModelAttribute("rwardManageVO") RwardManageVO rwardManageVO,
		...
		return "coreframework/com/uss/ion/rwd/EgovRwardConfmList";
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/rwd/EgovRwardConfm.cm")
	 public String selectRwardConfm( @ModelAttribute("rwardManageVO") RwardManageVO rwardManageVO,
		...
		return "coreframework/com/uss/ion/rwd/EgovRwardConfm";
    }
	 ...
	 * @return String - 리턴 Url
	 */
	 @RequestMapping(value="/uss/ion/rwd/updtRwardConfm.cm")
	 public String updtRwardManageConfm( @ModelAttribute("rwardManage")   RwardManage   rwardManage,
    	...
    	if (bindingResult.hasErrors()) {
			...
			return "coreframework/com/uss/ion/vct/EgovRwardConfm";
		} else {
	    	...
	    	return "forward:/uss/ion/rwd/EgovRwardConfmList.cm";
		}
	}
}
