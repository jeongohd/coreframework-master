package coreframework.com.uss.ion.ulm.web;
...
import coreframework.com.uss.ion.ulm.service.EgovUnityLinkService;
...
import coreframework.com.uss.ion.ulm.service.UnityLink;
...
public class EgovUnityLinkController {
     ...
     * @param unityLinkVO
     * @param model
     * @return "coreframework/com/uss/ion/ulm/UnityLinkSample"
     * @throws Exception
     */
    @RequestMapping(value = "/uss/ion/ulm/listUnityLinkSample.cm")
     ...
     * @param unityLinkVO
     * @param model
     * @return "coreframework/com/uss/ion/ulm/EgovOnlinePollList"
     * @throws Exception
     */
    @SuppressWarnings("unused")
	@IncludedInfo(name="통합링크관리", order = 780 ,gid = 50)
    @RequestMapping(value = "/uss/ion/ulm/listUnityLink.cm")
    public String egovUnityLinkList(
        ...
        return "coreframework/com/uss/ion/ulm/EgovUnityLinkList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/uss/ion/ulm/detailUnityLink.cm")
    public String egovUnityLinkDetail(
            @ModelAttribute("searchVO") ComDefaultVO searchVO,
            UnityLink unityLink, @RequestParam Map<?, ?> commandMap,
            ModelMap model) throws Exception {

        String sLocationUrl = "coreframework/com/uss/ion/ulm/EgovUnityLinkDetail";

        String sCmd = commandMap.get("cmd") == null ? "" : (String) commandMap.get("cmd");

        if (sCmd.equals("del")) {
            egovUnityLinkService.deleteUnityLink(unityLink);
            sLocationUrl = "forward:/uss/ion/ulm/listUnityLink.cm";
        } else {
            //통합링크구분설정
            ComDefaultCodeVO voComCode = new ComDefaultCodeVO();
            voComCode = new ComDefaultCodeVO();
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/uss/ion/ulm/updtUnityLink.cm")
    public String egovUnityLinkModify(
        ...
        String sLocationUrl = "coreframework/com/uss/ion/ulm/EgovUnityLinkUpdt";
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/uss/ion/ulm/registUnityLink.cm")
    public String egovUnityLinkRegist(
        ...
        String sLocationUrl = "coreframework/com/uss/ion/ulm/EgovUnityLinkRegist";
