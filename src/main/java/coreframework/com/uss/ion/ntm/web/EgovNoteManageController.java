package coreframework.com.uss.ion.ntm.web;
...
import coreframework.com.uss.ion.ntm.service.EgovNoteManageService;
import coreframework.com.uss.ion.ntm.service.NoteManageVO;
...
public class EgovNoteManageController {
    ...
    @RequestMapping(value = "/uss/ion/ntm/registEgovNoteManage.cm")
    public String EgovNoteRecptnRegistForm(NoteManageVO noteManage, @RequestParam Map<?, ?> commandMap, ModelMap model) throws Exception {
    	...
    	return "coreframework/com/uss/ion/ntm/EgovNoteManage";
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/uss/ion/ntm/registEgovNoteManageActor.cm")
    public String EgovNoteRecptnRegist(
    	...
    	String sLocationUrl = "coreframework/com/uss/ion/ntm/EgovNoteManage";
    ...
    @RequestMapping(value = "/uss/ion/ntm/listEgovNoteEmpListPopup.cm")
    public String EgovEgovNoteEmpList(
    	...
    	return "coreframework/com/uss/ion/ntm/EgovNoteEmpList";
    }
