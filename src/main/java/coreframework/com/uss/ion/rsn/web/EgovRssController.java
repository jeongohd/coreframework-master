package coreframework.com.uss.ion.rsn.web;

import java.util.List;
import java.util.Map;

import coreframework.com.cmm.CoreMessageSource;
import coreframework.com.uss.ion.rsn.service.EgovRssService;
import coreframework.com.uss.ion.rsn.service.RssInfo;
...
public class EgovRssController {
    ...
    @RequestMapping(value = "/uss/ion/rsn/listRssTagService.cm")
    public String EgovRssTagServiceList(
    	...
    	return "coreframework/com/uss/ion/rsn/EgovRssTagServiceList";
	...
	@RequestMapping(value = "/uss/ion/rsn/detailRssTagService.cm")
    public String EgovRssTagServiceDetail(
    		...
    		if(!sRssId.equals("")){
    			...
    			mapRssInfo.put("TRGET_SVC_TABLE", CoreWebUtil.removeSQLInjectionRisk(mapRssInfo.get("TRGET_SVC_TABLE")));	// 2012.11 KISA 보안조치

    			model.addAttribute("mapRssInfoList", egovRssService.selectRssTagServiceTable(mapRssInfo));

    		}

        	return "coreframework/com/uss/ion/rsn/EgovRssTagService";
    }
