package coreframework.com.uss.ion.evt.web;
...
import coreframework.com.uss.ion.evt.service.EgovEventManageService;
import coreframework.com.uss.ion.evt.service.EventAtdrn;
...
import coreframework.com.uss.ion.evt.service.EventManage;
import coreframework.com.uss.ion.evt.service.EventManageVO;
...
public class EgovEventManageController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/uss/ion/evt/EgovEventReqstManageListView.cm")
    public String selectEventManageListView() throws Exception {

        return "coreframework/com/uss/ion/evt/EgovEventReqstManageList";
    }
    ...
    @RequestMapping(value="/uss/ion/evt/EgovEventReqstManageList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/evt/EgovEventReqstDetail.cm")
	 public String selectEventManage(   @ModelAttribute("eventManage") EventManageVO eventManage,
		...
		if(sCmd.equals("updt")){
			...
			return "coreframework/com/uss/ion/evt/EgovEventReqstUpdt";
		}else if(sCmd.equals("popup")){
			model.addAttribute("check_popup", "Y");
			return "coreframework/com/uss/ion/evt/EgovEventReqstDetail";
		}else{
			return "coreframework/com/uss/ion/evt/EgovEventReqstDetail";
		}
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/evt/EgovEventReqstRegist.cm")
	 public String insertViewEventManage(  @ModelAttribute("eventManage") EventManageVO eventManage,
    	...
    	return "coreframework/com/uss/ion/evt/EgovEventReqstRegist";
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/evt/insertEventManage.cm")
	 public String insertEventManage(   @ModelAttribute("eventManage") EventManage eventManage,
    	...
    	if (bindingResult.hasErrors()) {
	    	...
	    	return "forward:/uss/ion/evt/EgovEventReqstManageList.cm";
    	}
	}
	 ...
	 * @return String - 리턴 Url
	 */
	 @RequestMapping(value="/uss/ion/evt/EgovEventReqstSave.cm")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/evt/EgovEventReqstDelete.cm")
    ...
    @RequestMapping(value="/uss/ion/evt/EgovEventRcrptManageList.cm")
	 public String selectEventAtdrnList(@ModelAttribute("eventManageVO") EventManageVO eventManageVO,
		...
		model.addAttribute("paginationInfo", paginationInfo);
		model.addAttribute("message", coreMessageSource.getMessage("success.common.select"));
		return "coreframework/com/uss/ion/evt/EgovEventRceptManageList";
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/evt/EgovEventRcrptDetail.cm")
	 public String selectEventAtdrn(    @ModelAttribute("eventAtdrn") EventAtdrn eventAtdrn,
    	...
    	return "coreframework/com/uss/ion/evt/EgovEventRceptDetail";
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/evt/EgovEventRceptRegist.cm")
	 public String insertViewEventAtdrn(
    	...
    	return "coreframework/com/uss/ion/evt/EgovEventRceptRegist";
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/evt/insertEventAtdrn.cm")
	 public String insertEventAtdrn(    @ModelAttribute("eventAtdrn") EventAtdrn eventAtdrn,
    	...
    	if (bindingResult.hasErrors()) {
    		model.addAttribute("eventManageVO", eventManageVO);
			return "forward:/uss/ion/evt/EgovEventRceptRegist.cm";
		} else {
			...
			if(eventManageVO_check.getPsncpa()> egovEventManageService.selectEventReqstAtdrnListTotCnt(eventManageVO))
			{
		    	...
		    	return "forward:/uss/ion/evt/EgovEventRcrptManageList.cm";
			}else{
	        	EventManageVO eventManageVO1 = egovEventManageService.selectEventManage(eventManageVO);
	        	LoginVO user = (LoginVO) CoreUserDetailsHelper.getAuthenticatedUser();
	        	status.setComplete();
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/evt/deleteEventAtdrn.cm")
    ...
    @RequestMapping(value="/uss/ion/evt/selectEventRceptConfmList.cm")
	 public String selectEventRceptConfmList(@ModelAttribute("eventManageVO") EventManageVO eventManageVO,
		...
		return "coreframework/com/uss/ion/evt/EgovEventRceptConfm";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	 @RequestMapping(value="/uss/ion/evt/updtEventAtdrn.cm")
	 public String updtEventAtdrn(@RequestParam("checkedEventRceptForConfm") String checkedEventRceptForConfm,
    	...
    	return "forward:/uss/ion/evt/selectEventRceptConfmList.cm";
	 }
	 ...
	 @RequestMapping(value="/uss/ion/evt/EgovEventReqstAtdrnList.cm")
	 public String selectEventReqstAtdrnList(@ModelAttribute("eventManageVO") EventManageVO eventManageVO,
		...
		return "coreframework/com/uss/ion/evt/EgovEventReqstAtdrnList";
	}
