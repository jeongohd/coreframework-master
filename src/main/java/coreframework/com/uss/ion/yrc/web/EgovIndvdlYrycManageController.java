package coreframework.com.uss.ion.yrc.web;
...
import coreframework.com.uss.ion.yrc.service.EgovIndvdlYrycManageService;
import coreframework.com.uss.ion.yrc.service.IndvdlYrycManage;
...
public class EgovIndvdlYrycManageController {
    ...
    @RequestMapping(value="/uss/ion/yrc/EgovIndvdlYrycManageList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/yrc/EgovIndvdlYrycRegist.cm", method=RequestMethod.GET)
	public String insertViewIndvdlYrycManage(@ModelAttribute IndvdlYrycManage indvdlYrycManage, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/ion/yrc/EgovIndvdlYrycRegist";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/yrc/EgovIndvdlYrycRegist.cm", method=RequestMethod.POST)
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/yrc/deleteIndvdlYryc.cm", method=RequestMethod.POST)
