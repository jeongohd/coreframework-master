package coreframework.com.uss.ion.ans.web;
...
import coreframework.com.uss.ion.ans.service.AnnvrsryManage;
import coreframework.com.uss.ion.ans.service.AnnvrsryManageVO;
import coreframework.com.uss.ion.ans.service.EgovAnnvrsryManageService;
...
public class EgovAnnvrsryManageController {
	 ...
	 * @exception Exception
	 */
	@RequestMapping("/uss/ion/ans/selectAnnvrsryManageListView.cm")
	public String selectAnnvrsryManageListView() throws Exception {

		return "coreframework/com/uss/ion/ans/EgovAnnvrsryManageList";
	}
	...
	@RequestMapping(value = "/uss/ion/ans/selectAnnvrsryManageList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/ans/selectAnnvrsryManage.cm")
	public String selectAnnvrsryManage(@ModelAttribute("annvrsryManage") AnnvrsryManage annvrsryManage,
		...
		if ("1".equals(annvrsryManageVO_Temp.getCldrSe())) {
			sTempCldrSe = coreMessageSource.getMessage("comUssIonAns.annvrsryGdcc.cldrSe1");//양
		}
		else {
			sTempCldrSe = coreMessageSource.getMessage("comUssIonAns.annvrsryGdcc.cldrSe2");//음
		}
		...
		if (sCmd.equals("update")) {
			...
			return "coreframework/com/uss/ion/ans/EgovAnnvrsryUpdt";
		} else {
			return "coreframework/com/uss/ion/ans/EgovAnnvrsryDetail";
		}
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/ans/insertViewAnnvrsry.cm")
	public String insertViewAnnvrsryManage(@ModelAttribute("annvrsryManage") AnnvrsryManage annvrsryManage,
		...
		return "coreframework/com/uss/ion/ans/EgovAnnvrsryRegist";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/ans/insertAnnvrsry.cm")
	public String insertAnnvrsryManage(@ModelAttribute("annvrsryManage") AnnvrsryManage annvrsryManage,
		...
		if (bindingResult.hasErrors()) {
			...
			model.addAttribute("annvrsryManageVO", annvrsryManageVO);
			model.addAttribute("message", coreMessageSource.getMessage("fail.common.insert"));
			return "coreframework/com/uss/ion/ans/EgovAnnvrsryRegist";
		} else {
			...
			if (egovAnnvrsryManageService.selectAnnvrsryManageDplctAt(annvrsryManage) == 0) {
				...
				model.addAttribute("message", coreMessageSource.getMessage("success.common.insert"));
				return "forward:/uss/ion/ans/selectAnnvrsryManageList.cm";
			} else {
				ComDefaultCodeVO vo = new ComDefaultCodeVO();
				vo.setCodeId("COM069");
				List<?> annvrsrySeCodeList = cmmUseService.selectCmmCodeDetail(vo);
				...
				model.addAttribute("annvrsrySeCode", annvrsrySeCodeList);
				model.addAttribute("annvrsryManageVO", annvrsryManageVO);
				model.addAttribute("dplctMessage", coreMessageSource.getMessage("comUssIonAns.common.duplicate"));//이미 등록된 데이타입니다. 해당 데이타를 확인해 주세요");
				return "coreframework/com/uss/ion/ans/EgovAnnvrsryRegist";
			}
		}
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/ans/updateAnnvrsryManage.cm")
	public String updateAnnvrsryManage(@ModelAttribute("annvrsryManage") AnnvrsryManage annvrsryManage,
		...
		if (bindingResult.hasErrors()) {
			...
			return "coreframework/com/uss/ion/ans/EgovAnnvrsryManageUpdt";
		} else {
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/ans/deleteAnnvrsryManage.cm")
	...
	@RequestMapping(value = "/uss/ion/ans/selectAnnvrsryMainList.cm")
	public String selectAnnvrsryMainList(@ModelAttribute("annvrsryManageVO") AnnvrsryManageVO annvrsryManageVO,
		...
		model.addAttribute("message", coreMessageSource.getMessage("success.common.select"));
		return "coreframework/com/uss/ion/ans/EgovAnnvrsryMainList";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/ans/selectAnnvrsryGdcc.cm")
	public String selectAnnvrsryGdcc(@ModelAttribute("annvrsryManageVO") AnnvrsryManageVO annvrsryManageVO,
		...
		*/
		...
		return "coreframework/com/uss/ion/ans/EgovAnnvrsryGdcc";
	}
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uss/ion/ans/EgovAnnvrsryManageListPop.cm")
	public String selectAnnvrsryManageBnde(final HttpServletRequest request,
		...
		return "coreframework/com/uss/ion/ans/EgovAnnvrsryManageBndeListPop";
	}

	@RequestMapping(value = "/uss/ion/ans/EgovAnnvrsryManageListPopAction.cm")
	 ...
	 * @return String              - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/ans/insertAnnvrsryManageBnde.cm")
