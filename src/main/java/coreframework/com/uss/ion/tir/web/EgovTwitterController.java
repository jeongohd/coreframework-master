package coreframework.com.uss.ion.tir.web;
...
import coreframework.com.uss.ion.tir.service.EgovTwitterRecptnService;
import coreframework.com.uss.ion.tir.service.EgovTwitterTrnsmitService;
import coreframework.com.uss.ion.tir.service.TwitterInfo;
...
public class EgovTwitterController {
	...
	@RequestMapping(value = "/uss/ion/tir/selectTwitterMain.cm")
	public String EgovTwitterMain(@RequestParam Map<?, ?> commandMap, ModelMap model) throws Exception {
		return "coreframework/com/uss/ion/tir/EgovTwitterMain";
	}
	 ...
	 * @throws Exception	-Exception Throws
	 */
	@RequestMapping(value = "/uss/ion/tir/selectTwitterAccount.cm", method = RequestMethod.GET)
	public String EgovTwitterAccountGet(ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/ion/tir/EgovTwitterAccount";
	}
	...
	@RequestMapping(value = "/uss/ion/tir/selectTwitterAccount.cm", method = RequestMethod.POST)
	 ...
	 * @throws Exception	-Exception Throws
	 */
	@RequestMapping(value = "/uss/ion/tir/selectTwitterPopup.cm")
	public String EgovTwitterPopupGet(ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/ion/tir/EgovTwitterPopup";
	}
	 ...
	 * @throws Exception	-Exception Throws
	 */
	@RequestMapping(value = "/uss/ion/tir/selectTwitterPopupActor.cm")
	public String EgovTwitterPopupPost(@RequestParam Map<?, ?> commandMap, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/ion/tir/EgovTwitterPopupActor";
	}
	 ...
	 * @throws Exception	-Exception Throws
	 */
	@RequestMapping(value = "/uss/ion/tir/selectTwitterPopupProcess.cm")
	public String EgovTwitterPopupProcess(ModelMap model) throws Exception {
		return "coreframework/com/uss/ion/tir/EgovTwitterPopupProcess";
	}
	 ...
	 * @throws Exception	-Exception Throws
	 */
	@RequestMapping(value = "/uss/ion/tir/listTwitterRecptn.cm")
	public String EgovTwitterRecptnPost(@ModelAttribute("searchVO") TwitterInfo searchVO, @ModelAttribute("twitterInfo") TwitterInfo twitterInfo, HttpServletRequest request,
		...
		//리턴 URL
		String sLocationUrl = "coreframework/com/uss/ion/tir/EgovTwitterRecptn";
	 ...
	 * @throws Exception	-Exception Throws
	 */
	@RequestMapping(value = "/uss/ion/tir/registTwitterTrnsmit.cm", method = RequestMethod.GET)
	public String EgovTwitterTrnsmitGet(ModelMap model) throws Exception {

		model.addAttribute("twitterInfo", new TwitterInfo());
		return "coreframework/com/uss/ion/tir/EgovTwitterTrnsmit";
	}
	 ...
	 * @throws Exception	-Exception Throws
	 */
	@RequestMapping(value = "/uss/ion/tir/registTwitterTrnsmit.cm", method = RequestMethod.POST)
	public String EgovTwitterTrnsmitPost(TwitterInfo twitterInfo, HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/ion/tir/EgovTwitterTrnsmitResult";
	}
}
