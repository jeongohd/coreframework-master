package coreframework.com.uss.ion.rsm.web;
...
import coreframework.com.uss.ion.rsm.service.EgovRecentSrchwrdService;
import coreframework.com.uss.ion.rsm.service.RecentSrchwrd;
...
public class EgovRecentSrchwrdController {
	 ...
	 * @param model
	 * @return "coreframework/com/uss/ion/rsm/EgovRecentSrchwrdList"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@IncludedInfo(name = "최근검색어 조회", order = 760, gid = 50)
	@RequestMapping(value = "/uss/ion/rsm/listRecentSrchwrd.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/ion/rsm/detailRecentSrchwrd.cm")
	public String egovRecentSrchwrdDetail(
		@ModelAttribute("searchVO") ComDefaultVO searchVO,
		RecentSrchwrd recentSrchwrd, @RequestParam Map<?, ?> commandMap,
		ModelMap model) throws Exception {

		String sLocationUrl = "coreframework/com/uss/ion/rsm/EgovRecentSrchwrdDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if (sCmd.equals("del")) {
			egovRecentSrchwrdService.deleteRecentSrchwrd(recentSrchwrd);
			sLocationUrl = "redirect:/uss/ion/rsm/listRecentSrchwrd.cm";
		} else {
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/ion/rsm/EgovRecentSrchwrdUpdt"
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/ion/rsm/updtRecentSrchwrd.cm")
	public String egovRecentSrchwrdModify(
		...
		String sLocationUrl = "coreframework/com/uss/ion/rsm/EgovRecentSrchwrdUpdt";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/ion/rsm/registRecentSrchwrd.cm")
	public String egovRecentSrchwrdRegist(
		...
		String sLocationUrl = "coreframework/com/uss/ion/rsm/EgovRecentSrchwrdRegist";
	 ...
	 * @param recentSrchwrdVO
	 * @param model
	 * @return "coreframework/com/uss/ion/rsm/EgovOnlinePollList"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value = "/uss/ion/rsm/listRecentSrchwrdResult.cm")
	public String egovRecentSrchwrdResultList(
		...
		return "coreframework/com/uss/ion/rsm/EgovRecentSrchwrdResultList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/ion/rsm/listRecentSrchwrdResultSerach.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/ion/rsm/registRecentSrchwrdResult.cm")
