package coreframework.com.uss.ion.noi.web;
...
import coreframework.com.uss.ion.noi.service.EgovNotificationService;
import coreframework.com.uss.ion.noi.service.Notification;
import coreframework.com.uss.ion.noi.service.NotificationVO;
...
import coreframework.com.cmm.util.EgovDoubleSubmitHelper;
...
public class EgovNotificationController {
    ...
    @RequestMapping("/uss/ion/noi/selectNotificationList.cm")
	...
	return "coreframework/com/uss/ion/noi/EgovNotificationList";
    }  
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/noi/addNotification.cm")
	...
	return "coreframework/com/uss/ion/noi/EgovNotificationRegist";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/noi/insertNotification.cm")
	...
	if (! notificationService.checkNotification(notification)) {
	    model.addAttribute("msg", coreMessageSource.getMessage("ussIonNoi.notificationUpdt.validate.alertNtfcTime"));
	    return "coreframework/com/uss/ion/noi/EgovNotificationRegist";
	}
	...
	return "forward:/uss/ion/noi/selectNotificationList.cm";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/noi/selectNotification.cm")
	...
	return "coreframework/com/uss/ion/noi/EgovNotificationDetail";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/noi/forUpdateNotification.cm")
	...
	return "coreframework/com/uss/ion/noi/EgovNotificationUpdt";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/noi/updateNotification.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/noi/deleteNotification.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/noi/getNotifications.cm")
	...
	return "coreframework/com/uss/ion/noi/EgovNotificationData";
    }
}
