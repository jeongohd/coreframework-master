...
package coreframework.com.uss.ion.bnr.web;
...
import coreframework.com.uss.ion.bnr.service.Banner;
import coreframework.com.uss.ion.bnr.service.BannerVO;
import coreframework.com.uss.ion.bnr.service.EgovBannerService;
...
public class EgovBannerController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/uss/ion/bnr/selectBannerListView.cm")
    public String selectBannerListView() throws Exception {

        return "coreframework/com/uss/ion/bnr/EgovBannerList";
    }
    ...
    @RequestMapping(value="/uss/ion/bnr/selectBannerList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/bnr/getBanner.cm")
	public String selectBanner(@RequestParam("bannerId") String bannerId,
    	...
    	model.addAttribute("message", coreMessageSource.getMessage("success.common.select"));
    	return "coreframework/com/uss/ion/bnr/EgovBannerUpdt";
	}
	...
	@RequestMapping(value="/uss/ion/bnr/addBanner.cm")
...
//	    	return "coreframework/com/uss/ion/bnr/EgovBannerUpdt";
			return "forward:/uss/ion/bnr/selectBannerList.cm";
	 ...
	 */
    @SuppressWarnings("unused")
	@RequestMapping(value="/uss/ion/bnr/updtBanner.cm")
	public String updateBanner(final MultipartHttpServletRequest multiRequest,
		...
		if (bindingResult.hasErrors()) {
			...
			//	    	return "forward:/uss/ion/bnr/getBanner.cm";
			return "forward:/uss/ion/bnr/selectBannerList.cm";
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/uss/ion/bnr/removeBanner.cm")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/uss/ion/bnr/removeBannerList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/uss/ion/bnr/getBannerImage.cm")
	public String selectBannerResult(@ModelAttribute("bannerVO") BannerVO bannerVO,
		...
		return "coreframework/com/uss/ion/bnr/EgovBannerView";
	}
    ...
    @RequestMapping(value="/uss/ion/bnr/selectBannerMainList.cm")
	public String selectBannerMainList(@ModelAttribute("bannerVO") BannerVO bannerVO,
		...
		return "coreframework/com/uss/ion/bnr/EgovBannerMainList";
	}
}
