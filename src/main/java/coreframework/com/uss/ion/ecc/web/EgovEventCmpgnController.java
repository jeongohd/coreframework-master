package coreframework.com.uss.ion.ecc.web;
...
import coreframework.com.uss.ion.ecc.service.EgovEventCmpgnService;
import coreframework.com.uss.ion.ecc.service.EventCmpgnVO;
import coreframework.com.uss.ion.ecc.service.TnextrlHrVO;
...
public class EgovEventCmpgnController {
	 ...
	 * @param eventCmpgnVO
	 * @param model
	 * @return "coreframework/com/uss/ion/ecc/EgovEventCmpgnList
	 * @throws Exception
	 */
	@IncludedInfo(name="행사/이벤트/캠페인", order = 710 ,gid = 50)
	@RequestMapping(value="/uss/ion/ecc/selectEventCmpgnList.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/ion/ecc/selectEventCmpgnListPopup.cm")
	public String selectEventCmpgnListPopup(@ModelAttribute("searchVO") EventCmpgnVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/ion/ecc/EgovEventCmpgnListPopup";
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/ecc/selectEventCmpgnDetail.cm")
    public String	selectEventCmpgnDetail(EventCmpgnVO eventCmpgnVO,
        ...
        return	"coreframework/com/uss/ion/ecc/EgovEventCmpgnDetail";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/ecc/insertEventCmpgnView.cm")
    public String insertEventCmpgnView(@ModelAttribute("searchVO") EventCmpgnVO searchVO, Model model) throws Exception {
        ...
        return "coreframework/com/uss/ion/ecc/EgovEventCmpgnRegist";
     ...
     * @param eventCmpgnVO
     * @param bindingResult
     * @return	"forward:/uss/ion/ecc/selectEventCmpgnList.cm"
     * @throws Exception
     */
     @RequestMapping("/uss/ion/ecc/insertEventCmpgn.cm")
     public String insertEventCmpgn(@ModelAttribute("searchVO") EventCmpgnVO searchVO, @ModelAttribute("eventCmpgnVO") EventCmpgnVO eventCmpgnVO,
 		...
 		if(bindingResult.hasErrors()){
 			return "coreframework/com/uss/olh/ecc/EgovEventCmpgnRegist";
 		}
      ...
      * @throws Exception
      */
     @RequestMapping("/uss/ion/ecc/updateEventCmpgnView.cm")
     public String updateEventCmpgnView(@RequestParam("eventId") String eventId ,
    	...
    	// 공통코드를 가져오기 위한 Vo
         ...
         return "coreframework/com/uss/ion/ecc/EgovEventCmpgnUpdt";
     }
      ...
      * @throws Exception
      */
     @RequestMapping("/uss/ion/ecc/updateEventCmpgn.cm")
     public String updateEventCmpgn(@ModelAttribute("searchVO") EventCmpgnVO searchVO, @ModelAttribute("eventCmpgnVO") EventCmpgnVO eventCmpgnVO,
     	...
     	beanValidator.validate(eventCmpgnVO, bindingResult);
 		if(bindingResult.hasErrors()){
 			return "coreframework/com/uss/olh/ecc/EgovEventCmpgnUpdt";
 		}
      ...
      * @throws Exception
      */
     @RequestMapping("/uss/ion/ecc/deleteEventCmpgn.cm")
 	 ...
 	 * @param tnextrlHrVO
 	 * @param model
 	 * @return "coreframework/com/uss/ion/ecc/EgovTnextrlHrList
 	 * @throws Exception
 	 */
 	@IncludedInfo(name="외부인사정보", order = 711 ,gid = 50)
 	@RequestMapping(value="/uss/ion/ecc/selectTnextrlHrList.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/ecc/selectTnextrlHrDetail.cm")
    public String	selectTnextrlHrDetail(TnextrlHrVO tnextrlHrVO, @ModelAttribute("searchVO") TnextrlHrVO searchVO, ModelMap model) throws Exception {
        ...
        return	"coreframework/com/uss/ion/ecc/EgovTnextrlHrDetail";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/ecc/insertTnextrlHrView.cm")
    public String insertTnextrlHrView(@ModelAttribute("searchVO") TnextrlHrVO searchVO, Model model) throws Exception {
        ...
        return "coreframework/com/uss/ion/ecc/EgovTnextrlHrRegist";
     ...
     * @param tnextrlHrVO
     * @param bindingResult
     * @return	"forward:/uss/ion/ecc/selectTnextrlHrList.cm"
     * @throws Exception
     */
     @RequestMapping("/uss/ion/ecc/insertTnextrlHr.cm")
     public String insertTnextrlHr(@ModelAttribute("searchVO") TnextrlHrVO searchVO, @ModelAttribute("tnextrlHrVO") TnextrlHrVO tnextrlHrVO,
 		...
 		if(bindingResult.hasErrors()){
 			return "coreframework/com/uss/olh/ecc/EgovTnextrlHrRegist";
 		}
         ...
         return "redirect:/uss/ion/ecc/selectTnextrlHrList.cm";
     }
      ...
      * @throws Exception
      */
     @RequestMapping("/uss/ion/ecc/updateTnextrlHrView.cm")
     public String updateTnextrlHrView(@RequestParam("extrlHrId") String extrlHrId ,
    	...
    	// 공통코드를 가져오기 위한 Vo
         ...
         return "coreframework/com/uss/ion/ecc/EgovTnextrlHrUpdt";
     }
      ...
      * @throws Exception
      */
     @RequestMapping("/uss/ion/ecc/updateTnextrlHr.cm")
     public String updateTnextrlHr(@ModelAttribute("searchVO") TnextrlHrVO searchVO, @ModelAttribute("tnextrlHrVO") TnextrlHrVO tnextrlHrVO,
     	...
     	beanValidator.validate(tnextrlHrVO, bindingResult);
 		if(bindingResult.hasErrors()){
 			return "coreframework/com/uss/olh/ecc/EgovTnextrlHrUpdt";
 		}
      ...
      * @throws Exception
      */
     @RequestMapping("/uss/ion/ecc/deleteTnextrlHr.cm")
