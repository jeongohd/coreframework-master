package coreframework.com.uss.ion.wik.bmk.web;
import java.util.List;
import java.util.Map;

import javax.annotation.Resource;

import coreframework.com.uss.ion.wik.bmk.service.EgovWikiBookmarkService;
import coreframework.com.uss.ion.wik.bmk.service.WikiBookmark;
...
public class EgovWikiBookmarkController {
    ...
    @RequestMapping(value = "/uss/ion/wik/bmk/listWikiBookmark.cm")
    public String EgovWikiBookmarkList(
        ...
        if(sCmd.equals("del")){
	        ...
	        return "redirect:/uss/ion/wik/bmk/listWikiBookmark.cm";
        }
    	...
    	return "coreframework/com/uss/ion/wik/bmk/EgovWikiBookmarkList";
	}
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/uss/ion/wik/bmk/registWikiBookmark.cm")
    public String EgovWikiBookmarkRegist(
    	...
    	return "coreframework/com/uss/ion/wik/bmk/EgovWikiBookmarkRegist";
	}
