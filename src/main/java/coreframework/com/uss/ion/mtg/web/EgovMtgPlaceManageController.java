package coreframework.com.uss.ion.mtg.web;
...
import coreframework.com.uss.ion.mtg.service.MtgPlaceResve;
...
import coreframework.com.uss.ion.mtg.service.EgovMtgPlaceManageService;
import coreframework.com.uss.ion.mtg.service.MtgPlaceManage;
import coreframework.com.uss.ion.mtg.service.MtgPlaceManageVO;
...
public class EgovMtgPlaceManageController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/uss/ion/mtg/selectMtgPlaceManageListView.cm")
    public String selectMtgPlaceManageListView() throws Exception {

        return "coreframework/com/uss/ion/mtg/EgovMtgPlaceManageList";
    }
    ...
    @RequestMapping(value="/uss/ion/mtg/selectMtgPlaceManageList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/mtg/selectMtgPlaceManage.cm")
	 public String selectMtgPlaceManage(@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
		...
		if(sCmd.equals("update")){
			return "coreframework/com/uss/ion/mtg/EgovMtgPlaceUpdt";
		}else{
			return "coreframework/com/uss/ion/mtg/EgovMtgPlaceDetail";
		}
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/mtg/insertViewMtgPlace.cm")
	 public String insertViewMtgPlaceManage(@ModelAttribute("mtgPlaceManage") MtgPlaceManage mtgPlaceManage,
    	...
    	return "coreframework/com/uss/ion/mtg/EgovMtgPlaceRegist";
	}
	...
	@RequestMapping(value="/uss/ion/mtg/insertMtgPlace.cm")
	 public String insertMtgPlaceManage(final MultipartHttpServletRequest multiRequest,			                            
    	...
    	if (bindingResult.hasErrors()) {
	    	...
	    	return "redirect:/uss/ion/mtg/selectMtgPlaceManageList.cm";
		}
	}
	 ...
	 */
	 @SuppressWarnings("unused")
	@RequestMapping(value="/uss/ion/mtg/updtMtgPlace.cm")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/mtg/deleteMtgPlaceManage.cm")
	 public String deleteMtgPlaceManage(@ModelAttribute("mtgPlaceManage") MtgPlaceManage mtgPlaceManage,
    	...
    	return "forward:/uss/ion/mtg/selectMtgPlaceManageList.cm";
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/mtg/selectMtgPlaceImage.cm")
	 public String selectMtgPlaceImage(@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
    	...
    	model.addAttribute("message", coreMessageSource.getMessage("success.common.select"));
		return "coreframework/com/uss/ion/mtg/EgovMtgPlaceImageDetail";
	}
    ...
    @RequestMapping(value="/uss/ion/mtg/selectMtgPlaceResveManageList.cm")
...
*/
		...
		return "coreframework/com/uss/ion/mtg/EgovMtgPlaceResveManageList";
	}
	 ...
	 */
     @SuppressWarnings("unused")
	@RequestMapping(value="/uss/ion/mtg/selectMtgPlaceResveManage.cm")
	 public String selectMtgPlaceResveManage(	@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
		...
		return "coreframework/com/uss/ion/mtg/EgovMtgPlaceResveRegist";
	}
	 ...
	 * @return String - 리턴 Url
	 */
     @RequestMapping(value="/uss/ion/mtg/selectMtgPlaceResveManageDetail.cm")
	 public String selectMtgPlaceResveManageDetail(	@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
		...
		if(sCmd.equals("detail")){
	    	...
	    	model.addAttribute("mtgPlaceManageVO",  mtgPlaceManageVO_Temp);
			return "coreframework/com/uss/ion/mtg/EgovMtgPlaceResveDetail";
		}else{
		    model.addAttribute("mtgPlaceManageVO",  mtgPlaceManageVO_Temp);
			return "coreframework/com/uss/ion/mtg/EgovMtgPlaceResveUpdt";
		}
	}
	 ...
	 * @return String - 리턴 Url
	 */
     @RequestMapping(value="/uss/ion/mtg/insertMtgPlaceResve.cm")
	 public String insertMtgPlaceResveManage(@ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
    	...
    	if (bindingResult.hasErrors()) {
    		model.addAttribute("mtgPlaceManageVO", mtgPlaceManageVO);
			return "forward:/uss/ion/mtg/selectMtgPlaceResveManage.cm";
		} else {
	    	...
	    	return "forward:/uss/ion/mtg/selectMtgPlaceResveManageList.cm";
		}
	}
	 ...
	 */
	 @SuppressWarnings("unused")
	@RequestMapping(value="/uss/ion/mtg/updtMtgPlaceResve.cm")
	 ...
	 * @return String - 리턴 Url
	 */
     @RequestMapping(value="/uss/ion/mtg/deleteMtgPlaceResve.cm")
	 ...
	 * @return int - 중복건수
	 */
     @RequestMapping(value="/uss/ion/mtg/mtgPlaceResveDplactCeck.cm")
	 public String mtgPlaceResveDplactCeck(  @ModelAttribute("mtgPlaceManageVO") MtgPlaceManageVO mtgPlaceManageVO,
		...
		return "coreframework/com/uss/ion/mtg/EgovMtgPlaceResveDplactCeck";
	}
