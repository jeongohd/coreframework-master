package coreframework.com.uss.ion.nts.web;
...
public class EgovNoteTrnsmitController {
    ...
    @RequestMapping(value = "/uss/ion/nts/listNoteTrnsmit.cm")
    public String EgovNoteTrnsmitList(
    	...
    	return "coreframework/com/uss/ion/nts/EgovNoteTrnsmitList";
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/uss/ion/nts/detailNoteTrnsmit.cm")
    public String EgovNoteTrnsmitDetail(
            ...
            if(sCmd.equals("del")){
            	...
            	sLocationUrl = "redirect:/uss/ion/nts/listNoteTrnsmit.cm";
            }else{
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/uss/ion/nts/selectNoteTrnsmitCnfirm.cm")
    public String EgovNoteTrnsmitCnfirm(
    		...
    		return "coreframework/com/uss/ion/nts/EgovNoteTrnsmitCnfirm";
    }
