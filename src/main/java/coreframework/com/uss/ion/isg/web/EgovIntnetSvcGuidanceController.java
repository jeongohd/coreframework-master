...
package coreframework.com.uss.ion.isg.web;

import java.util.List;

import coreframework.com.uss.ion.isg.service.EgovIntnetSvcGuidanceService;
import coreframework.com.uss.ion.isg.service.IntnetSvcGuidance;
import coreframework.com.uss.ion.isg.service.IntnetSvcGuidanceVO;
...
public class EgovIntnetSvcGuidanceController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/uss/ion/isg/selectIntnetSvcGuidanceListView.cm")
    public String selectIntnetSvcGuidanceListView() throws Exception {

        return "coreframework/com/uss/ion/isg/EgovIntnetSvcGuidanceList";
    }
	...
	@RequestMapping("/uss/ion/isg/selectIntnetSvcGuidanceList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/uss/ion/isg/getIntnetSvcGuidance.cm")
	public String selectIntnetSvcGuidance(@RequestParam("intnetSvcId") String intnetSvcId,
		...
		return "coreframework/com/uss/ion/isg/EgovIntnetSvcGuidanceUpdt";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/uss/ion/isg/addViewIntnetSvcGuidance.cm")
    public String insertIntnetSvcGuidanceView(@ModelAttribute("intnetSvcGuidanceVO") IntnetSvcGuidanceVO intnetSvcGuidanceVO) throws Exception {
        ...
        return "coreframework/com/uss/ion/isg/EgovIntnetSvcGuidanceRegist";
    }
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/uss/ion/isg/addIntnetSvcGuidance.cm")
...
//			return "coreframework/com/uss/ion/isg/EgovIntnetSvcGuidanceUpdt";
			return "forward:/uss/ion/isg/selectIntnetSvcGuidanceList.cm";
		}
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/uss/ion/isg/updtIntnetSvcGuidance.cm")
...
//			return "forward:/uss/ion/isg/getIntnetSvcGuidance.cm";
			return "forward:/uss/ion/isg/selectIntnetSvcGuidanceList.cm";
		}
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/uss/ion/isg/removeIntnetSvcGuidance.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping("/uss/ion/isg/selectIntnetSvcGuidanceResultList.cm")
	public String selectIntnetSvcGuidanceResult(@ModelAttribute("intnetSvcGuidanceVO") IntnetSvcGuidanceVO intnetSvcGuidanceVO,
		...
		return "coreframework/com/uss/ion/isg/EgovIntnetSvcGuidanceView";
	}
}
