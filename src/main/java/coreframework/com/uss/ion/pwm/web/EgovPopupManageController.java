package coreframework.com.uss.ion.pwm.web;
...
import coreframework.com.uss.ion.pwm.service.EgovPopupManageService;
import coreframework.com.uss.ion.pwm.service.PopupManageVO;
...
public class EgovPopupManageController {
	 ...
	 * @param popupManageVO
	 * @param model
	 * @return "coreframework/com/uss/ion/pwm/listPopupManage"
	 * @throws Exception
	 */
	@IncludedInfo(name = "팝업창관리", order = 720, gid = 50)
	@RequestMapping(value = "/uss/ion/pwm/listPopup.cm")
	public String egovPopupManageList(@RequestParam Map<?, ?> commandMap, PopupManageVO popupManageVO, ModelMap model)
		...
		return "coreframework/com/uss/ion/pwm/EgovPopupList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/ion/pwm/updtPopup.cm")
	public String egovPopupManageUpdt(@RequestParam Map<?, ?> commandMap, PopupManageVO popupManageVO,
		...
		String sLocationUrl = "coreframework/com/uss/ion/pwm/EgovPopupUpdt";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/ion/pwm/registPopup.cm")
	public String egovPopupManageRegist(@RequestParam Map<?, ?> commandMap,
		...
		String sLocationUrl = "coreframework/com/uss/ion/pwm/EgovPopupRegist";
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/ion/pwm/ajaxPopupManageInfo.cm")
	public void egovPopupManageInfoAjax(@RequestParam Map<?, ?> commandMap, HttpServletResponse response,
		...
		out.print(CoreWebUtil.clearXSSMinimum(sPrint));//2022.01 Potential XSS in Servlet
		out.flush();
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/ion/pwm/openPopupManage.cm")
	public String egovPopupManagePopupOpen(@RequestParam("fileUrl") String fileUrl,
		...
		fileUrl = CoreWebUtil.filePathBlackList(fileUrl);
	 ...
	 * @param popupManageVO
	 * @param model
	 * @return "coreframework/com/uss/ion/pwm/listMainPopup"
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/ion/pwm/listMainPopup.cm")
	public String egovPopupManageMainList(PopupManageVO popupManageVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/ion/pwm/EgovPopupMainList";
	}
