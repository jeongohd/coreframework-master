package coreframework.com.uss.ion.bnt.web;
...
import coreframework.com.uss.ion.bnt.service.BndtCeckManage;
import coreframework.com.uss.ion.bnt.service.BndtManageVO;
import coreframework.com.uss.ion.bnt.service.EgovBndtManageService;
...
import coreframework.com.uss.ion.bnt.service.BndtCeckManageVO;
import coreframework.com.uss.ion.bnt.service.BndtDiary;
import coreframework.com.uss.ion.bnt.service.BndtDiaryVO;
import coreframework.com.uss.ion.bnt.service.BndtManage;
...
public class EgovBndtManageController {
	...
	@RequestMapping("/uss/ion/bnt/EgovBndtManageList.cm")
	public String selectBndtManageListView(
		...
		return "coreframework/com/uss/ion/bnt/EgovBndtManageList";
	}
	 ...
	 */
	@RequestMapping(value = "/uss/ion/bnt/selectBndtManageList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/EgovBndtManageDetail.cm")
	public String selectBndtManage(@ModelAttribute("bndtManageVO") BndtManageVO bndtManageVO,
		...
		if (sCmd.equals("updt")) {
			...
			return "coreframework/com/uss/ion/bnt/EgovBndtManageUpdt";
		} else {
			return "coreframework/com/uss/ion/bnt/EgovBndtManageDetail";
		}
		//model.addAttribute("bndtManage", egovBndtManageService.selectBndtManage(bndtManageVO));
		//model.addAttribute("message", coreMessageSource.getMessage("success.common.select"));
		//return "coreframework/com/uss/ion/ans/EgovBndtManageUpdt";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/EgovBndtManageRegist.cm")
	public String insertViewBndtManage(@ModelAttribute("bndtManage") BndtManage bndtManage,
		...
		return "coreframework/com/uss/ion/bnt/EgovBndtManageRegist";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/insertBndtManage.cm")
	public String insertBndtManage(@ModelAttribute("bndtManage") BndtManage bndtManage,
		...
		if (bindingResult.hasErrors()) {
			...
			return "forward:/uss/ion/bnt/EgovBndtManageList.cm";
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/updtBndtManage.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/deleteBndtManage.cm")
	...
	@RequestMapping(value = "/uss/ion/bnt/EgovBndtCeckManageList.cm")
	public String selectBndtCeckManageList(@ModelAttribute("bndtCeckManageVO") BndtCeckManageVO bndtCeckManageVO,
		...
		return "coreframework/com/uss/ion/bnt/EgovBndtCeckManageList";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/EgovBndtCeckManage.cm")
	public String selectBndtCeckManage(@ModelAttribute("bndtCeckManageVO") BndtCeckManageVO bndtCeckManageVO,
		...
		if (sCmd.equals("updt")) {
			...
			return "coreframework/com/uss/ion/bnt/EgovBndtCeckManageUpdt";
		} else {
			return "coreframework/com/uss/ion/bnt/EgovBndtCeckManageDetail";
		}
	}
	 ...
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value = "/uss/ion/bnt/EgovBndtCeckManageRegist.cm")
	public String insertViewBndtCeckManage(@ModelAttribute("bndtCeckManage") BndtCeckManage bndtCeckManage,
		...
		return "coreframework/com/uss/ion/bnt/EgovBndtCeckManageRegist";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/insertBndtCeckManage.cm")
	public String insertBndtCeckManage(@ModelAttribute("bndtCeckManage") BndtCeckManage bndtCeckManage,
		...
		if (bindingResult.hasErrors()) {
			...
			if (egovBndtManageService.selectBndtCeckManageDplctAt(bndtCeckManage) == 0) {
				...
				model.addAttribute("message", coreMessageSource.getMessage("success.common.insert"));
				return "forward:/uss/ion/bnt/EgovBndtCeckManageList.cm";
			} else {
				ComDefaultCodeVO vo = new ComDefaultCodeVO();
				vo.setCodeId("COM071");
				List<?> bndtCeckSeList = cmmUseService.selectCmmCodeDetail(vo);
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/updtBndtCeckManage.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/deleteBndtCeckManage.cm")
	...
	@RequestMapping(value = "/uss/ion/bnt/selectBndtDiary.cm")
	public String selectBndtDiary(@ModelAttribute("bndtDiaryVO") BndtDiaryVO bndtDiaryVO,
		...
		if (sCmd.equals("insert")) {
			...
			return "coreframework/com/uss/ion/bnt/EgovBndtDiaryRegist";
		} else if (sCmd.equals("updt")) {
			return "coreframework/com/uss/ion/bnt/EgovBndtDiaryUpdt";
		} else {
			return "coreframework/com/uss/ion/bnt/EgovBndtDiaryDetail";
		}
	}
	 ...
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value = "/uss/ion/bnt/insertBndtDiary.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/updtBndtDiary.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/deleteBndtDiary.cm")
	 ...
	 * @exception Exception
	 */
	@RequestMapping(value = "/uss/ion/bnt/EgovBndtManageListPop.cm")
	public String selectBndtManageBnde(final HttpServletRequest request,
		...
		return "coreframework/com/uss/ion/bnt/EgovBndtManageBndeListPop";
	}

	@RequestMapping(value = "/uss/ion/bnt/EgovBndtManageListPopAction.cm")
			...
			while (itr.hasNext()) {
				...
				if (!"".equals(file.getOriginalFilename())) {
					...
					if ("xlsx".equals(ext)) {
						...
						throw new RuntimeException(coreMessageSource.getMessage("errors.file.extension"));
					}
				} else {
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value = "/uss/ion/bnt/insertBndtManageBnde.cm")
