package coreframework.com.uss.ion.ntr.web;
...
import coreframework.com.uss.ion.ntr.service.EgovNoteRecptnService;
import coreframework.com.uss.ion.ntr.service.NoteRecptn;
import coreframework.com.uss.ion.nts.service.EgovNoteTrnsmitService;
import coreframework.com.uss.ion.nts.service.NoteTrnsmit;
...
public class EgovNoteRecptnController {
    ...
    @RequestMapping(value = "/uss/ion/ntr/listNoteRecptn.cm")
    public String EgovNoteRecptnList(
    	...
    	return "coreframework/com/uss/ion/ntr/EgovNoteRecptnList";
	...
	@RequestMapping(value = "/uss/ion/ntr/detailNoteRecptn.cm")
    public String EgovNoteRecptnDetail(
		...
		String sLocationUrl = "coreframework/com/uss/ion/nts/EgovNoteTrnsmitDetail";

        String sCmd = commandMap.get("cmd") == null ? "" : (String) commandMap.get("cmd");

        if(sCmd.equals("del")){
        	egovNoteRecptnService.deleteNoteRecptn(searchVO);
        	return "redirect:/uss/ion/ntr/listNoteRecptn.cm";
        }else{
            //로그인 객체 선언/아이디설정
            LoginVO loginVO = (LoginVO) CoreUserDetailsHelper.getAuthenticatedUser();
        	...
        	NoteTrnsmit noteTrnsmit = new NoteTrnsmit();
    	...
    	return "coreframework/com/uss/ion/ntr/EgovNoteRecptnDetail";
    }
