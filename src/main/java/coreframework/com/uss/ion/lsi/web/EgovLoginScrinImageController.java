...
package coreframework.com.uss.ion.lsi.web;
...
import coreframework.com.uss.ion.lsi.service.EgovLoginScrinImageService;
import coreframework.com.uss.ion.lsi.service.LoginScrinImageVO;
...
import coreframework.com.uss.ion.lsi.service.LoginScrinImage;
...
public class EgovLoginScrinImageController {
	 ...
	 * @exception Exception
	 */
    @RequestMapping("/uss/ion/lsi/selectLoginScrinImageListView.cm")
    public String selectLoginScrinImageListView() throws Exception {

        return "coreframework/com/uss/ion/lsi/EgovLoginScrinImageList";
    }
    ...
    @RequestMapping(value="/uss/ion/lsi/selectLoginScrinImageList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/lsi/getLoginScrinImage.cm")
	public String selectLoginScrinImage(@RequestParam("imageId") String imageId,
    	...
    	model.addAttribute("message", coreMessageSource.getMessage("success.common.select"));
    	return "coreframework/com/uss/ion/lsi/EgovLoginScrinImageUpdt";
	}
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/lsi/addViewLoginScrinImage.cm")
	public String insertViewLoginScrinImage(@ModelAttribute("loginScrinImageVO") LoginScrinImageVO loginScrinImageVO) throws Exception {
    	return "coreframework/com/uss/ion/lsi/EgovLoginScrinImageRegist";
	}
	...
	@RequestMapping(value="/uss/ion/lsi/addLoginScrinImage.cm")
...
//	    	return "coreframework/com/uss/ion/lsi/EgovLoginScrinImageUpdt";
	    	return "forward:/uss/ion/lsi/selectLoginScrinImageList.cm";
	 ...
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value="/uss/ion/lsi/updtLoginScrinImage.cm")
...
//	    	return "forward:/uss/ion/lsi/getLoginScrinImage.cm";
	    	return "forward:/uss/ion/lsi/selectLoginScrinImageList.cm";
	 ...
	 * @return String - 리턴 Url
	 */
    @RequestMapping(value="/uss/ion/lsi/removeLoginScrinImage.cm")
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/uss/ion/lsi/removeLoginScrinImageList.cm")
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/uss/ion/lsi/getLoginScrinImageResult.cm")
	public String selectLoginScrinImageResult(@ModelAttribute("loginScrinImageVO") LoginScrinImageVO loginScrinImageVO,
		...
		return "coreframework/com/uss/ion/lsi/EgovLoginScrinImageView";
	}
}
