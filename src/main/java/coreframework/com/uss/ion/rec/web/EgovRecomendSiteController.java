package coreframework.com.uss.ion.rec.web;
...
import coreframework.com.uss.ion.rec.service.EgovRecomendSiteService;
...
import coreframework.com.uss.ion.rec.service.RecomendSiteVO;
...
public class EgovRecomendSiteController {
    ...
    @RequestMapping(value="/uss/ion/rec/selectRecomendSiteList.cm")
    public String selectRecomendSiteList(@ModelAttribute("searchVO") RecomendSiteVO searchVO, ModelMap model) throws Exception {
        ...
        return "coreframework/com/uss/ion/rec/EgovRecomendSiteList";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/rec/selectRecomendSiteDetail.cm")
    public String	selectRecomendSiteDetail(RecomendSiteVO recomendSiteVO,
        ...
        return	"coreframework/com/uss/ion/rec/EgovRecomendSiteDetail";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/rec/insertRecomendSiteView.cm")
    public String insertRecomendSiteView(@ModelAttribute("searchVO") RecomendSiteVO searchVO, Model model) throws Exception {
        ...
        return "coreframework/com/uss/ion/rec/EgovRecomendSiteRegist";
     ...
     * @param recomendSiteVO
     * @param bindingResult
     * @return	"forward:/uss/ion/rec/selectRecomendSiteList.cm"
     * @throws Exception
     */
    @RequestMapping("/uss/ion/rec/insertRecomendSite.cm")
    public String insertRecomendSite(
		...
		if(bindingResult.hasErrors()){
			return "coreframework/com/uss/olh/rec/EgovRecomendSiteRegist";
		}
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/rec/updateRecomendSiteView.cm")
    public String updateRecomendSiteView(@RequestParam("recomendSiteId") String recomendSiteId ,
        ...
        return "coreframework/com/uss/ion/rec/EgovRecomendSiteUpdt";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/rec/updateRecomendSite.cm")
    public String updateRecomendSite(@ModelAttribute("searchVO") RecomendSiteVO searchVO, @ModelAttribute("recomendSiteVO") RecomendSiteVO recomendSiteVO,
    	...
    	beanValidator.validate(recomendSiteVO, bindingResult);
		if(bindingResult.hasErrors()){
			return "coreframework/com/uss/olh/rec/EgovRecomendSiteUpdt";
		}
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/ion/rec/deleteRecomendSite.cm")
