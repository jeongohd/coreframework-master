 ...
 * @author Keith Donald
 */
package coreframework.com.uss.ion.fbk.web;
...
public class EgovFacebookController {
	...
	@RequestMapping(value = "/uss/ion/fbk/facebook.cm", method = RequestMethod.GET)
	public String home() {
		return "coreframework/com/uss/ion/fbk/EgovFacebookHome";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/uss/ion/fbk/feed.cm", method=RequestMethod.GET)
	public String showFeed(Model model) {
		model.addAttribute("feed", facebook.feedOperations().getFeed());
		return "coreframework/com/uss/ion/fbk/EgovFacebookFeed";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/uss/ion/fbk/feed.cm", method=RequestMethod.POST)
	public String postUpdate(String message) {
		facebook.feedOperations().updateStatus(message);
		return "redirect:/uss/ion/fbk/feed.cm";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/uss/ion/fbk/albums.cm", method=RequestMethod.GET)
	public String showAlbums(Model model) {
		model.addAttribute("albums", facebook.mediaOperations().getAlbums());
		return "coreframework/com/uss/ion/fbk/EgovFacebookAlbums";
	}
	...
	public String showAlbum(@PathVariable("albumId") String albumId, Model model) {
		...
		return "coreframework/com/uss/ion/fbk/EgovFacebookAlbum";
	}
	 ...
	 * @return String - 리턴 Url
	 */
	@RequestMapping(value="/uss/ion/fbk/profile.cm", method=RequestMethod.GET)
	public String profile(Model model) {
		...
		return "coreframework/com/uss/ion/fbk/EgovFacebookProfile";
	}
