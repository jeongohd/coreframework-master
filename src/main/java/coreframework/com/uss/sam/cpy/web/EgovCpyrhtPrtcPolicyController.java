package coreframework.com.uss.sam.cpy.web;
...
import coreframework.com.uss.sam.cpy.service.CpyrhtPrtcPolicyDefaultVO;
import coreframework.com.uss.sam.cpy.service.CpyrhtPrtcPolicyVO;
import coreframework.com.uss.sam.cpy.service.EgovCpyrhtPrtcPolicyService;
...
public class EgovCpyrhtPrtcPolicyController {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/uss/sam/cpy/EgovMain.cm")
    public String egovMain(ModelMap model) throws Exception {
    	return "coreframework/com/uss/sam/cpy/EgovMain";
    }
     ...
     * @throws Exception
     */
    @RequestMapping(value="/uss/sam/cpy/EgovLeft.cm")
    public String egovLeft(ModelMap model) throws Exception {
    	return "coreframework/com/uss/sam/cpy/EgovLeft";
    }
    ...
    @RequestMapping(value="/uss/sam/cpy/CpyrhtPrtcPolicyListInqire.cm")
    public String selectCpyrhtPrtcPolicyList(@ModelAttribute("searchVO") CpyrhtPrtcPolicyDefaultVO searchVO, ModelMap model) throws Exception {
        ...
        return "coreframework/com/uss/sam/cpy/EgovCpyrhtPrtcPolicyListInqire";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/sam/cpy/CpyrhtPrtcPolicyDetailInqire.cm")
    public String	selectCpyrhtPrtcPolicyDetail(CpyrhtPrtcPolicyVO cpyrhtPrtcPolicyVO,
        ...
        return	"coreframework/com/uss/sam/cpy/EgovCpyrhtPrtcPolicyDetailInqire";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/sam/cpy/CpyrhtPrtcPolicyCnRegistView.cm")
    public String insertCpyrhtPrtcPolicyCnView(
        ...
        return "coreframework/com/uss/sam/cpy/EgovCpyrhtPrtcPolicyCnRegist";
     ...
     * @param cpyrhtPrtcPolicyVO
     * @param bindingResult
     * @return	"forward:/uss/sam/cpy/CpyrhtPrtcPolicyListInqire.cm"
     * @throws Exception
     */
    @RequestMapping("/uss/sam/cpy/CpyrhtPrtcPolicyCnRegist.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/sam/cpy/CpyrhtPrtcPolicyCnUpdtView.cm")
    public String updateCpyrhtPrtcPolicyCnView(@RequestParam("cpyrhtId") String cpyrhtId ,
        ...
        return "coreframework/com/uss/sam/cpy/EgovCpyrhtPrtcPolicyCnUpdt";
    }
    ...
    * @throws Exception
    */
    @RequestMapping("/uss/sam/cpy/CpyrhtPrtcPolicyCnUpdt.cm")
    public String updateCpyrhtPrtcPolicyCn(
		...
		if(bindingResult.hasErrors()){
			...
			return "coreframework/com/uss/olh/wor/EgovCpyrhtPrtcPolicyCnUpdt";
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/sam/cpy/CpyrhtPrtcPolicyCnDelete.cm")
