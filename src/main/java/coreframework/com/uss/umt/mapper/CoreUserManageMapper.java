package coreframework.com.uss.umt.mapper;
 ...
 * </pre>
 */
@Mapper("CoreUserManageMapper")
public interface CoreUserManageMapper {
	...
	public List<?> selectUserList_S(UserDefaultVO userSearchVO) throws Exception;

	public int selectUserListTotCnt_S(UserDefaultVO userSearchVO) throws  Exception;
}