...
@Controller
public class CoreEntrprsManageController {

	private static final Logger LOGGER = LoggerFactory.getLogger(CoreEntrprsManageController.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreEntrprsMberRegist.cm")
	public String coreEntrprsMberRegist(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO,
	 ...
	 * @param model           화면모델
	 * @return forward:/uss/umt/coreEntrprsMberManageList.cm
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreEntrprsMberAdd.cm")
	public String coreEntrprsMberAdd(@ModelAttribute("entrprsManageVO") EntrprsManageVO entrprsManageVO,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreEntrprsMberUpdt.cm")
	 ...
	 * @param model 화면모델
	 * @return uss/umt/coreEntrprsMberUpdt.cm
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/CoreEntrprsMberLockIncorrect.cm")
	public String updateLockIncorrect(EntrprsManageVO entrprsManageVO, Model model) throws Exception {
		...
		return "forward:/uss/umt/coreEntrprsMberUpdt.cm";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreEntrprsMberModify.cm")
	public String coreEntrprsMberModify(@ModelAttribute("entrprsManageVO") EntrprsManageVO entrprsManageVO,
		BindingResult bindingResult, Model model) throws Exception {
	 ...
	 * @param userSearchVO 조회조건정보
	 * @param model 화면모델
	 * @return "forward:/uss/umt/coreUserManageList.cm"
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreEntrprsMberRemove.cm")
	public String coreEntrprsMberRemove(@RequestParam("checkedIdForDel") String checkedIdForDel,
		@ModelAttribute("searchVO") UserDefaultVO userSearchVO, HttpServletRequest request, Model model)
		throws Exception {
	...
	@RequestMapping(value = "/uss/umt/coreEntrprsMberManageList.cm")
	public String coreEntrprsMberManageList(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, ModelMap model)
		throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreEntrprsMberSbscrbRegist.cm")
	public String coreEntrprsMberSbscrbRegist(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO,
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreEntrprsMberSbscrbAdd.cm")
	public String coreEntrprsMberSbscrbAdd(@ModelAttribute("entrprsManageVO") EntrprsManageVO entrprsManageVO)
		throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreStplatCnfirmEntrprsList.cm")
	public String coreStplatCnfirmEntrprsList(Model model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/umt/coreEntrprsPasswordModify.cm")
	public String coreEntrprsPasswordModify(ModelMap model, @RequestParam Map<String, Object> commandMap,
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/umt/coreEntrprsPasswordUpdt.cm")
