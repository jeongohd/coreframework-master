...
@Controller
public class CoreMberManageController {

	private static final Logger LOGGER = LoggerFactory.getLogger(CoreMberManageController.class);
	...
	@RequestMapping(value = "/uss/umt/coreMberManageList.cm")
	public String coreMberManageList(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, ModelMap model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreMberManageRegist.cm")
	 ...
	 * @param model 화면모델
	 * @return forward:/uss/umt/coreMberManageList.cm
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreMberManageAdd.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreMberManage.cm")
	 ...
	 * @param mberManageVO 일반회원등록정보
	 * @param model 화면모델
	 * @return uss/umt/coreMberManage.cm
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreMberLockIncorrect.cm")
	public String coreMberLockIncorrect(MberManageVO mberManageVO, Model model) throws Exception {
	    ...
	    return "forward:/uss/umt/coreMberManage.cm";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreMberSelectModify.cm")
	public String coreMberSelectModify(@ModelAttribute("mberManageVO") MberManageVO mberManageVO, BindingResult bindingResult, Model model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreMberRemove.cm")
	public String CoreMberRemove(@RequestParam("checkedIdForDel") String checkedIdForDel, @ModelAttribute("searchVO") UserDefaultVO userSearchVO, HttpServletRequest request, Model model) throws Exception {
	...
	// 탈퇴 처리 기능에 대한 예시
	@RequestMapping("/uss/umt/coreMberWithdraw.cm")
	public String coreMberWithdraw(Model model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreMberSbscrbRegist.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreMberSbscrbAdd.cm")
	public String coreMberSbscrbAdd(@ModelAttribute("mberManageVO") MberManageVO mberManageVO) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/umt/coreStplatCnfirmMberList.cm")
	public String coreStplatCnfirmMber(Model model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/umt/coreMberPasswordModify.cm")
	public String coreMberPasswordModify(ModelMap model, @RequestParam Map<String, Object> commandMap, @ModelAttribute("searchVO") UserDefaultVO userSearchVO,
	...
	public String coreMberPasswordUpdt(ModelMap model, @RequestParam Map<String, Object> commandMap, @ModelAttribute("searchVO") UserDefaultVO userSearchVO,
			@ModelAttribute("mberManageVO") MberManageVO mberManageVO) throws Exception {
