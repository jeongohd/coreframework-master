package coreframework.com.uss.olh.faq.web;
...
import coreframework.com.uss.olh.faq.service.EgovFaqService;
import coreframework.com.uss.olh.faq.service.FaqVO;
...
public class EgovFaqController {
	...
	@RequestMapping(value = "/uss/olh/faq/selectFaqList.cm")
	public String selectFaqList(@ModelAttribute("searchVO") FaqVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/olh/faq/EgovFaqList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/faq/selectFaqDetail.cm")
	public String selectFaqDetail(FaqVO faqVO, @ModelAttribute("searchVO") FaqVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/olh/faq/EgovFaqDetail";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/faq/insertFaqView.cm")
	public String insertFaqView(@ModelAttribute("searchVO") FaqVO searchVO, Model model) throws Exception {
		...
		return "coreframework/com/uss/olh/faq/EgovFaqRegist";
	 ...
	 * @param faqVO
	 * @param bindingResult
	 * @return	"forward:/uss/olh/faq/selectFaqList.cm"
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/faq/insertFaq.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/faq/updateFaqView.cm")
	public String updateFaqView(@RequestParam("faqId") String faqId, @ModelAttribute("searchVO") FaqVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/olh/faq/EgovFaqUpdt";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/faq/updateFaq.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/faq/deleteFaq.cm")
