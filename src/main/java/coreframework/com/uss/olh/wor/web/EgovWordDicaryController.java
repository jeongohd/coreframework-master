package coreframework.com.uss.olh.wor.web;
...
import coreframework.com.uss.olh.wor.service.EgovWordDicaryService;
import coreframework.com.uss.olh.wor.service.WordDicaryVO;
...
public class EgovWordDicaryController {
	...
	@RequestMapping(value = "/uss/olh/wor/selectWordDicaryList.cm")
	public String selectWordDicaryList(@ModelAttribute("searchVO") WordDicaryVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/olh/wor/EgovWordDicaryList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/wor/selectWordDicaryDetail.cm")
	public String selectWordDicaryDetail(WordDicaryVO wordDicaryVO, @ModelAttribute("searchVO") WordDicaryVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/olh/wor/EgovWordDicaryDetail";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/wor/insertWordDicaryView.cm")
	public String insertWordDicaryView(@ModelAttribute("searchVO") WordDicaryVO searchVO, Model model) throws Exception {
		...
		return "coreframework/com/uss/olh/wor/EgovWordDicaryRegist";
	}
	 ...
	 * @param bindingResult
	 * @param model
	 * @return	"forward:/uss/olh/wor/selectWordDicaryList.cm"
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/wor/insertWordDicary.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/wor/updateWordDicaryView.cm")
	public String updateWordDicaryView(@RequestParam("wordId") String wordId, @ModelAttribute("searchVO") WordDicaryVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/olh/wor/EgovWordDicaryUpdt";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/wor/updateWordDicary.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/wor/deleteWordDicary.cm")
