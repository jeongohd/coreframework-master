package coreframework.com.uss.olh.omm.web;
...
import coreframework.com.uss.olh.omm.service.EgovOnlineManualService;
import coreframework.com.uss.olh.omm.service.OnlineManualVO;
...
public class EgovOnlineManualController {
     ...
     * @param onlineManual
     * @param model
     * @return "coreframework/com/uss/olh/omn/EgovOnlineManualList"
     * @throws Exception
     */
    @SuppressWarnings("unused")
	@IncludedInfo(name="사용자온라인매뉴얼", order = 571 ,gid = 50)
    @RequestMapping(value = "/uss/olh/omn/selectOnlineManualList.cm")
    public String selectOnlineManualUserList(@ModelAttribute("searchVO") OnlineManualVO searchVO, ModelMap model)
        ...
        return "coreframework/com/uss/olh/omm/EgovOnlineManualUserList";
    }
     ...
     */
    @SuppressWarnings("unused")
	@RequestMapping(value = "/uss/olh/omn/selectOnlineManualDetail.cm")
    public String selectOnlineManualUserDetail(@ModelAttribute("searchVO") OnlineManualVO searchVO, OnlineManualVO onlineManualVO, ModelMap model) throws Exception {
        ...
        return "coreframework/com/uss/olh/omm/EgovOnlineManualUserDetail";
    }
     ...
     * @param onlineManual
     * @param model
     * @return "coreframework/com/uss/olh/omm/EgovOnlineManualList"
     * @throws Exception
     */
    @SuppressWarnings("unused")
	@IncludedInfo(name="온라인매뉴얼", order = 570 ,gid = 50)
    @RequestMapping(value = "/uss/olh/omm/selectOnlineManualList.cm")
     ...
     */
    @SuppressWarnings("unused")
	@RequestMapping(value = "/uss/olh/omm/selectOnlineManualDetail.cm")
    public String selectOnlineManualDetail(@ModelAttribute("searchVO") OnlineManualVO searchVO, OnlineManualVO onlineManualVO, ModelMap model) throws Exception {
        ...
        return "coreframework/com/uss/olh/omm/EgovOnlineManualDetail";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/olh/omm/insertOnlineManualView.cm")
    public String insertOnlineManualView(@ModelAttribute("searchVO") OnlineManualVO searchVO, Model model) throws Exception {
        ...
        return "coreframework/com/uss/olh/omm/EgovOnlineManualRegist";
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/olh/omm/insertOnlineManual.cm")
    public String insertOnlineManual(
        ...
        return "forward:/uss/olh/omm/selectOnlineManualList.cm";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/olh/omm/updateOnlineManualView.cm")
    public String updateOnlineManualView(@RequestParam("onlineMnlId") String onlineMnlId ,
        ...
        return "coreframework/com/uss/olh/omm/EgovOnlineManualUpdt";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/olh/omm/updateOnlineManual.cm")
     ...
     * @throws Exception
     */
    @RequestMapping("/uss/olh/omm/deleteOnlineManual.cm")
