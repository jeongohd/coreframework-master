package coreframework.com.uss.olh.qna.web;
...
import coreframework.com.uss.olh.qna.service.EgovQnaService;
import coreframework.com.uss.olh.qna.service.QnaDefaultVO;
import coreframework.com.uss.olh.qna.service.QnaVO;
...
public class EgovQnaController {
	...
	@RequestMapping(value = "/uss/olh/qna/selectQnaList.cm")
	public String selectQnaList(@ModelAttribute("searchVO") QnaVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/olh/qna/EgovQnaList";
	}
	...
	@RequestMapping("/uss/olh/qna/selectQnaDetail.cm")
...
//		vo.setWritngPassword(EgovFileScrty.decode(writngPassword));
		...
		return "coreframework/com/uss/olh/qna/EgovQnaDetail";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/qna/insertQnaView.cm")
	public String insertQnaView(@ModelAttribute("searchVO") QnaVO searchVO, QnaVO qnaVO, Model model) throws Exception {
		...
		if (!isAuthenticated) {
			...
			return "coreframework/com/uss/olh/qna/EgovQnaRegist";
		}
	 ...
	 * @param qnaVO
	 * @param bindingResult
	 * @return	"forward:/uss/olh/qna/selectQnaList.cm"
	 * @throws Exception
	 */
	@SuppressWarnings("deprecation")
	@RequestMapping("/uss/olh/qna/insertQna.cm")
...
//		qnaVO.setWritngPassword(EgovFileScrty.encode(writngPassword));
	 ...
	 */
	@SuppressWarnings("deprecation")
	@RequestMapping("/uss/olh/qna/updateQnaView.cm")
...
//		vo.setWritngPassword(EgovFileScrty.decode(writngPassword));
		...
		return "coreframework/com/uss/olh/qna/EgovQnaUpdt";
	}
	 ...
	 */
	@SuppressWarnings("deprecation")
	@RequestMapping("/uss/olh/qna/updateQna.cm")
...
//		qnaManageVO.setWritngPassword(EgovFileScrty.encode(writngPassword));
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/qna/deleteQna.cm")
	...
	@RequestMapping(value = "/uss/olh/qna/selectQnaAnswerList.cm")
	public String selectQnaAnswerList(@ModelAttribute("searchVO") QnaVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/olh/qna/EgovQnaAnswerList";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/qna/selectQnaAnswerDetail.cm")
	public String selectQnaAnswerDetail(QnaVO qnaVO, @ModelAttribute("searchVO") QnaVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/olh/qna/EgovQnaAnswerDetail";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/qna/updateQnaAnswerView.cm")
	public String updateQnaAnswerView(QnaVO qnaVO, @ModelAttribute("searchVO") QnaVO searchVO, ModelMap model) throws Exception {
		...
		return "coreframework/com/uss/olh/qna/EgovQnaAnswerUpdt";
	}
	 ...
	 * @param qnaVO
	 * @param searchVO
	 * @return	"forward:/uss/olh/qnm/selectQnaAnswerList.cm"
	 * @throws Exception
	 */
	@RequestMapping("/uss/olh/qna/updateQnaAnswer.cm")
	public String updateQnaAnswer(QnaVO qnaVO, @ModelAttribute("searchVO") QnaVO searchVO) throws Exception {
		...
		return "forward:/uss/olh/qna/selectQnaAnswerList.cm";
