package coreframework.com.uss.mpe.web;
...
import coreframework.com.uss.mpe.service.EgovIndvdlPgeService;
...
public class EgovIndvdlPgeController {
	...
	@RequestMapping(value="/uss/mpe/selectIndvdlPgeList.cm")
	public String selectIndvdlPgeList(@ModelAttribute("searchVO") IndvdlPgeVO searchVO, ModelMap model) throws Exception {
        ...
        return "coreframework/com/uss/mpe/EgovIndvdlPgeList";
	}
     ...
     * @throws Exception
     */
     @RequestMapping("/uss/mpe/selectIndvdlPgeDetail.cm")
     public String selectIndvdlPgeDetail(IndvdlPgeVO indvdlPgeVO, @ModelAttribute("searchVO") IndvdlPgeVO searchVO, ModelMap model) throws Exception {
         ...
         return	"coreframework/com/uss/mpe/EgovIndvdlPgeDetail";
     }
      ...
      * @throws Exception
      */
     @RequestMapping("/uss/mpe/insertIndvdlPgeView.cm")
     public String insertIndvdlPgeView(@ModelAttribute("searchVO") IndvdlPgeVO searchVO, Model model) throws Exception {
         ...
         return "coreframework/com/uss/mpe/EgovIndvdlPgeRegist";
      ...
      * @param indvdlPgeVO
      * @param bindingResult
      * @return	"forward:/uss/mpe/selectIndvdlPgeList.cm"
      * @throws Exception
      */
      @RequestMapping("/uss/mpe/insertIndvdlPge.cm")
       ...
       * @throws Exception
       */
      @RequestMapping("/uss/mpe/updateIndvdlPgeView.cm")
      public String updateIndvdlPgeView(@RequestParam("cntntsId") String cntntsId ,
          ...
          return "coreframework/com/uss/mpe/EgovIndvdlPgeUpdt";
      }
       ...
       * @throws Exception
       */
      @RequestMapping("/uss/mpe/updateIndvdlPge.cm")
