package coreframework.com.uss.olp.qmc.web;
...
import coreframework.com.uss.olp.qmc.service.EgovQustnrManageService;
import coreframework.com.uss.olp.qmc.service.QustnrManageVO;
...
public class EgovQustnrManageController {
	 ...
	 * @param model
	 * @return "coreframework/com/uss/olp/qmc/EgovQustnrManageListPopup"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qmc/EgovQustnrManageListPopup.cm")
	...
	@RequestMapping(value="/uss/olp/qmc/EgovQustnrManageList.cm")
    ...
    throws Exception {
		...
		return "coreframework/com/uss/olp/qmc/EgovQustnrManageList";
	}
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/qmc/EgovQustnrManageDetail";
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qmc/EgovQustnrManageDetail.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qmc/EgovQustnrManageDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if(sCmd.equals("del")){
			egovQustnrManageService.deleteQustnrManage(qustnrManageVO);
			sLocationUrl = "redirect:/uss/olp/qmc/EgovQustnrManageList.cm";
		}else{
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qmc/EgovQustnrManageModify"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qmc/EgovQustnrManageModify.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qmc/EgovQustnrManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qmc/EgovQustnrManageRegist"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qmc/EgovQustnrManageRegist.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qmc/EgovQustnrManageRegist";
