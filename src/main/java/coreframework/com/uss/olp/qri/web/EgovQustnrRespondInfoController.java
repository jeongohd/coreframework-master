package coreframework.com.uss.olp.qri.web;
...
import coreframework.com.uss.olp.qrm.service.EgovQustnrRespondManageService;
import coreframework.com.uss.olp.qrm.service.QustnrRespondManageVO;
...
import coreframework.com.uss.olp.qri.service.EgovQustnrRespondInfoService;
import coreframework.com.uss.olp.qri.service.QustnrRespondInfoVO;
...
public class EgovQustnrRespondInfoController {
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/template/template"
	 * @throws Exception
	 */
    ...
    throws Exception {
		...
		// 안전한 경로 문자열로 조치
    	sTemplateUrl = CoreWebUtil.filePathBlackList(sTemplateUrl);
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/qnn/EgovQustnrRespondInfoManageStatistics"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qnn/EgovQustnrRespondInfoManageStatistics.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qnn/EgovQustnrRespondInfoManageStatistics";
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/qnn/EgovQustnrRespondInfoManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="설문조사", order = 600 ,gid = 50)
	@RequestMapping(value="/uss/olp/qnn/EgovQustnrRespondInfoManageList.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/qnn/EgovQustnrRespondInfoManageRegist"
	 * @throws Exception
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@RequestMapping(value="/uss/olp/qnn/EgovQustnrRespondInfoManageRegist.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qnn/EgovQustnrRespondInfoManageRegist";
        ...
        if(sCmd.equals("save")){
        	...
        	sLocationUrl = "forward:/uss/olp/qnn/EgovQustnrRespondInfoManageList.cm";
        }else{
	 ...
	 * @param model
	 * @return "coreframework/com/uss/olp/qri/EgovQustnrRespondInfoList"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qri/EgovQustnrRespondInfoList.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qri/EgovQustnrRespondInfoDetail.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qri/EgovQustnrRespondInfoDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if(sCmd.equals("del")){
			egovQustnrRespondInfoService.deleteQustnrRespondInfo(qustnrRespondInfoVO);
			sLocationUrl = "redirect:/uss/olp/qri/EgovQustnrRespondInfoList.cm";
		}else{
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qri/EgovQustnrRespondInfoModify"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qri/EgovQustnrRespondInfoModify.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qri/EgovQustnrRespondInfoModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qri/EgovQustnrRespondInfoRegist"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qri/EgovQustnrRespondInfoRegist.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qri/EgovQustnrRespondInfoRegist";
