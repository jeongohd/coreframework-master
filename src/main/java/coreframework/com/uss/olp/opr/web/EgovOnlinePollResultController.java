package coreframework.com.uss.olp.opr.web;

import java.util.List;

import coreframework.com.uss.olp.opr.service.EgovOnlinePollResultService;
import coreframework.com.uss.olp.opr.service.OnlinePollResult;
...
public class EgovOnlinePollResultController {
     ...
     * @param onlinePollVO
     * @param model
     * @return "coreframework/com/uss/olp/opr/EgovOnlinePollResultList"
     * @throws Exception
     */
    @RequestMapping(value = "/uss/olp/opr/listOnlinePollResult.cm")
