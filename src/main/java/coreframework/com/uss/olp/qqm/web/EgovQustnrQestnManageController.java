package coreframework.com.uss.olp.qqm.web;
...
import coreframework.com.uss.olp.qqm.service.EgovQustnrQestnManageService;
import coreframework.com.uss.olp.qqm.service.QustnrQestnManageVO;
...
public class EgovQustnrQestnManageController {
     ...
     * @param commandMap
     * @param model
     * @return "coreframework/com/uss/olp/qqm/EgovQustnrQestnManageStatistics"
     * @throws Exception
     */
    @RequestMapping(value="/uss/olp/qqm/EgovQustnrQestnManageStatistics.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qqm/EgovQustnrQestnManageStatistics";
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/qqm/EgovQustnrQestnManageListPopup"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qqm/EgovQustnrQestnManageListPopup.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/qqm/EgovQustnrQestnManageList"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@IncludedInfo(name="질문관리", order = 630 ,gid = 50)
	@RequestMapping(value="/uss/olp/qqm/EgovQustnrQestnManageList.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/qqm/EgovQustnrQestnManageDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qqm/EgovQustnrQestnManageDetail.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qqm/EgovQustnrQestnManageDetail";
		...
		if(sCmd.equals("del")){
			egovQustnrQestnManageService.deleteQustnrQestnManage(qustnrQestnManageVO);
			/** 목록으로갈때 검색조건 유지 */
			sLocationUrl = "redirect:/uss/olp/qqm/EgovQustnrQestnManageList.cm?";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qqm/EgovQustnrQestnManageModify"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qqm/EgovQustnrQestnManageModify.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qqm/EgovQustnrQestnManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qqm/EgovQustnrQestnManageRegist"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qqm/EgovQustnrQestnManageRegist.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qqm/EgovQustnrQestnManageRegist";
