package coreframework.com.uss.olp.qrm.web;
...
public class EgovQustnrRespondManageController {
	 ...
	 * @param model
	 * @return "coreframework/com/uss/olp/qrm/EgovQustnrRespondManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="응답자관리",  order = 620 ,gid = 50)
	@RequestMapping(value="/uss/olp/qrm/EgovQustnrRespondManageList.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/qrm/EgovQustnrRespondManageDetail"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qrm/EgovQustnrRespondManageDetail.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qrm/EgovQustnrRespondManageDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if(sCmd.equals("del")){
			egovQustnrRespondManageService.deleteQustnrRespondManage(qustnrRespondManageVO);
			sLocationUrl = "redirect:/uss/olp/qrm/EgovQustnrRespondManageList.cm";
		}else{
	     	//성별코드조회
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qrm/EgovQustnrRespondManageModify"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qrm/EgovQustnrRespondManageModify.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qrm/EgovQustnrRespondManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qrm/EgovQustnrRespondManageRegist"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qrm/EgovQustnrRespondManageRegist.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qrm/EgovQustnrRespondManageRegist";
