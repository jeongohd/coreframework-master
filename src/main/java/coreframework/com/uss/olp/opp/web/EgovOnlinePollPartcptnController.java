package coreframework.com.uss.olp.opp.web;
...
import coreframework.com.uss.olp.opp.service.EgovOnlinePollPartcptnService;
import coreframework.com.uss.olp.opp.service.OnlinePollPartcptn;
...
public class EgovOnlinePollPartcptnController {
     ...
     * @param model
     * @return "coreframework/com/uss/olp/opp/EgovOnlinePollList"
     * @throws Exception
     */
    @SuppressWarnings("unused")
	@RequestMapping(value = "/uss/olp/opp/listEgovOnlinePollPartcptnMain.cm")
    public String egovOnlinePollPartcptnMainList(
        ...
        return "coreframework/com/uss/olp/opp/EgovOnlinePollPartcptnMainList";
    }
    ...
    @RequestMapping(value = "/uss/olp/opp/listOnlinePollPartcptn.cm")
    public String egovOnlinePollPartcptnList(
        ...
        return "coreframework/com/uss/olp/opp/EgovOnlinePollPartcptnList";
    }
     ...
     */
    @SuppressWarnings("unused")
	@RequestMapping(value = "/uss/olp/opp/registOnlinePollPartcptn.cm")
    public String egovOnlinePollPartcptnRegist(
        ...
        String sLocationUrl = "coreframework/com/uss/olp/opp/EgovOnlinePollPartcptnRegist";
        ...
        if (sCmd.equals("save")) {
            ...
            if(egovOnlinePollPartcptnService.selectOnlinePollResult(onlinePollPartcptn) != 0){
                 ...
                 return "forward:/uss/olp/opp/listOnlinePollPartcptn.cm";
            }
            ...
            model.addAttribute("reusltScript", ReusltScript);
            sLocationUrl = "forward:/uss/olp/opp/listOnlinePollPartcptn.cm";
        } else {
            //POLL종류 설정
     ...
     */
    @SuppressWarnings("unused")
	@RequestMapping(value = "/uss/olp/opp/statisticsOnlinePollPartcptn.cm")
    public String egovOnlinePollManageStatistics(
        ...
        return "coreframework/com/uss/olp/opp/EgovOnlinePollPartcptnStatistics";
    }
