package coreframework.com.uss.olp.qtm.web;
...
import coreframework.com.uss.olp.qtm.service.EgovQustnrTmplatManageService;
import coreframework.com.uss.olp.qtm.service.QustnrTmplatManageVO;
...
public class EgovQustnrTmplatManageController {
	...
	@RequestMapping(value = "/uss/olp/qtm/EgovQustnrTmplatManageMain.cm")
	public String egovQustnrTmplatManageMain(ModelMap model) throws Exception {
		return "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageMain";
	}

	@RequestMapping(value = "/uss/olp/qtm/EgovQustnrTmplatManageLeft.cm")
	public String egovQustnrTmplatManageLeft(ModelMap model) throws Exception {
		return "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageLeft";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/olp/EgovMain.cm")
	public String egovMain(ModelMap model) throws Exception {
		return "coreframework/com/uss/olp/qtm/EgovMain";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/olp/EgovLeft.cm")
	public String egovLeft(ModelMap model) throws Exception {
		return "coreframework/com/uss/olp/qtm/EgovLeft";
	}
	 ...
	 * @param model
	 * @return "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name = "설문템플릿관리", order = 610, gid = 50)
	@RequestMapping(value = "/uss/olp/qtm/EgovQustnrTmplatManageList.cm")
	 ...
	 * @param qustnrTmplatManageVO
	 * @param commandMap
	 * @return "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageImg"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value = "/uss/olp/qtm/EgovQustnrTmplatManageImg.cm")
	 ...
	 * @param commandMap
	 * @param model
	 * @return "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageDetail"
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/olp/qtm/EgovQustnrTmplatManageDetail.cm")
	public String egovQustnrTmplatManageDetail(
		...
		String sLocationUrl = "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if (sCmd.equals("del")) {
			egovQustnrTmplatManageService.deleteQustnrTmplatManage(qustnrTmplatManageVO);
			sLocationUrl = "redirect:/uss/olp/qtm/EgovQustnrTmplatManageList.cm";
		} else {
	 ...
	 * @param qustnrTmplatManageVO
	 * @param model
	 * @return "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageModify"
	 * @throws Exception
	 */
	@SuppressWarnings("unused")
	@RequestMapping(value = "/uss/olp/qtm/EgovQustnrTmplatManageModify.cm")
	public String qustnrTmplatManageModify(
		...
		ModelMap model)
		throws Exception {
		String sLocationUrl = "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageModifyActor"
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/olp/qtm/EgovQustnrTmplatManageModifyActor.cm")
	public String qustnrTmplatManageModifyActor(
		...
		return "redirect:/uss/olp/qtm/EgovQustnrTmplatManageList.cm";
	}
	 ...
	 * @param qustnrTmplatManageVO
	 * @param model
	 * @return "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageRegist"
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/olp/qtm/EgovQustnrTmplatManageRegist.cm")
	public String qustnrTmplatManageRegist(
		...
		String sLocationUrl = "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageRegist";
	 ...
	 * @param qustnrTmplatManageVO
	 * @param model
	 * @return "coreframework/com/uss/olp/qtm/EgovQustnrTmplatManageRegistActor"
	 * @throws Exception
	 */
	@RequestMapping(value = "/uss/olp/qtm/EgovQustnrTmplatManageRegistActor.cm")
