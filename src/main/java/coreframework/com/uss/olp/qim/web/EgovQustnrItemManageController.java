package coreframework.com.uss.olp.qim.web;
...
import coreframework.com.uss.olp.qim.service.EgovQustnrItemManageService;
import coreframework.com.uss.olp.qim.service.QustnrItemManageVO;
...
public class EgovQustnrItemManageController {
	 ...
	 * @param model
	 * @return "coreframework/com/uss/olp/qim/EgovQustnrItemManageListPopup"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qim/EgovQustnrItemManageListPopup.cm")
	 ...
	 * @param qustnrItemManageVO
	 * @param model
	 * @return "coreframework/com/uss/olp/qim/EgovQustnrItemManageList"
	 * @throws Exception
	 */
	@IncludedInfo(name="항목관리", order = 640 ,gid = 50)
	@RequestMapping(value="/uss/olp/qim/EgovQustnrItemManageList.cm")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qim/EgovQustnrItemManageDetail.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qim/EgovQustnrItemManageDetail";

		String sCmd = commandMap.get("cmd") == null ? "" : (String)commandMap.get("cmd");

		if(sCmd.equals("del")){
			egovQustnrItemManageService.deleteQustnrItemManage(qustnrItemManageVO);
			sLocationUrl = "redirect:/uss/olp/qim/EgovQustnrItemManageList.cm";
		}else{
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qim/EgovQustnrItemManageModify"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qim/EgovQustnrItemManageModify.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qim/EgovQustnrItemManageModify";
	 ...
	 * @param bindingResult
	 * @param model
	 * @return "coreframework/com/uss/olp/qim/EgovQustnrItemManageRegist"
	 * @throws Exception
	 */
	@RequestMapping(value="/uss/olp/qim/EgovQustnrItemManageRegist.cm")
    ...
    throws Exception {
		...
		String sLocationUrl = "coreframework/com/uss/olp/qim/EgovQustnrItemManageRegist";
