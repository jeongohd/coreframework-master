...
loadScript(getContextPath() + '/js/coreframework/com/cmm/showModalDialog.js');
...
//	var url = "/sym/cal/EgovAdministCalPopup.cm";
...
function fn_egov_NormalCalendar(frm, sDate, vDate) {
	...
	var url = frm.cal_url.value;
//	var url = "/sym/cal/EgovNormalCalPopup.cm";
...
function fn_egov_Calendar(frm, sDate, vDate) {
	...
	var url = frm.cal_url.value;
//	var url = "/sym/cal/callCalPopup.cm";
