...
.toolbar { height: 52px; background-color: #e5e5e5; padding-bottom: 4px; border-bottom: 1px solid #dedede; }
	...
	.ed_bold { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_format_bold.gif') left top no-repeat; }
	.ed_italic { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_format_italic.gif') 2px top no-repeat; }
	.ed_underline { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_format_underline.gif') 1px top no-repeat; }
	.ed_strike { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_format_strike.gif') 1px top no-repeat; }
	.ed_sub { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_format_sub.gif') 1px 1px no-repeat; }
	.ed_sup { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_format_sup.gif') 1px 1px no-repeat; }
	.ed_copy { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_copy.gif') left top no-repeat; }
	.ed_cut { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_cut.gif') 1px top no-repeat; }
	.ed_paste { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_paste.gif') 1px top no-repeat; }
	.ed_undo { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_undo.gif') 1px top no-repeat; }
	.ed_redo { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_redo.gif') 1px 1px no-repeat; }
	.ed_rmformat { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_rmformat.gif') 1px top no-repeat; }
	.ed_killword { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_killword.gif') 1px top no-repeat; }
	.ed_al_left { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_align_left.gif') 1px top no-repeat; }
	.ed_al_center { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_align_center.gif') 1px top no-repeat; }
	.ed_al_right { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_align_right.gif') 1px top no-repeat; }
	.ed_al_justify { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_align_justify.gif') 1px top no-repeat; }
	.ed_right { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_left_to_right.gif') 1px top no-repeat; }
	.ed_left { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_right_to_left.gif') 1px top no-repeat; }
	.ed_num { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_list_num.gif') 1px top no-repeat; }
	.ed_bullet { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_list_bullet.gif') 1px top no-repeat; }
	.ed_indent_less { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_indent_less.gif') 1px top no-repeat; }
	.ed_indent_more { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_indent_more.gif') 1px top no-repeat; }
	.ed_fg { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_color_fg.gif') 1px top no-repeat; }
	.ed_bg { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_color_bg.gif') 1px top no-repeat; }
	.ed_hr { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_hr.gif') 1px top no-repeat; }
	.ed_link { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_link.gif') 1px top no-repeat; }
	.ed_image { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_image.gif') 1px top no-repeat; }
	.ed_table { background: url('../images/coreframework/com/cmm/paging/toolbar/insert_table.gif') 1px top no-repeat; }
	.ed_html { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_html.gif') 1px top no-repeat; }
	.ed_fullscreen { background: url('../images/coreframework/com/cmm/paging/toolbar/fullscreen_maximize.gif') 1px top no-repeat; }
	.ed_help { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_help.gif') 1px top no-repeat; }
	.ed_about { background: url('../images/coreframework/com/cmm/paging/toolbar/ed_about.gif') 1px top no-repeat; }
...
.pagination ul li.first a { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_first.gif"/>') 8px 9px no-repeat; text-indent: -10000em; }
.pagination ul li.prev a { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_prev.gif"/>') 11px 9px no-repeat; text-indent: -10000em; }
.pagination ul li.next a { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_next.gif"/>') 12px 9px no-repeat; text-indent: -10000em; }
.pagination ul li.last a { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_last.gif"/>') 10px 9px no-repeat; text-indent: -10000em; }
.pagination ul li.first a:hover { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_first_on.gif"/>') no-repeat; }
.pagination ul li.prev a:hover { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_prev_on.gif"/>') no-repeat; }
.pagination ul li.next a:hover { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_next_on.gif"/>/') no-repeat; }
...
.paging ul li.first a { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_first.gif"/>') center 5px no-repeat; text-indent: -10000em; }
.paging ul li.prev a { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_prev.gif"/>') center 5px no-repeat; text-indent: -10000em; }
.paging ul li.next a { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_next.gif"/>') center 5px no-repeat; text-indent: -10000em; }
.paging ul li.last a { background: url('<c:url value="/images/coreframework/com/cmm/paging/pagination_last.gif"/>') center 5px no-repeat; text-indent: -10000em; }
