...
function fn_egov_pageview(pageNo){
	...
	document.listForm.action = "<c:url value='/ssi/syi/ims/getCntcMessageList.cm'/>";
...
function fn_egov_regist_CntcMessage(){
	location.href = "<c:url value='/ssi/syi/ims/addCntcMessage.cm'/>";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
function fn_egov_modify_CntcMessage(){
	location.href = "<c:url value='/ssi/syi/ims/updateCntcMessage.cm'/>";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_CntcMessage(cntcMessageId){
	...
	varForm.action              = "<c:url value='/ssi/syi/ims/getCntcMessageDetail.cm'/>";
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/ssi/syi/ims/getCntcMessageList.cm'/>" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/ssi/syi/ims/addCntcMessage.cm'/>" onclick="" title="<spring:message code="title.create"/>"><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr style="cursor:pointer;cursor:hand;" onclick="fn_egov_detail_CntcMessage('<c:out value="${resultInfo.cntcMessageId}"/>');">
				...
				<td>
			    	<form name="subForm" method="post" action="<c:url value='/ssi/syi/ims/getCntcMessageDetail.cm'/>">
