...
function fn_egov_pageview(pageNo){
	...
	document.listForm.action = "<c:url value='/ssi/syi/ist/getCntcSttusList.cm'/>";
...
function fn_egov_detail_CntcSttus(cntcId){
	...
	varForm.action              = "<c:url value='/ssi/syi/ist/getCntcSttusDetail.cm'/>";
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/ssi/syi/ist/getCntcSttusList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
			    	<form name="subForm" method="post" action="<c:url value='/ssi/syi/ist/getCntcSttusDetail.cm'/>">
