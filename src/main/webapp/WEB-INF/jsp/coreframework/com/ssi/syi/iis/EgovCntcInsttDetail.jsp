...
function fn_egov_list_CntcInstt(){
	location.href = "<c:url value='/ssi/syi/iis/getCntcInsttList.cm'/>";
}
/* ********************************************************
 * 수정화면으로  바로가기
 ******************************************************** */
function fn_egov_modify_CntcInstt(){
	...
	varForm.action          = "<c:url value='/ssi/syi/iis/updateCntcInstt.cm'/>";
...
function fn_egov_delete_CntcInstt(){
	if (confirm("<spring:message code='common.delete.msg' />")) {
		var varForm				= document.all["Form"];
		varForm.action			= "<c:url value='/ssi/syi/iis/removeCntcInstt.cm'/>";
		varForm.insttId.value	= "<c:out value='${result.insttId}'/>";
		varForm.submit();
	}
}
...
function fn_egov_regist_CntcSystem(){
	var varForm				= document.all["Form"];
	varForm.action          = "<c:url value='/ssi/syi/iis/addCntcSystem.cm'/>";
	varForm.insttId.value	= "<c:out value='${result.insttId}'/>";
	varForm.submit();
}
/* ********************************************************
...
function fn_egov_regist_CntcService(sysId){
	var varForm				= document.all["Form"];
	varForm.action          = "<c:url value='/ssi/syi/iis/addCntcService.cm'/>";
	varForm.insttId.value	= "<c:out value='${result.insttId}'/>";
...
function fn_egov_modify_CntcSystem(sysId){
	var varForm				= document.all["Form"];
	varForm.action          = "<c:url value='/ssi/syi/iis/updateCntcSystem.cm'/>";
	varForm.insttId.value	= "<c:out value='${result.insttId}'/>";
	varForm.sysId.value		= sysId;
	varForm.submit();
}
...
function fn_egov_modify_CntcService(sysId, svcId){
	var varForm				= document.all["Form"];
	varForm.action          = "<c:url value='/ssi/syi/iis/updateCntcService.cm'/>";
	varForm.insttId.value	= "<c:out value='${result.insttId}'/>";
	varForm.sysId.value		= sysId;
...
function fn_egov_delete_CntcSystem(sysId){
	if (confirm("<spring:message code='common.delete.msg' />")) {
		var varForm				= document.all["Form"];
		varForm.action			= "<c:url value='/ssi/syi/iis/removeCntcSystem.cm'/>";
		varForm.insttId.value	= "<c:out value='${result.insttId}'/>";
		varForm.sysId.value		= sysId;
		varForm.submit();
	}
...
function fn_egov_delete_CntcService(sysId, svcId){
	if (confirm("<spring:message code='common.delete.msg' />")) {
		var varForm				= document.all["Form"];
		varForm.action			= "<c:url value='/ssi/syi/iis/removeCntcService.cm'/>";
		varForm.insttId.value	= "<c:out value='${result.insttId}'/>";
		varForm.sysId.value		= sysId;
		varForm.svcId.value		= svcId;
		varForm.submit();
...
<form name="listForm" action="<c:url value='/ssi/syi/iis/getCntcInsttDetail.cm'/>" method="post">
</form>
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<form name="formUpdt" action="<c:url value='/ssi/syi/iis/updateCntcInstt.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		...
		<form name="formDelete" action="<c:url value='/ssi/syi/iis/removeCntcInstt.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		...
		<form name="formList" action="<c:url value='/ssi/syi/iis/getCntcInsttList.cm'/>" method="post" style="display:inline-block; vertical-align:top">
...
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				<form name="formCntcSystemRegist" action="<c:url value='/ssi/syi/iis/addCntcSystem.cm'/>" method="post">
			...
			<tr>
				<td style="vertical-align:top">
					<table width="100%" cellpadding="0" class="table-register" border="0" style="border-top:1px solid #d9d9d9">
						...
						<tr>
							<td colspan="2">
								<form name="formCntcInsttUpdt" action="<c:url value='/ssi/syi/iis/updateCntcSystem.cm'/>" method="post" style="display:inline-block; vertical-align:top">
								...
								<form name="formCntcInsttDelete" action="<c:url value='/ssi/syi/iis/removeCntcSystem.cm'/>" method="post" style="display:inline-block; vertical-align:top">
								...
								<form name="formCntcInsttList" action="<c:url value='/ssi/syi/iis/addCntcService.cm'/>" method="post" style="display:inline-block; vertical-align:top">
					...
					<table width="100%" cellpadding="0" class="table-list" border="0">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<form name="formCntcUpdt" action="<c:url value='/ssi/syi/iis/updateCntcService.cm'/>" method="post" style="display:inline-block; vertical-align:top">
									...
									<form name="formCntcDelete" action="<c:url value='/ssi/syi/iis/removeCntcService.cm'/>" method="post" style="display:inline-block; vertical-align:top">
