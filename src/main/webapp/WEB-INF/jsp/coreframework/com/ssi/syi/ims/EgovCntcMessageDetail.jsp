...
function fn_egov_pageview(pageNo){
	...
	document.listForm.action = "<c:url value='/ssi/syi/ims/getCntcMessageDetail.cm'/>";
...
function fn_egov_list_CntcMessage(){
	location.href = "<c:url value='/ssi/syi/ims/getCntcMessageList.cm'/>";
}
/* ********************************************************
 * 수정화면으로  바로가기
 ******************************************************** */
function fn_egov_modify_CntcMessage(){
	...
	varForm.action              = "<c:url value='/ssi/syi/ims/updateCntcMessage.cm'/>";
...
function fn_egov_delete_CntcMessage(){
	if (confirm("<spring:message code='common.delete.msg' />")) {
		var varForm				    = document.all["Form"];
		varForm.action			    = "<c:url value='/ssi/syi/ims/removeCntcMessage.cm'/>";
		varForm.cntcMessageId.value	= "<c:out value='${result.cntcMessageId}'/>";
		varForm.submit();
	}
}
...
function fn_egov_regist_CntcMessageItem(){
	var varForm					= document.all["Form"];
	varForm.action          	= "<c:url value='/ssi/syi/ims/addCntcMessageItem.cm'/>";
	varForm.cntcMessageId.value	= "<c:out value='${result.cntcMessageId}'/>";
	varForm.submit();
}
/* ********************************************************
...
function fn_egov_modify_CntcMessageItem(itemId){
	var varForm					= document.all["Form"];
	varForm.action          	= "<c:url value='/ssi/syi/ims/updateCntcMessageItem.cm'/>";
	varForm.cntcMessageId.value	= "<c:out value='${result.cntcMessageId}'/>";
...
function fn_egov_delete_CntcMessageItem(itemId){
	if (confirm("<spring:message code='common.delete.msg' />")) {
		var varForm					= document.all["Form"];
		varForm.action				= "<c:url value='/ssi/syi/ims/removeCntcMessageItem.cm'/>";
		varForm.cntcMessageId.value	= "<c:out value='${result.cntcMessageId}'/>";
		varForm.itemId.value		= itemId;
		varForm.submit();
	}
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<form name="formUpdt" action="<c:url value='/ssi/syi/ims/updateCntcMessage.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		...
		<form name="formDelete" action="<c:url value='/ssi/syi/ims/removeCntcMessage.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		...
		<form name="formList" action="<c:url value='/ssi/syi/ims/getCntcMessageList.cm'/>" method="post" style="display:inline-block; vertical-align:top">
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<form name="formUpdt" action="<c:url value='/ssi/syi/ims/updateCntcMessageItem.cm'/>" method="post" style="display:inline-block; vertical-align:top">
					...
					<form name="formDelete" action="<c:url value='/ssi/syi/ims/removeCntcMessageItem.cm'/>" method="post" style="display:inline-block; vertical-align:top">
