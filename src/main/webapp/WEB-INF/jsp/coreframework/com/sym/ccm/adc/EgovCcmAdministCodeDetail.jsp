...
function fnModify(){
	...
	varForm.action                 = "<c:url value='/sym/ccm/adc/EgovCcmAdministCodeModify.cm'/>";
...
function fnDelete(){
	if (confirm("<spring:message code='common.delete.msg'/>")) {
		var varForm				       = document.getElementById("Form");
		varForm.action                 = "<c:url value='/sym/ccm/adc/EgovCcmAdministCodeRemove.cm'/>";
		varForm.administZoneSe.value   = "${result.administZoneSe}";
		varForm.administZoneCode.value = "${result.administZoneCode}";
		varForm.submit();
	}
...
<form name="Form" id="Form" method="post" action="<c:url value='/sym/ccm/adc/EgovCcmAdministCodeModify.cm'/>">
