...
<%
  ...
  */
  ...
  /* Image Path 설정 */
//  String imagePath_icon   = "/images/coreframework/com/sym/mnu/stm/icon/";
//  String imagePath_button = "/images/coreframework/com/sym/mnu/stm/button/";
%>
<html lang="ko">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" >
<link rel="stylesheet" href="<c:url value='/css/coreframework/com/com.css' />" type="text/css">
<link rel="stylesheet" href="<c:url value='/css/coreframework/com/button.css' />" type="text/css">
<title>메뉴생성</title>
<style type="text/css">
	h1 {font-size:12px;}
...
<body>
<form name="menuCreatManageForm" action ="<c:url value='/sym/mnu/mcm/EgovMenuCreatSelect.cm' />" method="post">
