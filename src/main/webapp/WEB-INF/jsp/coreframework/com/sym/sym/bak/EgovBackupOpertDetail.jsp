...
function fn_egov_update_view(){
    ...
    varForm.action = "<c:url value='/sym/sym/bak/getBackupOpertForUpdate.cm' />";
    varForm.submit();
}
/* ********************************************************
 * 삭제 처리
 ******************************************************** */
 function fn_egov_delete(){
        ...
        if(confirm("<spring:message code='common.delete.msg' />")){
            vForm.action = "<c:url value='/sym/sym/bak/deleteBackupOpert.cm' />";
            vForm.submit();
        }
}
</script>
...
<form name="backupOpertForm"  id="backupOpertForm" action="<c:url value='/sym/sym/bak/getBackupOpert.cm'/>" method="post">
	...
	<div class="wTableFrm">
		...
		<!-- 하단 버튼 -->
		<div class="btn">
			<span class="btn_s"><a href="<c:url value='/sym/sym/bak/getBackupOpertForUpdate.cm'></c:url>" onclick="fn_egov_update_view(); return false;"><spring:message code="button.update" /></a></span><!-- 수정 -->
			<input class="s_submit" type="submit" value='<spring:message code="button.delete" />' onclick="fn_egov_delete(); return false;" /><!-- 삭제 -->
			<span class="btn_s"><a href="<c:url value='/sym/sym/bak/getBackupOpertList.cm'></c:url>" onclick="fn_egov_list(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
		</div>
