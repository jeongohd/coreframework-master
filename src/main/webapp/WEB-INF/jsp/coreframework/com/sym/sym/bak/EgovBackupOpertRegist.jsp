...
function fn_egov_get_list(){
    var varForm = document.getElementById("backupOpert");
    varForm.action = "<c:url value='/sym/sym/bak/getBackupOpertList.cm' />";
    varForm.submit()
}
...
function fn_egov_save(){
    var varForm = document.getElementById("backupOpert");
    varForm.action =  "<c:url value='/sym/sym/bak/addBackupOpert.cm' />";
...
<form:form modelAttribute="backupOpert"  action="<c:url value='/sym/sym/bak/addBackupOpert.cm' />" method="post">
...
<noscript class="noScriptTitle"><spring:message code="common.noScriptTitle.msg" /></noscript><!-- 자바스크립트를 지원하지 않는 브라우저에서는 일부 기능을 사용하실 수 없습니다. -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/sym/bak/getBackupOpertList.cm'></c:url>" onclick="fn_egov_get_list(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
