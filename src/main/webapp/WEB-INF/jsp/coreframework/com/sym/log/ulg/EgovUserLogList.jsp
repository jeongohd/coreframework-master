...
function fn_egov_select_linkPage(pageNo){
	...
	document.UserLogForm.action = "<c:url value='/sym/log/ulg/SelectUserLogList.cm'/>";
...
function fn_egov_search_userLog(){
	...
	vFrom.action = "<c:url value='/sym/log/ulg/SelectUserLogList.cm'/>";
	vFrom.submit();
}
/* ********************************************************
 * 상세회면 처리 함수
...
function fn_egov_inquire_userLog(occrrncDe, rqesterId, srvcNm, methodNm) {
  	...
  	var top = 0;
  	var left = 0;
  	var url = "<c:url value='/sym/log/ulg/SelectUserLogDetail.cm' />?occrrncDe="+occrrncDe+"&rqesterId="+rqesterId+"&srvcNm="+srvcNm+"&methodNm="+methodNm;
...
<form name="UserLogForm" action="<c:url value='/sym/log/ulg/SelectUserLogList.cm'/>" method="post" onSubmit="fn_egov_search_userLog(); return false;">
<div class="board">
	...
	<tr>
		...
		<td>
		<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" class="cursor" onclick="fn_egov_inquire_userLog('<c:out value="${result.occrrncDe}"/>', '<c:out value="${result.rqesterId}"/>', '<c:out value="${result.srvcNm}"/>', '<c:out value="${result.methodNm}"/>'); return false;" alt="<spring:message code="title.detail" />"  title="<spring:message code="title.detail" />"></td>
	</tr>
	</c:forEach>
	</tbody>
	</table>
