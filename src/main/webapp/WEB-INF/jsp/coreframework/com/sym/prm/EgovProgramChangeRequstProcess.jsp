...
function linkPage(pageNo){
	...
	document.programChangeRequstProcessListForm.action = "<c:url value='/sym/prm/EgovProgramChangeRequstProcessListSelect.cm'/>";
...
function selectChangeRequstProcessListDetail(progrmFileNm, tmpNo) {
	...
	document.programChangeRequstProcessListForm.action = "<c:url value='/sym/prm/EgovProgramChangRequstProcessDetailSelect.cm'/>";
	document.programChangeRequstProcessListForm.submit();
}
			...
			<td colspan="6">
			 ...
			 <c:forEach var="result" items="${list_changerequst}" varStatus="status">
			  ...
			  <tr>
			    ...
			    <td>
			        <form name="item" method="post" action="<c:url value='/sym/prm/EgovProgramChangRequstProcessDetailSelect.cm'/>">
