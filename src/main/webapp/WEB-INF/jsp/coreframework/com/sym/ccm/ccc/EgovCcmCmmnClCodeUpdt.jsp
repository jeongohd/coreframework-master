...
function fn_egov_inqire_code() {
	cmmnClCodeVO.action = "<c:url value='/sym/ccm/ccc/SelectCcmCmmnClCodeList.cm'/>";
	cmmnClCodeVO.submit();	
}
</script>
</head>
...
<!-- 상단타이틀 -->
<form:form modelAttribute="cmmnClCodeVO" action="${pageContext.request.contextPath}/sym/ccm/ccc/UpdateCcmCmmnClCode.cm" method="post" onSubmit="fn_egov_updt_code(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<a href="<c:url value='/sym/ccm/ccc/SelectCcmCmmnClCodeList.cm' />" class="btn_s" title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a>
