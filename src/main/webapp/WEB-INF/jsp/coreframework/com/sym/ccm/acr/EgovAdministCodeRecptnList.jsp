...
function fn_egov_pageview(pageNo){
	...
	document.listForm.action = "<c:url value='/sym/ccm/acr/getAdministCodeRecptnList.cm'/>";
...
function fn_egov_detail_AdministCodeRecptn(administZoneSe,administZoneCode){
	...
	varForm.action                  = "<c:url value='/sym/ccm/acr/getAdministCodeDetail.cm'/>";
...
<form name="listForm" action="<c:url value='/sym/ccm/acr/getAdministCodeRecptnList.cm'/>" method="post">
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%"class="title_left">

   <img src="/images/coreframework/com/sym/ccm/acr/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;법정동코드수신 목록</td>
  <th>
  </th>
  <td width="10%">
  ...
  <th width="10%">
   <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><img src="/images/coreframework/com/sym/ccm/acr/btn/bu2_left.gif" alt="조회" width="8" height="20"></td>
      <td style="background-image:URL(<c:url value='/images/coreframework/com/cmm/btn/bu2_left.gif' />);" class="text_left" nowrap>
      ...
      <td><img src="/images/coreframework/com/sym/ccm/acr/btn/bu2_right.gif" alt="조회" width="8" height="20"></td>
    </tr>
   </table>
  </th>
 </tr>
...
<tr style="cursor:pointer;cursor:hand;" onclick="javascript:fn_egov_detail_AdministCodeRecptn('<c:out value="${resultInfo.administZoneSe}"/>','<c:out value="${resultInfo.administZoneCode}"/>');">
	...
	<td class="lt_text3" nowrap>
    	<form name="subForm" method="post" action="<c:url value='/sym/ccm/acr/getAdministCodeDetail.cm'/>">
