...
function getAddr(){
	$.ajax({
		 //url :"http://10.182.60.22/addrlink/addrLinkApiJsonp.cm"  //행정망
		 url :"http://www.juso.go.kr/addrlink/addrLinkApiJsonp.cm"  //인터넷망
		,type:"post"
		,data:$("#form").serialize()
		,dataType:"jsonp"
		,crossDomain:true
...
function getAddrLoc(){
	$.ajax({
		 url :"${contextPath}/sym/adr/getAdressCntcApi.cm"
		,type:"post"
		,data:$("#form").serialize()
		,dataType:"xml"
		,success:function(xmlStr){
