...
<%--
 /**
  * @Class Name : CoreMenuDetailSelectUpdt.jsp
...
<c:set var="ImgUrl" value="/images/coreframework/com/sym/mnu/mpm/"/>
<head>
...
function updateMenuManage(form) {
	...
	if(confirm("<spring:message code="common.save.msg"/>")){
		...
		if(!validateMenuManageVO(form)){
            ...
            form.action="<c:url value='/sym/mnu/mpm/coreMenuManageUpdt.cm' />";
			form.submit();
		}
	}
}
...
function deleteMenuManage(form) {
	if(confirm("<spring:message code="common.delete.msg"/>")){
        form.action="<c:url value='/sym/mnu/mpm/coreMenuManageRemove.cm' />";
		form.submit();
	}
}
/* ********************************************************
...
<form:form modelAttribute="menuManageVO" name="menuManageVO"  action ="<c:url value='/sym/mnu/mpm/coreMenuManageUpdt.cm' />" method="post">
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a id="popupUpperMenuId" href="<c:url value='/sym/mnu/mpm/coreMenuMvmn.cm' />" target="_blank" title="<spring:message code="comSymMnuMpm.menuDetailSelectUpdt.newWindow"/>"><img src="<c:url value='/images/coreframework/com/cmm/icon/search2.gif' />"
		...
		<tr>
			...
			<td class="left" colspan="3">
		        ...
		        <a id="popupProgrmFileNm" href="<c:url value='/sym/prm/coreProgrmListSearch.cm' />" target="_blank" title="<spring:message code="comSymMnuMpm.menuDetailSelectUpdt.newWindow"/>"><img src="<c:url value='/images/coreframework/com/cmm/icon/search2.gif' />"
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/evt/selectEventRceptList.cm'/>?menuNo=<c:out value='${menuManageVO.menuNo}'/>" onclick="deleteMenuManage(document.forms[0]); return false;"><spring:message code="button.delete" /></a></span><!-- 삭제 -->
