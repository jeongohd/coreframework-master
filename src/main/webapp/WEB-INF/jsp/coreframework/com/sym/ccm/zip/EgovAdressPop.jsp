...
function init(){
	...
	if(inputYn != "Y"){
		...
		document.form.action="http://www.juso.go.kr/addrlink/addrLinkUrl.cm"; //인터넷망
		//document.form.action="http://www.juso.go.kr/addrlink/addrMobileLinkUrl.cm"; //모바일 웹인 경우, 인터넷망
