...
<%
 /**
  * @Class Name : CoreProgramListManage.jsp
...
function fDeleteProgrmManageList() {
    ...
    if(confirm("<spring:message code="common.delete.msg" />")){	//삭제하시겠습니까?
    	...
    	document.progrmManageForm.action = "<c:url value='/sym/prm/coreProgrmRemoves.cm'/>";
...
//	document.menuManageForm.searchKeyword.value =
	...
	document.progrmManageForm.action = "<c:url value='/sym/prm/coreProgrmList.cm'/>";
   	document.progrmManageForm.submit();
}
...
function insertProgramListManage() {
   	document.progrmManageForm.action = "<c:url value='/sym/prm/coreProgrmRegist.cm'/>";
   	document.progrmManageForm.submit();
}
/* ********************************************************
 * 상세조회처리 함수
...
function selectUpdtProgramListDetail(progrmFileNm) {
	document.progrmManageForm.tmp_progrmNm.value = progrmFileNm;
   	document.progrmManageForm.action = "<c:url value='/sym/prm/coreProgrm.cm'/>";
   	document.progrmManageForm.submit();
}
/* ********************************************************
 * focus 시작점 지정함수
...
<div class="board">
	...
	<form name="progrmManageForm" action ="<c:url value='/sym/prm/coreProgrmList.cm' />" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/sym/prm/coreProgrmRegist.cm'/>" onclick="insertProgramListManage(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span><!-- 등록 -->
			...
			<%-- 데이터를 없을때 화면에 메세지를 출력해준다 --%>
			 ...
			 <c:forEach var="result" items="${list_progrmmanage}" varStatus="status">
			  <tr>
			    ...
			    <td>
		            <span class="link"><a href="<c:url value='/sym/prm/coreProgrm.cm'/>?tmp_progrmNm=<c:out value="${result.progrmFileNm}"/>"  onclick="selectUpdtProgramListDetail('<c:out value="${result.progrmFileNm}"/>'); return false;">
