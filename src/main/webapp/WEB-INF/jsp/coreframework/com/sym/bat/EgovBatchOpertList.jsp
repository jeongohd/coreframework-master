...
<script type="text/javascript">
    ...
    function fn_egov_get_list(pageNo) {
        ...
        document.frm.action = "<c:url value='/sym/bat/getBatchOpertList.cm'/>";
        document.frm.submit();
    }

    function fn_egov_get_detail_view(batchOpertId) {
        document.frm.batchOpertId.value = batchOpertId;
        document.frm.action = "<c:url value='/sym/bat/getBatchOpert.cm'/>";
        document.frm.submit();
    }
    /* ********************************************************
     * 등록 처리 함수
    ...
    function fn_egov_get_regist_view(){
        document.frm.action = "<c:url value='/sym/bat/getBatchOpertForRegist.cm'/>";
        document.frm.submit();
    }
</script>
...
<div class="board">
    ...
    <form name="frm" id="frm" action="<c:url value='/sym/bat/getBatchOpertList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/sym/bat/getBatchOpertForRegist.cm'></c:url>" onclick="fn_egov_get_regist_view(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
	        ...
	        <c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	          <tr>
	                <td>
	                    <form name="item" method="post" action="<c:url value='/sym/bat/getBatchOpert.cm'/>">
