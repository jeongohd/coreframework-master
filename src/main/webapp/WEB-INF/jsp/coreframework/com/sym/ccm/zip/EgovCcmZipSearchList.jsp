...
function fn_egov_pageview(pageNo){
	...
	document.listForm.action = "<c:url value='/sym/ccm/zip/EgovCcmZipSearchList.cm'/>";
...
<form name="listForm" action="<c:url value='/sym/ccm/zip/EgovCcmZipSearchList.cm'/>" method="post">
