...
function fn_egov_list_code(){
	location.href = "<c:url value='/sym/ccm/cca/SelectCcmCmmnCodeList.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
...
<form:form modelAttribute="cmmnCodeVO" action="${pageContext.request.contextPath}/sym/ccm/cca/RegistCcmCmmnCode.cm" method="post" onSubmit="fn_egov_regist_code(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/ccm/cca/SelectCcmCmmnCodeList.cm' />" title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
