...
function fn_egov_select_linkPage(pageNo){
	...
	document.CcmClCodeForm.action = "<c:url value='/sym/ccm/ccc/SelectCcmCmmnClCodeList.cm'/>";
...
function fn_egov_inquire_codedetail(clCode) {
	...
	document.CcmClCodeForm.clCode.value = clCode;
  	document.CcmClCodeForm.action = "<c:url value='/sym/ccm/ccc/SelectCcmCmmnClCodeDetail.cm'/>";
  	document.CcmClCodeForm.submit();
}
</script>
</head>
...
<form name="CcmClCodeForm" action="<c:url value='/sym/ccm/ccc/SelectCcmCmmnClCodeList.cm'/>" method="post" onSubmit="fn_egov_search_code(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/sym/ccm/ccc/RegistCcmCmmnClCodeView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td><a href="<c:url value='/sym/ccm/ccc/SelectCcmCmmnClCodeDetail.cm'/>?clCode=${resultInfo.clCode}" onClick="fn_egov_inquire_codedetail('<c:out value="${resultInfo.clCode}"/>');return false;"><c:out value='${fn:substring(resultInfo.clCodeNm, 0, 40)}'/></a></td>
