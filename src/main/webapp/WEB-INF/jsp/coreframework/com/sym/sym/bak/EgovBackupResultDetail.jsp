...
function fn_egov_list(){
    ...
    varForm.action = "<c:url value='/sym/sym/bak/getBackupResultList.cm' />";
    varForm.submit()
}
/* ********************************************************
 * 삭제 처리
 ******************************************************** */
 function fn_egov_delete(){
        ...
        if(confirm("<spring:message code='common.delete.msg' />")){
            vForm.action = "<c:url value='/sym/sym/bak/deleteBackupResult.cm' />";
            vForm.submit();
        }
}
</script>
...
<form name="backupResultForm"  id="backupResultForm" action="<c:url value='/sym/sym/bak/getBackupResult.cm'/>" method="post">
	...
	<div class="wTableFrm">
		...
		<div class="btn">
			...
			<span class="btn_s"><a href="<c:url value='/sym/sym/bak/getBackupResultList.cm'></c:url>" onclick="fn_egov_list(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
		</div>
