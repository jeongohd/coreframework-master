...
function fn_egov_list_Restde(){
	location.href = "<c:url value='/sym/cal/EgovRestdeList.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a href="#noscript" onclick="fn_egov_NormalCalendar(document.restde, document.restde.restdeDe, document.restde.vrestdeDe); return false;"><img src="<c:url value='/images/coreframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"/></a>
			</td>
		</tr>
		<tr>
