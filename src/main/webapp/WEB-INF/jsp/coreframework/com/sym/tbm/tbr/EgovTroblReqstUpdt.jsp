...
function fncTroblReqstUpdate() {
    ...
    var varFrom = document.getElementById("troblReqst");
    varFrom.action = "<c:url value='/sym/tbm/tbr/updtTroblReqst.cm'/>";
...
<div class="wTableFrm">
    ...
    <form name="troblReqst" id="troblReqst" method="post" action="${pageContext.request.contextPath}/sym/tbm/tbr/updtTroblReqst.cm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/tbm/selectTroblReqstList.cm'/>?pageIndex=<c:out value='${troblReqstVO.pageIndex}'/>&amp;strTroblNm=<c:out value="${troblReqstVO.strTroblNm}"/>" onclick="fncSelectTroblReqstList(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
