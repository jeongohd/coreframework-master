...
function fn_egov_pageview(pageNo){
	...
	document.listForm.action = "<c:url value='/sym/cal/EgovRestdeList.cm'/>";
...
function fn_egov_regist_Restde(){
	location.href = "<c:url value='/sym/cal/EgovRestdeRegist.cm' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_Restde(restdeNo){
	...
	varForm.action           = "<c:url value='/sym/cal/EgovRestdeDetail.cm'/>";
...
<form name="listForm" action="<c:url value='/sym/cal/EgovRestdeList.cm'/>" method="post">
