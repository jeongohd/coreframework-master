...
function fncServerUpdate() {
    var varFrom = document.getElementById("server");
    varFrom.action = "<c:url value='/sym/sym/srv/updtServer.cm'/>";
...
<div class="wTableFrm">
	...
	<form name="server" id="server" method="post" action="${pageContext.request.contextPath}/sym/sym/srv/updtServer.cm">
	<!-- 등록폼 -->
	<table class="wTable">
		<colgroup>
			<col style="width:16%" />
