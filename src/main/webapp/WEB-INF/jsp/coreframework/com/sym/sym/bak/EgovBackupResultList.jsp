...
function fn_egov_get_list(pageNo) {
    ...
    */
    ...
    document.frm.action = "<c:url value='/sym/sym/bak/getBackupResultList.cm'/>";
    document.frm.submit();
}

function fn_egov_get_detail_view(backupResultId) {
    document.frm.backupResultId.value = backupResultId;
    document.frm.action = "<c:url value='/sym/sym/bak/getBackupResult.cm'/>";
    document.frm.submit();
}
</script>
...
<div class="board">
	...
	<form name="frm" id="frm" action="<c:url value='/sym/sym/bak/getBackupResultList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				<td>
					<form name="item" method="post" action="<c:url value='/sym/sym/bak/getBackupResult.cm'/>">
