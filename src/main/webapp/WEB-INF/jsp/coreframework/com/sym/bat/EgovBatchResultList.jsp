...
function fn_egov_get_list(pageIndex) {
    ...
    */
    ...
    document.frm.action = "<c:url value='/sym/bat/getBatchResultList.cm'/>";
    document.frm.submit();
}
...
function fn_egov_get_detail_view(batchResultId) {
    ...
    document.frm.action = "<c:url value='/sym/bat/getBatchResult.cm'/>";
    document.frm.submit();
}
</script>
</head>
...
<div class="board">
    ...
    <form name="frm" id="frm" action="<c:url value='/sym/bat/getBatchResultList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
	        ...
	        <c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	          <tr>
				<td>
				    <form name="item" method="post" action="<c:url value='/sym/bat/getBatchResult.cm'/>">
