...
function fncServerEqpmnInsert() {
    var varFrom = document.getElementById("serverEqpmn");
    varFrom.action = "<c:url value='/sym/sym/srv/addServerEqpmn.cm'/>";
...
<div class="wTableFrm">
    ...
    <form name="serverEqpmn" id="serverEqpmn" method="post" action="${pageContext.request.contextPath}/sym/sym/srv/addServerEqpmn.cm">
