...
function linkPage(pageNo){
	...
	document.progrmManageForm.action = "<c:url value='/sym/prm/coreProgrmListSearch.cm'/>";
...
<body>
<form name="progrmManageForm" action ="<c:url value='/sym/prm/coreProgrmListSearch.cm'/>" method="post">
