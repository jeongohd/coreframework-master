...
<link type="text/css" rel="stylesheet" href="/css/coreframework/com/sym/ccm/acr/button.css">
...
function fn_egov_list_AdministCode(){
	location.href = "/sym/ccm/acr/getAdministCodeRecptnList.cm.cm";
}
-->
</script>
</head>
...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="/images/coreframework/com/sym/ccm/acr/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;법정동코드 상세조회</td>
 </tr>
</table>
...
<c:if test="${result.administZoneCode != null}">
  <tr>
    <th width="30%" height="23" class="required_text" nowrap >법정동코드<img src="/images/coreframework/com/sym/ccm/acr/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td><c:out value="${result.administZoneCode}"/></td>
  </tr>
  <tr>
    <th width="30%" height="23" class="required_text" nowrap >행정구역명<img src="/images/coreframework/com/sym/ccm/acr/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td><c:out value="${result.administZoneNm}"/></td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >생성일자<img src="/images/coreframework/com/sym/ccm/acr/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >폐지유무<img src="/images/coreframework/com/ssi/syi/sim/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap>
...
<tr>
	<td>
		...
		<tr>
			<td>
				<form name="formList" action="<c:url value='/sym/ccm/acr/getAdministCodeRecptnList.cm'/>" method="post">
...
<form name="listForm" action="<c:url value='/sym/ccm/acr/EgovAdministCodeRecptnList.cm'/>" method="post">
</form>
