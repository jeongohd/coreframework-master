...
<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/coreframework/com/sym/mnu/mcm/EgovMenuCreat.js' />"></script>
...
function selectMenuCreatTmp() {
    document.menuCreatManageForm.action = "<c:url value='/sym/mnu/mcm/EgovMenuCreatSelect.cm'/>";
...
function fInsertMenuCreat() {
    ...
    document.menuCreatManageForm.action = "<c:url value='/sym/mnu/mcm/EgovMenuCreatInsert.cm'/>";
    document.menuCreatManageForm.submit();
}
/* ********************************************************
 * 메뉴사이트맵 생성 화면 호출
...
function fMenuCreatSiteMap() {
	...
	window.open("<c:url value='/sym/mnu/mcm/EgovMenuCreatSiteMapSelect.cm'/>?authorCode="+id,'Pop_SiteMap','scrollbars=yes, width=550, height=700');
}
...
<form name="menuCreatManageForm" action ="<c:url value='/sym/mnu/mcm/EgovMenuCreatSiteMapSelect.cm' />" method="post">
...
<%-- <table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  ...
  <h1><img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" alt="">&nbsp;메뉴생성</h1></td>
  <td width="10%"></td>
  <td width="25%"></td>
  <th width="25%">
