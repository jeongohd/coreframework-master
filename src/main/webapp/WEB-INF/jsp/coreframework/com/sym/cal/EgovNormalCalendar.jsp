...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/coreframework/com/sym/cal/cal.css' />" />
<script type="text/javascript" src="<c:url value='/js/coreframework/com/cmm/showModalDialogCallee.js'/>" ></script>
	...
	if (varParam.sDate) {
		...
		if(sDate.length == 10) {
			if(pForm.init.value != "OK") {
				pForm.init.value  = "OK";
				varForm.action      = "<c:url value='/sym/cal/EgovselectNormalCalendar.cm'/>";
...
<form name="Form" action ="<c:url value='/sym/cal/EgovselectNormalCalendar.cm'/>" method="post">
	 ...
	 <thead>
	  <tr>
	    <th class="title" width="36" nowrap colspan=1>
	    	<a href="javascript:fnChangeCalendar(${resultList[0].year-1},${resultList[0].month});"  style="selector-dummy:expression(this.hideFocus=false);cursor:pointer;cursor:hand;"><img src="<c:url value='/images/coreframework/com/sym/cal/icon_pre_year.gif' />" alt="이전년도"></a>
	    </th>
	    <th class="title" width="36" nowrap colspan=1>
	    	<a href="javascript:fnChangeCalendar(${resultList[0].year},${resultList[0].month-1});"  style="selector-dummy:expression(this.hideFocus=false);cursor:pointer;cursor:hand;"><img src="<c:url value='/images/coreframework/com/sym/cal/icon_pre_month.gif' />" alt="이전달"></a>
	    </th>
	    <th class="title" width="108" nowrap colspan=3>${resultList[0].year}년${resultList[0].month}월</th>
	    <th class="title" width="36" nowrap colspan=1>
	    	<a href="javascript:fnChangeCalendar(${resultList[0].year},${resultList[0].month+1});"  style="selector-dummy:expression(this.hideFocus=false);cursor:pointer;cursor:hand;"><img src="<c:url value='/images/coreframework/com/sym/cal/icon_aft_month.gif' />" alt="다음달"></a>
	    </th>
	    <th class="title" width="36" nowrap colspan=1>
	    	<a href="javascript:fnChangeCalendar(${resultList[0].year+1},${resultList[0].month});"  style="selector-dummy:expression(this.hideFocus=false);cursor:pointer;cursor:hand;"><img src="<c:url value='/images/coreframework/com/sym/cal/icon_aft_year.gif' />" alt="다음년도"></a>
	  </tr>
	  <tr>
