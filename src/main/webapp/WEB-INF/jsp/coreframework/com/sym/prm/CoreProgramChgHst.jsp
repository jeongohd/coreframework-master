...
<%
 /**
  * @Class Name : CoreProgramChgHst.jsp
...
//	document.programChgHstForm.searchKeyword.value =
	...
	document.programChgHstForm.action = "<c:url value='/sym/prm/coreProgrmCngHstList.cm'/>";
...
function selectChgHstListDetail(progrmFileNm, tmp_no) {
	...
	document.programChgHstForm.action = "<c:url value='/sym/prm/coreProgrmCngHst.cm'/>";
	document.programChgHstForm.submit();
}
-->
</script>
...
<div class="board">
	...
	<form name="programChgHstForm" action ="<c:url value='/sym/prm/coreProgrmCngHstList.cm'/>" method="post">
			 ...
			 <c:forEach var="result" items="${list_changerequst}" varStatus="status">
			  <tr>
			    <td style="cursor:hand;">
			        <form name="item" method="post" action="<c:url value='/sym/prm/coreProgrmCngHst.cm'/>">
