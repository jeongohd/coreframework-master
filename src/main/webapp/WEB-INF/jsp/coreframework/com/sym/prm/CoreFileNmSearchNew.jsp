...
<%
 /**
  * @Class Name : CoreFileNmSearch.jsp
...
<script type="text/javascript" src="<c:url value='/js/coreframework/com/cmm/jquery-1.4.2.min.js' />" ></script>
...
function linkPage(pageNo){
	...
	document.progrmManageForm.action = "<c:url value='/sym/prm/coreProgrmListSearchNew.cm'/>";
...
<body>
<form name="progrmManageForm" action ="<c:url value='/sym/prm/coreProgrmListSearchNew.cm'/>" method="post">
