...
<%
 /**
  * @Class Name : CoreProgramChgHstDetail.jsp
...
function deleteChangRequstProcess() {
   document.progrmChangRequstProcessForm.action = "<c:url value='EgovProgramChangeRequstProcessDelete.cm'/>";
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/sym/prm/coreProgrmCngHstList.cm' />";
}
-->
</script>
</head>
...
<form name="progrmChangeRequstForm" action ="<c:url value='/sym/prm/coreProgrmCngHstList.cm'/>" method="post">
