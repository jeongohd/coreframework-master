...
function fncTroblProcessInsert() {
    ...
    varFrom.action = "<c:url value='/sym/tbm/tbp/addTroblProcess.cm'/>";
...
function fncTroblProcessDelete(troblId) {
    ...
    varFrom.action = "<c:url value='/sym/tbm/tbp/removeTroblProcess.cm'/>";
...
function fncSelectTroblProcessList() {
    var varFrom = document.getElementById("troblProcess");
    varFrom.action = "<c:url value='/sym/tbm/tbp/selectTroblProcessList.cm'/>";
    varFrom.submit();
}
...
<div class="wTableFrm">
	...
	<form name="troblProcess" id="troblProcess" method="post" action="${pageContext.request.contextPath}/sym/tbm/tbp/addTroblProcess.cm">
	<!-- 등록폼 -->
	<table class="wTable">
		<colgroup>
			<col style="width:16%" />
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/tbm/tbp/removeTroblProcess.cm'/>?troblId=<c:out value='${troblProcess.troblId}'/>" onclick="fncTroblProcessDelete('${troblProcess.troblId}'); return false;"><spring:message code="button.delete" /></a></span><!-- 삭제 -->
		</c:if>
		<span class="btn_s"><a href="<c:url value='/sym/tbm/tbp/selectTroblProcessList.cm'/>?pageIndex=<c:out value='${troblProcessVO.pageIndex}'/>&amp;strTroblNm=<c:out value="${troblProcessVO.strTroblNm}"/>" onclick="fncSelectTroblProcessList(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
