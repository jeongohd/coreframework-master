...
function fn_egov_save(){
    ...
    if(confirm("<spring:message code='common.save.msg' />")){
        varForm.action =  "<c:url value='/sym/bat/updateBatchOpert.cm'/>";
...
<form:form modelAttribute="batchOpert" id="batchOpert" action="/sym/bat/updateBatchOpert.cm" method="post">
