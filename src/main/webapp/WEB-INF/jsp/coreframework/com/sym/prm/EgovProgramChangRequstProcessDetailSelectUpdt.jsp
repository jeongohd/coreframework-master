...
function updateChangRequstProcess(form) {
	if(confirm("<spring:message code="common.save.msg"/>")){
		if(!validateProgrmManageDtlVO(form)){
            ...
            form.action ="<c:url value='/sym/prm/EgovProgramChangRequstProcessDetailSelectUpdt.cm' />";
			form.submit();
		}
	}
}
...
function deleteChangRequstProcess(form) {
   form.action = "<c:url value='/sym/prm/EgovProgramChangeRequstProcessDelete.cm' />";
   form.submit();
}
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/sym/prm/EgovProgramChangeRequstProcessListSelect.cm' />";
}
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/sym/prm/EgovProgramChangeRequstProcessListSelect.cm'/>" onclick="selectList(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
