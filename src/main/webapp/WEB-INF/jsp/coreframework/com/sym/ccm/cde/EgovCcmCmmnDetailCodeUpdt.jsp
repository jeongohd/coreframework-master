...
<!-- 상단타이틀 -->
<form:form modelAttribute="cmmnDetailCodeVO" action="${pageContext.request.contextPath}/sym/ccm/cde/UpdateCcmCmmnDetailCode.cm" method="post" onSubmit="fn_egov_updt_code(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<a href="<c:url value='/sym/ccm/cde/SelectCcmCmmnDetailCodeList.cm' />" class="btn_s" title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a>
