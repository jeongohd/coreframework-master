...
function fn_egov_list(){
    ...
    varForm.action = "<c:url value='/sym/bat/getBatchResultList.cm' />";
    varForm.submit()
}
/* ********************************************************
 * 삭제 처리
 ******************************************************** */
 function fn_egov_delete(){
        ...
        if(confirm("<spring:message code='common.delete.msg' />")){
            vForm.action = "<c:url value='/sym/bat/deleteBatchResult.cm' />";
            vForm.submit();
        }
}
</script>
...
<form name="batchResultForm"  id="batchResultForm" action="<c:url value='/sym/bat/getBatchResult.cm'/>" method="post">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/bat/getBatchResultList.cm'></c:url>" onclick="fn_egov_list(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
