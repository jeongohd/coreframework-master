...
<script type="text/javaScript" language="javascript">
	...
	function fnInit(){
		...
		if (varParam.administZoneSe) {
			...
			if(pForm.init.value != "OK") {
				pForm.init.value  = "OK";
				varForm.action      = "<c:url value='/sym/ccm/adc/EgovCcmAdministCode.cm'/>";
	...
	function linkPage(pageNo){
		...
		document.listForm.action = "<c:url value='/sym/ccm/adc/EgovCcmAdministCode.cm'/>";
...
<div class="board">
<form name="listForm" action="<c:url value='/sym/ccm/adc/EgovCcmAdministCode.cm'/>" method="post">
	<h1>${pageTitle}</h1>
...
<form name="Form" id="Form" method="post" action="<c:url value='/sym/ccm/adc/EgovCcmAdministCode.cm'/>">
