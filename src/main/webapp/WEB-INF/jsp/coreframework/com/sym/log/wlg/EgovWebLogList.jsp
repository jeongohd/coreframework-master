...
function fn_egov_select_linkPage(pageNo){
	...
	document.WebLogForm.action = "<c:url value='/sym/log/wlg/SelectWebLogList.cm'/>";
...
function fn_egov_search_webLog(){
	...
	vFrom.action = "<c:url value='/sym/log/wlg/SelectWebLogList.cm'/>";
	vFrom.submit();
}
/* ********************************************************
 * 상세회면 처리 함수
...
function fn_egov_detail_webLog(requstId) {
  	...
  	var top = 0;
  	var left = 0;
  	var url = "<c:url value='/sym/log/wlg/SelectWebLogDetail.cm' />?requstId="+requstId;
...
<form name="WebLogForm" action="<c:url value='/sym/log/wlg/SelectWebLogList.cm'/>" method="post" onSubmit="fn_egov_search_webLog(); return false;">
<div class="board">
	...
	<tr>
		...
		<td>
		<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" class="cursor" onclick="fn_egov_detail_webLog('<c:out value="${result.requstId}"/>'); return false;" alt="<spring:message code="title.detail" />"  title="<spring:message code="title.detail" />">
		</td>
	</tr>
	</c:forEach>
	</tbody>
