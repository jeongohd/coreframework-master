 ...
 ******************************************************** */
 function fn_egov_delete_code(codeId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.CcmCodeForm.action = "<c:url value='/sym/ccm/cca/RemoveCcmCmmnCode.cm'/>";
...
<form name="CcmCodeForm" action="<c:url value='/sym/ccm/cca/UpdateCcmCmmnCodeView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/ccm/cca/RemoveCcmCmmnCode.cm?codeId=${result.codeId}' />" onClick="fn_egov_delete_code('<c:out value="${result.codeId}"/>'); return false;" title="<spring:message code="title.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/sym/ccm/cca/SelectCcmCmmnCodeList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
