...
function fncServerInsert() {
    var varFrom = document.getElementById("server");
    varFrom.action = "<c:url value='/sym/sym/srv/addServer.cm'/>";
...
<div class="wTableFrm">
    ...
    <form name="server" id="server" method="post" action="${pageContext.request.contextPath}/sym/sym/srv/addServer.cm">
	<!-- 등록폼 -->
	<table class="wTable">
		<colgroup>
			<col style="width:16%" />
