...
<script type="text/javascript">
    ...
    function fn_egov_get_list(pageNo) {
        ...
        document.frm.action = "<c:url value='/sym/bat/getBatchOpertList.cm?popupAt=Y'/>";
        document.frm.submit();  
    }
...
<div class="board">
    ...
    <form name="frm" id="frm" action="<c:url value='/sym/bat/getBatchOpertList.cm?popupAt=Y'/>" method="post">
