...
function fn_egov_save(){
    var varForm = document.getElementById("batchSchdul");
    varForm.action =  "<c:url value='/sym/bat/addBatchSchdul.cm'/>";
...
<!-- 상단타이틀 -->
<form:form modelAttribute="batchSchdul"  action="<c:url value='/sym/bat/addBatchSchdul.cm'/>" method="post">
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
		        ...
		        <a href="#LINK" onclick="fn_egov_popup_batch_opert_list(); return false;"><img src="<c:url value='/images/coreframework/com/cmm/icon/search2.gif' />" alt="배치작업조회팝업 제공"/></a>
			</td>
		</tr>
		<tr>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/bat/getBatchSchdulList.cm'/>" onclick="fn_egov_get_list(); return false;"><spring:message code="button.list" /></a></span>
	</div>
