...
<script type="text/javascript">
	...
	function fn_egov_select_trsmrcvLog(pageNo){
		...
		if(fromDate > toDate) {
			...
			document.frm.action = "<c:url value='/sym/log/tlg/SelectTrsmrcvLogList.cm'/>";
			document.frm.submit();
	    }
	}

	function fn_egov_add_trsmrcvLog(){
		document.frm.action = "<c:url value='/sym/log/tlg/AddTrsmrcvLog.cm'/>";
		document.frm.submit();
	}

	function fn_egov_inqire_trsmrcvLog(requstId){
		var url = "<c:url value='/sym/log/tlg/InqireTrsmrcvLog.cm' />?requstId="+requstId;
...
<form name="frm" action ="<c:url value='/sym/log/tlg/SelectTrsmrcvLogList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="#noscript" onclick="fn_egov_inqire_trsmrcvLog('<c:out value="${result.requstId}"/>'); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>"  alt="<spring:message code="title.detail" />" title="<spring:message code="title.detail" />"  /></a>
				</td>
			</tr>
			</c:forEach>
