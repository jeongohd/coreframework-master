...
function fn_egov_list(){
    ...
    varForm.action = "<c:url value='/sym/bat/getBatchOpertList.cm'/>";
    varForm.submit()
}
/* ********************************************************
 * 수정화면으로  바로가기
...
function fn_egov_update_view(){
    ...
    varForm.action = "<c:url value='/sym/bat/getBatchOpertForUpdate.cm'/>";
    varForm.submit();
}
/* ********************************************************
 * 삭제 처리
 ******************************************************** */
 function fn_egov_delete(){
        ...
        if(confirm("<spring:message code='common.delete.msg' />")){
            vForm.action = "<c:url value='/sym/bat/deleteBatchOpert.cm'/>";
            vForm.submit();
        }
}
</script>
...
<div class="wTableFrm">
	...
	<form name="batchOpertForm"  id="batchOpertForm" action="<c:url value='/sym/bat/getBatchOpert.cm'/>" method="post">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s2"><a href="<c:url value='/sym/bat/getBatchOpertForUpdate.cm'></c:url>" onclick="fn_egov_update_view(); return false;"><spring:message code="button.update" /></a></span><!-- 수정 -->
		<input class="s_submit" type="submit" value='<spring:message code="button.delete" />' onclick="fn_egov_delete(); return false;" /><!-- 삭제 -->
		<span class="btn_s"><a href="<c:url value='/sym/bat/getBatchOpertList.cm'></c:url>" onclick="fn_egov_list(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
