...
function fncSelectServerList() {
    ...
    varFrom.action = "<c:url value='/sym/sym/srv/selectServerList.cm'/>";
    varFrom.submit();       
}
...
function fncServerUpdateView(serverId) {
    ...
    varFrom.action = "<c:url value='/sym/sym/srv/updtViewServer.cm'/>";
    varFrom.submit();
}
...
function fncServerDelete(serverId) {
    ...
    varFrom.serverId.value = serverId;
    varFrom.action = "<c:url value='/sym/sym/srv/removeServer.cm'/>";
...
<form:form modelAttribute="server" method="post" action="${pageContext.request.contextPath}/sym/sym/srv/updtViewServer.cm">
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/sym/sym/srv/updtViewServer.cm'/>?serverId=<c:out value='${server.serverId}'/>" onclick="fncServerUpdateView('${server.serverId}'); return false;"><spring:message code="button.update" /></a></span><!-- 수정 -->
		<span class="btn_s"><a href="<c:url value='/sym/sym/srv/removeServer.cm'/>?serverId=<c:out value='${server.serverId}'/>" onclick="fncServerDelete('${server.serverId}'); return false;"><spring:message code="button.delete" /></a></span><!-- 삭제 -->
		<span class="btn_s"><a href="<c:url value='/sym/sym/srv/selectServerList.cm'/>?pageIndex=<c:out value='${serverVO.pageIndex}'/>&amp;strServerNm=<c:out value="${serverVO.strServerNm}"/>" onclick="fncSelectServerList(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
