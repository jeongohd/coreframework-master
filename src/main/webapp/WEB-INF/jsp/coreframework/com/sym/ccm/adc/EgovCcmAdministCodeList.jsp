...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/sym/ccm/adc/EgovCcmAdministCodeList.cm'/>";
 ...
 ******************************************************** */
function fnRegist(){
	location.href = "<c:url value='/sym/ccm/adc/EgovCcmAdministCodeRegist.cm' />";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
...
function fnDetail(administZoneSe,administZoneCode){
	...
	varForm.action                 = "<c:url value='/sym/ccm/adc/EgovCcmAdministCodeDetail.cm'/>";
...
<div class="board">
<form name="listForm" action="<c:url value='/sym/ccm/adc/EgovCcmAdministCodeList.cm'/>" method="post">
	<h1>${pageTitle}</h1>
...
<form name="Form" id="Form" method="post" action="<c:url value='/sym/ccm/adc/EgovCcmAdministCodeList.cm'/>">
