...
<%@ page import="coreframework.com.cmm.service.Globals"  %>
<%
 /**
  ...
  */
  ...
  /* Image Path 설정 */
  String imagePath_icon   = "/images/coreframework/com/sym/mnu/mcm/icon/";
  String imagePath_button = "/images/coreframework/com/sym/mnu/mcm/button/";
%>
<html lang="ko">
<head>
...
<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/coreframework/com/sym/mnu/mcm/EgovMenuCreatSiteMap.js' />"></script>
<script language="javascript1.2" type="text/javaScript">
<!--
/*절대 path 사이트맵이 저장될 장소의  절대 패스*/
//var vRootPath    = "C:/coreframework/workspace2/sym.mnu.mcm/src/main/webapp";   // Window webapp 위치
//var vRootPath    = "/product/jeus/webhome/was_com/coreframework-com-1_0/coreframework-com-1_0_war___"; // Unix webapp 위치
/* 절대 path내  사이트맵 jsp를 저장할 장소 지정 */
//var vSiteMapPath = "/html/coreframework/com/sym/mnu/mcm/";
...
function selectMenuCreatSiteMap() {
	...
	document.menuCreatManageSiteMapForm.action = "<c:url value='/sym/mnu/mcm/EgovMenuCreatSiteMapSelect.cm'/>";
...
function CreatSiteMap() {
	...
	document.menuCreatManageSiteMapForm.action = "<c:url value='/sym/mnu/mcm/EgovMenuCreatSiteMapInsert.cm'/>";
    document.menuCreatManageSiteMapForm.submit();
}
...
<form name="menuCreatManageSiteMapForm" action ="<c:url value='/sym/mnu/mcm/EgovMenuCreatSiteMapSelect.cm' />" method="post">
