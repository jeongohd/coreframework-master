...
function fncSelectServerEqpmnRelateList(pageNo){
    ...
    document.listForm.action = "<c:url value='/sym/sym/srv/selectServerEqpmnRelateList.cm'/>";
...
function fncAddServerEqpmnRelateInsert() {
    if(fncManageChecked()) {
        if(confirm("<spring:message code="comSymSymSrv.serverEqpmnRelateRegist.validate.save"/>")) {
            document.listForm.action = "<c:url value='/sym/sym/srv/saveServerEqpmnRelate.cm'/>";
            document.listForm.submit();
        }
    } else return;
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/sym/sym/srv/selectServerEqpmnRelateList.cm'/>" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/sym/sym/srv/saveServerEqpmnRelate.cm'/>?pageIndex=<c:out value='${serverEqpmnRelateVO.pageIndex}'/>" onclick="fncAddServerEqpmnRelateInsert(); return false;" title='<spring:message code="button.save" />'><spring:message code="button.save" /></a></span><!-- 저장 -->
