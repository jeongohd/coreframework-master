...
function fn_egov_list_code(){
	location.href = "<c:url value='/sym/ccm/cde/SelectCcmCmmnDetailCodeList.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_regist_code(form){
	...
	if (!validateCmmnDetailCodeVO(form)) {	
		...
		if(confirm("<spring:message code="common.regist.msg" />")){	
			form.action="<c:url value='/sym/ccm/cde/RegistCcmCmmnDetailCode.cm'/>";
			form.submit();	
		}
	} 
}
...
function fn_egov_get_CodeId(form){
	...
	form.action="<c:url value='/sym/ccm/cde/RegistCcmCmmnDetailCodeView.cm'/>";
	form.submit();
}
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/ccm/cde/SelectCcmCmmnDetailCodeList.cm' />" title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
