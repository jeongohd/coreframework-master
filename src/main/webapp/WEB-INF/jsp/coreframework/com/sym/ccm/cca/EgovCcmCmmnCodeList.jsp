...
function fn_egov_select_linkPage(pageNo){
	...
	document.CcmCodeForm.action = "<c:url value='/sym/ccm/cca/SelectCcmCmmnCodeList.cm'/>";
...
function fn_egov_inquire_codedetail(codeId) {
	...
	document.CcmCodeForm.codeId.value = codeId;
  	document.CcmCodeForm.action = "<c:url value='/sym/ccm/cca/SelectCcmCmmnCodeDetail.cm'/>";
  	document.CcmCodeForm.submit();
}
</script>
</head>
...
<form name="CcmCodeForm" action="<c:url value='/sym/ccm/cca/SelectCcmCmmnCodeList.cm'/>" method="post" onSubmit="fn_egov_search_code(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/sym/ccm/cca/RegistCcmCmmnCodeView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td><a href="<c:url value='/sym/ccm/cca/SelectCcmCmmnCodeDetail.cm'/>?codeId=${resultInfo.codeId}" onClick="fn_egov_inquire_codedetail('<c:out value="${resultInfo.codeId}"/>');return false;"><c:out value='${fn:substring(resultInfo.codeId, 0, 40)}'/></a></td>
		<td><a href="<c:url value='/sym/ccm/cca/SelectCcmCmmnCodeDetail.cm'/>?codeId=${resultInfo.codeId}" onClick="fn_egov_inquire_codedetail('<c:out value="${resultInfo.codeId}"/>');return false;"><c:out value='${fn:substring(resultInfo.codeIdNm, 0, 40)}'/></a></td>
