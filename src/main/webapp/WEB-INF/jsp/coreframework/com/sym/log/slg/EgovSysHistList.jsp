...
function fn_egov_insert_sysHist(){
	document.frm.action = "<c:url value='/sym/log/slg/AddSysHistory.cm'/>";
	document.frm.submit();
}

function fn_egov_select_sysHist(pageNo){
	document.frm.pageIndex.value = pageNo;
	document.frm.action = "<c:url value='/sym/log/slg/SelectSysHistoryList.cm'/>";
	document.frm.submit();
}

function fn_egov_inqire_sysHist(histId){
	document.frm.histId.value = histId;
	document.frm.action = "<c:url value='/sym/log/slg/InqireSysHistory.cm'/>";
	document.frm.submit();
}
</script>
</head>
...
<div class="board">
	...
	<form name="frm" action ="<c:url value='/sym/log/slg/SelectSysHistoryList.cm'/>" method="post">
		...
		<tbody>
			...
			<c:forEach var="result" items="${resultList}" varStatus="status">
				<tr>
					...
					<img src="<c:url value='/images/coreframework/com/cmm/icon/search.gif'/>"  alt="<spring:message code="comSymLogSlg.sysHistList.fnEgovInqireSysHist"/>" /></a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
