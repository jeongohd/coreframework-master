...
function fn_egov_list(){
    var varForm = document.getElementById("batchSchdul");
    varForm.action = "<c:url value='/sym/bat/getBatchSchdulList.cm'/>";
    varForm.submit();
}
/* ********************************************************
 * 저장처리화면
...
function fn_egov_save(){
    var varForm = document.getElementById("batchSchdul");
    varForm.action =  "<c:url value='/sym/bat/updateBatchSchdul.cm'/>";
...
function fn_egov_popup_batch_opert_list(){
    ...
    var retVal;
    var url = "<c:url value='/sym/bat/getBatchOpertListPopup.cm'/>";
...
<form:form modelAttribute="batchSchdul" id="batchSchdul" action="/sym/bat/updateBatchSchdul.cm" method="post">
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
	            ...
	            <a href="#LINK" onclick="fn_egov_popup_batch_opert_list(); return false;" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/icon/search2.gif' />" alt="배치작업조회팝업 제공"/></a>
			</td>
		</tr>
		<tr>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/bat/getBatchSchdulList.cm'></c:url>" onclick="fn_egov_list(); return false;"><spring:message code="button.list" /></a></span>
	</div>
