...
<%
//String imagePath_icon   = "/images/coreframework/com/sym/mnu/mpm/icon/";
//String imagePath_button = "/images/coreframework/com/sym/mnu/mpm/button/";
%>
<html lang="ko">
<head>
...
var imgpath = "<c:url value='/images/coreframework/com/cmm/utl/'/>";
</script>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/coreframework/com/cmm/jqueryui.css' />">
...
<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/coreframework/com/sym/mnu/mpm/EgovMenuList.js' />"></script>
...
function insertMenuList() {
	...
	document.menuManageVO.action = "<c:url value='/sym/mnu/mpm/coreMenuAdd.cm'/>";
	menuManageVO.submit();
...
function updateMenuList() {
	...
	document.menuManageVO.action = "<c:url value='/sym/mnu/mpm/coreMenuManageUpdt.cm'/>";
	menuManageVO.submit();
}
...
function deleteMenuList() {
    if(!fn_validatorMenuList()){return;}
    if(document.menuManageVO.tmp_CheckVal.value != "U"){alert("<spring:message code="comSymMnuMpm.menuList.validate.checkVal" />"); return;} //상세조회시는 수정혹은 삭제만 가능합니다.
	document.menuManageVO.action = "<c:url value='/sym/mnu/mpm/coreMenuRemove.cm'/>";
	menuManageVO.submit();
}
...
function selectMenuList() {
    document.menuManageVO.action = "<c:url value='/sym/mnu/mpm/coreMenuList.cm'/>";
...
function selectMenuListTmp() {
	document.menuManageVO.req_RetrunPath.value = "/sym/mnu/mpm/CoreMenuList";
    document.menuManageVO.action = "<c:url value='/sym/mnu/mpm/CoreMenuListSelectTmp.cm'/>";
    document.menuManageVO.submit();
}
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#popupProgrmFileNm').click(function (e) {
            ...
            var page = "<c:url value='/sym/prm/coreProgrmListSearchNew.cm'/>";
            var $dialog = $('<div></div>')
        ...
        $('#popupUpperMenuId').click(function (e) {
            ...
            //var page = $(this).attr("href");
            var pagetitle = $(this).attr("title");
            var page = "<c:url value='/sym/mnu/mpm/coreMenuMvmnNew.cm'/>";
...
<form name="menuManageVO" action ="<c:url value='/sym/mnu/mpm/coreMenuAdd.cm' />" method="post">
<input type="hidden" name="req_RetrunPath" value="/sym/mnu/mpm/CoreMenuList">
...
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				<span class="btn_b"><a href="<c:url value='/sym/mnu/mpm/coreMenuList.cm'/>" onclick="initlMenuList(); return false;" title="<spring:message code="button.init" />"><spring:message code="button.init" /></a></span><!-- 초기화 -->
...
<%-- <table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <h1><img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;메뉴 목록</h1></td>
 </tr>
</table> --%>
  ...
  <tr>
   ...
   <%-- <td width="*" class="title_left">
	   <table border="0" cellspacing="0" cellpadding="0" align="left">
		<tr>
          <td width="90%"></td>
          <td><span class="button"><a href="<c:url value='/sym/mnu/mpm/coreMenuList.cm'/>" onclick="initlMenuList(); return false;">초기화</a></span></td>
          <td width="2%"></td>
   ...
   <td style="vertical-align:top">
		...
		<table class="wTable" >
		  ...
		  <tr>
	        ...
	        <a id="popupUpperMenuId" href="/sym/mnu/mpm/coreMenuMvmn.cm" target="_blank" title="<spring:message code="comSymMnuMpm.menuList.upperMenuId" />" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/icon/search2.gif' />"
		  ...
		  <tr>
	        ...
	        <a id="popupProgrmFileNm" href="/sym/prm/coreProgrmListSearch.cm" target="_blank" title="<spring:message code="comSymMnuMpm.menuList.progrmFileNm" />" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/icon/search2.gif' />"
