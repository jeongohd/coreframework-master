...
<c:set var="ImgUrl" value="${pageContext.request.contextPath}/images/coreframework/com/sym/mnu/mpm/"/>
<html lang="ko">
<head>
...
function mvmnMenuList() {
	window.open("<c:url value='/sym/mnu/mpm/coreMenuMvmn.cm' />",'Pop_Mvmn','scrollbars=yes,width=600,height=600');
}
...
function searchFileNm() {
	...
	window.open("<c:url value='/sym/prm/coreProgrmListSearch.cm' />",'Pop_progrmFileNm','width=500,height=600');
}
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/sym/mnu/mpm/coreMenuManageList.cm' />";
}
/* ********************************************************
 * 파일명 엔터key 목록조회  함수
 ******************************************************** */
...
<form:form modelAttribute="menuManageVO" name="menuManageVO" method="post" action="${pageContext.request.contextPath}/sym/mnu/mpm/coreMenuRegist.cm">
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a id="popupUpperMenuId" href="<c:url value='/sym/mnu/mpm/coreMenuMvmn.cm' />" target="_blank" title="<spring:message code="comSymMnuMpm.menuRegist.newWindow"/>"><img src="<c:url value='/images/coreframework/com/cmm/icon/search2.gif' />"
		...
		<tr>
			...
			<td class="left" colspan="3">
		        ...
		        <a id="popupProgrmFileNm" href="<c:url value='/sym/prm/coreProgrmListSearch.cm'/>?tmp_SearchElementName=progrmFileNm" target="_blank" title="<spring:message code="comSymMnuMpm.menuRegist.newWindow"/>">
					<img src="<c:url value='/images/coreframework/com/cmm/icon/search2.gif' />" alt='' />(<spring:message code="comSymMnuMpm.menuRegist.programFileNameSearch"/>)</a><!-- 새창으로 --><!-- 프로그램파일명 검색 -->
			</td>
		</tr>
		<tr>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/mnu/mpm/coreMenuManageList.cm'/>" onclick="selectList(); return false;"><spring:message code="button.list"/></a></span><!-- 목록 -->
	</div>
