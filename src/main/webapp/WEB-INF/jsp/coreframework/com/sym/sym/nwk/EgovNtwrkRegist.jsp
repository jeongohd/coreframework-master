...
function fncNtwrkInsert() {
    ...
    varFrom.action = "<c:url value='/sym/sym/nwk/addNtwrk.cm'/>";
...
<div class="wTableFrm">
    ...
    <form name="ntwrk" id="ntwrk" method="post" action="${pageContext.request.contextPath}/sym/sym/nwk/addNtwrk.cm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/sym/nwk/selectNtwrkList.cm'/>?pageIndex=<c:out value='${ntwrkVO.pageIndex}'/>&amp;strManageIem=<c:out value="${ntwrkVO.strManageIem}"/>&amp;strUserNm=<c:out value="${ntwrkVO.strUserNm}"/>" onclick="fncSelectNtwrkList(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
