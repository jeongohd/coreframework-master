...
function fncSelectTroblProcessList(pageNo){
    ...
    document.listForm.action = "<c:url value='/sym/tbm/tbp/selectTroblProcessList.cm'/>";
    document.listForm.submit();
}

function fncSelectTroblProcess(troblId) {
    document.listForm.troblId.value = troblId;
    document.listForm.action = "<c:url value='/sym/tbm/tbp/getTroblProcess.cm'/>";
    document.listForm.submit();   
}
...
function fncAddTroblProcessInsert() {
    ...
    document.listForm.action = "<c:url value='/sym/tbm/tbp/addViewTroblProcess.cm'/>";
    document.listForm.submit(); 
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/sym/tbm/tbp/selectTroblProcessList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
			<c:forEach var="troblProcess" items="${troblProcessList}" varStatus="status">
			  <tr>
			    <td>
			        <form name="item" method="post" action="<c:url value='/sym/tbm/tbp/getTroblProcess.cm'/>">
