...
function fn_egov_pageview(pageNo){
	...
	document.listForm.action = "<c:url value='/sym/ccm/zip/EgovCcmZipList.cm'/>";
...
//	location.href = "<c:url value='/sym/ccm/zip/EgovCcmZipRegist.cm'/>";
	var varForm	   			 = document.getElementById("Form");
	varForm.action 			 = "<c:url value='/sym/ccm/zip/EgovCcmZipRegist.cm'/>";
...
//	location.href = "<c:url value='/sym/ccm/zip/EgovCcmExcelZipRegist.cm' />";
	var varForm	   			 = document.getElementById("Form");
	varForm.action 			 = "<c:url value='/sym/ccm/zip/EgovCcmExcelZipRegist.cm'/>";
	varForm.searchList.value = no;
	varForm.submit();
}
/* ********************************************************
...
function fn_egov_detail_Zip(zip,sn){
	var varForm				 = document.getElementById("Form");
	varForm.action           = "<c:url value='/sym/ccm/zip/EgovCcmZipDetail.cm'/>";
...
<form name="listForm" action="<c:url value='/sym/ccm/zip/EgovCcmZipList.cm'/>" method="post">
<div class="board">
