...
<c:set var="ImgUrl" value="/images/coreframework/com/sym/mnu/bmm/"/>
<c:set var="CssUrl" value="/css/coreframework/com/sym/mnu/bmm/"/>
<%
String imagePath_icon   = "/images/coreframework/com/sym/mnu/bmm/icon/";
String imagePath_button = "/images/coreframework/com/sym/mnu/bmm/button/";
%>
<html lang="ko">
<head>
...
<div class="board">
	...
	<h2><img src="<c:url value='/images/coreframework/com/cmm/utl/menu_base.gif' />" alt="base icon" /> <spring:message code="comSymMnuBmm.BookMarkMenuPopup.shortCut" /></h2><!-- 바로가기 -->
	...
	<table class="e002">
		...
		<tr>
			<td><!-- 왼편여백 --></td>
			<td>
			    <img src="<c:url value='/images/coreframework/com/cmm/utl/menu_page.gif' />" alt="menu_page icon" />
