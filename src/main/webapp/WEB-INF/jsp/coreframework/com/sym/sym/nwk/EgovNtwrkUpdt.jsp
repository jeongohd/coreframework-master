...
function fncNtwrkUpdate() {
    var varFrom = document.getElementById("ntwrk");
    varFrom.action = "<c:url value='/sym/sym/nwk/updtNtwrk.cm'/>";
...
<form name="ntwrk" id="ntwrk" method="post" action="${pageContext.request.contextPath}/sym/sym/nwk/updtNtwrk.cm">
