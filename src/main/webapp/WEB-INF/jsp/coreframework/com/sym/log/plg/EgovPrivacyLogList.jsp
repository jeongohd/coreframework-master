...
function fn_egov_select_linkPage(pageNo){
	...
	document.PrivacyLogForm.action = "<c:url value='/sym/log/plg/SelectPrivacyLogList.cm'/>";
...
function fn_egov_search_privacyLog(){
	...
	vFrom.action = "<c:url value='/sym/log/plg/SelectPrivacyLogList.cm'/>";
	vFrom.submit();
}
/* ********************************************************
 * 상세회면 처리 함수
...
function fn_egov_detail_privacyLog(requestId) {
  	...
  	var top = 0;
  	var left = 0;
  	var url = "<c:url value='/sym/log/plg/SelectPrivacyLogDetail.cm' />?requestId="+requestId;
...
<form name="PrivacyLogForm" action="<c:url value='/sym/log/plg/SelectPrivacyLogList.cm'/>" method="post" onSubmit="fn_egov_search_privacyLog(); return false;">
<div class="board">
	...
	<tr>
		...
		<td>
		<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" class="cursor" onclick="fn_egov_detail_privacyLog('<c:out value="${result.requestId}"/>'); return false;"  alt="<spring:message code="title.detail" />"  title="<spring:message code="title.detail" />">
		</td>
	</tr>
	</c:forEach>
	</tbody>
