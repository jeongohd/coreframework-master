...
<script type="text/javaScript" language="javascript">
	...
	function fn_egov_list_AdministCode(){
		location.href = "<c:url value='/sym/ccm/adc/EgovCcmAdministCodeList.cm' />";
	}
	...
	function fn_egov_AdministCodePopup(upperAdministZoneCode,upperAdministZoneNm){
		...
		var url = "<c:url value='/sym/ccm/adc/EgovCcmAdministCodePopup.cm' />";
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a href="#noscript" onclick="fn_egov_NormalCalendar(document.administCode, document.administCode.creatDe, document.administCode.vcreatDe); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"></a>
		...
		<tr>
			...
			<td class="left">
				...
				<a href="#noscript" onclick="fn_egov_NormalCalendar(document.administCode, document.administCode.ablDe, document.administCode.vablDe); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"></a>
		...
		<tr>
			...
			<td class="left">
				...
				<a href="#noscript" onclick="fn_egov_AdministCodePopup(administCode.upperAdministZoneCode,administCode.upperAdministZoneNm); return false;" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/icon/search2.gif' />" alt="행정코드찾기"></a>
