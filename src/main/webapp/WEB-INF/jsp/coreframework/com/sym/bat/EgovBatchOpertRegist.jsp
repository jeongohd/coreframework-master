...
function fn_egov_save(){
    var varForm = document.getElementById("batchOpert");
    varForm.action =  "<c:url value='/sym/bat/addBatchOpert.cm'/>";
...
<form:form modelAttribute="batchOpert"  action="<c:url value='/sym/bat/addBatchOpert.cm'/>" method="post">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/bat/getBatchOpertList.cm'></c:url>" onclick="fn_egov_get_list(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
