...
<script type="text/javascript">
	function fn_egov_update_sysHist(){
		document.history.action = "<c:url value='/sym/log/slg/UpdateSysHistory.cm'/>";
		document.history.submit();
	}

	function fn_egov_select_sysHist(){
		document.history.action = "<c:url value='/sym/log/slg/SelectSysHistoryList.cm'/>";
		document.history.submit();
	}
</script>
</head>
...
<input type="hidden" name="returnUrl" value="<c:url value='/sym/log/slg/ModifySysHistory.cm'/>"/>
