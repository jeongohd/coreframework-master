...
function fncSelectTroblReqstList(pageNo){
    ...
    document.listForm.action = "<c:url value='/sym/tbm/tbr/selectTroblReqstList.cm'/>";
    document.listForm.submit();
}

function fncSelectTroblReqst(troblId) {
    document.listForm.troblId.value = troblId;
    document.listForm.action = "<c:url value='/sym/tbm/tbr/getTroblReqst.cm'/>";
    document.listForm.submit();   
}
...
function fncAddTroblReqstInsert() {
    ...
    document.listForm.action = "<c:url value='/sym/tbm/tbr/addViewTroblReqst.cm'/>";
    document.listForm.submit(); 
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/sym/tbm/tbr/selectTroblReqstList.cm'/>" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/sym/tbm/tbr/addViewTroblReqst.cm'/>?pageIndex=<c:out value='${troblReqstVO.pageIndex}'/>&amp;strTroblNm=<c:out value="${troblReqstVO.strTroblNm}"/>" onclick="fncAddTroblReqstInsert(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			<c:forEach var="troblReqst" items="${troblReqstList}" varStatus="status">
			  <tr>
			    <td>
			        <form name="item" method="post" action="<c:url value='/sym/tbm/tbr/getTroblReqst.cm'/>">
