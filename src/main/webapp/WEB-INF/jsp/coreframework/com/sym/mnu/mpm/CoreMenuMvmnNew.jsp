...
<script language="javascript1.2" type="text/javaScript" src="<c:url value='/js/coreframework/com/sym/mnu/mpm/CoreMenuList.js' />" /></script>
...
function selectMenuListTmp() {
	document.menuListForm.req_RetrunPath.value = "<c:url value='/sym/mnu/mpm/CoreMenuMvmn'/>";
    document.menuListForm.action = "<c:url value='/sym/mnu/mpm/CoreMenuListSelectTmp.cm'/>";
...
<body>
<form name="searchUpperMenuIdForm" action ="<c:url value='/sym/mnu/mpm/CoreMenuListSelectTmp.cm'/>" method="post">
<div style="visibility:hidden;display:none;"><input name="iptSubmit" type="submit" value="전송" title="전송"></div>
<input type="hidden" name="req_RetrunPath" value="/sym/mnu/mpm/CoreMenuMvmn">
