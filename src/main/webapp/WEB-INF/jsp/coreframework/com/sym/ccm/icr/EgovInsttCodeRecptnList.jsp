...
function fn_egov_pageview(pageNo){
    ...
    document.listForm.action = "<c:url value='/sym/ccm/icr/getInsttCodeRecptnList.cm'/>";
...
function fn_egov_detail_InsttCodeRecptn(insttCode){
    ...
    varForm.action           = "<c:url value='/sym/ccm/icr/getInsttCodeDetail.cm'/>";
...
<form name="listForm" action="<c:url value='/sym/ccm/icr/getInsttCodeRecptnList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr style="cursor:pointer" onclick="fn_egov_detail_InsttCodeRecptn('<c:out value="${resultInfo.insttCode}"/>');">
				...
				<td>
					<form name="subForm" method="post" action="<c:url value='/sym/ccm/icr/getInsttCodeDetail.cm'/>">
