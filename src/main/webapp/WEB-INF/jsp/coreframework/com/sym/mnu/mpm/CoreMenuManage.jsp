...
function fDeleteMenuList() {
    ...
    if(confirm("<spring:message code="common.delete.msg" />")){	//삭제하시겠습니까?
	    ...
	    document.menuManageForm.action = "<c:url value='/sym/mnu/mpm/coreMenuManageRemoves.cm'/>";
...
//	document.menuManageForm.searchKeyword.value =
	...
	document.menuManageForm.action = "<c:url value='/sym/mnu/mpm/coreMenuManageList.cm'/>";
   	document.menuManageForm.submit();
}
...
function insertMenuManage() {
   	document.menuManageForm.action = "<c:url value='/sym/mnu/mpm/coreMenuRegist.cm'/>";
   	document.menuManageForm.submit();
}
 ...
 */
function bndeInsertMenuManage() {
   	document.menuManageForm.action = "<c:url value='/sym/mnu/mpm/coreMenuBndeRegist.cm'/>";
   	document.menuManageForm.submit();
}
/* ********************************************************
 * 상세조회처리 함수
...
function selectUpdtMenuManageDetail(menuNo) {
	document.menuManageForm.req_menuNo.value = menuNo;
   	document.menuManageForm.action = "<c:url value='/sym/mnu/mpm/CoreMenuManageListDetailSelect.cm'/>";
   	document.menuManageForm.submit();
}
/* ********************************************************
 * 최초조회 함수
...
<form name="menuManageForm" action ="<c:url value='/sym/mnu/mpm/coreMenuManageList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/sym/mnu/mpm/coreMenuRegist.cm'/>" onclick="bndeInsertMenuManage(); return false;" title="<spring:message code="button.bulkUpload" />"><spring:message code="button.bulkUpload" /></a></span><!-- 일괄등록 -->
				<span class="btn_b"><a href="<c:url value='/sym/mnu/mpm/coreMenuRegist.cm'/>" onclick="insertMenuManage(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span><!-- 등록 -->
			...
			<c:forEach var="result" items="${list_menumanage}" varStatus="status">
			  <tr>
			    ...
			    <td style="cursor:hand;">
			       <span class="link"><a href="<c:url value='/sym/mnu/mpm/CoreMenuManageListDetailSelect.cm?req_menuNo='/>${result.menuNo}" onclick="selectUpdtMenuManageDetail('<c:out value="${result.menuNo}"/>'); return false;"><c:out value="${result.menuNm}"/></a></span>
			    </td>
