...
<%--
 /**
  * @Class Name : CoreProgramListDetailSelectUpdt.jsp
...
function updateProgramListManage(form) {
	if(confirm("<spring:message code="common.save.msg" />")){
		if(!validateProgrmManageVO(form)){
            ...
            form.action="<c:url value='/sym/prm/coreProgrmUpdt.cm' />";
			form.submit();
		}
	}
}
...
function deleteProgramListManage(form) {
	if(confirm("<spring:message code="common.delete.msg" />")){
        form.action="<c:url value='/sym/prm/coreProgrmRemove.cm' />";
		form.submit();
	}
}
...
function selectList(){
    ...
    varForm.action = "<c:url value='/sym/prm/coreProgrmList.cm' />";
    varForm.submit();
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/prm/coreProgrmRemove.cm'/>?progrmFileNm=<c:out value="${progrmManageVO.progrmFileNm  }"/>" onclick="deleteProgramListManage(document.forms[0]); return false;"><spring:message code="button.delete" /></a></span><!-- 삭제 -->
	</div>
