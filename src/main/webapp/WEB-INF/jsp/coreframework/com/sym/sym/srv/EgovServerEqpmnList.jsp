...
function fncSelectServerEqpmnList(pageNo){
    ...
    document.listForm.action = "<c:url value='/sym/sym/srv/selectServerEqpmnList.cm'/>";
    document.listForm.submit();
}

function fncSelectServerEqpmn(serverEqpmnId) {
    document.listForm.serverEqpmnId.value = serverEqpmnId;
    document.listForm.action = "<c:url value='/sym/sym/srv/getServerEqpmn.cm'/>";
    document.listForm.submit();   
}
...
function fncAddServerEqpmnInsert() {
    ...
    document.listForm.action = "<c:url value='/sym/sym/srv/addViewServerEqpmn.cm'/>";
    document.listForm.submit(); 
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/sym/sym/srv/selectServerEqpmnList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
			<c:forEach var="serverEqpmn" items="${serverEqpmnList}" varStatus="status">
			  <tr>
			    <td>
			        <form name="item" method="post" action="<c:url value='/sym/sym/srv/getServerEqpmn.cm'/>">
