...
function fn_egov_deleteBkmkInf(){
	...
	if(confirm("삭제하시겠습니까?")){
    	...
    	document.frm.action = "<c:url value='/sym/mnu/bmm/EgovBkmkMenuManageDelete.cm'/>";
    	document.frm.submit();
    }
}
	...
	function fn_egov_select_bkmkInfs(pageNo){
		...
		document.frm.action = "<c:url value='/sym/mnu/bmm/selectBkmkMenuManageList.cm'/>";
		document.frm.submit();
	}

	function fn_egov_add_bkmkInfs(){
		document.frm.action = "<c:url value='/sym/mnu/bmm/addBkmkInf.cm'/>";
		document.frm.submit();
	}

	function fn_egov_preview_bkmkInfs(){
		var retVal;
		var url = "<c:url value='/sym/mnu/bmm/openPopup.cm?requestUrl=/sym/mnu/bmm/previewBkmkInf.cm&width=850&height=360'/>";
...
<div class="board">
	...
	<form name="frm" action = "<c:url value='/sym/mnu/bmm/selectBkmkMenuManageList.cm' />" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/sym/mnu/bmm/addBkmkInf.cm'/>" onclick="fn_egov_add_bkmkInfs(); return false;" title="<spring:message code="button.create" />"><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
