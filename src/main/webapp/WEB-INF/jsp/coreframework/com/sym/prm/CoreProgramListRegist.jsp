...
<%--
 /**
  * @Class Name : CoreProgramListRegist.jsp
 ...
 ******************************************************** */
function selectList(){
	location.href = "<c:url value='/sym/prm/coreProgrmList.cm' />";
}
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sym/prm/coreProgrmList.cm'/>" onclick="selectList(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
