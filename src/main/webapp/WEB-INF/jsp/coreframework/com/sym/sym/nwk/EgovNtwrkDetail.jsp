...
function fncSelectNtwrkList() {
    ...
    varFrom.action = "<c:url value='/sym/sym/nwk/selectNtwrkList.cm'/>";
    varFrom.submit();       
}
...
function fncNtwrkUpdateView(ntwrkId) {
    ...
    varFrom.action = "<c:url value='/sym/sym/nwk/updtViewNtwrk.cm'/>";
    varFrom.submit();
}
...
function fncNtwrkDelete(ntwrkId) {
    var varFrom = document.getElementById("ntwrk");
    varFrom.ntwrkId.value = ntwrkId;
    varFrom.action = "<c:url value='/sym/sym/nwk/removeNtwrk.cm'/>";
...
<form:form modelAttribute="ntwrk" method="post" action="${pageContext.request.contextPath}/sym/sym/nwk/updtViewNtwrk.cm">
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/sym/sym/nwk/updtViewNtwrk.cm'/>?ntwrkId=<c:out value='${ntwrk.ntwrkId}'/>" onclick="fncNtwrkUpdateView('${ntwrk.ntwrkId}'); return false;"><spring:message code="button.update" /></a></span><!-- 수정 -->
		<span class="btn_s"><a href="<c:url value='/sym/sym/nwk/removeNtwrk.cm'/>?ntwrkId=<c:out value='${ntwrk.ntwrkId}'/>" onclick="fncNtwrkDelete('${ntwrk.ntwrkId}'); return false;"><spring:message code="button.delete" /></a></span><!-- 삭제 -->
		<span class="btn_s"><a href="<c:url value='/sym/sym/nwk/selectNtwrkList.cm'/>?pageIndex=<c:out value='${ntwrkVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${ntwrkVO.searchKeyword}"/>&amp;searchCondition=1" onclick="fncSelectNtwrkList(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
