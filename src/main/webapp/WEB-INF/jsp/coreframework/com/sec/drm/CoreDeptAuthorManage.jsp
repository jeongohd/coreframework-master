...
function fncSelectDeptAuthorList(pageNo) {
    ...
    document.listForm.action = "<c:url value='/sec/drm/CoreDeptAuthorList.cm'/>";
...
function fncAddDeptAuthorInsert() {
    ...
    if(confirm("<spring:message code="common.regist.msg" />")){	//등록하겠습니까?
        document.listForm.action = "<c:url value='/sec/drm/CoreDeptAuthorInsert.cm'/>";
        document.listForm.submit();
    }
}
...
function fncDeptAuthorDeleteList() {
    ...
    if(confirm("<spring:message code="common.delete.msg" />")){	//삭제하시겠습니까?
        document.listForm.action = "<c:url value='/sec/drm/CoreDeptAuthorDelete.cm'/>";
        document.listForm.submit();
    }
}
...
function fncSelectDeptAuthorPop() {
    ...
    var url = "<c:url value='/sec/drm/CoreDeptSearchView.cm'/>";
...
function fncSelectDeptAuthorPop() {
    ...
    var url = "<c:url value='/sec/drm/CoreDeptSearchList.cm'/>";
    var openParam = "dialogWidth:500px;dialogHeight:485px;scroll:no;status:no;center:yes;resizable:yes;";
    /*
    var retVal = window.showModalDialog(url, varParam, openParam);
    if(retVal) {
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#deptSelectPopup').click(function (e) {
            ...
            var page = "<c:url value='/sec/drm/CoreDeptSearchList.cm'/>";
            var $dialog = $('<div></div>')
...
<form:form name="listForm" action="${pageContext.request.contextPath}/sec/drm/CoreDeptAuthorList.cm" method="post">
<div class="board">
