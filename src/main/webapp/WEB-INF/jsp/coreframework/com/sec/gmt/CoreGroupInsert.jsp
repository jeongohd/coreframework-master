<%
/**
 * @Class Name  : CoreAuthorInsert.java
 * @Description : CoreAuthorInsert jsp
...
<form:form modelAttribute="groupManage" method="post" action="${pageContext.request.contextPath}/sec/gmt/CoreGroupInsert.cm" onSubmit="fncGroupInsert(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
