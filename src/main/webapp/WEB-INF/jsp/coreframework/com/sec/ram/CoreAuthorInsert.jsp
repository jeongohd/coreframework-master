...
function fncSelectAuthorList() {
	...
	varFrom.action = "<c:url value='/sec/ram/CoreAuthorList.cm'/>";
	varFrom.submit();
}
...
function fncAuthorUpdate() {
	var varFrom = document.getElementById("authorManage");
	varFrom.action = "<c:url value='/sec/ram/CoreAuthorUpdate.cm'/>";
...
function fncAuthorDelete() {
	var varFrom = document.getElementById("authorManage");
	varFrom.action = "<c:url value='/sec/ram/CoreAuthorDelete.cm'/>";
...
<form:form modelAttribute="authorManage" action="${pageContext.request.contextPath}/sec/ram/CoreAuthorInsert.cm" method="post" onSubmit="fncAuthorInsert(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/sec/ram/CoreAuthorList.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
