<%
 /**
  * @Class Name : CoreGroupSearch.java
  * @Description : CoreGroupSearch Search 화면
...
function fncSelectGroupList(pageNo){
 ...
 // document.listForm.action = "<c:url value='/sec/gmt/CoreGroupSearchList.cm'/>";
...
<form:form name="listForm" action="${pageContext.request.contextPath}/sec/gmt/CoreGroupSearchList.cm" method="post">
<div class="popup">
