<%
/**
 * @Class Name  : CoreAuthorUpdate.java
 * @Description : CoreAuthorUpdate jsp
...
function fncSelectGroupList() {
    ...
    varFrom.action = "<c:url value='/sec/gmt/CoreGroupList.cm'/>";
    varFrom.submit();
}
...
function fncGroupDelete() {
    ...
    varFrom.action = "<c:url value='/sec/gmt/CoreGroupDelete.cm'/>";
...
<form:form modelAttribute="groupManage" method="post" action="${pageContext.request.contextPath}/sec/gmt/CoreGroupUpdate.cm" onSubmit="fncGroupUpdate(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
	<span class="btn_s"><a href="<c:url value='/sec/gmt/CoreGroupList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
