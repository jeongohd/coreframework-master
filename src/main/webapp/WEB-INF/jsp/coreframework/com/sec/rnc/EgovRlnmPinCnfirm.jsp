...
function fnGpinCnfirm(){
	...
	//document.cnfirmForm.action = "<c:url value='/sec/rnc/EgovRlnmPinCnfirm.cm'/>";
	//핀인증화면을 팝업으로 띄운다.
	//document.cnfirmForm.action = "<c:url value='/sec/rnc/EgovGPinCall.cm'/>";
    //jsp 팝업으로 띄운다.
    wWidth = 360;
    wHight = 120;
    ...
    //open 형태로 호출
    //var w = window.open("<c:url value='/sec/rnc/CorePageLink.cm' />?link=cmm/sec/rnc/EgovCallGpin", "gPinLoginWin", "directories=no,toolbar=no,left="+wX+",top="+wY+",width="+wWidth+",height="+wHight);

    //submit 형태로 호출
    var ww = window.open("#","_openWin", "directories=no,toolbar=no,left="+wX+",top="+wY+",width="+wWidth+",height="+wHight);
    document.cnfirmForm.action="<c:url value='/sec/rnc/CorePageLink.cm' />?link=/coreframework/com/sec/rnc/EgovCallGpin";
...
function fnIhidnumMove(){
    //GPIN 실명인증 화면으로 이동한다.
    document.cnfirmForm.action = "<c:url value='/sec/rnc/EgovRlnmCnfirm.cm'/>";
...
<body>
        <!-- content start -->
        <form name="cnfirmForm" method="post" action="<c:url value='/sec/rnc/EgovRlnmCnfirm.cm'/>">
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;공공IPIN 실명확인</td>
            </tr>
        </table>
        <table width="717" border="0"  cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <tr>
                    <!-- 실명확인 
	                <td align="right"><img src="<c:url value='/images/coreframework/com/cmm/btn/bu2_left.gif' />" width="8" height="20" alt="버튼이미지"></td>
	                ...
	                <td align="left"><img src="<c:url value='/images/coreframework/com/cmm/btn/bu2_right.gif' />" width="8" height="20" alt="버튼이미지"></td>
	                -->
