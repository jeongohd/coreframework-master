...
<form:form modelAttribute="authorManage" action="${pageContext.request.contextPath}/sec/ram/CoreAuthorUpdate.cm" method="post" onSubmit="fncAuthorUpdate(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
