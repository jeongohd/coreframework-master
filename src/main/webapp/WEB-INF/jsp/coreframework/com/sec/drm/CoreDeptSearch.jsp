<%
 /** 
  * @Class Name : CoreDeptSearch.java
  * @Description : CoreDeptSearch Search 화면
...
function fncSelectDeptList(pageNo){
 ...
 // document.listForm.action = "<c:url value='/sec/drm/CoreDeptSearchList.cm'/>";
...
<form:form name="listForm" action="${pageContext.request.contextPath}/sec/drm/CoreDeptSearchList.cm" method="post">
<div class="popup">
