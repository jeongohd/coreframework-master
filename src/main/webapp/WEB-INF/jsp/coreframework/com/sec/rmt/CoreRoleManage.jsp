...
function fncAddRoleInsert() {
    location.href = "<c:url value='/sec/rmt/CoreRoleInsertView.cm'/>";
}
...
<form:form name="listForm" action="${pageContext.request.contextPath}/sec/rmt/CoreRoleList.cm" method="post">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/sec/rmt/CoreRoleInsertView.cm'/>" onClick="javascript:fncAddRoleInsert();"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td><a href="<c:url value='/sec/rmt/CoreRoleList.cm'/>?roleCode=${role.roleCode}" onclick="javascript:fncSelectRole('<c:out value="${role.roleCode}"/>');return false;"><c:out value="${role.roleCode}"/></a></td>
		...
		<td><a href="<c:url value='/sec/rmt/CoreRoleList.cm'/>?roleCode=${role.roleCode}" onclick="javascript:fncSelectRole('<c:out value="${role.roleCode}"/>');return false;s"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" alt="<spring:message code="title.detail" />"  title="<spring:message code="title.detail" />"></a></td>
	</tr>
	</c:forEach>
	</tbody>
	</table>
