...
<script language="javascript1.2" src="<c:url value='/js/coreframework/com/sym/mnu/mpm/CoreMainMenu.js' />" /></script>
</head>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight= "0">
<form name="menuListForm" action ="<c:url value='/sym/mnu/mpm/coreMenuList.cm' />" method="post">
