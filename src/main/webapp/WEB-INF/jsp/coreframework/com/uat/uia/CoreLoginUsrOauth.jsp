...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/coreframework/com/uat/uia/login.css' />">
...
function actionLogin() {
	if (document.loginForm.id.value =="") {
        ...
        document.loginForm.action="<c:url value='/uat/uia/actionLogin.cm'/>";
...
function actionCrtfctLogin() {
    document.defaultForm.action="<c:url value='/uat/uia/actionCrtfctLogin.cm'/>";
    document.defaultForm.submit();
}

function goFindId() {
    document.defaultForm.action="<c:url value='/uat/uia/egovIdPasswordSearch.cm'/>";
    document.defaultForm.submit();
}
...
function goRegiUsr() {
    ...
    // 일반회원
    if (userSe == "GNR") {
        document.loginForm.action="<c:url value='/uss/umt/EgovStplatCnfirmMber.cm'/>";
        document.loginForm.submit();
    // 기업회원
    } else if (userSe == "ENT") {
        document.loginForm.action="<c:url value='/uss/umt/EgovStplatCnfirmEntrprs.cm'/>";
        document.loginForm.submit();
    // 업무사용자
    } else if (userSe == "USR") {
...
function goGpkiIssu() {
    document.defaultForm.action="<c:url value='/uat/uia/egovGpkiIssu.cm'/>";
    document.defaultForm.submit();
}
...
<div class="login_form">
	<form name="loginForm" id="loginForm" action="<c:url value='/uat/uia/actionLogin.cm'/>" method="post">
	<input type="hidden" id="message" name="message" value="<c:out value='${message}'/>">
	
	<fieldset>
		<img src="<c:url value='/images/coreframework/com/uat/uia/login_tit.png'/>" style="margin:30px 0 0px 60px" alt="login title image"  title="login title image">
			...
			<ul>
				...
				<li>
					<ul class="btn_idpw" >
						...
						<li><a href="<c:url value='/uat/uia/egovGpkiIssu.cm'/>"><spring:message code="comUatUia.loginForm.gpki.info"/></a></li><!-- 인증서안내 -->
					</ul>
				</li>
	...
	<a href="${ naver_url }"><img width="300" src="<c:url value='/images/coreframework/com/uat/uia/naver-login.png'/>" alt="Naver Login" /></a>
	<br><br>
	<a href="${ google_url }"><img width="300" src="<c:url value='/images/coreframework/com/uat/uia/google-login.png'/>" alt="Google Login" /></a>
	<br><br>
	<a href="${ kakao_url }"><img width="300" src="<c:url value='/images/coreframework/com/uat/uia/kakao-login.png'/>" alt="Kakao Login" /></a>
