...
function fnOnepassLogin() {
	if ('${authType}' == 'session') {
		...
		document.onepassForm.action = '<c:url value="/uat/uia/onepass/onepassLogin.cm"/>';
	...
	<div style="border:2px solid #e6e6e6; margin-top:20px;">
		...
		<ul style="margin:10px 0px 10px;">
			<li style="text-align:center;">
				하나의 아이디로 간편하게
				<a href="#" onclick="javascript:fnOnepassLogin();"><img src="<c:url value='/images/coreframework/com/uat/uia/onepass.png'/>" alt="디지털원패스 로그인" title="디지털원패스 로그인"></a>
			</li>
		</ul>
	</div>
