...
<%
 /**
  * @Class Name : CoreUnitContent.jsp
...
function fnPasswordMoveEnt(){
    document.pwdManage.action = "<c:url value='/uss/umt/coreEntrprsPasswordUpdt.cm'/>";
    document.pwdManage.submit();
}
// 일반회원 (USER)
function fnPasswordMoveMber(){
    document.pwdManage.action = "<c:url value='/uss/umt/coreMberPasswordUpdt.cm'/>";
    document.pwdManage.submit();
}
// 업무사용자 (TEST1/webmaster)
function fnPasswordMoveUser(){
	document.pwdManage.action = "<c:url value='/uss/umt/coreUserPasswordUpdt.cm'/>";
    document.pwdManage.submit();
}
...
<body onload="fn_egov_init()">
	...
	src/main/resources/coreframework/coreProps/globals.properties
	<p/>
	<b><img src="${pageContext.request.contextPath }/images/coreframework/com/cmm/icon/tit_icon.png"> <spring:message code="comCmm.expirePwdContent.22"/> </b><p/><!-- 비밀번호 유효기간 만료 -->
	...
	<br /><b><img src="${pageContext.request.contextPath }/images/coreframework/com/cmm/icon/tit_icon.png"> <spring:message code="comCmm.expirePwdContent.25"/></b><p/><!-- 비밀번호 유효기간 초과일수 -->
