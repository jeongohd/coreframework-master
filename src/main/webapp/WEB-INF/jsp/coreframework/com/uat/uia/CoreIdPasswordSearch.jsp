<%
 /**
  * @Class Name : CoreIdPasswordSearch.jsp
...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/coreframework/com/uat/uia/idpw.css' />">
<script>
...
<div class="idpw_form">
	...
	<form name="idForm" action ="<c:url value='/uat/uia/searchId.cm'/>" method="post">
	...
	<fieldset class="pw_search">
		<form name="passwordForm" action ="<c:url value='/uat/uia/searchPassword.cm'/>" method="post">
