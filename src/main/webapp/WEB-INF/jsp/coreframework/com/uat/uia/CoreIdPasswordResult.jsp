...
<%
 /**
  * @Class Name : CoreIdPasswordResult.jsp
...
function fncGoIdPwd(){
    location.href="<c:url value='/uat/uia/egovIdPasswordSearch.cm'/>";
}

function fncGoLogin(){
	location.href="<c:url value='/uat/uia/coreLoginUsr.cm'/>";
}
...
<body>
	...
	<p style="font-size: 18px; color: #000; margin-bottom: 10px; "><img src="<c:url value='/images/coreframework/com/cmm/er_logo.jpg' />" width="379" height="57" /></p>
