...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/cop/sms/selectSmsList.cm'/>?pageIndex=1" onclick="fn_egov_select_smsList('1'); return false;"><spring:message code="button.list"/></a></span><!-- 목록 -->
	</div>
