...
<form:form modelAttribute="leaderSchdulVO" name="leaderSchdulVO" action="${pageContext.request.contextPath}/cop/smt/lsm/mng/updateLeaderSchdul.cm" method="post">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulList.cm'/>" onclick="fn_egov_list_LeaderSchdul(); return false;"><spring:message code="button.list" /></a></span>
	</div>
