...
<form:form modelAttribute="commuMasterVO" action="${pageContext.request.contextPath}/cop/cmy/insertCommuMaster.cm" method="post" onSubmit="fn_egov_regist_commu(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
