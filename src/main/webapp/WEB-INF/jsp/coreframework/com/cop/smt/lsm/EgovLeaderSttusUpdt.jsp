...
<script type="text/javascript">
	...
	function fn_egov_update_leadersttus() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.leaderSttusVO.action = "<c:url value='/cop/smt/lsm/mng/updateLeaderSttus.cm'/>";
...
<form:form modelAttribute="leaderSttusVO" name="leaderSttusVO" method="post" action="${pageContext.request.contextPath}/cop/smt/lsm/mng/updateLeaderSttus.cm' />">
