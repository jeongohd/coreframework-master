...
<script type="text/javascript">	
	function fn_egov_regist_sms() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			form = document.sms;
			form.action = "<c:url value='/cop/sms/insertSms.cm'/>";
	...
	function fn_egov_select_sms() {
		form = document.sms;
		form.action = "<c:url value='/cop/sms/selectSmsList.cm'/>";
		form.submit();	
	}
...
<form:form modelAttribute="sms" name="sms" method="post" action="${pageContext.request.contextPath}/cop/sms/insertSms.cm' />">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/sms/selectSmsList.cm'/>?pageIndex=<c:out value='${searchVO.pageIndex}'/>" onclick="fn_egov_select_sms(); return false;"><spring:message code="button.list" /></a></span>
	</div>
