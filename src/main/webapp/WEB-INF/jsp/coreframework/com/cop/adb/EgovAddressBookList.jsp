...
<script type="text/javascript">
	...
	function fn_egov_select_adbkInfs(pageNo){
		...
		document.frm.action = "<c:url value='/cop/adb/selectAdbkList.cm'/>";
		document.frm.submit();
	}
	...
	function fn_egov_addadbkInf(){
		location.href = "<c:url value='/cop/adb/addAdbkInf.cm'/>";
	}
	...
	function fn_egov_deleteAdbk(adbkId, frm){
		...
		if(confirm("<spring:message code="common.delete.msg" />")){	
			...
			frm.action = "<c:url value='/cop/adb/deleteAdbkInf.cm'/>";
			frm.submit();
		}
	...
	function fn_egov_update_adbkInf(adbkId){
		...
		document.item.action = "<c:url value='/cop/adb/updateAdbkInf.cm'/>";
...
<!-- 검색영역 -->
<form:form name="frm" action="${pageContext.request.contextPath}/cop/adb/selectAdbkList.cm" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/cop/adb/addAdbkInf.cm'/>" onClick="javascript:fn_egov_addadbkInf();return false;"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
...
<input type="hidden" name="adbkId" value = "'<c:out value="${searchVO.adbkId}" />'" >
	...
	<tr>
		...
		<form name="subForm" method="post" action="<c:url value='/cop/adb/updateAdbkInf.cm'/>">
		...
		<form name="subFormDelete" method="post" action="<c:url value='/cop/adb/deleteAdbkInf.cm'/>" onsubmit="fn_egov_deleteAdbk('<c:out value="${result.adbkId}" />', this.form); return false;">
		    <input name="adbkId" type="hidden" value="<c:out value="${result.adbkId}"/>">
		    <input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>
