...
function fn_egov_select_linkPage(pageNo){
	...
	document.articleScrapForm.action = "<c:url value='/cop/scp/selectArticleScrapList.cm'/>";
...
function fn_egov_inquire_articleScrapDetail(scrapId) {
	...
	document.articleScrapForm.scrapId.value = scrapId;
  	document.articleScrapForm.action = "<c:url value='/cop/scp/selectArticleScrapDetail.cm'/>";
  	document.articleScrapForm.submit();
}
</script>
</head>
...
<form name="articleScrapForm" action="<c:url value='/cop/scp/selectArticleScrapList.cm'/>" method="post" onSubmit="fn_egov_search_articleScrap(); return false;">
<div class="board">
	...
	<tr>
		...
		<td>
			<form name="subForm" method="post" action="<c:url value='/cop/scp/selectArticleScrapDetail.cm'/>">
