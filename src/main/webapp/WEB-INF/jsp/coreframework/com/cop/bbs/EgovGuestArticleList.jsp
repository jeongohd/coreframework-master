 ...
 ******************************************************** */
 function fn_egov_delete_guest(nttId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.articleForm.action = "<c:url value='/cop/bbs/deleteGuestArticle.cm'/>";
  ...
  ******************************************************** */
	function fn_egov_updt_guest(form) {
		...
		if (confirm('<spring:message code="common.update.msg" />')) {
			...
			form.action = "<c:url value='/cop/bbs/updateGuestArticle.cm'/>";
			form.submit();
		}
	}
/* ********************************************************
 ...
 ******************************************************** */
	function fn_egov_selectGuestForupdt(nttId) {
		document.articleForm.nttId.value = nttId;	
		document.articleForm.action = "<c:url value='/cop/bbs/updateGuestArticleView.cm'/>";
		document.articleForm.submit();
	}
...
function fn_egov_select_guestList(pageNo) {
	...
	document.articleForm.action = "<c:url value='/cop/bbs/selectGuestArticleList.cm'/>";
	document.articleForm.submit();
}
</script>
<!-- 댓글 작성 스크립트  -->
...
<!-- 방명록 리스트 출력 -->
<form name="articleForm" action="<c:url value='/cop/bbs/updateGuestArticleView.cm'/>" method="post">
<div class="board">
<h2>${pageTitle}</h2>
<div class="reply">
	<ul>
...
<!-- 방명록 입력폼 -->
<form:form modelAttribute="articleVO" action="${pageContext.request.contextPath}/cop/bbs/insertGuestArticle.cm" method="post" onSubmit="fn_egov_insert_guest(document.forms[1]); return false; " style="float:left; clear:both;">
	<div class="wTableFrm" >
