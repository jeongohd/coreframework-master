...
function fn_egov_DeptSchdulManage(schdulId){
	window.showModalDialog("<c:url value='/cop/smt/sdm/EgovDeptSchdulManageDetail.cm' />?schdulId=" + schdulId , self ,"dialogWidth=800px;dialogHeight=500px;resizable=yes;center=yes");
}
</script>
