...
function fn_egov_schdulDept_DeptSchdulManage(){
	...
	window.showModalDialog("<c:url value='/cop/smt/sdm/EgovDeptSchdulManageAuthorGroupPopup.cm' />", arrParam ,"dialogWidth=780px;dialogHeight=500px;resizable=yes;center=yes");
}
...
function fn_egov_schdulCharger_DeptSchdulManagee(){
	...
	arrParam[1] = "typeDeptSchdule";
 	...
 	window.showModalDialog("<c:url value='/cop/smt/sdm/EgovDeptSchdulManageEmpLyrPopup.cm' />", arrParam,"dialogWidth=780px;dialogHeight=600px;resizable=yes;center=yes");
}
...
function fn_egov_list_DeptSchdulManage(){
	location.href = "<c:url value='/cop/smt/sdm/EgovDeptSchdulManageList.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
...
<!--  상단타이틀 -->
<form:form modelAttribute="deptSchdulManageVO" name="deptSchdulManageVO" action="${pageContext.request.contextPath}/cop/smt/sdm/EgovDeptSchdulManageModifyActor.cm" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_DeptSchdulManage(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<tbody>
		...
		<tr>
			...
			<td class="nopd">
				...
				<a href="#" onClick="fn_egov_schdulDept_DeptSchdulManage()"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt="${title} <spring:message code="input.button"/>" title="${title} <spring:message code="input.button"/>"></a>
		...
		<tr>
			...
			<td class="nopd">
				...
				<a href="#" onClick="fn_egov_schdulCharger_DeptSchdulManagee()"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt="${title} <spring:message code="input.button"/>" title="${title} <spring:message code="input.button"/>"></a>
		...
		<tr>
			...
			<c:import charEncoding="utf-8" url="/cmm/fms/selectFileInfsForUpdate.cm" >
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageList.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
...
<input type="hidden" name="cal_url" value="<c:url value='/sym/cal/EgovNormalCalPopup.cm'/>" />
<input type="hidden" name="returnUrl" value="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageModify.cm'/>"/>
</form:form>
