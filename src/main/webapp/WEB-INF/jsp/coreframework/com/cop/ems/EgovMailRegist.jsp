...
function fn_egov_regist_sndngMail(form) {
	...
	if(!validateSndngMailVO(form)){
		...
		if(confirm("<spring:message code="common.regist.msg" />")){	
			form.action = "<c:url value='/cop/ems/insertSndngMail.cm'/>";
			form.submit();	
		}
	}
}
...
<div class="wTableFrm">
	...
	<form:form name="sndngMailVO" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/cop/ems/insertSndngMail.cm" onSubmit="fn_egov_regist_sndngMail(document.forms[0]); return false;">
