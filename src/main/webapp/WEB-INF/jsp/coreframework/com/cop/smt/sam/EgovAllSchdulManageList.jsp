...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/cop/smt/sam/EgovAllSchdulManageList.cm'/>";
...
function fn_egov_regist_AllSchdulManage(){
	location.href = "<c:url value='/cop/smt/sam/EgovAllSchdulManageRegist.cm' />";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
function fn_egov_modify_AllSchdulManage(){
	location.href = "<c:url value='/cop/smt/sam/EgovAllSchdulManageModify.cm' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_AllSchdulManage(schdulKindCode, schdulId){
	...
	if(schdulKindCode == "1"){
		vFrom.action = "<c:url value='/cop/smt/sdm/EgovDeptSchdulManageDetail.cm' />";
	}else{
...
function fn_egov_search_AllSchdulManage(){
	...
	vFrom.action = "<c:url value='/cop/smt/sam/EgovAllSchdulManageList.cm' />";
	vFrom.submit();
...
<form name="listForm" action="<c:url value='/cop/smt/sam/EgovAllSchdulManageList.cm'/>" method="post" onSubmit="fn_egov_search_stplatcn(); return false;">
<div class="board">
	...
	<tr>
		...
		<td class="left">
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageDetail.cm'/>?schdulId=${resultInfo.schdulId}&pageIndex=${searchVO.pageIndex}" onclick="JavaScript:fn_egov_detail_AllSchdulManage('${resultInfo.schdulKindCode}','${resultInfo.schdulId}'); return false;"><c:out value='${fn:substring(resultInfo.schdulNm, 0, 40)}'/>
		</a></td>
