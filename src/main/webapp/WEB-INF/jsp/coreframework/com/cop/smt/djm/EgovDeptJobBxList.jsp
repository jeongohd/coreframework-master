...
<script type="text/javascript">
	...
	function fn_egov_select_deptjobbx(pageNo) {
		...
		document.frm.action = "<c:url value='/cop/smt/djm/selectDeptJobBxList.cm'/>";
		document.frm.submit();	
	}
	
	function fn_egov_inqire_deptjobbx(deptJobBxId) {
		document.frm.deptJobBxId.value = deptJobBxId;
		document.frm.action = "<c:url value='/cop/smt/djm/modifyDeptJobBx.cm'/>";
		document.frm.submit();	
	}
	...
	function fn_egov_inqire_deptjobbx_ordr(ordrCnd) {
		...
		document.frm.action = "<c:url value='/cop/smt/djm/updateDeptJobBxOrdr.cm'/>";
		document.frm.submit();	
	}

	function fn_egov_insert_deptjobbx(){	
		document.frm.action = "<c:url value='/cop/smt/djm/addDeptJobBx.cm'/>";
		document.frm.submit();
	}
...
<div class="board">
	...
	<form name="frm" method="post" action="<c:url value='/cop/smt/djm/selectDeptJobBxList.cm'/>">
		...
		<table class="board_list">
			...
			<tbody>
				<c:forEach var="result" items="${resultList}" varStatus="status">
					<tr>
						<td>
							<form name="deptJobBxCheck" method="post" action="<c:url value='/cop/smt/djm/selectDeptJobBxList.cm'/>">
						...
						<td>
							<form name="deptJobBxVO" method="post" action="<c:url value='/cop/smt/djm/modifyDeptJobBx.cm'/>">
								<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
