...
function fn_egov_list_IndvdlSchdulManage(){
	location.href = "<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageList.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
...
<!--  상단타이틀 -->
<form:form modelAttribute="indvdlSchdulManageVO" name="indvdlSchdulManageVO" action="${pageContext.request.contextPath}/cop/smt/sim/EgovIndvdlSchdulManageModifyActor.cm" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_IndvdlSchdulManage(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageList.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
