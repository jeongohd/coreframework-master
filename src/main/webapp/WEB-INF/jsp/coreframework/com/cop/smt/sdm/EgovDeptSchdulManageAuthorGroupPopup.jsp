...
function fn_egov_search_MeetingManage(){
	...
	vFrom.action = "<c:url value='/uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopup.cm' />";
	vFrom.submit();
...
<div class="popup">
	...
	<form name="listForm" id="listForm" action="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageAuthorGroupPopup.cm'/>" method="post">
