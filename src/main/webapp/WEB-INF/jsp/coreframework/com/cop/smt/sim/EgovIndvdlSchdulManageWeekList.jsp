...
<HEAD>
	...
	******************************************************** */
	...
	function fnEgovSchdulSe(setValue) {
		location.href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageWeekList.cm' />?year=<%=iNowYear%>&month=<%=iNowMonth%>&week=<%=iNowWeek%>&searchCondition=SCHDUL_SE&searchKeyword=" + setValue;
	}

	function fnEgovSchdulTodate() {
		location.href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageWeekList.cm' />?searchCondition=SCHDUL_SE&searchKeyword=" + document.deptSchdulManageVO.schdulSe.value;
	}
...
<div class="sort_area">
	...
	<div class="date_view">
		<ul>
			...
			<li><a class="prev" href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageWeekList.cm' />?year=<%=iNowYear-1%>&amp;month=<%=iNowMonth%>&amp;week=<%=iNowWeek%>">prev</a></li>
			<li class="date"><%=iNowYear%> <spring:message code="comCopSmtSim.Navi.Year"/></li>
			<li><a class="next" href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageWeekList.cm' />?year=<%=iNowYear+1%>&amp;month=<%=iNowMonth%>&amp;week=<%=iNowWeek%>">next</a></li>
			<li class="date">&nbsp;</li>
			<%if(iNowMonth > 0 ){ %>
			<li><a class="prev" href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageWeekList.cm' />?year=<%=iNowYear%>&amp;month=<%=iNowMonth-1%>&amp;week=<%=0%>">prev</a></li>
			<%}%>
			<li class="date"><%=iNowMonth+1%> <spring:message code="comCopSmtSim.Navi.Month"/></li><!-- 월 -->
			<%if(iNowMonth < 11 ){ %>
			<li><a class="next" href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageWeekList.cm' />?year=<%=iNowYear%>&amp;month=<%=iNowMonth+1%>&amp;week=<%=0%>">next</a></li>
			<%}%>
			<li class="date">&nbsp;</li>
			<%if(iNowWeek > 0 ){ %>
			<li><a class="prev" href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageWeekList.cm' />?year=<%=iNowYear%>&month=<%=iNowMonth%>&week=<%=iNowWeek-1%>">prev</a></li>
			<%}%>
			<li class="date"><%=iNowWeek+1%> <spring:message code="comCopSmtSim.Navi.Week"/> </li><!-- 주 -->
			<%if(iNowWeek < listWeekGrop.size()-1 ){ %>
			<li><a class="next" href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageWeekList.cm' />?year=<%=iNowYear%>&month=<%=iNowMonth%>&week=<%=iNowWeek+1%>">next</a></li>
			<%}%>
