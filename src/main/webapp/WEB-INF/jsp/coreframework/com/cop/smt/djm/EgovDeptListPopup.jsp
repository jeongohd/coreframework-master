...
<!-- ------------------------------------------------------------------ iframe -->
<iframe id="DeptListView" src="<c:url value='/cop/smt/djm/selectDeptList.cm' />" width="100%" height="475px" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" title="부서 목록">
</iframe>
</DIV>
</body>
</html>
