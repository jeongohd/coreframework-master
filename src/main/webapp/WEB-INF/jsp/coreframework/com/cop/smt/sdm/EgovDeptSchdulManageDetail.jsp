...
function fn_egov_list_DeptSchdulManage(){
	...
	<c:if test="${sLinkType eq 'asm'}">
		location.href = "<c:url value='/cop/smt/asm/EgovAllSchdulManageList.cm' />";
	</c:if>
}
/* ********************************************************
 * 저장처리화면
...
function fn_egov_modify_DeptSchdulManage(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/cop/smt/sdm/EgovDeptSchdulManageModify.cm' />";;
	vFrom.submit();
...
<div class="wTableFrm">
	...
	<form name="DeptSchdulManageForm" id="DeptSchdulManageForm" action="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageModify.cm'/>" method="post" method="post" style="float:left;">
	...
	<form name="formDelete" action="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageDetail.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
	...
	<form name="formList" action="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageList.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
