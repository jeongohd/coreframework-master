...
function fn_egov_IndvdlSchdulManage(schdulId){
	window.showModalDialog("<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageDetail.cm' />?schdulId=" + schdulId , self ,"dialogWidth=800px;dialogHeight=500px;resizable=yes;center=yes");
}
</script>
