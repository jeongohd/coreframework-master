...
function fn_egov_init(){
	...
	//filebrowserUploadUrl: '${pageContext.request.contextPath}/utl/wed/insertImage.cm', // 파일 업로드를 처리 할 경로 설정.
	var ckeditor_config = {
...
<form:form modelAttribute="articleVO" action="${pageContext.request.contextPath}/cop/bbs/insertArticle.cm" method="post" onSubmit="fn_egov_regist_article(document.forms[0]); return false;" enctype="multipart/form-data">
<div class="wTableFrm">
	<!-- 타이틀 -->
