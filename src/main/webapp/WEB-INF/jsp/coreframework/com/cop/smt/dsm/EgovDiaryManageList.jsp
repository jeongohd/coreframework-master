...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/cop/smt/dsm/EgovDiaryManageList.cm'/>";
...
function fn_egov_regist_DiaryManage(){
	location.href = "<c:url value='/cop/smt/dsm/EgovDiaryManageRegist.cm' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_DiaryManage(diaryId){
	...
	vFrom.action = "<c:url value='/cop/smt/dsm/EgovDiaryManageDetail.cm' />";
	vFrom.submit();
}
...
<div class="board">
	...
	<form name="StplatListForm" action="<c:url value='/cop/smt/dsm/EgovDiaryManageList.cm'/>" method="post">
		<!-- 검색영역 -->
		<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
			<ul>
				...
				<li>
					...
					<span class="btn_b"><a href="<c:url value='/cop/smt/dsm/EgovDiaryManageRegist.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span><!-- 목록 -->
				</li>
			</ul>
		</div>
	...
	<tr>
		...
		<form name="subForm" method="post" action="<c:url value='/cop/smt/dsm/EgovDiaryManageDetail.cm'/>">
