...
<form:form modelAttribute="boardMasterVO" action="${pageContext.request.contextPath}/cop/bbs/insertBBSMaster.cm" method="post" onSubmit="fn_egov_regist_bbs(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/bbs/selectBBSMasterInfs.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
