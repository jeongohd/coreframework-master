...
function fn_egov_modify_DiaryManage(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/cop/smt/dsm/EgovDiaryManageModify.cm' />";;
	vFrom.submit();
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<form name="QustnrManageForm" action="<c:url value='/cop/smt/dsm/EgovDiaryManageModify.cm'/>" method="post" style="float:left;">
		...
		<form name="formDelete" action="<c:url value='/cop/smt/dsm/EgovDiaryManageDetail.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<form name="formList" action="<c:url value='/cop/smt/dsm/EgovDiaryManageList.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
