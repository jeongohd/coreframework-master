...
function fn_egov_list_LeaderSchdul(){
	...
	vFrom.action = "<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulList.cm' />";
	vFrom.submit();
}
/* ********************************************************
 * 저장처리화면
...
function modalDialogCallback(retVal) {
	if(retVal != null){
		...
		document.leaderSchdulVO.action = "<c:url value='/cop/smt/lsm/mng/addLeaderSchdul.cm' />";
...
function layerPopUp(){
       ...
       var page = "<c:url value='/cop/smt/lsm/selectEmplyrList.cm' />";
       var $dialog = $('<div></div>')
...
<form:form modelAttribute="leaderSchdulVO" action="${pageContext.request.contextPath}/cop/smt/lsm/mng/insertLeaderSchdul.cm" name="leaderSchdulVO" method="post">
...
<div class="wTableFrm">
		...
		<tr>
			...
			<td class="left">
			    <form:input path="leaderName"  readonly="true" maxlength="10" title="간부명" cssStyle="width:98px" />
			    	<a id="popupleaderName" title="<spring:message code="comCopSmtLsm.leaderSchdul.validate.leaderName" />"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" /></a>
			    <!-- 2018.07.19 추가 시작 -->
		...
		<tr>
			...
			<td class="left">
				<form:input path="schdulChargerName" size="15" readonly="true" maxlength="10" title="담당자명" cssStyle="width:98px"/>
					<a id="popupschdulChargerName" title="<spring:message code="comCopSmtLsm.leaderSchdul.validate.schdulChargerName" />"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" /></a>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulList.cm'/>" onclick="fn_egov_list_LeaderSchdul(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
