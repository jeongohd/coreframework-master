...
<script type="text/javascript">
	function fn_egov_regist_updtConfirmInf() {
		if (confirm('<spring:message code="common.update.msg" />')) {
			document.frm.action = "<c:url value='/cop/com/updateConfirmRequest.cm'/>";
			document.frm.submit();
		}
	}
	...
	function fn_egov_select_confirmList() {
		...
		if (target == '') {
			actionUrl = "<c:url value='/cop/com/selectConfirmRequest.cm'/>";
		} else {
			actionUrl = "<c:url value='/cop/com/selectConfirmRequestByTrget.cm'/>";
		}
...
<body>
<form name="frm" method="post" action="<c:url value='/cop/com/updateConfirmRequest.cm'/>">
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
		<h1>
	  		<img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목버튼이미지">&nbsp;승인정보수정
	  	</h1>
	  </td>
	 </tr>
	</table>
