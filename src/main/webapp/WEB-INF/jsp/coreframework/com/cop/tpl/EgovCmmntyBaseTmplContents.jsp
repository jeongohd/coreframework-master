...
td.rightGap {background:url(<c:url value='/images/coreframework/com/cop/tpl/right_gap.gif'/>) }
</style>
<c:choose>
...
<!--
	function fn_egov_loadArticleList(bbsId, bbsTyCode) {
		...
		location.href="<c:url value='/cop/bbs/selectBoardList.cm' />?bbsId="+bbsId+"&bbsTyCode="+bbsTyCode;
	}
	...
	<tr>
		<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
						...
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[0].bbsId}" />','<c:out value="${bbsList[0].bbsTyCode}" />');"><img src="<c:url value='/images/coreframework/com/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100%" class="rightGap"><img src="<c:url value='/images/coreframework/com/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" /></td>
								<td><img src="<c:url value='/images/coreframework/com/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" /></td>
							</tr>
							<tr>
								<td height="9" class="rightGap"><img src="<c:url value='/images/coreframework/com/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지"/></td>
				...
				<td align="center"><img src="<c:url value='/images/coreframework/com/cop/tpl/gray_white.gif' />" width="20" height="23" alt="여백이미지" /></td>
					...
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[1].bbsId}" />','<c:out value="${bbsList[1].bbsTyCode}" />');"><img src="<c:url value='/images/coreframework/com/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
					...
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[2].bbsId}" />','<c:out value="${bbsList[2].bbsTyCode}" />');"><img src="<c:url value='/images/coreframework/com/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
					...
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[3].bbsId}" />','<c:out value="${bbsList[3].bbsTyCode}" />');"><img src="<c:url value='/images/coreframework/com/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
