...
<!--
	function fn_egov_loadArticleList(bbsId, bbsAttrbCode) {
		...
		location.href="<c:url value='/cop/bbs/selectArticleList.cm' />?bbsId="+bbsId+"&bbsAttrbCode="+bbsAttrbCode;
	}

	function fn_egov_loadArticle(bbsId, nttId) {
		document.frm.nttId.value = nttId;
		document.frm.bbsId.value = bbsId;
		document.frm.action = "<c:url value='/cop/bbs/selectArticleDetail.cm' />";
		document.frm.submit();
	}
//-->
</script>
