...
function fn_egov_select_linkPage(pageNo){
	...
	document.BBSMasterForm.action = "<c:url value='/cop/bbs/selectBBSMasterInfs.cm'/>";
...
function fn_egov_inquire_bbsdetail(bbsId) {
	...
	document.BBSMasterForm.bbsId.value = bbsId;
  	document.BBSMasterForm.action = "<c:url value='/cop/bbs/selectBBSMasterDetail.cm'/>";
  	document.BBSMasterForm.submit();
}
</script>
</head>
...
<form name="BBSMasterForm" action="<c:url value='/cop/bbs/selectBBSMasterInfs.cm'/>" method="post" onSubmit="fn_egov_search_bbssj(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/cop/bbs/insertBBSMasterView.cm?cmmntyId=${searchVO.cmmntyId}' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/cop/bbs/selectBBSMasterDetail.cm?bbsId=${resultInfo.bbsId}'/>" onClick="fn_egov_inquire_bbsdetail('<c:out value="${resultInfo.bbsId}"/>');return false;"><c:out value='${fn:substring(resultInfo.bbsNm, 0, 40)}'/></a></td>
