...
<form:form modelAttribute="blogMasterVO" action="${pageContext.request.contextPath}/cop/bbs/insertBlogMaster.cm" method="post" onSubmit="fn_egov_regist_blog(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/bbs/selectBlogList.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
