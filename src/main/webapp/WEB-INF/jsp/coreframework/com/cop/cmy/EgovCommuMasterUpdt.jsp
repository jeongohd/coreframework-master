...
function fn_egov_inqire_commulist() {
	commuMasterVO.action = "<c:url value='/cop/cmy/selectCommuMasterList.cm'/>";
...
<!-- 상단타이틀 -->
<form:form modelAttribute="commuMasterVO" action="${pageContext.request.contextPath}/cop/cmy/updateCommuMaster.cm" method="post" onSubmit="fn_egov_updt_commu(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/cmy/selectCommuMasterList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
