...
<script type="text/javascript">
	...
	function fn_egov_update_memoreprt() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.memoReprtVO.action = "<c:url value='/cop/smt/mrm/updateMemoReprt.cm'/>";
	...
	function fn_egov_list_memoreprt(){
		document.memoReprtVO.action = "<c:url value='/cop/smt/mrm/selectMemoReprtList.cm'/>";
		document.memoReprtVO.submit();
	}
	...
	******************************************************** */
	function fn_egov_reportr_MemoReprt(strTitle, frmUniqId, frmEmplNo, frmEmplyrNm, frmOrgnztNm){
		...
		arrParam[5] = frmOrgnztNm;
	 	...
	 	window.showModalDialog("<c:url value='/cop/smt/mrm/selectReportrListPopup.cm' />", arrParam,"dialogWidth=800px;dialogHeight=500px;resizable=yes;center=yes");
	}
</script>
</head>
...
<form:form modelAttribute="memoReprtVO" name="memoReprtVO" method="post" action="${pageContext.request.contextPath}/cop/smt/mrm/updateMemoReprt.cm' />" enctype="multipart/form-data">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a href="<c:url value='/cop/smt/mrm/selectReportrListPopup.cm' />" target="_blank"  title="새 창으로 이동"  onclick="fn_egov_reportr_MemoReprt('보고대상', 'reportrId', '', 'reportrNm', '');return false;">
				<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />" alt="보고대상 검색" title="보고대상 검색"/>
				</a>
