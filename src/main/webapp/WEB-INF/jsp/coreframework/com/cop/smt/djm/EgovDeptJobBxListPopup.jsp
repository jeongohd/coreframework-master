...
function fn_egov_init_deptjobbx(){
	...
	var urlGo = "<c:url value='/cop/smt/djm/selectDeptJobBxList.cm' />?popupCnd=Y&deptId=" + opener[2];
...
<!-- ------------------------------------------------------------------ iframe -->
<iframe id="DeptJobBxListView" src="<c:url value='/cop/smt/djm/selectDeptJobBxList.cm' />?popupCnd=Y" width="100%" height="475px" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" title="부서업무함 목록">
</iframe>
</DIV>
</body>
</html>
