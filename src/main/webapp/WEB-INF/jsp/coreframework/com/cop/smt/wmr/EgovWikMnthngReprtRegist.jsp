 ...
 ******************************************************** */
	function fn_egov_insert_wikmnthngreprt() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.wikMnthngReprtVO.action = '<c:url value="/cop/smt/wmr/insertWikMnthngReprt.cm"/>';
...
<form:form modelAttribute="wikMnthngReprtVO" name="wikMnthngReprtVO" method="post" action="${pageContext.request.contextPath}/cop/smt/wmr/insertWikMnthngReprt.cm' />" enctype="multipart/form-data">
