...
<script type="text/javascript">
	...
	function fn_egov_modify_wikmnthngreprt() {
		document.wikMnthngReprtVO.action = "<c:url value='/cop/smt/wmr/modifyWikMnthngReprt.cm'/>";
	...
	function fn_egov_delete_wikmnthngreprt(){
		if(confirm("<spring:message code="common.delete.msg"/>")){/* 삭제 하시겠습니까? */
			document.wikMnthngReprtVO.action = "<c:url value='/cop/smt/wmr/deleteWikMnthngReprt.cm'/>";
			document.wikMnthngReprtVO.submit();
		}
	}
	...
	function fn_egov_confirm_wikmnthngreprt(){
		if(confirm("<spring:message code="common.acknowledgement.msg"/>")){/* 승인 하시겠습니까? */
			document.wikMnthngReprtVO.action = "<c:url value='/cop/smt/wmr/confirmWikMnthngReprt.cm'/>";
			document.wikMnthngReprtVO.submit();
		}
	}
...
<form:form modelAttribute="wikMnthngReprtVO" name="wikMnthngReprtVO" method="post" action="${pageContext.request.contextPath}/cop/smt/wmr/modifyWikMnthngReprt.cm' />">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/smt/wmr/deleteWikMnthngReprt.cm'/>?reprtId=<c:out value='${wikMnthngReprtVO.reprtId}'/>" onclick="fn_egov_delete_wikmnthngreprt(); return false;"><spring:message code="button.delete" /></a></span>
		</c:if>
