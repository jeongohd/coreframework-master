...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/cop/smt/sdm/EgovDeptSchdulManageList.cm'/>";
...
function fn_egov_regist_DeptSchdulManage(){
	location.href = "<c:url value='/cop/smt/sdm/EgovDeptSchdulManageRegist.cm' />";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
function fn_egov_modify_DeptSchdulManage(){
	location.href = "<c:url value='/cop/smt/sdm/EgovDeptSchdulManageModify.cm' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
...
function fn_egov_search_DeptSchdulManage(){
	...
	vFrom.action = "<c:url value='/cop/smt/sdm/EgovDeptSchdulManageListPopup.cm' />";
	vFrom.submit();
...
<form name="StplatListForm" action="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageListPopup.cm'/>" method="post">
<div class="board">
	<h1>${pageTitle}</h1>
	<!-- 검색영역 -->
