...
<script type="text/javascript">
	...
	function fn_egov_insert_memoreprt() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.memoReprtVO.action = "<c:url value='/cop/smt/mrm/insertMemoReprt.cm'/>";
...
<form:form modelAttribute="memoReprtVO" name="memoReprtVO" method="post" action="${pageContext.request.contextPath}/cop/smt/mrm/insertMemoReprt.cm' />" enctype="multipart/form-data">
