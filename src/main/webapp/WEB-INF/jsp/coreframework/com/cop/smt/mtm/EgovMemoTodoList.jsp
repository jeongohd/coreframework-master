...
<script type="text/javascript">
	...
	function fn_egov_select_memotodo(pageNo) {
		...
		document.frm.action = "<c:url value='/cop/smt/mtm/selectMemoTodoList.cm'/>";
	...
	function fn_egov_select_memotoday() {
		document.frm.action = "<c:url value='/cop/smt/mtm/selectMemoTodoListToday.cm'/>";
		document.frm.submit();
	}
	/* ********************************************************
	 * 메모할일 상세조회로 가기
	...
	function fn_egov_inqire_memotodo(todoId) {
		...
		document.frm.action = "<c:url value='/cop/smt/mtm/selectMemoTodo.cm'/>";
		document.frm.submit();
	}
	/* ********************************************************
	 * 메모할일 등록 가기
	...
	function fn_egov_insert_memotodo(){
		document.frm.action = "<c:url value='/cop/smt/mtm/addMemoTodo.cm'/>";
		document.frm.submit();
	}
	/* ********************************************************
	 * 셀렉트박스 초기화 
...
<div class="board">
	...
	<form name="frm" method="post" action="<c:url value='/cop/smt/mtm/selectMemoTodoList.cm'/>">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/cop/smt/mtm/selectMemoTodoListToday.cm'/>" onclick="fn_egov_select_memotoday(); return false;" title="<spring:message code="comCopSmtMtm.memoTodoList.toDoListToday"/>"><spring:message code="comCopSmtMtm.memoTodoList.toDoListToday"/></a></span><!-- 오늘의 할일 -->
				...
				<span class="btn_b"><a href="<c:url value='/cop/smt/mtm/addMemoTodo.cm'/>" onclick="fn_egov_insert_memotodo('1'); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	</form>
		...
		<tbody>
			<c:forEach var="result" items="${resultList}" varStatus="status">
			  <tr>
			    ...
			    <td>
			     <form name="memoReprtVO" method="post" action="<c:url value='/cop/smt/mtm/selectMemoTodo.cm'/>">
			    	<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
