...
function fn_egov_select_linkPage(pageNo){
	...
	document.articleForm.action = "<c:url value='/cop/bbs/selectArticleList.cm'/>";
...
function fn_egov_inquire_articledetail(bbsId, nttId) {
	...
	document.articleForm.nttId.value = nttId;
  	document.articleForm.action = "<c:url value='/cop/bbs/selectArticleDetail.cm'/>";
  	document.articleForm.submit();
}
</script>
</c:otherwise>
...
<div class="board">
	<form name="articleForm" action="<c:url value='/cop/bbs/selectArticleList.cm'/>" method="post" onSubmit="fn_egov_search_article(); return false;">
		...
		<ul>
			...
			<li>
				...
				<c:if test="${preview != 'true'}">
					<span class="btn_b"><a href="<c:url value='/cop/bbs/insertArticleView.cm?bbsId=${boardMasterVO.bbsId}' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span><!-- 등록 -->
				</c:if>
			</li>
		</ul>
	</div>
	...
	<tr>
		<td><img src="<c:url value='/images/coreframework/com/cop/bbs/icon_notice.png'/>" alt="notice"></td>
		<td class="bold">
			<form name="subForm" method="post" action="<c:url value='/cop/bbs/selectArticleDetail.cm'/>">
	...
	<c:choose>
		...
		<img src="<c:url value='/images/coreframework/com/cop/bbs/icon_lock.png'/>" alt="secret">&nbsp;<c:out value='${fn:substring(resultInfo.nttSj, 0, 40)}'/>
	...
	<!-- 
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/cop/bbs/insertBBSMasterView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
	</div>
	-->
