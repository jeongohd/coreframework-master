 ...
 ******************************************************** */
 function fn_egov_delete_commu(cmmntyId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.CommuMasterForm.action = "<c:url value='/cop/cmy/deleteCommuMaster.cm'/>";
...
<form name="CommuMasterForm" action="<c:url value='/cop/cmy/updateCommuMasterView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="5" class="cnt">
			<a href="<c:url value='/cop/cmy/cmmntyMain.cm?cmmntyId=${result.cmmntyId}' />">/cop/cmy/cmmntyMain.cm?cmmntyId=${result.cmmntyId }</a>
			</td>
		</tr>
		</c:if>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/cmy/selectCommuMasterList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
