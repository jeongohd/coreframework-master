...
<form:form modelAttribute="articleVO" action="${pageContext.request.contextPath}/cop/bbs/replyArticle.cm" method="post" onSubmit="fn_egov_reply_article(document.forms[0]); return false;" enctype="multipart/form-data">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<tbody>
		...
		<tr>
			...
			<td class="nopd" colspan="3">
				...
				<ckeditor:replace replace="nttCn" basePath="${pageContext.request.contextPath}/html/coreframework/com/cmm/utl/ckeditor/" />
