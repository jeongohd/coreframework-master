...
<script type="text/javascript" src="<c:url value='/js/coreframework/com/cmm/utl/CoreCmmUtl.js' />"></script>
...
<script type="text/javascript">
	function fn_egov_update_wikmnthngreprt() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.wikMnthngReprtVO.action = "<c:url value='/cop/smt/wmr/updateWikMnthngReprt.cm'/>";
 ...
 ******************************************************** */
	function fn_egov_list_wikmnthngreprt(){
		document.wikMnthngReprtVO.action = "<c:url value='/cop/smt/wmr/selectWikMnthngReprtList.cm'/>";
		document.wikMnthngReprtVO.submit();
	}
...
******************************************************** */
	function fn_egov_reportr_WikMnthngReprt(strTitle, frmUniqId, frmEmplNo, frmEmplyrNm, frmOrgnztNm){
		...
		arrParam[5] = frmOrgnztNm;
	 	...
	 	window.showModalDialog("<c:url value='/cop/smt/wmr/selectReportrListPopup.cm' />", arrParam,"dialogWidth=800px;dialogHeight=500px;resizable=yes;center=yes");
	}
/* ********************************************************
 * 달력
 ******************************************************** */
...
<form:form modelAttribute="wikMnthngReprtVO" name="wikMnthngReprtVO" method="post" action="${pageContext.request.contextPath}/cop/smt/wmr/updateWikMnthngReprt.cm' />" enctype="multipart/form-data">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a href="<c:url value='/cop/smt/wmr/selectReportrListPopup.cm' />" target="_blank"  title="새 창으로 이동"  onclick="fn_egov_reportr_WikMnthngReprt('보고대상자', 'reportrId', '', 'reportrNm', '');return false;">
					<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />" alt="보고대상자 검색" title="보고대상자 검색" />
				</a>
