...
function fnDelete(){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		document.detailForm.action = "<c:url value='/cop/ems/deleteSndngMail.cm'/>";
 ...
 ******************************************************** */
function fnBack(){
	document.detailForm.action = "<c:url value='/cop/ems/backSndngMailDetail.cm'/>";
	document.detailForm.target = "";
	document.detailForm.submit();
}
...
function fnSelectXml(){
	document.detailForm.action = "<c:url value='/cop/ems/selectSndngMailXml.cm'/>";
...
<h2><spring:message code="comCopSymEms.regist.title" /> <spring:message code="title.detail" /></h2>
	...
	<tr>
		...
		<td class="left">
		<c:import url="/cmm/fms/selectFileInfs.cm" >
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/ems/deleteSndngMail.cm'/>" onClick="fnDelete(); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/cop/ems/selectSndngMailList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
