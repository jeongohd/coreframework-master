...
function fn_egov_delete_ncrdInf(){
	if (confirm('<spring:message code="common.delete.msg" />')) {
		document.nameCard.action = "<c:url value='/cop/ncm/deleteNcrdInf.cm'/>?ncrdId=<c:out value='${ncrdVO.ncrdId}'/>";
...
<div class="board">
	...
	<!-- 하단 버튼 --> 
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/cop/ncm/selectNcrdInfs.cm'/>"><spring:message code='button.list' /></a></span> <!-- 목록 -->
		<span class="btn_s"><a href="<c:url value='/cop/ncm/deleteNcrdInf.cm'/>?ncrdId=<c:out value='${ncrdVO.ncrdId}'/>" onclick="fn_egov_delete_ncrdInf(); return false;"><spring:message code="button.delete" /></a></span><!-- 삭제 -->
	</div>
</div>
