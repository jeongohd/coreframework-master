...
function fn_egov_select_linkPage(pageNo){
	...
	document.CommuMasterForm.action = "<c:url value='/cop/cmy/selectCommuMasterList.cm'/>";
...
function fn_egov_inquire_commudetail(cmmntyId) {
	...
	document.CommuMasterForm.cmmntyId.value = cmmntyId;
  	document.CommuMasterForm.action = "<c:url value='/cop/cmy/selectCommuMasterDetail.cm'/>";
  	document.CommuMasterForm.submit();
}
</script>
</head>
...
<form name="CommuMasterForm" action="<c:url value='/cop/cmy/selectCommuMasterList.cm'/>" method="post" onSubmit="fn_egov_search_commu(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/cop/cmy/insertCommuMasterView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/cop/cmy/selectCommuMasterDetail.cm'/>?cmmntyId=${resultInfo.cmmntyId}" onClick="fn_egov_inquire_commudetail('<c:out value="${resultInfo.cmmntyId}"/>');return false;"><c:out value='${fn:substring(resultInfo.cmmntyNm, 0, 40)}'/></a></td>
	...
	<!-- 
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/cop/cmy/insertCommuMasterView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
	</div>
	-->
