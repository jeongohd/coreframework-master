...
<script type="text/javascript">
	...
	function fn_egov_select_tmplatInfo(pageNo){
		...
		document.frm.action = "<c:url value='/cop/tpl/selectTemplateInfsPop.cm'/>";
		document.frm.submit();
	}
...
<body>
<form name="frm" action ="<c:url value='/cop/tpl/selectTemplateInfsPop.cm'/>" method="post">
<input type="hidden" name="tmplatId" value="" />
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="40%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;템플릿 목록
	  	</h1>
	  </td>
	  <th >
	  </th>
