...
<script type="text/javascript">
	function fn_egov_returnUserInfo(uniqId) {
		...
		document.frm.action = "<c:url value='/cop/cmy/deleteCmmntyUserBySelf.cm'/>";
		document.frm.submit();
	}
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	   <img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle" alt="제목버튼이미지">
	   &nbsp;승인자 선택</td>
	 </tr>
	</table>
