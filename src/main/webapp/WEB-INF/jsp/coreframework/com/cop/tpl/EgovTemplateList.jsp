...
<script type="text/javascript">
	...
	function fn_egov_insert_addTmplatInfo(){
		document.frm.action = "<c:url value='/cop/tpl/addTemplateInf.cm'/>";
		document.frm.submit();
	}

	function fn_egov_select_tmplatInfo(pageNo){
		document.frm.pageIndex.value = pageNo;
		document.frm.action = "<c:url value='/cop/tpl/selectTemplateInfs.cm'/>";
		document.frm.submit();
	}

	function fn_egov_inqire_tmplatInfor(tmplatId){
		document.frm.tmplatId.value = tmplatId;
		document.frm.action = "<c:url value='/cop/tpl/selectTemplateInf.cm'/>";
		document.frm.submit();
	}
</script>
</head>
	...
	<table class="board_list" summary="">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="<c:url value='/cop/tpl/selectTemplateInf.cm'/>?tmplatId=<c:out value='${result.tmplatId}'/>" onclick="">
