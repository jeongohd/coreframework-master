...
<script type="text/javascript">
	...
	function fn_egov_insert_deptjob() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.deptJobVO.action = "<c:url value='/cop/smt/djm/insertDeptJob.cm'/>";
...
<form:form modelAttribute="deptJobVO" name="deptJobVO" method="post" action="${pageContext.request.contextPath}/cop/smt/djm/insertDeptJob.cm' />" enctype="multipart/form-data">
