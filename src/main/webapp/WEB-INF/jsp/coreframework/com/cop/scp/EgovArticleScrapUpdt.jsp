...
<script type="text/javascript">
	...
	function fn_egov_inqire_articleScrapList() {
		articleScrapVO.action = "<c:url value='/cop/scp/selectArticleScrapList.cm'/>";
...
<body onLoad="fn_egov_init();">
	...
	<!-- 상단타이틀 -->
	<form:form modelAttribute="articleScrapVO" action="${pageContext.request.contextPath}/cop/scp/updateArticleScrap.cm" method="post"	onSubmit="fn_egov_updt_articleScrap(document.forms[0]); return false;">
		<div class="wTableFrm">
			<h2>${pageTitle}
			...
			<div class="btn">
				...
				<span class="btn_s"><a href="<c:url value='/cop/scp/selectArticleScrapList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span></div><!-- 목록 -->
