...
<%@ page import="coreframework.com.cmm.CoreWebUtil" %>
<%@ page import="coreframework.com.cmm.CoreWebUtil" %>
...
sLinkType = CoreWebUtil.clearXSSMaximum(sLinkType);
%>
...
function fn_egov_diary_IndvdlSchdulManage(frm){
	var vFrom = frm;
	//vFrom.cmd.value = '';
	//vFrom.action = "<c:url value='/cop/smt/dsm/EgovDiaryManageList.cm' />";;
	vFrom.submit();
}
/* ********************************************************
 * 목록 으로 가기
...
function fn_egov_list_IndvdlSchdulManage(){
	...
	<c:if test="${sLinkType eq 'asm'}">
		location.href = "<c:url value='/cop/smt/sam/EgovAllSchdulManageList.cm' />";
	</c:if>
}
/* ********************************************************
 * 저장처리화면
...
function fn_egov_modify_IndvdlSchdulManage(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageModify.cm' />";;
	vFrom.submit();
...
function fn_egov_delete_IndvdlSchdulManage(frm){
	...
	if(confirm("<spring:message code="common.delete.msg" />")){	
		//vFrom.cmd.value = 'del';
		//vFrom.action = "<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageDetail.cm' />";
		vFrom.submit();
	}else{
		vFrom.cmd.value = '';
	}
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<form name="IndvdlSchdulManageForm" id="IndvdlSchdulManageFormh" action="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageModify.cm'/>" method="post" style="float:left;">
		...
		<form name="formDelete" action="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageDetail.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<form name="formSubDiaryManage" action="<c:url value='/cop/smt/dsm/EgovDiaryManageList.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<form name="formList" action="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageList.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
