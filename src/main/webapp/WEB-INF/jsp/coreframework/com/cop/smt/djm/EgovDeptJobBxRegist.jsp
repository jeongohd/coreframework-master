...
<script type="text/javascript">
	...
	function fn_egov_regist_deptjobbx() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.deptJobBxVO.action = "<c:url value='/cop/smt/djm/insertDeptJobBx.cm'/>";
...
<form:form modelAttribute="deptJobBxVO" name="deptJobBxVO" method="post" action="${pageContext.request.contextPath}/cop/smt/djm/insertDeptJobBx.cm' />">
