...
<script type="text/javascript">
	function fn_egov_select_ncrdInfs(){
		document.nameCard.action = "<c:url value='/cop/ncm/selectMyNcrdUseInf.cm'/>";
	...
	function fn_egov_updt_ncrdInf(){
		...
		if (confirm('<spring:message code="common.update.msg" />')) {
			document.nameCard.action = "<c:url value='/cop/ncm/updateNcrdInf.cm'/>";
			document.nameCard.submit();
		}
	}
	...
	function fn_egov_inqire_user(){
		var retVal;
		var url = "<c:url value='/cop/com/openPopup.cm?requestUrl=/cop/com/selectUserList.cm&width=850&height=360'/>";
...
<input type="hidden" name="zip_url" value="<c:url value='/sym/ccm/zip/EgovCcmZipSearchPopup.cm'/>" />
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left" colspan="3">
				...
				<a href="#LINK" onclick="fn_egov_ZipSearch(document.nameCard, document.nameCard.v_zipCode, document.nameCard.zipCode, document.nameCard.adres)" style="selector-dummy: expression(this.hideFocus=false);"><img alt="검색" src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />" /></a><br />
