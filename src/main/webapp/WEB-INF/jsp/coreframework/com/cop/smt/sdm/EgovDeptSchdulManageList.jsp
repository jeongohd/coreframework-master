...
return;
	...
	if(objArr == 0){
		document.getElementById("SchdulView").src="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageMonthList.cm' />";
		document.getElementById("tabMenu0").bgColor = '#BBBBBB';
	}else if(objArr == 1){
		document.getElementById("SchdulView").src="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageWeekList.cm' />";
		document.getElementById("tabMenu1").bgColor = '#BBBBBB';
	}else if(objArr == 2){
		document.getElementById("SchdulView").src="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageDailyList.cm' />";
