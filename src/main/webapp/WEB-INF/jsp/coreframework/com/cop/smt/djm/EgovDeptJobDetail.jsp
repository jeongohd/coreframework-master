...
<script type="text/javascript">
	...
	function fn_egov_modify_deptjob() {
		document.deptJobVO.action = "<c:url value='/cop/smt/djm/modifyDeptJob.cm'/>";
		document.deptJobVO.submit();
	}

	function fn_egov_delete_deptjob(){
		if(confirm("<spring:message code="common.delete.msg"/>")){/* 삭제하시겠습니까? */
			document.deptJobVO.action = "<c:url value='/cop/smt/djm/deleteDeptJob.cm'/>";
			document.deptJobVO.submit();
		}
	}
	...
	******************************************************** */
	function fn_egov_charger_DeptJob(strType){
		...
		arrParam[1] = strType;
	 	...
	 	window.showModalDialog("<c:url value='/uss/ion/ism/selectSanctnerListPopup.cm' />", arrParam,"dialogWidth=800px;dialogHeight=500px;resizable=yes;center=yes");
	}
</script>
</head>
...
<form:form modelAttribute="deptJobVO" name="deptJobVO" method="post" action="${pageContext.request.contextPath}/cop/smt/djm/modifyDeptJob.cm" >
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				<c:import charEncoding="utf-8" url="/cmm/fms/selectFileInfs.cm" >
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/smt/djm/deleteDeptJob.cm'/>?deptJobId=<c:out value='${deptJobVO.deptJobId}'/>" onclick="fn_egov_delete_deptjob(); return false;"><spring:message code="button.delete" /></a></span>
