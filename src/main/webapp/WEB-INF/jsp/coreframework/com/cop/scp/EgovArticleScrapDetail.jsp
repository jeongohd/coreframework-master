...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<form name="articleScrapForm" action="<c:url value='/cop/scp/updateArticleScrapView.cm'/>" method="post" style="float:left;">
		...
		<form name="formDelete" action="<c:url value='/cop/scp/deleteArticleScrap.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<form name="formList" action="<c:url value='/cop/scp/selectArticleScrapList.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
