...
<script type="text/javascript">
	function fn_egov_updt_bbsUseInf(){
		...
		document.boardUseInf.action = "<c:url value='/cop/com/updateBBSUseInf.cm'/>";
...
<body>
<form name="boardUseInf" method="post" action="<c:url value='/cop/com/updateBBSUseInf.cm'/>">
...
<div id="border" style="width:730px">
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;게시판 사용정보 수정
	  	</h1>
	  </td>
	 </tr>
	</table>
	...
	<tr>
      ...
      <a href="<c:url value='/cop/com/updateBBSUseInf.cm'/>" onclick="fn_egov_updt_bbsUseInf(); return false;">수정</a>
      </span></td>
      <td width="10"></td>
      <td><span class="button">
      <a href="<c:url value='/cop/com/selectBBSUseInfs.cm'/>" onclick="fn_egov_select_bbsUseInfs(); return false;">목록</a>
      </span></td>
	</tr>
	</table>
	</div>
