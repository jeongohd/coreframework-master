...
<script type="text/javascript">
	...
	function fn_egov_select_linkPage(pageNo){
		...
		document.frm.action = "<c:url value='/cop/smt/wmr/selectWikMnthngReprtList.cm'/>";
	   	document.frm.submit();
	}
	...
	function fn_egov_inqire_wikmnthngreprt(reprtId) {
		...
		document.frm.action = "<c:url value='/cop/smt/wmr/selectWikMnthngReprt.cm'/>";
		document.frm.submit();
	}

	function fn_egov_insert_wikmnthngreprt(){
		document.frm.action = "<c:url value='/cop/smt/wmr/addWikMnthngReprt.cm'/>";
		document.frm.submit();
	}
/* ********************************************************
 * 달력
...
<div class="board">
<form name="frm" method="post" action="<c:url value='/cop/smt/wmr/selectWikMnthngReprtList.cm'/>">
		...
		<tbody>
			<c:forEach var="result" items="${resultList}" varStatus="status">
			  <tr>
			    ...
			    <td>
			     <form name="wikMnthngReprtVO" method="post" action="<c:url value='/cop/smt/wmr/selectWikMnthngReprt.cm'/>">
			    	<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
