...
<script type="text/javascript">
	...
	function fn_egov_select_bbsUseInfs(pageNo) {
		...
		document.frm.action = "<c:url value='/cop/com/selectCmyBBSUseInfsByTrget.cm'/>";
		document.frm.submit();
	}
	...
	function fn_egov_update_bbsUseInf(bbsId, trgetId) {
		if (confirm('<spring:message code="cop.use.msg" />')) {
			...
			document.frm.action = "<c:url value='/cop/com/updateBBSUseInfByTrget.cm'/>";
			document.frm.submit();
		}
	}
	...
	function fn_egov_insert_bbsUseInf(bbsId, trgetId) {
		if (confirm('<spring:message code="cop.use.msg" />')) {
			...
			document.frm.param_trgetId.value = trgetId;
			document.frm.useAt.value = 'Y';
			document.frm.action = "<c:url value='/cop/com/insertBBSUseInfByTrget.cm'/>";
			document.frm.submit();
		}
	}
</script>
...
<body>
<form name="frm" method="post" action="<c:url value='/cop/com/selectCmyBBSUseInfsByTrget.cm'/>">
