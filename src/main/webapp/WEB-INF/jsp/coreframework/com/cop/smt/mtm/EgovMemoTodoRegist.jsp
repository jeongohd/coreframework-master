...
<script type="text/javascript">
	...
	function fn_egov_insert_memotodo() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.memoTodoVO.action = "<c:url value='/cop/smt/mtm/insertMemoTodo.cm'/>";
...
<form:form modelAttribute="memoTodoVO" name="memoTodoVO" method="post" action="${pageContext.request.contextPath}/cop/smt/mtm/insertMemoTodo.cm' />">
