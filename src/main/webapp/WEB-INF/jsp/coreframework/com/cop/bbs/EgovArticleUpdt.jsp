	...
	<form:form modelAttribute="articleVO" action="${pageContext.request.contextPath}/cop/bbs/updateArticle.cm" method="post" onSubmit="fn_egov_updt_article(document.forms[0]); return false;" enctype="multipart/form-data">
		<div class="wTableFrm">
				...
				<tbody>
					...
					<c:if test="${boardMasterVO.fileAtchPosblAt == 'Y'}">
						...
						<tr>
							<th>${title}</th>
							<td class="nopd" colspan="3">
								<c:import url="/cmm/fms/selectFileInfsForUpdate.cm" charEncoding="utf-8">
			...
			<div class="btn">
				...
				<span class="btn_s"><a href="<c:url value='/cop/bbs/selectArticleList.cm' />?bbsId=${boardMasterVO.bbsId}"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
			</div>
