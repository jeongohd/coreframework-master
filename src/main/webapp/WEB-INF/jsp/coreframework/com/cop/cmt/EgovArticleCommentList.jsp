...
<!-- 댓글 내용  -->
	...
	<form:form modelAttribute="articleCommentVO" action="${pageContext.request.contextPath}/cop/cmt/insertArticleComment.cm" method="post" onSubmit="fn_egov_insert_commentList(); return false;" style="float:left; clear:both;">
	<div class="wTableFrm" >
