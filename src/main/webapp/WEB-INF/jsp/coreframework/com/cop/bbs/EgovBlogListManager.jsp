...
<form name="BlogMasterForm" action="<c:url value='/cop/bbs/selectBlogListManager.cm' />" method="post" onSubmit="fn_egov_search_blog(); return false;">
<div class="board">
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/cop/bbs/selectBBSMasterDetail.cm'/>?bbsId=${resultInfo.bbsId}&blogId=${resultInfo.blogId}" return false;"><c:out value='${fn:substring(resultInfo.bbsNm, 0, 40)}'/></a></td>
