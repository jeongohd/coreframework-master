...
<script type="text/javascript">
	...
	function fn_egov_select_memoreprt(pageNo) {
		...
		document.frm.action = "<c:url value='/cop/smt/mrm/selectMemoReprtList.cm'/>";
	...
	function fn_egov_inqire_memoreprt(reprtId) {
		...
		document.frm.action = "<c:url value='/cop/smt/mrm/selectMemoReprt.cm'/>";
		document.frm.submit();
	}
	/* ********************************************************
	 * 메모보고 등록으로 가기
	...
	function fn_egov_insert_memoreprt(){
		document.frm.action = "<c:url value='/cop/smt/mrm/addMemoReprt.cm'/>";
		document.frm.submit();
	}
</script>
</head>
...
<div class="board">
	...
	<form name="frm" method="post" action="<c:url value='/cop/smt/mrm/selectMemoReprtList.cm'/>">
		...
		<tbody>
			<c:forEach var="result" items="${resultList}" varStatus="status">
			  <tr>
			    ...
			    <td>
			     <form name="memoReprtVO" method="post" action="<c:url value='/cop/smt/mrm/selectMemoReprt.cm'/>">
			    	<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
