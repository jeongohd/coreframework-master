...
<script type="text/javascript">
	...
	function fn_egov_select_leadersttus(pageNo) {
		...
		document.frm.action = "<c:url value='/cop/smt/lsm/usr/selectLeaderSttusList.cm'/>";
		document.frm.submit();	
	}
...
<div id="border" style="width:730px">
	...
	<form name="frm" method="post" action="<c:url value='/cop/smt/lsm/usr/selectLeaderSttusList.cm'/>">
	...
	<tbody>
	 <tr>
	  <td width="40%" class="title_left">
	   <h1><img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;간부상태 목록</h1></td>
		<td width="25%" >
