...
<script type="text/javascript">
	...
	function fn_egov_regist_adbkInf(form){
		...
		if(confirm("<spring:message code="common.regist.msg" />")){
			document.adbk.action = "<c:url value='/cop/adb/RegistAdbkInf.cm'/>";
	...
	function fn_egov_inqire_user(){
		...
		var retVal;
		var url = "<c:url value='/cop/adb/openPopup.cm?requestUrl=/cop/adb/selectManList.cm&width=750&height=800'/>";
...
<form name="adbk" action="${pageContext.request.contextPath}/cop/adb/RegistAdbkInf.cm"  method="post" onSubmit="fn_egov_regist_adbkInf(document.forms[0]); return false;">
