...
function fn_egov_list_DiaryManage(){
	location.href = "<c:url value='/cop/smt/dsm/EgovDiaryManageList.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
 ...
 ******************************************************** */
 function fn_egov_Schdule_DiaryManage(){
	...
	fn_egov_popup("DEPT_DIARY_POPUP","<c:url value='/cop/smt/sdm/EgovDeptSchdulManageListPopup.cm' />",800,580);
...
<form:form modelAttribute="diaryManageVO"  action="${pageContext.request.contextPath}/cop/smt/dsm/EgovDiaryManageRegistActor.cm" name="deptSchdulManageVO" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_DiaryManage(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<tbody>
		...
		<tr>
			...
			<td class="left">
			   ...
			   <a href="#" onClick="fn_egov_Schdule_DiaryManage()"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt=<spring:message code="comCopSmtDsm.registBtn.schdulCn"/> title="<spring:message code="comCopSmtDsm.registBtn.schdulCn"/>"></a>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/smt/dsm/EgovDiaryManageList.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
