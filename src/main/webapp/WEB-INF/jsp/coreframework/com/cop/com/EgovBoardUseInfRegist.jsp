...
<script type="text/javascript">
	function fn_egov_select_bbsUseInfs(){
		document.boardUseInf.action = "<c:url value='/cop/com/selectBBSUseInfs.cm'/>";
	...
	function fn_egov_regist_bbsUseInf(){
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			...
			document.boardUseInf.action = "<c:url value='/cop/com/insertBBSUseInf.cm'/>";
			document.boardUseInf.submit();
		}
	}
	...
	function fn_egov_inqire_bbsInf(){
		var retVal;
		var url = "<c:url value='/cop/com/openPopup.cm' />?requestUrl=/cop/bbs/SelectBBSMasterInfsPop.cm&width=850&height=520";
	...
	function fn_egov_inqire_cmmnty() {
		var retVal;
		var url = "<c:url value='/cop/com/openPopup.cm' />?requestUrl=/cop/cmy/selectCmmntyInfsByPop.cm&width=850&height=360";
	...
	function fn_egov_inqire_club() {
		var retVal;
		var url = "<c:url value='/cop/com/openPopup.cm' />?requestUrl=/cop/clb/selectClubInfsByPop.cm&width=850&height=360";
		var openParam = "dialogWidth: 850px; dialogHeight: 360px; resizable: 0, scroll: 1, center: 1";
...
<div id="border" style="width:730px">
	<table width="100%" cellpadding="8" class="table-search" border="0"  summary="게시판명, 커뮤니티 동호회 정보  입니다">
	 <tr>
	  <td width="100%"class="title_left">
	  	<h1>
	  		<img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;게시판 사용등록
	  	</h1>
	  </td>
	 </tr>
	</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register">
	  <tr>
	    ...
	    <img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시"></th>
	    <td width="70%" nowrap colspan="3">
	      ...
	      &nbsp;<a href="#LINK" onclick="fn_egov_inqire_bbsInf();" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/icon/search.gif' />"
	  ...
	  <tr>
	    <th width="30%" height="23" class="required_text" nowrap >
	    	...
	    	<img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수입력표시">
	    </th>
	    <td width="70%" nowrap colspan="3">
	...
	<tr>
      ...
      <td background="<c:url value='/images/coreframework/com/cmm/btn/bu2_bg.gif'/>" class="text_left" nowrap>
      ...
      <a href="<c:url value='/cop/com/selectBBSUseInfs.cm'/>?searchCondition=1" onclick="fn_egov_select_bbsUseInfs(); return false;"><spring:message code="button.list" /></a>
      </span></td>
	</tr>
	</table>
	</div>
