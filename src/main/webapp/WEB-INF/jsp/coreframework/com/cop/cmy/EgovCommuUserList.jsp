...
function fn_egov_select_linkPage(pageNo){
	...
	document.CommuUserForm.action = "<c:url value='/cop/cmy/selectCommuMasterList.cm'/>";
...
<form name="CommuUserForm" action="<c:url value='/cop/cmy/selectCommuUserList.cm'/>" method="post" onSubmit="fn_egov_search_user(); return false;">
<div class="board">
	...
	<tr>
		...
		<c:choose>
			...
			<!-- 회원가입 신청상태일 경우 -->
				<td>
					<a class="btn02" href="<c:url value='/cop/cmy/insertCommuUser.cm?cmmntyId=${resultInfo.cmmntyId}&emplyrId=${resultInfo.emplyrId}' />">가입승인</a>&nbsp;
					<a class="btn02" href="<c:url value='/cop/cmy/deleteCommuUser.cm?cmmntyId=${resultInfo.cmmntyId}&emplyrId=${resultInfo.emplyrId}' />">가입거절</a>
				</td>		
			</c:when>
			...
			<!-- 일반회원 상태일 경우 -->
				<td>
					<a class="btn02" href="<c:url value='/cop/cmy/insertCommuUserAdmin.cm?cmmntyId=${resultInfo.cmmntyId}&emplyrId=${resultInfo.emplyrId}' />">관리자등록</a>&nbsp;
					<a class="btn02" href="<c:url value='/cop/cmy/deleteCommuUser.cm?cmmntyId=${resultInfo.cmmntyId}&emplyrId=${resultInfo.emplyrId}' />">탈퇴</a>
				</td>		
			</c:when>
			...
			<!-- 관리자일 경우 -->
				<td>
					<a class="btn02" href="<c:url value='/cop/cmy/deleteCommuUserAdmin.cm?cmmntyId=${resultInfo.cmmntyId}&emplyrId=${resultInfo.emplyrId}' />">관리자해제</a>
				</td>		
			</c:when>
