...
<%@ page import="coreframework.com.cmm.service.EgovProperties" %>
...
function fn_egov_insert_satisfactionList() {
	...
	if (confirm('<spring:message code="common.regist.msg" />')) {
		document.frm.action = "<c:url value='/cop/stf${prefix}/insertSatisfaction.cm'/>";
		document.frm.submit();
	}
}
...
function fn_egov_updt_satisfactionList() {
	...
	if (confirm('<spring:message code="common.update.msg" />')) {
		...
		document.frm.action = "<c:url value='/cop/stf${prefix}/updateSatisfaction.cm'/>";
		document.frm.submit();
	}
}
...
function fn_egov_selectSatisfactionForupdt(satisfactionNo, index) {
	...
	document.frm.action = "<c:url value='/cop/bbs${prefix}/selectArticleDetail.cm'/>";
	document.frm.submit();
}
...
function fn_egov_deleteSatisfactionList(satisfactionNo, index) {
	...
	if (confirm('<spring:message code="common.delete.msg" />')) {
		document.frm.modified.value = "true";
		document.frm.stsfdgNo.value = satisfactionNo;
		document.frm.action = "<c:url value='/cop/stf${prefix}/deleteSatisfaction.cm'/>";
		document.frm.submit();
	}
}
