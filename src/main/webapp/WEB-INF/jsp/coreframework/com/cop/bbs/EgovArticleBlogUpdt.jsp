...
<script type="text/javascript" src="<c:url value='/html/coreframework/com/cmm/utl/ckeditor/ckeditor.js?t=B37D54V'/>" ></script>
...
function fn_egov_init() {
	...
	var ckeditor_config = {
		filebrowserImageUploadUrl: '${pageContext.request.contextPath}/utl/wed/insertImageCk.cm', // 파일 업로드를 처리 할 경로 설정.
	};
...
function fn_egov_inqire_articlelist() {
	articleVO.action = "<c:url value='/cop/bbs/selectArticleList.cm'/>";
	articleVO.submit();
}
...
<body onLoad="fn_egov_init();">
	...
	<!-- 상단타이틀 -->
	<form:form modelAttribute="articleVO" action="${pageContext.request.contextPath}/cop/bbs/updateArticle.cm" method="post" onSubmit="fn_egov_updt_article(document.forms[0]); return false;" enctype="multipart/form-data">
		<div class="wTableFrm">
			...
			<div class="btn">
				...
				<span class="btn_s"><a href="<c:url value='/cop/bbs/selectArticleBlogList.cm' />?bbsId=${boardMasterVO.bbsId}"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
			</div>
