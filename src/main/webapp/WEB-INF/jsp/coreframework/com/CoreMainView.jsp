...
<div>
	...
	<div class="mp_top">
		...
		<div class="l"><!-- right layout -->
			...
			<div style="height:150px">
			<c:import charEncoding="utf-8" url="/cop/smt/sdm/EgovDeptSchdulManageMainList.cm" ></c:import>
			</div>
			
			<!-- 나의일정관리 -->
			<h3 class="m_tit01 mt15"><spring:message code="comSymMnuMpm.mainView.indvdlSchdulManageMainList"/></h3><!-- 나의일정관리 -->
			<div style="height:150px">
			<c:import charEncoding="utf-8" url="/cop/smt/sim/EgovIndvdlSchdulManageMainList.cm" ></c:import>
			</div>
		</div>
	...
	<div class="mp_bn">
		<c:import url="/uss/ion/bnr/getBannerImage.cm" charEncoding="utf-8">
