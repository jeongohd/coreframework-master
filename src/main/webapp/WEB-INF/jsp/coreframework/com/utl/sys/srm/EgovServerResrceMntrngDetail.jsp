...
function fncSelectServerResrceMntrngList() {
    ...
    varFrom.action = "<c:url value='/utl/sys/srm/selectServerResrceMntrngList.cm'/>";
    varFrom.submit();
}
...
<div class="wTableFrm">
	...
	<form:form modelAttribute="serverResrceMntrng" method="post" action="${pageContext.request.contextPath}/utl/sys/srm/selectServerResrceMntrngList.cm">
	<!-- 등록폼 -->
