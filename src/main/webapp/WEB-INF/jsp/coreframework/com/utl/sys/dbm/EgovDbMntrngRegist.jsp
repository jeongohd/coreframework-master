...
function fn_egov_save_db_mntrng(){
    var varForm = document.getElementById("dbMntrng");
    varForm.action =  "<c:url value='/utl/sys/dbm/addDbMntrng.cm'/>";
...
<form:form modelAttribute="dbMntrng"  action="<c:url value='/utl/sys/dbm/addDbMntrng.cm'/>" method="post">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/utl/sys/dbm/getDbMntrngList.cm'></c:url>" onclick="fn_egov_get_db_mntrng_list(); return false;"><spring:message code="button.list" /></a></span>
	</div>
