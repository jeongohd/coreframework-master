...
<script type="text/javascript">
	...
	function fn_egov_insert_filesysmntrng() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.fileSysMntrngVO.action = "<c:url value='/utl/sys/fsm/insertFileSysMntrng.cm'/>";
			document.fileSysMntrngVO.submit();					
		}
	}

	function fn_egov_select_filesysmg() {
		document.fileSysMntrngVO.action = "<c:url value='/utl/sys/fsm/selectFileSysMg.cm'/>";
		document.fileSysMntrngVO.submit();					
	}
	...
	function fn_egov_list_filesysmntrng(){
		document.fileSysMntrngVO.action = "<c:url value='/utl/sys/fsm/selectFileSysMntrngList.cm'/>";
		document.fileSysMntrngVO.submit();	
	}	
...
<form:form modelAttribute="fileSysMntrngVO" name="fileSysMntrngVO" method="post" action="${pageContext.request.contextPath}/utl/sys/fsm/insertFileSysMntrng.cm">
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a class="btn02" href="<c:url value='/utl/sys/fsm/selectFileSysMg.cm'/>?searchWrd=<c:out value='${fileSysMntrngVO.searchWrd}'/>&amp;searchCnd=<c:out value='${fileSysMntrngVO.searchCnd}'/>&amp;pageIndex=<c:out value='${fileSysMntrngVO.pageIndex}'/>" onclick="fn_egov_select_filesysmg(); return false;"><spring:message code="comUtlSysFsm.fileSysMntrngRegist.selectFileSysMg"/></a><!-- 파일시스템확인 -->
			</td>
		</tr>
		<tr>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/utl/sys/fsm/selectFileSysMntrngList.cm'/>?searchWrd=<c:out value='${fileSysMntrngVO.searchWrd}'/>&amp;searchCnd=<c:out value='${fileSysMntrngVO.searchCnd}'/>&amp;pageIndex=<c:out value='${fileSysMntrngVO.pageIndex}'/>" onclick="fn_egov_list_filesysmntrng(); return false;"><spring:message code="button.list" /></a></span>
	</div>
