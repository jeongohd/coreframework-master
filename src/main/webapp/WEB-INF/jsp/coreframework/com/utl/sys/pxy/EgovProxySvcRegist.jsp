...
function fncProxySvcInsert() {
    var varFrom = document.getElementById("proxySvc");
    varFrom.action = "<c:url value='/utl/sys/pxy/addProxySvc.cm'/>";
...
<div class="wTableFrm">
	...
	<form:form modelAttribute="proxySvc" method="post" action="${pageContext.request.contextPath}/utl/sys/pxy/addProxySvc.cm">
	<!-- 등록폼 -->
	<table class="wTable">
		<colgroup>
			<col style="width:16%" />
