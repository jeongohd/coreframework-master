...
function fn_egov_get_list(){
    ...
    varForm.action = "<c:url value='/utl/sys/trm/getTrsmrcvMntrngList.cm'/>";
    varForm.submit()
}
/* ********************************************************
 * 저장처리화면
...
function fn_egov_save(){
    ...
    if(confirm("<spring:message code='common.save.msg' />")){
        varForm.action =  "<c:url value='/utl/sys/trm/updateTrsmrcvMntrng.cm'/>";
...
<div class="wTableFrm">					
<!-- 상단타이틀 -->
<form:form modelAttribute="trsmrcvMntrng" id="trsmrcvMntrng" action="<c:url value='/utl/sys/trm/updateTrsmrcvMntrng.cm'/>" method="post">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="idTestClassNm" for="testClassNm"><spring:message code="comUtlSysTrm.trsmrcvMntrng.testClassName" /></label><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th><!-- 테스트클래스명 -->
    <td class="left">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdMngrNm" for="mngrNm"><spring:message code="comUtlSysTrm.trsmrcvMntrng.managerName" /></label><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th><!-- 관리자명 -->
    <td class="left">
  ...
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdMngrEmailAddr" for="mngrEmailAddr"><spring:message code="comUtlSysTrm.trsmrcvMntrng.managerEmail" /></label><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th><!-- 관리자이메일주소 -->
    <td class="left">
