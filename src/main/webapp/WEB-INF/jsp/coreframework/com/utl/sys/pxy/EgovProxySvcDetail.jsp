...
function fncSelectProxySvcList() {
    ...
    varFrom.action = "<c:url value='/utl/sys/pxy/selectProxySvcList.cm'/>";
    varFrom.submit();       
}
...
function fncProxySvcUpdateView(proxyId) {
    ...
    varFrom.action = "<c:url value='/utl/sys/pxy/updtViewProxySvc.cm'/>";
    varFrom.submit();
}
...
function fncProxySvcDelete(proxyId) {
    var varFrom = document.getElementById("proxySvc");
    varFrom.proxyId.value = proxyId;
    varFrom.action = "<c:url value='/utl/sys/pxy/removeProxySvc.cm'/>";
...
<div class="wTableFrm">
	...
	<form:form modelAttribute="proxySvc" method="post" action="${pageContext.request.contextPath}/utl/sys/pxy/removeProxySvc.cm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/utl/sys/pxy/updtViewProxySvc.cm'/>?proxyId=<c:out value='${proxySvc.proxyId}'/>" onclick="fncProxySvcUpdateView('${proxySvc.proxyId}'); return false;"><spring:message code="button.update" /></a></span>
		<input class="s_submit" type="submit" value='<spring:message code="button.delete" />' onclick="fncProxySvcDelete('${proxySvc.proxyId}')" />
		<span class="btn_s"><a href="<c:url value='/utl/sys/pxy/selectProxySvcList.cm'/>?pageIndex=<c:out value='${proxySvcVO.pageIndex}'/>&amp;strProxyNm=<c:out value="${proxySvcVO.strProxyNm}"/>" onclick="fncSelectProxySvcList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
