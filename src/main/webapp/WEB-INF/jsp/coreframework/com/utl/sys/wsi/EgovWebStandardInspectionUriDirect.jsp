...
<%@page import="coreframework.com.utl.fcc.service.EgovNumberCheckUtil"%>
<%@page import="coreframework.com.cmm.CoreWebUtil"%>
<%@page import="coreframework.com.cmm.util.EgovResourceCloseHelper"%>
<%@ page import="coreframework.com.cmm.CoreWebUtil" %>
...
<%
	...
	sUri = CoreWebUtil.clearXSSMinimum(sUri);
	sNum = CoreWebUtil.clearXSSMinimum(sNum);
	...
	try {
		...
		//URL 체크
		sUri = CoreWebUtil.filePathBlackList(sUri);
