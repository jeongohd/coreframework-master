...
<c:set var="ImgUrl" value="/images/coreframework/com/cmm/"/>
...
<script type="text/javascript">
	...
	function fn_egov_update_filesysmntrng() {
		document.fileSysMntrngVO.action = "<c:url value='/utl/sys/fsm/modifyFileSysMntrng.cm'/>";
		document.fileSysMntrngVO.submit();	
	}

	function fn_egov_delete_filesysmntrng(){
		if(confirm("<spring:message code='common.delete.msg' />")){
			document.fileSysMntrngVO.action = "<c:url value='/utl/sys/fsm/deleteFileSysMntrng.cm'/>";
			document.fileSysMntrngVO.submit();
		}
	}
...
<form:form modelAttribute="fileSysMntrngVO" name="fileSysMntrngVO" method="post" action="${pageContext.request.contextPath}/utl/sys/fsm/modifyFileSysMntrng.cm">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/utl/sys/fsm/deleteFileSysMntrng.cm'/>?fileSysId=<c:out value='${fileSysMntrngVO.fileSysId}'/>" onclick="fn_egov_delete_filesysmntrng(); return false;"><spring:message code="button.delete" /></a></span>
