...
<script type="text/javascript">
	...
	function fn_egov_update_ntwrksvcmntrng() {
		document.ntwrkSvcMntrngVO.action = "<c:url value='/utl/sys/nsm/modifyNtwrkSvcMntrng.cm'/>";
		document.ntwrkSvcMntrngVO.submit();	
	}

	function fn_egov_delete_ntwrksvcmntrng(){
		if(confirm("<spring:message code='common.delete.msg' />")){
			document.ntwrkSvcMntrngVO.action = "<c:url value='/utl/sys/nsm/deleteNtwrkSvcMntrng.cm'/>";
			document.ntwrkSvcMntrngVO.submit();
		}
	}
	...
	function fn_egov_list_ntwrksvcmntrng(){
		document.ntwrkSvcMntrngVO.action = "<c:url value='/utl/sys/nsm/selectNtwrkSvcMntrngList.cm'/>";
		document.ntwrkSvcMntrngVO.submit();	
	}	
...
<form:form modelAttribute="ntwrkSvcMntrngVO" name="ntwrkSvcMntrngVO" method="post" action="${pageContext.request.contextPath}/utl/sys/nsm/modifyNtwrkSvcMntrng.cm">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/utl/sys/nsm/deleteNtwrkSvcMntrng.cm'/>?sysIp=<c:out value='${ntwrkSvcMntrngVO.sysIp}'/>&amp;sysPort=<c:out value='${ntwrkSvcMntrngVO.sysPort}'/>" onclick="fn_egov_delete_ntwrksvcmntrng(); return false;"><spring:message code="button.delete" /></a></span><!-- 삭제 -->
		<span class="btn_s"><a href="<c:url value='/utl/sys/nsm/selectNtwrkSvcMntrngList.cm'/>?searchWrd=<c:out value='${ntwrkSvcMntrngVO.searchWrd}'/>&amp;searchCnd=<c:out value='${ntwrkSvcMntrngVO.searchCnd}'/>&amp;pageIndex=<c:out value='${ntwrkSvcMntrngVO.pageIndex}'/>" onclick="fn_egov_list_ntwrksvcmntrng(); return false;"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
