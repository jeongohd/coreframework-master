		...
		<DIV class="wTableFrm">
			...
			<form:hidden path="sysId"/>	
				...
				<caption>${pageTitle}</caption>
  					<tr>
    					<th scope="row" width="20%" height="23" class="required_text" nowrap><spring:message code="comUtlSysHtm.comUtlHttpMon.webService" /><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th><!-- 웹서비스종류 -->
	    				<td class="left">
				  	...
				  	<tr>
				    	<th scope="row" width="20%" height="23" class="required_text" nowrap><spring:message code="comUtlSysHtm.comUtlHttpMon.systemURL" /><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th><!-- 시스템URL -->
				  	...
				  	<tr>
				    	<th scope="row" width="20%" height="23" class="required_text" nowrap><spring:message code="comUtlSysHtm.comUtlHttpMon.managerName" /><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th><!-- 관리자명 -->
				    	<td width="80%" class="left">
				  	...
				  	<tr>
				  		<th scope="row" width="20%" height="23" class="required_text" nowrap><spring:message code="comUtlSysHtm.comUtlHttpMon.managerEmail" /><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th><!-- 관리자이메일 -->
				    	<td width="80%" class="left">
