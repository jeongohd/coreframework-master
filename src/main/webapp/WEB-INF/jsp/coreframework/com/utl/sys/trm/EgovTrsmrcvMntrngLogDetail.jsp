...
function fn_egov_list(){
    ...
    varForm.action = "<c:url value='/utl/sys/trm/getTrsmrcvMntrngLogList.cm'/>";
    varForm.submit()
}
</script>
</head>
...
<form name="trsmrcvMntrngLogForm"  id="trsmrcvMntrngLogForm" action="<c:url value='/utl/sys/trm/getTrsmrcvMntrngLogList.cm'/>" method="post">
