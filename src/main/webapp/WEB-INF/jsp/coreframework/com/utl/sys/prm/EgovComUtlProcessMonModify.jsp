			...
			<form:hidden path="processId"/>	
				...
				<table width="700" border="0" cellpadding="0" cellspacing="1" class="wTable" 
					...
					<caption>${pageTitle}</caption>
				  	...
				  	<!-- <tr>
				    	<th scope="row" width="20%" height="23" class="required_text">상태<img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력표시"  width="15" height="15"></th>
