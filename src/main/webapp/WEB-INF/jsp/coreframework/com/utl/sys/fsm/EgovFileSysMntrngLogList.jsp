...
<script type="text/javascript" src="<c:url value='/js/coreframework/com/cmm/jqueryui.js' />"></script>
...
<script type="text/javascript">
	...
	function fn_egov_select_filesysmntrnglog(pageNo) {
		...
		document.frm.action = "<c:url value='/utl/sys/fsm/selectFileSysMntrngLogList.cm'/>";
	...
	function fn_egov_inqire_filesysmntrnglog(fileSysId, logId) {
		...
		document.frm.action = "<c:url value='/utl/sys/fsm/selectFileSysMntrngLog.cm'/>";
		document.frm.submit();
	}

	function fn_egov_select_filesysmntrng(){
		document.frm.action = "<c:url value='/utl/sys/fsm/selectFileSysMntrngList.cm'/>";
		document.frm.submit();
	}
...
<div class="board">
	<h1>${pageTitle} <spring:message code="title.list" /></h1>
		...
		<form name="frm" method="post" action="<c:url value='/utl/sys/fsm/selectFileSysMntrngLogList.cm'/>">
		...
		<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
			<ul>
				<li>
					...
					<span class="btn_b"><a href="<c:url value='/utl/sys/fsm/selectFileSysMntrngList.cm'/>" onclick="fn_egov_select_filesysmntrng(); return false;" title="<spring:message code="comUtlSysFsm.fileSysMntrngLogList.list"/>"><spring:message code="comUtlSysFsm.fileSysMntrngLogList.list"/></a></span><!-- 목록 -->
				</li>
			</ul>	
		</div>
	</form>
		...
		<tbody>
			<c:forEach var="result" items="${resultList}" varStatus="status">
			  <tr>
			    ...
			    <td>
			     <form name="fileSysMntrngLogVO" method="post" action="<c:url value='/utl/sys/fsm/selectFileSysMntrngLog.cm'/>">
			    	<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
