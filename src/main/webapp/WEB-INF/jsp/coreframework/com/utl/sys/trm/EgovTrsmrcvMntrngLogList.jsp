...
function fn_egov_get_list(pageNo) {
    ...
    */
    ...
    document.frm.action = "<c:url value='/utl/sys/trm/getTrsmrcvMntrngLogList.cm'/>";
    document.frm.submit();
}

function fn_egov_get_detail_view(logId) {
    document.frm.logId.value = logId;
    document.frm.action = "<c:url value='/utl/sys/trm/getTrsmrcvMntrngLog.cm'/>";
    document.frm.submit();
}

function fn_egov_select_mntrng(){
	document.frm.action = "<c:url value='/utl/sys/trm/getTrsmrcvMntrngList.cm'/>";
    document.frm.submit();
}
</script>
...
<div class="board">
    ...
    <form name="frm" id="frm" action="<c:url value='/utl/sys/trm/getTrsmrcvMntrngLogList.cm'/>" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/trm/getTrsmrcvMntrngList.cm'/>" onclick="fn_egov_select_mntrng(); return false;" title="<spring:message code="button.list" />"><spring:message code="button.list" /></a></span>
			</li>
		</ul>
	</div>
		...
		<tbody>
	        ...
	        <c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	          <tr>
	                ...
	                <td>
	                    <form name="item" method="post" action="/utl/sys/trm/getTrsmrcvMntrngLog.cm">
