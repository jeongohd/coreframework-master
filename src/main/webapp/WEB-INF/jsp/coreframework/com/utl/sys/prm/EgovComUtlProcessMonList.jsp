...
<html lang="ko">
	<head>
		...
		function linkPage(pageNo){
			...
			document.listForm.action = "<c:url value='/utl/sys/prm/EgovComUtlProcessMonList.cm'/>";
			form.submit();
		}
		/* ********************************************************
		 * 조회 처리 
	...
	<form name="listForm" action="<c:url value='/utl/sys/prm/EgovComUtlProcessMonList.cm'/>" method="post">
		<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
			<ul>
				<li>
					...
					<span class="btn_b"><a href="<c:url value='/utl/sys/prm/EgovComUtlProcessMonRegist.cm'/>" onclick="" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
			...
			<tbody>
				<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
					<tr>
						...
						<td>
						<a href="<c:url value='/utl/sys/prm/EgovComUtlProcessMon.cm'/>?pageIndex=${searchVO.pageIndex}&amp;processNm=${resultInfo.processNm}"><c:out value="${resultInfo.processNm}"/></a>
						</td>						
