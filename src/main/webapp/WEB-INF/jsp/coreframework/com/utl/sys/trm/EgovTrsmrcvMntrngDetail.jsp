...
function fn_egov_update_view(){
    ...
    varForm.action = "<c:url value='/utl/sys/trm/getTrsmrcvMntrngForUpdate.cm'/>";
    varForm.submit();
}
/* ********************************************************
 * 삭제 처리
 ******************************************************** */
 function fn_egov_delete(){
        ...
        if(confirm("<spring:message code='common.delete.msg' />")){
            vForm.action = "<c:url value='/utl/sys/trm/deleteTrsmrcvMntrng.cm'/>";
            vForm.submit();
        }
}
</script>
...
<form name="Form"  id="Form" action="<c:url value='/utl/sys/trm/getTrsmrcvMntrng.cm'/>" method="post">
