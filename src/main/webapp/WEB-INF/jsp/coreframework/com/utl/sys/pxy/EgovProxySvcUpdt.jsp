...
function fncProxySvcUpdate() {
    var varFrom = document.getElementById("proxySvc");
    varFrom.action = "<c:url value='/utl/sys/pxy/updtProxySvc.cm'/>";
...
<div class="wTableFrm">
    ...
    <form:form modelAttribute="proxySvc" method="post" action="${pageContext.request.contextPath}/utl/sys/pxy/updtProxySvc.cm">
