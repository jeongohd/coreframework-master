...
<script type="text/javascript">
    ...
    function fn_egov_get_detail_view(cntcId) {
        ...
        document.frm.action = "<c:url value='/utl/sys/trm/getTrsmrcvMntrng.cm'/>";
        document.frm.submit();          
    }
    /* ********************************************************
     * 등록 처리 함수 
    ...
    function fn_egov_get_regist_view(){
        document.frm.action = "<c:url value='/utl/sys/trm/getTrsmrcvMntrngForRegist.cm'/>";
        document.frm.submit();  
    }   
...
<div class="board">
    ...
    <form name="frm" id="frm" action="<c:url value='/utl/sys/trm/getTrsmrcvMntrngList.cm'/>" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/trm/getTrsmrcvMntrngForRegist.cm'/>" onclick="fn_egov_get_regist_view(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
				<span class="btn_b"><a href="<c:url value='/utl/sys/trm/getTrsmrcvMntrngLogList.cm'/>" onclick="fn_egov_log_mntrng_list(); return false;" title="<spring:message code="button.log" />"><spring:message code="button.log" /></a></span>
			</li>
		</ul>
	</div>
		...
		<tbody>
	        ...
	        <c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	          <tr>
	                ...
	                <td>
	                    <form name="item" method="post" action="/utl/sys/trm/getTrsmrcvMntrng.cm">
