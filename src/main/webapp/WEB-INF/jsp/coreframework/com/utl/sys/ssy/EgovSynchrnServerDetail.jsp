...
function fncSelectSynchrnServerList() {
    ...
    varFrom.action = "<c:url value='/utl/sys/ssy/selectSynchrnServerList.cm'/>";
    varFrom.submit();       
}
...
function fncSynchrnServerUpdateView(serverId) {
    ...
    varFrom.action = "<c:url value='/utl/sys/ssy/updtViewSynchrnServer.cm'/>";
    varFrom.submit();
}
...
function fncSynchrnServerDelete(serverId) {
    var varFrom = document.getElementById("synchrnServer");
    varFrom.serverId.value = serverId;
    varFrom.action = "<c:url value='/utl/sys/ssy/removeSynchrnServer.cm'/>";
...
function fncRemoveSynchrnServerFile(fileNm) {
    ...
    varFrom.action = "<c:url value='/utl/sys/ssy/removeSynchrnServerFile.cm'/>";
    if(confirm("<spring:message code='common.delete.msg' />")){
        varFrom.submit();
    }
}
...
function fncDownSynchrnServerFile(fileNm) {
    var varFrom = document.getElementById("fileList");
    varFrom.fileNm.value = fileNm;
    varFrom.action = "<c:url value='/utl/sys/ssy/getSynchrnServerFile.cm'/>";
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/utl/sys/ssy/updtViewSynchrnServer.cm'/>?serverId=<c:out value='${synchrnServer.serverId}'/>" onclick="fncSynchrnServerUpdateView('${synchrnServer.serverId}'); return false;"><spring:message code="button.update" /></a></span>
		<span class="btn_s"><a href="<c:url value='/utl/sys/ssy/removeSynchrnServer.cm'/>?serverId=<c:out value='${synchrnServer.serverId}'/>" onclick="fncSynchrnServerDelete('${synchrnServer.serverId}'); return false;"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/utl/sys/ssy/selectSynchrnServerList.cm'/>?pageIndex=<c:out value='${synchrnServerVO.pageIndex}'/>&amp;strSynchrnServerNm=<c:out value="${synchrnServerVO.strSynchrnServerNm}"/>" onclick="fncSelectSynchrnServerList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
	<div style="clear:both;"></div>
</div>

<div class="board">
<form:form modelAttribute="fileList" method="post" action="${pageContext.request.contextPath}/utl/sys/ssy/removeSynchrnServerFile.cm">
		...
		<tbody>
	        ...
	        <tr>
	            <c:if test="${file != 'noList'}">
	                ...
	                <td><span class="button"><a href="<c:url value='/utl/sys/ssy/getSynchrnServerFile.cm'/>?pageIndex=<c:out value='${synchrnServerVO.pageIndex}'/>&amp;strSynchrnServerNm=<c:out value="${synchrnServerVO.strSynchrnServerNm}"/>" onclick="fncDownSynchrnServerFile('<c:out value="${file}"/>'); return false;"><spring:message code="comUtlSysSsy.synchrnServer.fileDownload.label" /></a></span>&nbsp;</td><!-- 다운로드 -->
	                <!-- 동기화대상서버 파일 삭제 기능 -->
