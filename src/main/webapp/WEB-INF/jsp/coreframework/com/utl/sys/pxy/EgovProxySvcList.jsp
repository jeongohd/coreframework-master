...
function fncSelectProxySvcList(pageNo){
    ...
    document.listForm.action = "<c:url value='/utl/sys/pxy/selectProxySvcList.cm'/>";
    document.listForm.submit();
}

function fncSelectProxySvc(proxyId) {
    document.listForm.proxyId.value = proxyId;
    document.listForm.action = "<c:url value='/utl/sys/pxy/getProxySvc.cm'/>";
    document.listForm.submit();
}
...
function fncAddProxySvcInsert() {
    ...
    document.listForm.action = "<c:url value='/utl/sys/pxy/addViewProxySvc.cm'/>";
    document.listForm.submit();
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/utl/sys/pxy/selectProxySvcList.cm'/>" method="post">
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/pxy/addViewProxySvc.cm'/>?pageIndex=<c:out value='${proxySvcVO.pageIndex}'/>&amp;strProxyNm=<c:out value="${proxySvcVO.strProxyNm}"/>" onclick="fncAddProxySvcInsert(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
				<span class="btn_b"><a href="<c:url value='/utl/sys/pxy/selectProxyLogList.cm'/>" onclick="" title="<spring:message code="comUtlSysPxy.proxyLog.log"/>"><spring:message code="comUtlSysPxy.proxyLog.log"/></a></span><!-- 로그 -->
			</li>
		</ul>
	</div>
	</form>
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
			  <td>
			      <form name="item" method="post" action="<c:url value='/utl/sys/pxy/getProxySvc.cm'/>">
