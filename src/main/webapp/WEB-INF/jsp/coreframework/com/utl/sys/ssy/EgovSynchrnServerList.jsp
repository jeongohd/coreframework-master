...
function fncSelectSynchrnServerList(pageNo){
    ...
    document.listForm.action = "<c:url value='/utl/sys/ssy/selectSynchrnServerList.cm'/>";
    document.listForm.submit();
}

function fncSelectSynchrnServer(serverId) {
    document.listForm.serverId.value = serverId;
    document.listForm.action = "<c:url value='/utl/sys/ssy/getSynchrnServer.cm'/>";
    document.listForm.submit();   
}
...
function fncAddSynchrnServerInsert() {
    ...
    document.listForm.action = "<c:url value='/utl/sys/ssy/addViewSynchrnServer.cm'/>";
    document.listForm.submit(); 
}
...
function fncProcessSynchrn(){
    ...
    if(confirm("<spring:message code='comUtlSysSsy.sync.msg' />")) {
        document.listForm.action = "<c:url value='/utl/sys/ssy/processSynchrn.cm'/>";
        document.listForm.submit();
    }
}
...
function fncUploadFile(){	
	if(document.fileForm.file.value.length > 0){
    	...
    	document.fileForm.action = "<c:url value='/utl/sys/ssy/uploadFile.cm'/>";
...
function fncDeleteFile(deleteFileNm){
    if(confirm("<spring:message code='common.delete.msg' />")){
        ...
        document.fileForm.action = "<c:url value='/utl/sys/ssy/deleteFile.cm'/>";
        document.fileForm.submit();
    }
}
...
function fncFileListDelete() {
    if(fncManageChecked()) {
        if(confirm("<spring:message code='common.delete.msg' />")) {
            document.deleteForm.action = "<c:url value='/utl/sys/ssy/deleteFile.cm'/>";
...
<form name="listForm" action="<c:url value='/utl/sys/ssy/selectSynchrnServerList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/ssy/addViewSynchrnServer.cm'/>?pageIndex=<c:out value='${synchrnServerVO.pageIndex}'/>&amp;strSynchrnServerNm=<c:out value="${synchrnServerVO.strSynchrnServerNm}"/>" onclick="fncAddSynchrnServerInsert(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
				<span class="btn_b"><a href="<c:url value='/utl/sys/ssy/processSynchrn.cm'/>?pageIndex=<c:out value='${synchrnServerVO.pageIndex}'/>" onclick="fncProcessSynchrn(); return false;" title="동기화"><spring:message code="comUtlSysSsy.synchrnServer.synch"/></a></span><!-- 동기화 -->
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			<c:forEach var="synchrnServer" items="${synchrnServerList}" varStatus="status">
			  <tr>
			    <td>
			        <form name="item" method="post" action="<c:url value='/utl/sys/ssy/getSynchrnServer.cm'/>">
...
<div class="wTableFrm">
<form name="fileForm" action="<c:url value='/utl/sys/ssy/uploadFile.cm'/>" method="post" enctype="multipart/form-data">
	<!-- 타이틀 -->
...
<div class="board">
<form name="deleteForm" action="<c:url value='/utl/sys/ssy/deleteFile.cm'/>" method="post">
