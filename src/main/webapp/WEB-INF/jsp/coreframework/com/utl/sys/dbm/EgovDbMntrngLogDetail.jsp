...
function fn_egov_list(){
    ...
    varForm.action = "<c:url value='/utl/sys/dbm/getDbMntrngLogList.cm'/>";
    varForm.submit()
}
</script>
</head>
...
<form name="dbMntrngLogForm"  id="dbMntrngLogForm" action="<c:url value='/utl/sys/dbm/getDbMntrngLog.cm'/>" method="post">
