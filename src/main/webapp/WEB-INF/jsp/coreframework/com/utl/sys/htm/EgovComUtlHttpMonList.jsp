...
<html lang="ko">
	<head>
		...
		<script type="text/javascript" src="/js/coreframework/com/cmm/utl/CoreCmmUtl.js"></script>
		...
		function linkPage(pageNo){
			...
			document.listForm.action = "<c:url value='/utl/sys/htm/EgovComUtlHttpMonList.cm'/>";
			form.submit();
		}
		/* ********************************************************
		 * 조회 처리 
	...
	<body onLoad="fn_egov_initl_HttpMon();">
		...
		<form name="listForm" action="<c:url value='/utl/sys/htm/EgovComUtlHttpMonList.cm'/>" method="post">
			<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
				<ul>
					<li>
						...
						<span class="btn_b"><a href="<c:url value='/utl/sys/htm/EgovComUtlHttpMonRegist.cm'/>" onclick="" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
				...
				<tbody>
					<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
						<tr>	
							...
							<td>
							<a href="<c:url value='/utl/sys/htm/EgovComUtlHttpMonDetail.cm'/>?pageIndex=${searchVO.pageIndex}&amp;sysId=${resultInfo.sysId}"><c:out value="${resultInfo.siteUrl}"/></a>
							</td>							
