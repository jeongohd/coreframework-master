...
<link href="/css/coreframework/com/cmm/utl/com.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="/js/coreframework/com/uss/ion/rss/jquery.js"></script>
...
function fn_egov_submit_WebStandardInspection(form, nNmm){
	...
	*/
	...
	if(form.rdoUri[0].checked == true){
		form.action='/CorePageLink.cm?link=utl/sys/wsi/EgovWebStandardInspectionUriDirect';
	}else{
		form.action='/CorePageLink.cm?link=utl/sys/wsi/EgovWebStandardInspectionUri';
	}
 ...
 ******************************************************** */
 function fn_egov_submit_WebStandardInspectionLink(form){
	...
	if(form.uri.value == ''){
	 ...
	 if(form.rdoUri[0].checked == true){
		 document.formHidden.action = "/CorePageLink.cm?link=utl/sys/wsi/EgovWebStandardInspectionUriDirectLink";
	 }else{
...
border : 0 solid #000;
color : #000000;
background-image : url(/images/coreframework/com/cmm/uss/umt/button/bu2_bg.gif);
cursor : pointer;
}
</style>
</head>
...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="/images/coreframework/com/cmm/uss/umt/icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt="">&nbsp;웹표준 검사</h1></td>
 </tr>
</table>
...
<%
	for(int i=1 ; i<10; i++){ 
%>
<form name="webInspection" method="post" action="/CorePageLink.cm?link=utl/sys/wsi/EgovWebStandardInspectionUri" target="ifr_hidden">
...
<tr> 
	...
	<tr>       
	  <td>&nbsp;</td>
	  <td><img src="/images/coreframework/com/cmm/uss/umt/btn/bu2_left.gif"  width="8" height="20"></td>
	  ...
	  <td><img src="/images/coreframework/com/cmm/uss/umt/btn/bu2_right.gif"  width="8" height="20"></td>
	</tr>
	</table>
