...
<html lang="ko">
	<head>
		...
		function fn_egov_select_processMonLog(pageNo) {
			...
			document.frm.action = "<c:url value='/utl/sys/prm/EgovComUtlProcessMonLogList.cm'/>";
		...
		function fn_egov_inqire_processMonLog(processNm, logId) {
			...
			document.frm.action = "<c:url value='/utl/sys/prm/EgovComUtlProcessMonLog.cm'/>";
			document.frm.submit();
		}
			...
			<tbody>
				<c:forEach var="result" items="${resultList}" varStatus="status">
			  		<tr>
					    ...
					    <td>
					    	<form name="processMonLogVO" method="post" action="<c:url value='EgovComUtlProcessMonLogList.cm'/>">
					    	<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
