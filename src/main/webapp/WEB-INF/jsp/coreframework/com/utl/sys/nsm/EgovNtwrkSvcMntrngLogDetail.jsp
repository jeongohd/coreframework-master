...
<script type="text/javascript">
	...
	function fn_egov_list_ntwrksvcmntrnglog(){
		document.ntwrkSvcMntrngLogVO.action = "<c:url value='/utl/sys/nsm/selectNtwrkSvcMntrngLogList.cm'/>";
...
<form:form modelAttribute="ntwrkSvcMntrngLogVO" name="ntwrkSvcMntrngLogVO" method="post" action="${pageContext.request.contextPath}/utl/sys/nsm/selectNtwrkSvcMntrngLogList.cm">
<div class="wTableFrm">
	<!-- 타이틀 -->
