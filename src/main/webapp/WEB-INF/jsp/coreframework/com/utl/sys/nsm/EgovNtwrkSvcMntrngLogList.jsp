...
<script type="text/javascript">
	...
	function fn_egov_select_ntwrksvcmntrnglog(pageNo) {
		...
		document.frm.action = "<c:url value='/utl/sys/nsm/selectNtwrkSvcMntrngLogList.cm'/>";
	...
	function fn_egov_inqire_ntwrksvcmntrnglog(sysIp, sysPort, logId) {
		...
		document.frm.action = "<c:url value='/utl/sys/nsm/selectNtwrkSvcMntrngLog.cm'/>";
		document.frm.submit();
	}

	function fn_egov_select_ntwrksvcmntrng(){
		document.frm.action = "<c:url value='/utl/sys/nsm/selectNtwrkSvcMntrngList.cm'/>";
		document.frm.submit();
	}
...
<div class="board">
	...
	<form name="frm" method="post" action="<c:url value='/utl/sys/nsm/selectNtwrkSvcMntrngLogList.cm'/>">
	...
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/nsm/selectNtwrkSvcMntrngList.cm'/>" onclick="fn_egov_select_ntwrksvcmntrng(); return false;" title="<spring:message code='title.list' />"><spring:message code='title.list' /></a></span><!-- 목록 -->
			</li>
		</ul>
	</div>
		...
		<tbody>
			<c:forEach var="result" items="${resultList}" varStatus="status">
			  <tr>
			    ...
			    <td>
			     <form name="ntwrkSvcMntrngVO" method="post" action="<c:url value='/utl/sys/nsm/selectNtwrkSvcMntrngLog.cm'/>">
			    	<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
