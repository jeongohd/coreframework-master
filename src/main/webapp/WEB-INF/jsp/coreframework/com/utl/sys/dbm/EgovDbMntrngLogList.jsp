...
function fn_egov_get_db_mntrng_log_list(pageNo) {
    ...
    */
    ...
    document.frm.action = "<c:url value='/utl/sys/dbm/getDbMntrngLogList.cm'/>";
    document.frm.submit();
}

function fn_egov_get_db_mntrng_log(logId) {
    document.frm.logId.value = logId;
    document.frm.action = "<c:url value='/utl/sys/dbm/getDbMntrngLog.cm'/>";
    document.frm.submit();
}

function fn_egov_select_db_mntrng(){
	document.frm.action = "<c:url value='/utl/sys/dbm/getDbMntrngList.cm'/>";
    document.frm.submit();
}
</script>
...
<div class="board">
    ...
    <form name="frm" id="frm" action="<c:url value='/utl/sys/dbm/getDbMntrngLogList.cm'/>" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/dbm/getDbMntrngList.cm'/>" onclick="fn_egov_select_db_mntrng(); return false;" title="<spring:message code="button.list" />"><spring:message code="button.list" /></a></span>
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
	        ...
	        <c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	          <tr>
                <td>
                    <form name="item" method="post" action="<c:url value='/utl/sys/dbm/getDbMntrngLog.cm'/>">
