...
function fncSynchrnServerInsert() {
    var varFrom = document.getElementById("synchrnServer");
    varFrom.action = "<c:url value='/utl/sys/ssy/addSynchrnServer.cm'/>";
...
<form:form modelAttribute="synchrnServer" method="post" action="${pageContext.request.contextPath}/utl/sys/ssy/addSynchrnServer.cm">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/utl/sys/ssy/selectSynchrnServerList.cm'/>?pageIndex=<c:out value='${synchrnServerVO.pageIndex}'/>&amp;strServerNm=<c:out value="${synchrnServerVO.strSynchrnServerNm}"/>" onclick="fncSelectSynchrnServerList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
