...
<script type="text/javascript">
	...
	function fn_egov_update_filesysmntrng() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.fileSysMntrngVO.action = "<c:url value='/utl/sys/fsm/updateFileSysMntrng.cm'/>";
...
<div class="wTableFrm">
	...
	<form:form modelAttribute="fileSysMntrngVO" name="fileSysMntrngVO" method="post" action="${pageContext.request.contextPath}/utl/sys/fsm/updateFileSysMntrng.cm">
