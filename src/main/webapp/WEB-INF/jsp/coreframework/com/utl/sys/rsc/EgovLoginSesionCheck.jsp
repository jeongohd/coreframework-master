...
function fncSelectLoginSession() {
    ...
    varFrom.action = "<c:url value='/utl/sys/rsc/loginSessionView.cm'/>";
    varFrom.submit();
}

function fncSetLoginSession() {
    var varFrom = document.getElementById("loginSessionCheck");
    varFrom.action = "<c:url value='/utl/sys/rsc/setLoginSession.cm'/>";
...
-->
 ...
 <%
	 ...
	 if(user != null && (user.getUrl() == null || user.getUrl().equals(""))) 
		 user.setUrl(contextPath+"/index.cm");
 %>
<body>
<noscript class="noScriptTitle"><spring:message code="common.noScriptTitle.msg" /></noscript><!-- 자바스크립트를 지원하지 않는 브라우저에서는 일부 기능을 사용하실 수 없습니다. -->

<div class="wTableFrm">
<form:form modelAttribute="loginSessionCheck" method="post" action="${pageContext.request.contextPath}/utl/sys/rsc/setLoginSession.cm">
	<!-- 타이틀 -->
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/utl/sys/rsc/loginSessionView.cm'/>" onclick="fncSelectLoginSession(); return false;"><spring:message code="button.inquire" /></a></span>
