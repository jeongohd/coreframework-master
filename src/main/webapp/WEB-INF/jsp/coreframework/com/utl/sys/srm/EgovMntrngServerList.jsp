...
function fncSelectMntrngServerList(pageNo) {
    ...
    document.listForm.action = "<c:url value='/utl/sys/srm/selectMntrngServerList.cm'/>";
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/utl/sys/srm/selectMntrngServerList.cm'/>" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/srm/selectServerResrceMntrngList.cm'/>" onclick="" title="<spring:message code="ultSysScm.mntrngServerList.btnLog" /> <spring:message code="input.button" />"><spring:message code="ultSysScm.mntrngServerList.btnLog" /></a></span><!-- 로그 -->
			</li>
		</ul>
	</div>
