...
function fn_egov_update_view(){
    ...
    varForm.action = "<c:url value='/utl/sys/dbm/getDbMntrngForUpdate.cm'/>";
    varForm.submit();
}
/* ********************************************************
 * 삭제 처리
 ******************************************************** */
 function fn_egov_delete(){
        ...
        if(confirm("<spring:message code='common.delete.msg' />")){
            vForm.action = "<c:url value='/utl/sys/dbm/deleteDbMntrng.cm'/>";
            vForm.submit();
        }
}
</script>
...
<form name="dbMntrngForm"  id="dbMntrngForm" action="<c:url value='/utl/sys/dbm/getDbMntrng.cm'/>" method="post">
