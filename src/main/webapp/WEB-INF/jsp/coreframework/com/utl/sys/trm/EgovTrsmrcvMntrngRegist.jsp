...
function fn_egov_save(){
    var varForm = document.getElementById("trsmrcvMntrng");
    varForm.action = "<c:url value='/utl/sys/trm/addTrsmrcvMntrng.cm' />";
...
function fn_egov_popup_cntc_list(){
    ...
    var retVal;
    var url = "<c:url value='/utl/sys/trm/getCntcListPopup.cm' />";
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
		        ...
		        <a href="#LINK" onclick="fn_egov_popup_cntc_list(); return false;"><img src="<c:url value='/images/coreframework/com/cmm/icon/search2.gif' />" alt="<spring:message code="comUtlSysTrm.trsmrcvMntrng.interOperationPopup" />"/></a><!-- 연계정보조회팝업 제공 -->
			</td>
		</tr>
		<tr>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/utl/sys/trm/getTrsmrcvMntrngList.cm'/>" onclick="fn_egov_get_list(); return false;"><spring:message code="button.list" /></a></span>
	</div>
