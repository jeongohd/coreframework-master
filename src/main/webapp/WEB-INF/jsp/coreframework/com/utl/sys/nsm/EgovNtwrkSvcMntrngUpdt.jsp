...
<script type="text/javascript">
	...
	function fn_egov_update_ntwrksvcmntrng() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.ntwrkSvcMntrngVO.action = "<c:url value='/utl/sys/nsm/updateNtwrkSvcMntrng.cm'/>";
...
<form:form modelAttribute="ntwrkSvcMntrngVO" name="ntwrkSvcMntrngVO" method="post" action="${pageContext.request.contextPath}/utl/sys/nsm/updateNtwrkSvcMntrng.cm">
