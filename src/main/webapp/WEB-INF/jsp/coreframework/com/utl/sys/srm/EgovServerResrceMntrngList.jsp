...
function fncSelectServerResrceMntrngList(pageNo) {
    ...
    document.listForm.action = "<c:url value='/utl/sys/srm/selectServerResrceMntrngList.cm'/>";
...
function fncSelectServerResrceMntrng(logId) {
    ...
    document.listForm.action = "<c:url value='/utl/sys/srm/getServerResrceMntrng.cm'/>";
    document.listForm.submit();
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/utl/sys/srm/selectServerResrceMntrngList.cm'/>" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/srm/selectMntrngServerList.cm'/>" onclick="" title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
			</li>
		</ul>
	</div>
	...
	<table class="board_list" summary="<spring:message code="common.summary.list" arguments="${pageTitle}" />">
		...
		<tbody>
			<c:forEach var="serverResrceMntrng" items="${serverResrceMntrngList}" varStatus="status">
			  <tr>
			     <td>
			        <form name="item" method="post" action="<c:url value='/utl/sys/srm/getServerResrceMntrng.cm'/>">
