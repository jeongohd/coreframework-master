...
function fn_egov_list_db_mntrng(){
    ...
    varForm.action = "<c:url value='/utl/sys/dbm/getDbMntrngList.cm'/>";
    varForm.submit()
}
/* ********************************************************
 * 저장처리화면
...
function fn_egov_save_db_mntrng(){
    ...
    if(confirm("<spring:message code='common.save.msg' />")){
        varForm.action =  "<c:url value='/utl/sys/dbm/updateDbMntrng.cm'/>";
...
<DIV class="wTableFrm">
<!-- 상단타이틀 -->
<form:form modelAttribute="dbMntrng" id="dbMntrng" action="<c:url value='/utl/sys/dbm/updateDbMntrng.cm'/>" method="post">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="wTable" summary="<spring:message code="comUtlSysDbm.dbMntrngModify.summary" />"><!-- DB서비스모니터링 수정기능을 제공한다. -->
      <tr> 
        <th width="20%" height="23" class="required_text" nowrap ><label id="IdDataSourcNm" for="dataSourcNm"><spring:message code="comUtlSysDbm.dbMntrng.dataSourceName" /></label><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th><!-- 데이타소스명 -->
      ...
      <tr> 
        <th width="20%" height="23" class="required_text" nowrap ><label id="IdServerNm"  for="serverNm"><spring:message code="comUtlSysDbm.dbMntrng.serverName" /></label><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th><!-- 서버명 -->
        <td class="left">
      ...
      <tr> 
        <th width="20%" height="23" class="required_text" nowrap ><label id="IdDbmsKind"  for="dbmsKind"><spring:message code="comUtlSysDbm.dbMntrng.dbms" /></label><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th><!-- DBMS종류 -->
        <td class="left">
      ...
      <tr> 
        <th width="20%" height="23" class="required_text" nowrap ><label id="IdCeckSql"  for="ceckSql"><spring:message code="comUtlSysDbm.dbMntrng.checkSQL" /></label><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th><!-- 체크SQL -->
        <td class="left">
      ...
      <tr> 
        <th width="20%" height="23" class="required_text" nowrap ><label id="IdMngrNm"  for="mngrNm"><spring:message code="comUtlSysDbm.dbMntrng.managerName" /></label><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th><!-- 관리자명 -->
        <td class="left">
      ...
      <tr> 
        <th width="20%" height="23" class="required_text" nowrap ><label id="IdMngrEmailAddr"  for="mngrEmailAddr"><spring:message code="comUtlSysDbm.dbMntrng.managerEmail" /></label><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="필수입력" title="필수입력" width="15" height="15"></th><!-- 관리자이메일주소 -->
        <td class="left">
