...
function fncSelectProxyLogList(pageNo){
    ...
    document.listForm.action = "<c:url value='/utl/sys/pxy/selectProxyLogList.cm'/>";
...
<div class="board">
    ...
    <form name="listForm" action="<c:url value='/utl/sys/pxy/selectProxyLogList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/pxy/selectProxySvcList.cm'/>" onclick="" title="<spring:message code="title.list"/>"><spring:message code="title.list"/></a></span><!-- 목록 -->
			</li>
		</ul>
	</div>
