...
<script type="text/javascript">
	...
	function fn_egov_list_filesysmntrnglog(){
		document.fileSysMntrngLogVO.action = "<c:url value='/utl/sys/fsm/selectFileSysMntrngLogList.cm'/>";
...
<div class="wTableFrm">
	...
	<form:form modelAttribute="fileSysMntrngLogVO" name="fileSysMntrngLogVO" method="post" action="${pageContext.request.contextPath}/utl/sys/fsm/selectFileSysMntrngLogList.cm">
