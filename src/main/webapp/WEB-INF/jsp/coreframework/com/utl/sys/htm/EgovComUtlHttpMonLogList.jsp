...
<html lang="ko">
	<head>
		...
		function fn_egov_select_httpMonLog(pageNo) {
			...
			document.frm.action = "<c:url value='/utl/sys/htm/EgovComUtlHttpMonLogList.cm'/>";
		...
		function fn_egov_inqire_httpMonLog(webKind, logId) {
			...
			document.frm.action = "<c:url value='/utl/sys/htm/EgovComUtlHttpMonDetailLog.cm'/>";
			document.frm.submit();
		}
	...
	<div class="board">
		...
		<h1>${pageTitle}</h1>
			...
			<form name="frm" method="post" action="<c:url value='/utl/sys/prm/EgovComUtlProcessMonLogList.cm'/>">
			...
			<tbody>
				<c:forEach var="result" items="${resultList}" varStatus="status">
			  		<tr>
					    ...
					    <td>
						    	<form name="httpMonLogVO" method="post" action="<c:url value='EgovComUtlHttpMonLogList.cm'/>">
						    	<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
