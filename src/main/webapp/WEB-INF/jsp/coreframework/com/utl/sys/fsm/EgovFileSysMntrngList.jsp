...
<script type="text/javascript">
	...
	function fn_egov_inqire_filesysmntrng(fileSysId) {
		...
		document.frm.action = "<c:url value='/utl/sys/fsm/selectFileSysMntrng.cm'/>";
		document.frm.submit();
	}

	function fn_egov_insert_filesysmntrng(){
		document.frm.action = "<c:url value='/utl/sys/fsm/addFileSysMntrng.cm'/>";
		document.frm.submit();
	}
...
<div class="board">
	...
	<form name="frm" method="post" action="<c:url value='/utl/sys/fsm/selectFileSysMntrngList.cm'/>">
	...
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/fsm/addFileSysMntrng.cm'/>" onclick="fn_egov_insert_filesysmntrng('1'); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
				<span class="btn_b"><a href="<c:url value='/utl/sys/fsm/selectFileSysMntrngLogList.cm'/>" onclick="fn_egov_log_filesysmntrng(); return false;" title='<spring:message code="button.log" />'><spring:message code="button.log" /></a></span>
			</li>
		</ul>
	</div>
	</form>
		...
		<tbody>
			<c:forEach var="result" items="${resultList}" varStatus="status">
			  <tr>
			    ...
			    <td>
			     <form name="fileSysMntrngVO" method="post" action="<c:url value='/utl/sys/fsm/selectFileSysMntrng.cm'/>">
			    	<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
