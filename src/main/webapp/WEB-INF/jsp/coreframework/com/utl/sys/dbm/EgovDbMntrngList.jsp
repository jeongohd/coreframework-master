...
<script type="text/javascript">
    ...
    function fn_egov_get_db_mntrng(dataSourcNm) {
        ...
        document.frm.action = "<c:url value='/utl/sys/dbm/getDbMntrng.cm'/>";
        document.frm.submit();
    }
    /* ********************************************************
     * 등록 처리 함수
    ...
    function fn_egov_regist_db_mntrng(){
        document.frm.action = "<c:url value='/utl/sys/dbm/getDbMntrngForRegist.cm'/>";
        document.frm.submit();
    }
...
<div class="board">
    ...
    <form name="frm" id="frm" action="<c:url value='/utl/sys/dbm/getDbMntrngList.cm'/>" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/utl/sys/dbm/getDbMntrngForRegist.cm'></c:url>" onclick="fn_egov_regist_db_mntrng(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
				<span class="btn_b"><a href="<c:url value='/utl/sys/dbm/getDbMntrngLogList.cm'/>" onclick="fn_egov_log_db_mntrng_list(); return false;" title="로그">로그</a></span>
			</li>
		</ul>
	</div>
		...
		<tbody>
	        ...
	        <c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	          <tr>
	          		...
	          		<td>
	                    <form name="item" method="post" action="<c:url value='/utl/sys/dbm/getDbMntrng.cm'/>">
