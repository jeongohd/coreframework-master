...
<%@page import="coreframework.com.utl.pao.service.EgovPrntngOutpt"  %>
...
<!-- 준비화면  시작-->
<form name="ready" action ="/utl/pao/EgovPrntngOutpt.cm" method="post">
...
<!-- 결과화면 시작 -->
<form name="result" action ="/utl/pao/EgovPrntngOutpt.cm">
...
<table border="1">
   	...
   	<tr>
   		<td>
			<img src="/utl/pao/EgovErncsl.cm?sOrgCode=<c:out value="${sOrgCode}"/>&sErncslSe=<c:out value="${sErncslSe}"/>">
   		</td>
   	</tr>
</table> 
<br>
