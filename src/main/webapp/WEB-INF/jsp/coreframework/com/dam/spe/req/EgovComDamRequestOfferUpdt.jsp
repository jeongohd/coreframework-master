...
<c:set var="JsUrl" value="/js/coreframework/com/dam/spe/req/"/>
<!DOCTYPE html>
<html lang="ko">
<head>
...
function fn_egov_save_RequestOffer(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		...
		vFrom.action = "<c:url value='/dam/spe/req/updtRequestOfferActor.cm'/>";
...
<form:form modelAttribute="requestOfferVO" name="requestOfferVO" action="${pageContext.request.contextPath}/dam/spe/req/updtRequestOffer.cm" method="post" enctype="multipart/form-data" >
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/dam/spe/req/listRequestOffer.cm'/>"><spring:message code="button.list" /></a></span><!-- 목록 -->
	</div>
	<div style="clear:both;"></div>

</div>
<input type="hidden" name="posblAtchFileNumber" id="posblAtchFileNumber" value="3">
<input type="hidden" name="returnUrl" value="<c:url value='/dam/spe/req/updtRequestOffer.cm'/>" >
