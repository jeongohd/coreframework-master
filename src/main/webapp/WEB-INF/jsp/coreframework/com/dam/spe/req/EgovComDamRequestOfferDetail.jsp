...
function fn_egov_modify_RequestOffer(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/dam/spe/req/updtRequestOffer.cm'/>";;
	vFrom.submit();
...
function fn_egov_delete_RequestOffer(){
	...
	if(confirm("삭제 하시겠습니까?")){
		vFrom.cmd.value = 'del';
		vFrom.action = "<c:url value='/dam/spe/req/detailRequestOffer.cm'/>";
		vFrom.submit();
	}else{
		vFrom.cmd.value = '';
	}
...
<div class="wTableFrm">
	...
	<form name="RequestOfferForm" action="<c:url value='/dam/spe/req/detailRequestOffer.cm'/>" method="post">
	...
	<div class="btn">
		...
		<form name="formUpdt" action="<c:url value='/dam/spe/req/updtRequestOffer.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		...
		<form name="formDelete" action="<c:url value='/dam/spe/req/detailRequestOffer.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		...
		<form name="formReply" action="<c:url value='/dam/spe/req/registRequestOffer.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		...
		<form name="formList" action="<c:url value='/dam/spe/req/listRequestOffer.cm'/>" method="post" style="display:inline-block; vertical-align:top">
