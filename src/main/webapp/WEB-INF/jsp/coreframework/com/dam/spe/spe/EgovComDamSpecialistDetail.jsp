...
<html lang="ko">
	<head>
		...
		function fnModify(){
			...
			varForm.action      = "<c:url value='/dam/spe/spe/EgovComDamSpecialistModify.cm'/>";
		...
		function fnDelete(){
			if (confirm("<spring:message code="common.delete.msg" />")) {
				var varForm			= document.all["Form"];
				varForm.action      = "<c:url value='/dam/spe/spe/EgovComDamSpecialistRemove.cm'/>";
				varForm.speId.value = "${result.speId}";
				varForm.knoTypeCd.value = "${result.knoTypeCd}";
				varForm.appTypeCd.value = "${result.appTypeCd}";							
				varForm.submit();
	...
	<div class="wTableFrm">
		...
		<form name="Form" action="<c:url value='/dam/spe/spe/EgovComDamSpecialistModify.cm'/>" method="post">
