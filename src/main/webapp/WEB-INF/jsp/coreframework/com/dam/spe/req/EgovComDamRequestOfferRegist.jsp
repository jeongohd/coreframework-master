...
function fn_egov_save_RequestOffer(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		...
		vFrom.action = "<c:url value='/dam/spe/req/registRequestOfferActor.cm' />";
...
<form:form modelAttribute="requestOfferVO" name="requestOfferVO" action="${pageContext.request.contextPath}/dam/spe/req/registRequestOffer.cm" method="post" enctype="multipart/form-data" >
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/dam/spe/req/listRequestOffer.cm' />"><spring:message code="button.list" /></a></span>
	</div>
