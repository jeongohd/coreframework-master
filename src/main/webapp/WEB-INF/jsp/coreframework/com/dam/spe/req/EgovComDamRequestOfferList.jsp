...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/dam/spe/req/listRequestOffer.cm'/>";
...
function fn_egov_search_RequestOffer(){
	...
	vFrom.action = "<c:url value='/dam/spe/req/listRequestOffer.cm' />";
	vFrom.submit();
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/dam/spe/req/listRequestOffer.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/dam/spe/req/registRequestOffer.cm'/>?pageIndex=<c:out value='${searchVO.pageIndex}'/>" onclick="" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
...
<%-- 데이터를 화면에 출력해준다 --%>
			...
			<tr>
				...
				<td>
					...
					<a href="<c:url value='/dam/spe/req/detailRequestOffer.cm'/>?pageIndex=${searchVO.pageIndex}&amp;knoId=${resultInfo.knoId}"><c:out value="${resultInfo.knoNm}"/></a>
				</td>
