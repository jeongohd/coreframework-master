...
function fn_egov_list_KnoPersonal(){
	location.href = "<c:url value='/dam/per/EgovComDamPersonalList.cm'/>";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_modify_KnoPersonal(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		...
		form.action = "<c:url value='/dam/per/EgovComDamPersonalModify.cm'/>";
...
<form:form modelAttribute="knoPersonal" name="knoPersonal" action="<c:url value='/dam/per/EgovComDamPersonalModifyView.cm'/>" method="post" enctype="multipart/form-data">
...
<input type="hidden" name="returnUrl" value="<c:url value='/dam/per/EgovComDamPersonalModifyView.cm'/>" >
</form:form>
