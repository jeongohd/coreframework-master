...
<html lang="ko">
	<head>
		...
		function fn_egov_list_KnoSpecialist(){
			location.href = "<c:url value='/dam/spe/spe/EgovComDamSpecialistList.cm'/>";
		}
		/* ********************************************************
		 * 저장처리화면
		 ******************************************************** */
		 function fn_egov_regist_KnoSpecialist(form){
			if(confirm("<spring:message code="common.save.msg" />")){
				if(!validateKnoSpecialist(form)){ 			
					...
					form.action = "<c:url value='/dam/spe/spe/EgovComDamSpecialistRegist.cm'/>";
					form.submit();
				}
			}
		}		
		...
		function fn_egov_inqire_user(){
			var retVal;
			var url = "<c:url value='/cop/com/openPopup.cm?requestUrl=/cop/com/selectUserList.cm&width=850&height=700'/>";
		...
		<table class="wTable">
			...
			<tr>
				...
				<td class="left">
					...
					<img src="<c:url value='/images/coreframework/com/cmm/icon/search.gif' />" alt="search"/></a>
