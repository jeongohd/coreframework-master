...
<html lang="ko">
	<head>
		...
		function linkPage(pageNo){
			...
			document.listForm.action = "<c:url value='/dam/spe/spe/EgovComDamSpecialistList.cm'/>";
		 ...
		 ******************************************************** */
		function fnRegist(){
			location.href = "<c:url value='/dam/spe/spe/EgovComDamSpecialistRegist.cm'/>";
		}
		/* ********************************************************
		 * 수정 처리 함수
		 ******************************************************** */
	...
	<div class="board">
		...
		<form name="listForm" action="<c:url value='/dam/spe/spe/EgovComDamSpecialistList.cm'/>" method="post">
		<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
			<ul>
				<li>
					...
					<span class="btn_b"><a href="<c:url value='/dam/spe/spe/EgovComDamSpecialistRegist.cm'/>" onclick="" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span><!-- 등록 -->
				</li>
			</ul>
		</div>
			...
			<tbody>
				<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
					<tr>					
						...
						<td>
						<a href="<c:url value='/dam/spe/spe/EgovComDamSpecialist.cm?pageIndex=${searchVO.pageIndex}&amp;speId=${resultInfo.speId}&amp;knoTypeCd=${resultInfo.knoTypeCd}&amp;appTypeCd=${resultInfo.appTypeCd}'/>"><c:out value="${resultInfo.userNm}"/></a>
						</td>								
					    <td>
