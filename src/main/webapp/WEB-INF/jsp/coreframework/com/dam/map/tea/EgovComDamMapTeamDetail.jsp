...
<html lang="ko">
	<head>
		 ...
		 ******************************************************** */
		function fnList(){
			location.href = "<c:url value='/dam/map/tea/EgovComDamMapTeamList.cm'/>";
		}
		/* ********************************************************
		 * 수정화면으로  바로가기
		 ******************************************************** */
		function fnModify(){
			...
			varForm.action           = "<c:url value='/dam/map/tea/EgovComDamMapTeamModify.cm'/>";
		...
		function fnDelete(){
			if (confirm("<spring:message code="common.delete.msg" />")) {
				var varForm				 = document.all["Form"];
				varForm.action           = "<c:url value='/dam/map/tea/EgovComDamMapTeamRemove.cm'/>";
				varForm.orgnztId.value   = "${result.orgnztId}";
				varForm.submit();
			}
		}
	...
	<form name="Form" action="<c:url value='/dam/map/tea/EgovComDamMapTeamModify.cm'/>" method="post">
