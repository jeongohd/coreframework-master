...
<html lang="ko">
	<head>
		...
		function fnModify(){
			...
			varForm.action      = "<c:url value='/dam/per/EgovComDamPersonalModifyView.cm'/>";
		...
		function fnDelete(){
			if (confirm("<spring:message code="common.delete.msg" />")) {
				var varForm			= document.all["Form"];
				varForm.action      = "<c:url value='/dam/per/EgovComDamPersonalRemove.cm'/>";
				varForm.knoId.value = "${result.knoId}";
				varForm.submit();
			}
		}
	...
	<form name="Form" action="<c:url value='/dam/per/EgovComDamPersonalModify.cm'/>" method="post">
