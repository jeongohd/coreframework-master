...
<html lang="ko">
	<head>
		...
		function linkPage(pageNo){
			...
			document.listForm.action = "<c:url value='/dam/mgm/EgovComDamManagementList.cm'/>";
	...
	<div class="board">
		...
		<form name="listForm" action="<c:url value='/dam/mgm/EgovComDamManagementList.cm'/>" method="post">
			...
			<tbody>
				<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
					<tr>
						...
						<td>
						<a href="<c:url value='/dam/mgm/EgovComDamManagement.cm'/>?pageIndex=${searchVO.pageIndex}&amp;knoId=${resultInfo.knoId}"><c:out value="${resultInfo.knoNm}"/></a>
						</td>															
