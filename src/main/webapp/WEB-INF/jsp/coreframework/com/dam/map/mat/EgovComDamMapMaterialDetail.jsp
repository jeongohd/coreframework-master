...
<html lang="ko">
	<head>
		...
		function fnModify(){
			...
			varForm.action           = "<c:url value='/dam/map/mat/EgovComDamMapMaterialModify.cm'/>";
		...
		function fnDelete(){
			if (confirm("<spring:message code="common.delete.msg" />")) {
				var varForm				 = document.all["Form"];
				varForm.action           = "<c:url value='/dam/map/mat/EgovComDamMapMaterialRemove.cm'/>";
				varForm.knoTypeCd.value   = "${result.knoTypeCd}";
				varForm.submit();
			}
		}
	...
	<form name="Form" action="<c:url value='/dam/map/mat/EgovComDamMapMaterialModify.cm'/>" method="post">
