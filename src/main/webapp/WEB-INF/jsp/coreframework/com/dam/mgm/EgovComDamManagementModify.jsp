...
<html lang="ko">
	<head>
		...
		function fn_egov_list_KnoManagement(){
			location.href = "<c:url value='/dam/mgm/EgovComDamManagementList.cm'/>";
		}
		/* ********************************************************
		 * 저장처리화면
		 ******************************************************** */
	...
	<form:form modelAttribute="knoManagement" name="knoManagement" action="${pageContext.request.contextPath}/dam/mgm/EgovComDamManagementModify.cm" method="post">
