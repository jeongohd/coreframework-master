...
function fnSearch(){
	...
	document.listForm.action = "<c:url value='/sts/cst/selectConectStats.cm'/>";
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/sts/cst/selectConectStats.cm'/>" method="post">
		        ...
		        <c:forEach items="${conectStats}" var="resultInfo" varStatus="status">
			      <tr>
			        ...
			        <td width="560" height="10">
					  <img src="<c:url value='/images/coreframework/com/cmm/left_bg.gif' />" width="<c:out value='${resultInfo.statsCo * statsInfo.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.statsCo}&nbsp;<spring:message code="comStsCst.conectStats.results.unit"/> <!-- 회 -->
					</td>
			      </tr>
			    </c:forEach>
