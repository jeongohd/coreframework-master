...
<script type="text/javascript" language="javascript1.2" src="<c:url value='/js/coreframework/com/sts/sst/treemenu.js' />" ></script>
...
function fnSearch(){
	...
	document.listForm.action = "<c:url value='/sts/sst/selectScrinStats.cm'/>";
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/sts/sst/selectScrinStats.cm'/>" method="post">
	    ...
	    <input type="hidden" name="req_RetrunPath" value="/sym/mpm/CoreMenuList">
			        ...
			        <c:forEach items="${scrinStats}" var="resultInfo" varStatus="status">
				      <tr>
				        ...
				        <td width="350" height="10">
						  <img src="<c:url value='/images/coreframework/com/cmm/left_bg.gif' />" width="<c:out value='${resultInfo.statsCo * statsInfo.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.statsCo}&nbsp;<spring:message code="comStsSst.scrinStats.results.unit"/> <!-- 회 -->
						</td>
				      </tr>
				    </c:forEach>
			      </table>
