...
function fncSelectDtaUseStatsList() {
    ...
    varFrom.action = "<c:url value='/sts/dst/selectDtaUseStatsList.cm'/>";
    varFrom.submit();
}
...
<form:form modelAttribute="dtaUseStats" method="post" action="${pageContext.request.contextPath}/sts/dst/selectDtaUseStatsList.cm">
<div class="board">
	<h1>${pageTitle}</h1>
