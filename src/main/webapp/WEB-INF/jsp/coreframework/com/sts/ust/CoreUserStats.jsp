...
function fnSearch(){
	...
	document.listForm.action = "<c:url value='/sts/ust/coreUserStatsList.cm'/>";
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/sts/ust/coreUserStatsList.cm'/>" method="post">
        ...
        <c:forEach items="${userStats}" var="resultInfo" varStatus="status">
	      <tr>
	        ...
	        <td width="90%" height="10">
			  <img src="<c:url value='/images/coreframework/com/cmm/left_bg.gif'/>" width="<c:out value='${resultInfo.statsCo * statsInfo.maxUnit}'/>" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.statsCo}&nbsp;명
			</td>
	      </tr>
	    </c:forEach>
