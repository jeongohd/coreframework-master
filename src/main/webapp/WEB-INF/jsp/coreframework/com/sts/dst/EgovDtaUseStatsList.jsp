...
function fncSelectDtaUseStatsList(pageNo) {
    ...
    document.listForm.action = "<c:url value='/sts/dst/selectDtaUseStatsList.cm'/>";
...
function fncSelectDtaUseStats(bbsId, nttId, atchFileId, fileSn) {
    ...
    document.listForm.action = "<c:url value='/sts/dst/getDtaUseStats.cm'/>";
    document.listForm.submit();
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/sts/dst/selectDtaUseStatsList.cm'/>" method="post">
		...
		<tbody>
			...
			<tr>
				<td class="lt_text3" nowrap>
					<form name="item" method="post" action="<c:url value='/sts/dst/getDtaUseStats.cm'/>">
...
<div class="board">
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
	    ...
	    <tr>
	      ...
	      <td width="90%"><img src="<c:url value='/images/coreframework/com/cmm/left_bg.gif'/>" width="<c:out value='${dtaUseStatsBar.grpCnt * dtaUseStatsVO.maxUnit}'/>" height="10" align="left" alt="">&nbsp;&nbsp;<c:out value="${dtaUseStatsBar.grpCnt}"/> <spring:message code="comStsDst.dtaUseStats.results.unit"/></td>
	    </tr>
	    </c:forEach>
	</table>
