...
function fnSearch(){
	...
	document.listForm.action = "<c:url value='/sts/bst/selectBbsStats.cm'/>";
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/sts/bst/selectBbsStats.cm'/>" method="post">
	...
	<div id="tab1" style="display:none;">
		...
		<colgroup>
			...
			<tr>
		    	...
		    	<td>
					<img src="<c:url value='/images/coreframework/com/cmm/left_bg.gif' />" width="<c:out value='${resultInfo.statsCo * statsInfo.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.statsCo}&nbsp;개
				</td>
		    </tr>
			</c:forEach>
	...
	<div id="tab2" style="display:none;">
		...
		<colgroup>
			...
			<tr>
		   		<td>${resultInfo.statsDate}</td>
		    	<td>
					<img src="<c:url value='/images/coreframework/com/cmm/left_bg.gif' />" width="<c:out value='${resultInfo.statsCo * statsInfo.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.statsCo}&nbsp;회
				</td>
		    </tr>
			</c:forEach>
			<c:if test="${fn:length(bbsStatsList) == 0}">
