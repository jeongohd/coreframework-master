...
<script type="text/javascript" src="<c:url value='/js/coreframework/com/sym/cal/EgovCalPopup.js' />"></script>
...
function fncSelectReprtStatsList(pageNo) {
    ...
    document.listForm.action = "<c:url value='/sts/rst/selectReprtStatsList.cm'/>";
...
function fncSelectReprtStats(reprtTy, reprtSttus) {
    ...
    document.listForm.action = "<c:url value='/sts/rst/getReprtStats.cm'/>";
    document.listForm.submit();
}
...
function fncAddReprtStatsInsert() {
    ...
    document.listForm.action = "<c:url value='/sts/rst/addViewReprtStats.cm'/>";
    document.listForm.submit();
}
...
<form name="listForm" action="<c:url value='/sts/rst/selectReprtStatsList.cm'/>" method="post">
...
<input type="hidden" name="searchCondition" value="1">	
			 ...
			 <c:forEach var="reprtStats" items="${reprtStatsList}" varStatus="status">
			  <tr>
			    <td class="lt_text3" nowrap>
			        <form name="item" method="post" action="<c:url value='/sts/rst/getReprtStats.cm'/>">
	...
	<table class="e001 mb10">
	    ...
	    <tr>
	      ...
	      <td>
	      	<img src="<c:url value='/images/coreframework/com/cmm/left_bg.gif' />" width="<c:out value='${reprtStatsBar.grpCnt * reprtStatsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;<c:out value="${reprtStatsBar.grpCnt}" /> <spring:message code="comStsRst.reprtStats.results.unit"/> <!-- 개 -->
	      </td>
	    </tr>
	    </c:forEach>
	</table>
	...
	<table class="e001 mb10">
	    ...
	    <tr>
	      ...
	      <td>
	      	<img src="<c:url value='/images/coreframework/com/cmm/left_bg.gif' />" width="<c:out value='${reprtStatsByReprtTy.grpReprtTyCnt * reprtStatsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;<c:out value="${reprtStatsByReprtTy.grpReprtTyCnt}" /> <spring:message code="comStsRst.reprtStats.results.unit"/>
	      </td>
	    </tr>
	    </c:forEach>
	</table>
	...
	<table class="e001 mb10">
	    ...
	    <tr>
	      ...
	      <td>
	      	<img src="<c:url value='/images/coreframework/com/cmm/left_bg.gif' />" width="<c:out value='${reprtStatsByReprtSttus.grpReprtSttusCnt * reprtStatsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;<c:out value="${reprtStatsByReprtSttus.grpReprtSttusCnt}" /> <spring:message code="comStsRst.reprtStats.results.unit"/>
	      </td>
	    </tr>
	    </c:forEach>
	</table>
