...
function fncSelectReprtStatsList() {
    ...
    varFrom.action = "<c:url value='/sts/rst/selectReprtStatsList.cm'/>";
    varFrom.submit();
}
...
function fncReprtStatsInsert() {
    ...
    var varFrom = document.getElementById("reprtStats");
    varFrom.action = "<c:url value='/sts/rst/addReprtStats.cm'/>";
...
function fncReprtStatsUpdate() {
    var varFrom = document.getElementById("reprtStats");
    varFrom.action = "<c:url value='/sts/rst/updtReprtStats.cm'/>";
...
function fncReprtStatsDelete() {
    var varFrom = document.getElementById("reprtStats");
    varFrom.action = "<c:url value='/sts/rst/removeReprtStats.cm'/>";
...
<form:form modelAttribute="reprtStats" method="post" action="${pageContext.request.contextPath}/sts/rst/addReprtStats.cm' />">
