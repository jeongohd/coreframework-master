...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/coreframework/com/ext/msg/table.css'/>"/>
...
<script>
	...
	function openPopup(roomId) {
		...
		popupPost("<c:url value='/cop/msg/websocketMessengePopup.cm'/>", targetTitle, popOptions);
	}
