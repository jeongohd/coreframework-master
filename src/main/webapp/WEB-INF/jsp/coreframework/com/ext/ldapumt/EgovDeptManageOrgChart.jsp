...
<html>
  <head>
	...
	<script src="<c:url value='/html/coreframework/com/ext/ldapumt/libs/jquery.js' />"></script>
	<script src="<c:url value='/html/coreframework/com/ext/ldapumt/jstree.js' />"></script>
	<script type="text/javascript">
	  ...
	  function drawChart(dn){
		...
		var url = "<c:url value='/ext/ldapumt/dpt/getDeptManageSublist.cm' />";
