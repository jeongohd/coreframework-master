...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/coreframework/com/ext/msg/button.css'/>"/>
...
<script>
	$(document).ready(function() {
		$('#connectMsgBtn').click(function() {
			...
			form.attr("action", "<c:url value='/cop/msg/websocketMessengerMain.cm'/>");
