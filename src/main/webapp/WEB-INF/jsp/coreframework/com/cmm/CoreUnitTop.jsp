...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/coreframework/com/cmm/main.css' />">
...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	var logoutUrl = "<c:url value='/uat/uia/actionLogout.cm'/>";
	var timer;
	...
	function reqTimeAjax() {
		...
		$.ajax({
		    url:'${pageContext.request.contextPath}/uat/uia/refreshSessionTimeout.cm', //request 보낼 서버의 경로
...
<div id="header">
	<div class="header_box">
		<h1>
			<a href="<c:url value='/CoreContent.cm' />" target="_content"><img src="<c:url value='/images/coreframework/com/cmm/main/top_logo.png' />" alt="eGovframe"></a>
		</h1>
