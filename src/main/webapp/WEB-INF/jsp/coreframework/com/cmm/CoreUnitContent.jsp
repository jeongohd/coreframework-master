...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var page = "${pageContext.request.contextPath}/uat/uia/noticeExpirePwd.cm";
...
<body>
	<c:if test="${loginVO != null}">
		${loginVO.name}(${loginVO.id})<spring:message code="comCmm.unitContent.2"/> <a href="${pageContext.request.contextPath }/uat/uia/actionLogout.cm"><spring:message code="comCmm.unitContent.3"/></a>
		<!--
	...
	<c:if test="${loginVO == null }">
		<jsp:forward page="/uat/uia/coreLoginUsr.cm"/>
	</c:if>
	<p/><p/><p/>
	<b><spring:message code="comCmm.unitContent.4"/><br /><br/><!-- 실행 시 오류 사항이 있으시면 표준프레임워크센터로 연락하시기 바랍니다. -->
	<b><img src="${pageContext.request.contextPath }/images/coreframework/com/cmm/icon/tit_icon.png"> <spring:message code="comCmm.unitContent.5"/></b><p/><!-- 화면 설명 -->
	...
	<br /><b><img src="${pageContext.request.contextPath }/images/coreframework/com/cmm/icon/tit_icon.png"> coreframework.com.cmm.web.CoreComIndexController.java</b><p/>
