...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/coreframework/com/cmm/modal.css' />">
<script src="<c:url value='/js/coreframework/com/cmm/modal.js' />"></script>
<%} %>
<!-- The Modal -->
<div id="<%=CoreWebUtil.clearXSSMaximum(sModelName) %>" class="modal">
	<!-- Modal content -->
	<div class="modal-content">
		<div class="modal-header">
			<span class="close"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_close.png'/>" /></span>
