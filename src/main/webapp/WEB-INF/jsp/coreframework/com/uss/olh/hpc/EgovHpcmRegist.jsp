 ...
 * 저장처리화면
 ******************************************************** */
function fn_egov_regist_hpcm(form){
...
<form:form modelAttribute="hpcmVO" action="${pageContext.request.contextPath}/uss/olh/hpc/insertHpcm.cm" method="post" onSubmit="fn_egov_regist_hpcm(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
