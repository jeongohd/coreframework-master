...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/olp/mgt/EgovMeetingManageList.cm'/>";
...
function fn_egov_regist_MeetingManage(){
	location.href = "<c:url value='/uss/olp/mgt/EgovMeetingManageRegist.cm' />";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
function fn_egov_modify_MeetingManage(){
	location.href = "<c:url value='/uss/olp/mgt/EgovMeetingManageModify.cm' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_MeetingManage(mtgId){
	...
	vFrom.action = "<c:url value='/uss/olp/mgt/EgovMeetingManageDetail.cm' />";
	vFrom.submit();
}
/* ********************************************************
 * 삭제 처리 함수
...
function fn_egov_delete_MeetingManage(mtgId){
	...
	if(confirm("<spring:message code="common.delete.msg"/>")){/* 삭제 하시겠습니까? */
		vFrom.mtgId.value = mtgId;
		vFrom.cmd.value = 'del';
		vFrom.action = "<c:url value='/uss/olp/mgt/EgovMeetingManageList.cm' />";
		vFrom.submit();
	}else{
		vFrom.cmd.value = '';
	}
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/olp/mgt/EgovMeetingManageRegist.cm' />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="<c:url value='/uss/olp/mgt/EgovMeetingManageDetail.cm'/>?mtgId=${resultInfo.mtgId}&pageIndex=${searchVO.pageIndex}" onClick="fn_egov_detail_MeetingManage('<c:out value="${resultInfo.mtgId}"/>');return false;"><c:out value="${resultInfo.mtgDe}"/></a>
					
				</td>
				<td>
					<a href="<c:url value='/uss/olp/mgt/EgovMeetingManageDetail.cm'/>?mtgId=${resultInfo.mtgId}&pageIndex=${searchVO.pageIndex}" onClick="fn_egov_detail_MeetingManage('<c:out value="${resultInfo.mtgId}"/>');return false;"><c:out value="${resultInfo.mtgNm}"/></a>
				</td>
