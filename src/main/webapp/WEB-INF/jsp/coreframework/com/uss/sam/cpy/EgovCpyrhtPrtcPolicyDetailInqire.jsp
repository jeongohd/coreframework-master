...
function fn_egov_updt_cpyrhtprtcpolicycn(cpyrhtId){
	...
	document.CpyrhtPrtcPolicyForm.action = "<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyCnUpdtView.cm'/>";
	document.CpyrhtPrtcPolicyForm.submit();	
...
function fn_egov_delete_cpyrhtprtcpolicycn(cpyrhtId){
	...
	if	(confirm("<spring:message code="common.delete.msg" />"))	{	
		...
		// Delete하기 위한 키값을 셋팅
		document.CpyrhtPrtcPolicyForm.cpyrhtId.value = cpyrhtId;	
		document.CpyrhtPrtcPolicyForm.action = "<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyCnDelete.cm'/>";
		document.CpyrhtPrtcPolicyForm.submit();
...
<body>
<form name="CpyrhtPrtcPolicyForm" action="<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyDetailInqire.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyCnDelete.cm'/>?cpyrhtId=<c:out value='${result.cpyrhtId}'/>" onclick="fn_egov_delete_cpyrhtprtcpolicycn('<c:out value="${result.cpyrhtId}"/>'); return false;"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyListInqire.cm'/>" onclick="fn_egov_inqire_cpyrhtprtcpolicylist(); return false;"><spring:message code="button.list" /></a></span>
	</div>
