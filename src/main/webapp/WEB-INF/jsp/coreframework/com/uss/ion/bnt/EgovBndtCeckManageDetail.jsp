...
function fncBndtCeckManageList() {
    ...
    varFrom.action = "<c:url value='/uss/ion/bnt/EgovBndtCeckManageList.cm'/>";
    varFrom.submit();       
}
 ...
 ******************************************************** */
 function fncEgovBndtCeckManage() {
		...
		varFrom.action = "<c:url value='/uss/ion/bnt/EgovBndtCeckManage.cm'/>";
		varFrom.submit();   
 }
 ...
 function fncDeleteBndtCeckManage() {
     var varFrom = document.getElementById("bndtCeckManage");
     varFrom.action = "<c:url value='/uss/ion/bnt/deleteBndtCeckManage.cm'/>";
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/uss/ion/bnt/EgovBndtCeckManage.cm'/>?cmd=updt&bndtCeckSe=<c:out value='${bndtCeckManageVO.bndtCeckSe}'/>&bndtCeckCd=<c:out value='${bndtCeckManageVO.bndtCeckCd}'/>" onclick="fncEgovBndtCeckManage(); return false;"><spring:message code="button.update" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/bnt/deleteBndtCeckManage.cm'/>?bndtCeckSe=<c:out value='${bndtCeckManageVO.bndtCeckSe}'/>&bndtCeckCd=<c:out value='${bndtCeckManageVO.bndtCeckCd}'/>" onclick="fncDeleteBndtCeckManage(); return false;"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/bnt/EgovBndtCeckManageList.cm'/>" onclick="fncBndtCeckManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
