...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/olp/qmc/EgovQustnrManageListPopup.cm'/>";
...
function fn_egov_search_QustnrManage(){
	...
	vFrom.action = "<c:url value='/uss/olp/qmc/EgovQustnrManageListPopup.cm' />";
	vFrom.submit();
...
<form name="ListForm" action="<c:url value='/uss/olp/qmc/EgovQustnrManageListPopup.cm'/>" method="post" onSubmit="fn_egov_search_QustnrManage(); return false;">
