...
function fncEgovRwardManageList(){
	location.href = "<c:url value='/uss/ion/rwd/selectRwardManageList.cm'/>";
}
...
function fncEgovRwardManage() {
		...
		varFrom.action = "<c:url value='/uss/ion/rwd/EgovRwardManageDetail.cm'/>";
		varFrom.submit();   
}
/* ********************************************************
* 삭제처리화면
...
function fncDeleteRwardManage() {
	    var varFrom = document.getElementById("rwardManage");
	    varFrom.action = "<c:url value='/uss/ion/rwd/deleteRwardManage.cm'/>";
...
<div class="wTableFrm">
	...
	<div class="btn">
		<c:if test="${rwardManageVO.confmAt eq 'A' }">
		<span class="btn_s"><a href="<c:url value='/uss/ion/rwd/EgovRwardManageDetail.cm'/>?cmd=updt&rwardId=<c:out value='${rwardManageVO.rwardId}'/>" onclick="fncEgovRwardManage(); return false;"><spring:message code="button.update" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/rwd/deleteRwardManage.cm'/>?cmd=delete&rwardId=<c:out value='${rwardManageVO.rwardId}'/>&infrmlSanctnId=<c:out value='${rwardManageVO.infrmlSanctnId}'/>" onclick="fncDeleteRwardManage(); return false;"><spring:message code="button.delete" /></a></span>
        </c:if>
        <span class="btn_s"><a href="<c:url value='/uss/ion/rwd/selectRwardManageList.cm'/>?searchCondition=1" onclick="fncEgovRwardManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
