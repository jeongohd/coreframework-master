...
function fncIntnetSvcGuidanceInsert() {
    ...
    var varFrom = document.getElementById("intnetSvcGuidance");
    varFrom.action = "<c:url value='/uss/ion/isg/addIntnetSvcGuidance.cm'/>";
...
<form:form modelAttribute="intnetSvcGuidance" name="intnetSvcGuidance" method="post" action="${pageContext.request.contextPath}/uss/ion/isg/addIntnetSvcGuidance.cm" >
