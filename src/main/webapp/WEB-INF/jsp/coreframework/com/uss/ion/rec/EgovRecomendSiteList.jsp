...
function fn_egov_select_linkPage(pageNo){
	...
	document.recomendSiteForm.action = "<c:url value='/uss/ion/rec/selectRecomendSiteList.cm'/>";
...
function fn_egov_inquire_sitedetail(recomendSiteId) {
	...
	document.recomendSiteForm.recomendSiteId.value = recomendSiteId;
  	document.recomendSiteForm.action = "<c:url value='/uss/ion/rec/selectRecomendSiteDetail.cm'/>";
  	document.recomendSiteForm.submit();
}
</script>
</head>
...
<form name="recomendSiteForm" action="<c:url value='/uss/ion/rec/selectRecomendSiteList.cm'/>" method="post" onSubmit="fn_egov_search_site(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/rec/insertRecomendSiteView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td><a href="<c:url value='/uss/ion/rec/selectRecomendSiteDetail.cm?recomendSiteId=${resultInfo.recomendSiteId}'/>" onClick="fn_egov_inquire_sitedetail('<c:out value="${resultInfo.recomendSiteId}"/>');return false;"><c:out value='${fn:substring(resultInfo.recomendSiteNm, 0, 40)}'/></a></td>
