 ...
 ******************************************************** */
 ...
 function linkPage(pageNo){
	...
	varForm.action = "<c:url value='/uss/ion/bnt/EgovBndtCeckManageList.cm'/>";
	varForm.submit();
 }
...
function fncBndtCeckManageRegist(){
	location.href = "<c:url value='/uss/ion/bnt/EgovBndtCeckManageRegist.cm'/>";
}
...
function fncBndtCeckManageDetail(bndtCeckSe, bndtCeckCd){
	...
	varForm.action           = "<c:url value='/uss/ion/bnt/EgovBndtCeckManage.cm'/>";
	varForm.submit();
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/uss/ion/bnt/EgovBndtCeckManageList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/bnt/EgovBndtCeckManageRegist.cm'/>?searchCondition=1" onclick="fncBndtCeckManageRegist(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	</form>
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
		        <form name="item" method="post" action="<c:url value='/uss/ion/bnt/EgovBndtCeckManage.cm'/>">
