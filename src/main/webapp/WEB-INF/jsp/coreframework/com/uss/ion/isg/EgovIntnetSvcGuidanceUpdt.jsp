...
function fncSelectIntnetSvcGuidanceList() {
    ...
    varFrom.action = "<c:url value='/uss/ion/isg/selectIntnetSvcGuidanceList.cm'/>";
    varFrom.submit();
}
...
function fncIntnetSvcGuidanceUpdate() {
    ...
    var varFrom = document.getElementById("intnetSvcGuidance");
    varFrom.action = "<c:url value='/uss/ion/isg/updtIntnetSvcGuidance.cm'/>";
...
function fncIntnetSvcGuidanceDelete() {
    var varFrom = document.getElementById("intnetSvcGuidance");
    varFrom.action = "<c:url value='/uss/ion/isg/removeIntnetSvcGuidance.cm'/>";
...
<form:form modelAttribute="intnetSvcGuidance" name="intnetSvcGuidance" method="post" action="${pageContext.request.contextPath}/uss/ion/isg/updtIntnetSvcGuidance.cm" >
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/isg/removeIntnetSvcGuidance.cm'/>?intnetSvcId=<c:out value='${intnetSvcGuidanceVO.intnetSvcId}'/>" onclick="fncIntnetSvcGuidanceDelete(); return false;"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/isg/selectIntnetSvcGuidanceList.cm'/>?pageIndex=<c:out value='${intnetSvcGuidanceVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${intnetSvcGuidanceVO.searchKeyword}"/>&amp;searchCondition=1" onclick="fncSelectIntnetSvcGuidanceList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
