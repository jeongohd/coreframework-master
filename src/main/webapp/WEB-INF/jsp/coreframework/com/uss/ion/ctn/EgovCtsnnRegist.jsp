...
<script type="text/javaScript" language="javascript">
	...
	function fncInsertEgovCtsnnManage() {
	    ...
	    varFrom.action = "<c:url value='/uss/ion/ctn/insertCtsnnManage.cm'/>";
	...
	function modalDialogCallback(retVal) {
		if(retVal != null){
			...
			document.ctsnnManage.action = "<c:url value='/uss/ion/ctn/EgovCtsnnRegist.cm'/>";
	 ...
	 $(document).ready(function () {
	        $('#CtsnnRegist').click(function (e) {
	            ...
	            var page = "<c:url value='/uss/ion/ism/selectSanctnerListNew.cm'/>";
...
<div class="wTableFrm">
	...
	<table class="wTable mb10">
		...
		<tr>
			...
			<td class="left">
			    ...
			    <span class="link">
			    <a id="CtsnnRegist" title="<spring:message code="comUssIonRwd.common.searchNm"/>" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />"
	...
	<!-- 결재권자 지정 Include -->
	<c:import url="/WEB-INF/jsp/coreframework/com/uss/ion/ism/EgovInfrmlSanctnRegist.jsp" charEncoding="utf-8"/>
	<!-- //결재권자 지정 Include -->
