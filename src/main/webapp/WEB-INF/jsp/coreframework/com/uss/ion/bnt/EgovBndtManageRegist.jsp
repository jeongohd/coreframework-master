...
<script type="text/javaScript" language="javascript" defer="defer">
	 ...
	 ******************************************************** */
	 function fncInsertBndtManage() {
		    ...
		    varForm.action = "<c:url value='/uss/ion/bnt/insertBndtManage.cm'/>";
	...
	function modalDialogCallback(retVal) {
		if(retVal != null){
			...
			document.bndtManage.action = "<c:url value='/uss/ion/bnt/EgovBndtManageRegist.cm'/>";
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			  ...
			  <a id="BndtRegist" title="<spring:message code="comUssIonBnt.common.bndtIdName"/>" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />"
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/bnt/EgovBndtManageList.cm'/>?searchCondition=1" onclick="fncBndtManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
