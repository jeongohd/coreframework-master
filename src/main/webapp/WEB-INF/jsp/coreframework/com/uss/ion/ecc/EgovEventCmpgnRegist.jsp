...
<form:form modelAttribute="eventCmpgnVO" action="${pageContext.request.contextPath}/uss/ion/ecc/insertEventCmpgn.cm" method="post" onSubmit="fn_egov_regist_event(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/ecc/selectEventCmpgnList.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
