...
function fn_egov_modify_QustnrRespondManage(){
	...
	vFrom.action = "<c:url value='/uss/olp/qrm/EgovQustnrRespondManageModify.cm' />";;
	vFrom.submit();
...
<div class="wTableFrm">
<form name="QustnrRespondManageForm" id="QustnrRespondManageForm" action="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageModify.cm'/>" method="post">
	<!-- 타이틀 -->
	...
	<div class="btn">
		<!-- 수정 버튼 -->
		<form name="formUpdt" action="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageModify.cm'/>" method="post" onsubmit="fn_egov_modify_QustnrRespondManage(document.forms[0]); return false;" style="float:left;">
			<input type="submit" class="s_submit" value="<spring:message code='button.update' />" title="<spring:message code='title.update' /> <spring:message code='input.button' />" />
			<input name="qestnrRespondId" type="hidden" value="${resultList[0].qestnrRespondId}">
		</form>
		<!-- 삭제 버튼 -->
		<form name="formDelete" action="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageDetail.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<!-- 목록 버튼 -->
		<form name="formList" action="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageList.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
