...
function fncUpdtEventReqstManage() {
    ...
    varFrom.action = "<c:url value='/uss/ion/evt/EgovEventReqstSave.cm'/>";
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/evt/EgovEventReqstManageList.cm'/>?searchCondition=1" onclick="fncEventReqstManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
