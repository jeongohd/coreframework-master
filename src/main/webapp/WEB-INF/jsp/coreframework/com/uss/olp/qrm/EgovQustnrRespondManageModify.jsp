...
function fn_egov_list_QustnrRespondManage(){
	location.href = "<c:url value='/uss/olp/qrm/EgovQustnrRespondManageList.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_save_QustnrRespondManage(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/uss/olp/qrm/EgovQustnrRespondManageModify.cm' />";
 ...
 ******************************************************** */
 function fn_egov_QustnrManageListPopup_QustnrItemManage(){
 	...
 	window.showModalDialog("<c:url value='/uss/olp/qmc/EgovQustnrManageListPopup.cm' />", self,"dialogWidth800px;dialogHeight500px;resizableyes;centeryes");
  ...
  ******************************************************** */
  function fn_egov_QustnrQestnManageListPopup_QustnrItemManage(){
	...
	sParam = sParam + "&searchKeyword=" + document.getElementById("qestnrId").value;
  	...
  	window.showModalDialog("<c:url value='/uss/olp/qrm/EgovQustnrQestnManageListPopup.cm' />?" + sParam, self,"dialogWidth800px;dialogHeight500px;resizableyes;centeryes");
...
function fn_egov_QustnrItemManageListPopup_QustnrItemManage(){
	...
	sParam = sParam + "&searchKeyword=" + document.getElementById("qestnrQesitmId").value;
  	...
  	window.showModalDialog("<c:url value='/uss/olp/qim/EgovQustnrItemManageListPopup.cm' />?" + sParam, self,"dialogWidth800px;dialogHeight500px;resizableyes;centeryes");
...
<div class="wTableFrm">
<!-- 상단타이틀 -->
<form:form modelAttribute="qustnrRespondManageVO" name="qustnrRespondManageVO" action="${pageContext.request.contextPath}/uss/olp/qrm/EgovQustnrRespondManageModify.cm" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrItemManage(document.forms[0]); return false;">
...
<div class="btn">
	...
	<!-- 목록버튼 -->	
	<span class="btn_s"><a href="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageList.cm' />"   title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
