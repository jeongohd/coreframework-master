...
function fn_egov_inqire_list() {
	hpcmVO.action = "<c:url value='/uss/olh/hpc/selectHpcmList.cm'/>";
	hpcmVO.submit();	
}
</script>
</head>
...
<!-- 상단타이틀 -->
<form:form modelAttribute="hpcmVO" action="${pageContext.request.contextPath}/uss/olh/hpc/updateHpcm.cm" method="post" onSubmit="fn_egov_updt_hpcm(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/hpc/selectHpcmList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
