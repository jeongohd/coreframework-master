...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <%=CoreWebUtil.clearXSSMinimum(""+status.isFavorited()) %>
			</td>
		</tr>
		<tr>
			<th><spring:message code="ussIonTir.twitterTrnsmitResult.isRetweet"/></th>
			<td class="left">
			    <%=CoreWebUtil.clearXSSMinimum(""+status.isRetweet()) %>
			</td>
		</tr>
		<tr>
			<th><spring:message code="ussIonTir.twitterTrnsmitResult.isTruncated"/></th>
			<td class="left">
			    <%=CoreWebUtil.clearXSSMinimum(""+status.isTruncated()) %>
			</td>
		</tr>
	</table>
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/uss/ion/tir/registTwitterTrnsmit.cm'/>" onclick=""><spring:message code="ussIonTir.twitterTrnsmitResult.confirm"/></a></span><!-- 확인 -->
	</div>
