...
function fn_egov_regist_cnsltdtls(form){
		...
		if (!validateCnsltManageVO(form)) {
			...
			if(confirm("<spring:message code="common.regist.msg" />")){	
				form.action = "<c:url value='/uss/olp/cns/CnsltDtlsRegist.cm'/>";
				form.submit();
				return true;
			}
...
<form:form modelAttribute="cnsltManageVO" action="${pageContext.request.contextPath}/uss/olp/cns/CnsltDtlsRegist.cm" method="post" enctype="multipart/form-data" onSubmit="fn_egov_regist_cnsltdtls(document.forms[0]); return false;">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olp/cns/CnsltListInqire.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
