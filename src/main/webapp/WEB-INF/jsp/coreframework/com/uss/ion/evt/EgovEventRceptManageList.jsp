 ...
 ******************************************************** */
 ...
 function linkPage(pageNo){
	...
	varForm.action = "<c:url value='/uss/ion/evt/EgovEventRcrptManageList.cm'/>";
	varForm.submit();
 }
...
function fncEventRceptRegist(eventId){
	...
	varForm.action           = "<c:url value='/uss/ion/evt/EgovEventRceptRegist.cm'/>";
	varForm.submit();
}
...
function fncEventRceptManageDetail(eventId, applcntId){
	...
	varForm.action           = "<c:url value='/uss/ion/evt/EgovEventRcrptDetail.cm'/>";
	varForm.submit();
}
...
<form name="listForm" action="<c:url value='/uss/ion/evt/selectEventRceptList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td><span class="link"><a href="<c:url value='/uss/ion/evt/EgovEventReqstDetail.cm?cmd=popup&'/>eventId=${resultInfo.eventId}" target="_blank" title="<spring:message code="comUssIonEvt.common.toNewWindow"/>" onclick="fncEventReqstDetailPop('<c:out value="${resultInfo.eventId}"/>'); return false;"><c:out value="${resultInfo.eventNm}"/></a></span></td><!-- 새창으로 -->
				...
				<c:if test="${empty resultInfo.confmAt}"> 
			        <form name="item" method="post" action="<c:url value='/uss/ion/evt/EgovEventRceptRegist.cm'/>">
		        ...
		        <c:if test="${!empty resultInfo.confmAt}">
		        <form name="item" method="post" action="<c:url value='/uss/ion/evt/EgovEventRcrptDetail.cm'/>">
		        	<input type="hidden" name="eventId"   value="<c:out value="${resultInfo.eventId}"/>">
