...
function fn_egov_select_linkPage(pageNo){
	...
	document.newsForm.action = "<c:url value='/uss/ion/nws/selectNewsList.cm'/>";
...
function fn_egov_inquire_newsdetail(newsId) {
	...
	document.newsForm.newsId.value = newsId;
  	document.newsForm.action = "<c:url value='/uss/ion/nws/selectNewsDetail.cm'/>";
  	document.newsForm.submit();
}
</script>
</head>
...
<form name="newsForm" action="<c:url value='/uss/ion/nws/selectNewsList.cm'/>" method="post" onSubmit="fn_egov_search_news(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/nws/insertNewsView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/uss/ion/nws/selectNewsDetail.cm?newsId=${resultInfo.newsId}'/>" onClick="fn_egov_inquire_newsdetail('<c:out value="${resultInfo.newsId}"/>');return false;"><c:out value='${fn:substring(resultInfo.newsSj, 0, 40)}'/></a></td>
