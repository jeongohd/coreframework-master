...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/olp/qqm/EgovQustnrQestnManageListPopup.cm'/>";
...
function fn_egov_search_QustnrQestnManage(){
	...
	vFrom.action = "<c:url value='/uss/olp/qqm/EgovQustnrQestnManageListPopup.cm' />";
	vFrom.submit();
...
<form name="ListForm" action="<c:url value='/uss/olp/qqm/EgovQustnrQestnManageListPopup.cm'/>" method="post" onSubmit="fn_egov_search_QustnrQestnManage(); return false;">
