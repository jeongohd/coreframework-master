...
function fncEgovBndtManage() {
	...
	varForm.action = "<c:url value='/uss/ion/bnt/EgovBndtManageDetail.cm'/>";
	varForm.submit();   
}
/* ********************************************************
* 삭제처리화면
...
function fncDeleteBndtManage() {
   ...
   varFrom.action = "<c:url value='/uss/ion/bnt/deleteBndtManage.cm'/>";
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/bnt/deleteBndtManage.cm'/>?bndtId=<c:out value='${bndtManageVO.bndtId}'/>&bndtDe=<c:out value='${bndtManageVO.bndtDe}'/>" onclick="fncDeleteBndtManage(); return false;"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/bnt/EgovBndtManageList.cm'/>" onclick="fncBndtManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
