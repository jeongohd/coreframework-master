...
function fn_egov_inqire_eventlist() {
	eventCmpgnVO.action = "<c:url value='/uss/ion/ecc/selectEventCmpgnList.cm'/>";
	eventCmpgnVO.submit();
}
...
<!-- 상단타이틀 -->
<form:form modelAttribute="eventCmpgnVO" action="${pageContext.request.contextPath}/uss/ion/ecc/updateEventCmpgn.cm" method="post" onSubmit="fn_egov_updt_event(document.forms[0]); return false;" >
	<div class="wTableFrm">
	...
	<span class="btn_s"><a href="<c:url value='/uss/ion/ecc/selectEventCmpgnList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span></div>
