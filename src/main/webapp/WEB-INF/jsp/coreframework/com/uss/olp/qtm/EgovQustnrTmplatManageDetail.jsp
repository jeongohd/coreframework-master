...
function fn_egov_list_QustnrTmplatManage(){
	location.href = "<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageList.cm' />";
}
/* ********************************************************
 * 수정처리화면
 ******************************************************** */
function fn_egov_modify_QustnrTmplatManage(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageModify.cm' />";;
	vFrom.submit();
...
<div class="wTableFrm">
<form name="QustnrTmplatManageForm" id="QustnrTmplatManageForm" action="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageModify.cm'/>" method="post">
	<!-- 타이틀 -->
	...
	<tbody >
		...
		<tr>
			...
			<c:if test="${resultList[0].qestnrTmplatImagepathnm ne null}">
  				...
  				<img src="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageImg.cm'/>?qestnrTmplatId=${resultList[0].qestnrTmplatId}" alt="${resultList[0].qestnrTmplatTy}<spring:message code='comUssOlpQtm.title.image'/>" title="${resultList[0].qestnrTmplatTy}<spring:message code='comUssOlpQtm.title.image'/>"><!-- title="${resultList[0].qestnrTmplatTy}이미지" -->
				</c:if>
			</c:if> 
			</td>
		</tr>
	...
	<div class="btn">
		<!-- 수정 버튼 -->
		<form name="formUpdt" action="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageModify.cm'/>" method="post" onsubmit="fn_egov_modify_QustnrTmplatManage('<c:out value="${resultList[0].qestnrTmplatId}"/>'); return false;" style="float:left;">
		<input type="submit" class="s_submit" value="<spring:message code='button.update' />" title="<spring:message code="title.update" /> <spring:message code="input.button" />" />
		<input name="qestnrTmplatId" type="hidden" value="${resultList[0].qestnrTmplatId}">
		</form>
		<!-- 삭제 버튼 -->
		<form name="formDelete" action="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageDetail.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<!-- 목록 버튼 -->
		<form name="formList" action="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageList.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
