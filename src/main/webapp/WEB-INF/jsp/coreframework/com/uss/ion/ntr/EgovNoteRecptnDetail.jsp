...
function fn_egov_list_NoteRecptn(){
	location.href = "<c:url value='/uss/ion/ntr/listNoteRecptn.cm'/>";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_modify_NoteRecptn(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/uss/ion/ntr/registNoteRecptn.cm'/>";;
	vFrom.submit();
...
<div class="wTableFrm">
	...
	<form name="NoteRecptnForm" action="<c:url value='/uss/ion/ntr/detailNoteRecptn.cm'/>" method="post">
	<!-- 상세조회 -->
	...
	<div class="btn">
		...
		<form name="formUpdt" action="<c:url value='/uss/ion/ntm/registEgovNoteManage.cm'/>" method="post" style="float:left;">
		...
		<form name="formDelete" action="<c:url value='/uss/ion/ntr/detailNoteRecptn.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<form name="formList" action="<c:url value='/uss/ion/ntr/listNoteRecptn.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
