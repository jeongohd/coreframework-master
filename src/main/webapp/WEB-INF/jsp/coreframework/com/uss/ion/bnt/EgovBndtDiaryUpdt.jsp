...
function fncUpdtBndtDiary() {
   ...
   varFrom.action = "<c:url value='/uss/ion/bnt/updtBndtDiary.cm'/>";
...
<div class="board">
	...
	<form:form modelAttribute="bndtDiary" name="bndtDiary" method="post" action="${pageContext.request.contextPath}/uss/ion/bnt/updtBndtDiary.cm">
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				<td><c:out value="${resultInfo.bndtCeckCdNm}"/><img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" alt="<spring:message code="comUssIonBnt.common.requiredInputSign"/>"  width="15" height="15"></td><!-- 필수입력표시 -->
