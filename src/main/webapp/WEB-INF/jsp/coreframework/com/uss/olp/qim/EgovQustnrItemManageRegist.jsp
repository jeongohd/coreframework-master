...
function fn_egov_list_QustnrItemManage(){
	location.href = "<c:url value='/uss/olp/qim/EgovQustnrItemManageList.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_save_QustnrItemManage(){
	...
	if(confirm("<spring:message code='common.save.msg'/>")){
		...
		varFrom.action =  "<c:url value='/uss/olp/qim/EgovQustnrItemManageRegist.cm' />";
...
<form:form modelAttribute="qustnrItemManageVO" action="${pageContext.request.contextPath}/uss/olp/qim/EgovQustnrItemManageRegist.cm" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrItemManage(document.forms[0]); return false;">
...
<div class="wTableFrm">
	...
	<tbody >
		...
		<tr>
			...
			<td class="left">
			    ...
			    <img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" onClick="" align="middle" style="border:0px" alt="<spring:message code='comUssOlpQim.regist.qestnrCn'/>" title="<spring:message code='comUssOlpQim.regist.qestnrCn'/>"><!-- alt="설문정보" title="설문정보" -->
			    </a>
		...
		<tr>
			...
			<td class="nopd">
				<input name="qestnrQesitmCn" id="qestnrQesitmCn" type="text" title="<spring:message code='comUssOlpQim.regist.qestnrQesitmCn'/><spring:message code='input.input'/>" size="73" value="" maxlength="4000" style="width:300px;" disabled="disabled"><!-- title="설문문항정보 입력" -->
  				...
  				<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" alt="<spring:message code='comUssOlpQim.regist.qestnrQesitmCn'/>" title="<spring:message code='comUssOlpQim.regist.qestnrQesitmCn'/>"><!-- alt="설문문항정보" title="설문문항정보" -->
  				</a>
	...
	<div class="btn">
		...
		<!-- 목록버튼 -->
		<span class="btn_s"><a href="<c:url value='/uss/olp/qim/EgovQustnrItemManageList.cm' />"  title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
