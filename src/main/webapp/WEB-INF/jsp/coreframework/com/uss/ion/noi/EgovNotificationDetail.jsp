...
<script type="text/javascript">
	...
	function fn_egov_delete_notification() {		
		if (confirm('<spring:message code="common.delete.msg" />')) {/* 삭제하겠습니까? */
			document.frm.action = "<c:url value='/uss/ion/noi/deleteNotification.cm'/>";
			document.frm.submit();
		}	
	}
	
	function fn_egov_moveUpdt_notification() {
		document.frm.action = "<c:url value='/uss/ion/noi/forUpdateNotification.cm'/>";
		document.frm.submit();			
	}
</script>
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<form name="modifyFrm" method="post" action="<c:url value='/uss/ion/noi/forUpdateNotification.cm'/>" style="display:inline-block; vertical-align:top;">
		...
		<form name="deleteFrm" method="post" action="<c:url value='/uss/ion/noi/deleteNotification.cm'/>" style="display:inline-block; vertical-align:top;">
			<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
			<input type="hidden" name="ntfcNo" value="<c:out value='${result.ntfcNo}'/>" >
		...
		<form name="listFrm" method="post" action="<c:url value='/uss/ion/noi/selectNotificationList.cm'/>" style="display:inline-block; vertical-align:top;">
