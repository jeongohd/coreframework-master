...
function fn_egov_inqire_recomendsitelist() {
	stplatManageVO.action = "<c:url value='/uss/sam/stp/StplatListInqire.cm'/>";
...
<!-- 상단타이틀 -->
<form:form modelAttribute="stplatManageVO" action="${pageContext.request.contextPath}/uss/sam/stp/StplatCnUpdt.cm" method="post" onSubmit="fn_egov_updt_stplatcn(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/sam/stp/StplatListInqire.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
