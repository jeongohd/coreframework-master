...
<script type="text/javaScript" language="javascript">
	...
	function fncEgovVcatnConfmList(){
		location.href = "<c:url value='/uss/ion/vct/EgovVcatnConfmList.cm'/>";
	}
	...
	function modalDialogCallback(retVal) {
		if(retVal != null){
		    ...
		    varForm.action = "<c:url value='/uss/ion/vct/updtVcatnConfm.cm'/>";
...
<div class="wTableFrm">
	...
	<form:form modelAttribute="vcatnManage" name="vcatnManage" method="post" action="<c:url value='/uss/ion/vct/EgovVcatnConfm.cm'/>">
	...
	<div class="btn">
	    ...
	    <span class="btn_s"><a href="<c:url value='/uss/ion/vct/EgovVcatnConfmList.cm'/>?searchCondition=1" onclick="fncEgovVcatnConfmList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
