...
<form:form modelAttribute="newsVO" action="${pageContext.request.contextPath}/uss/ion/nws/insertNews.cm" method="post" onSubmit="fn_egov_regist_news(document.forms[0]); return false;" enctype="multipart/form-data">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/nws/selectNewsList.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
