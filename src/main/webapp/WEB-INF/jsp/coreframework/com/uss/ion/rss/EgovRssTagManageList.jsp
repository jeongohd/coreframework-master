...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/ion/rss/listRssTagManage.cm'/>";
...
function fn_egov_detail_RssTagManage(noteId,noteTrnsmitId){
	...
	vFrom.action = "<c:url value='/uss/ion/rss/detailRssTagManage.cm'/>";
	vFrom.submit();
}
...
function fn_egov_search_RssTagManage(){
	...
	vFrom.action = "<c:url value='/uss/ion/rss/listRssTagManage.cm'/>";
	vFrom.submit();
...
<div class="board">
<form name="listForm" action="<c:url value='/uss/ion/rss/listRssTagManage.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/rss/registRssTagManage.cm'/>?pageIndex=<c:out value='${searchVO.pageIndex}'/>" onclick="" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<a href="<c:url value='/uss/ion/rss/detailRssTagManage.cm?pageIndex=${searchVO.pageIndex}&amp;rssId=${resultInfo.rssId}'/>"><c:out value="${resultInfo.trgetSvcNm}"/></a>
				</td>
				<td style="word-break;break-all">
					<div class="divDotText" style="width:200px;border:0px;">
					<a href="<c:url value='/uss/ion/rss/detailRssTagManage.cm?pageIndex=${searchVO.pageIndex}&amp;rssId=${resultInfo.rssId}'/>"><c:out value="${resultInfo.trgetSvcTable}"/></a>
					</div>
				</td>
