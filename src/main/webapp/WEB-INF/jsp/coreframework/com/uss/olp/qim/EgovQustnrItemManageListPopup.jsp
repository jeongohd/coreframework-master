...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/olp/qim/EgovQustnrItemManageListPopup.cm'/>";
...
function fn_egov_regist_QustnrItemManage(){
	self.href = "<c:url value='/uss/olp/qim/EgovQustnrItemManageRegist.cm' />";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
//function fn_egov_modify_QustnrItemManage(){
//	self.href = "<c:url value='/uss/olp/qim/EgovQustnrItemManageModify.cm' />";
//}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
...
<form name="ListForm" action="<c:url value='/uss/olp/qim/EgovQustnrItemManageListPopup.cm'/>" method="post" onSubmit="fn_egov_search_QustnrItemManage(); return false;">
	...
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			...
			<li>
				...
				<!-- 등록버튼 -->
				<span class="btn_r" > <a href="<c:url value='/uss/olp/qim/EgovQustnrItemManageRegist.cm'/>" title="<spring:message code='button.create' /> <spring:message code='input.button' />"><spring:message code="button.create" /></a></span>
