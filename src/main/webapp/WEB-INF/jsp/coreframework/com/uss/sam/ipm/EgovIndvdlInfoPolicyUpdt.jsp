...
function fn_egov_save_IndvdlInfoPolicy(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/uss/sam/ipm/updtIndvdlInfoPolicy.cm' />";
...
<form:form modelAttribute="indvdlInfoPolicy" name="indvdlInfoPolicy" action="${pageContext.request.contextPath}/uss/sam/ipm/updtIndvdlInfoPolicy.cm" method="post" enctype="multipart/form-data">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/sam/ipm/listIndvdlInfoPolicy.cm' />" onclick=""><spring:message code="button.list" /></a></span>
	</div>
