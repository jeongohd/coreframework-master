...
function fn_egov_list_NoteTrnsmit(){
	location.href = "<c:url value='/uss/ion/nts/listNoteTrnsmit.cm'/>";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_modify_NoteTrnsmit(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/uss/ion/ntm/registEgovNoteManage.cm'/>";;
	vFrom.submit();
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<form name="formDelete" action="<c:url value='/uss/ion/nts/detailNoteTrnsmit.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<form name="formList" action="<c:url value='/uss/ion/nts/listNoteTrnsmit.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
