...
function fn_egov_select_linkPage(pageNo){
	...
	document.wordDicaryForm.action = "<c:url value='/uss/olh/wor/selectWordDicaryList.cm'/>";
...
function fn_egov_inquire_worddicarydetail(wordId) {
	...
	document.wordDicaryForm.wordId.value = wordId;
  	document.wordDicaryForm.action = "<c:url value='/uss/olh/wor/selectWordDicaryDetail.cm'/>";
  	document.wordDicaryForm.submit();
}
</script>
</head>
...
<form name="wordDicaryForm" action="<c:url value='/uss/olh/wor/selectWordDicaryList.cm'/>" method="post" onSubmit="fn_egov_search_worddicary(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/olh/wor/insertWordDicaryView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/uss/olh/wor/selectWordDicaryDetail.cm?wordId=${resultInfo.wordId}'/>" onClick="fn_egov_inquire_worddicarydetail('<c:out value="${resultInfo.wordId}"/>');return false;"><c:out value='${fn:substring(resultInfo.wordNm, 0, 40)}'/></a></td>
