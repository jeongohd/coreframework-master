 ...
 ******************************************************** */
 function fn_egov_delete_administrationword(administWordId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.administrationWordForm.action = "<c:url value='/uss/olh/awm/deleteAdministrationWord.cm'/>";
...
<form name="administrationWordForm" action="<c:url value='/uss/olh/awm/updateAdministrationWordView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/awm/deleteAdministrationWord.cm' />" onClick="fn_egov_delete_administrationword('<c:out value="${result.administWordId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/olh/awm/selectAdministrationWordList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
