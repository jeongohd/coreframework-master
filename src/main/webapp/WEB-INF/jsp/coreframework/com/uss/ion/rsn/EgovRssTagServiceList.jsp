...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/ion/rsn/listRssTagService.cm'/>";
...
function fn_egov_search_RssTagManage(){
	...
	vFrom.action = "<c:url value='/uss/ion/rsn/listRssTagService.cm'/>";
	vFrom.submit();
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<a href="<c:url value='/uss/ion/rsn/detailRssTagService.cm'/>?rssId=${resultInfo.rssId}" target="_blank" title="새 창으로 이동"><c:out value="${resultInfo.trgetSvcNm}"/></a>
				</td>
				<td>
				<a href="<c:url value='/uss/ion/rsn/detailRssTagService.cm'/>?rssId=${resultInfo.rssId}" target="_blank" title="새 창으로 이동"><c:out value="${resultInfo.trgetSvcTable}"/></a>
				</td>
