<%
 /**
  * @Class Name : CoreStplatCnfirm.jsp
...
function fnAgree(){
    ...
    //패키지 변경 document.stplatForm.action = "<c:url value='/uss/umt/CoreRlnmCnfirm.cm'/>";
    document.stplatForm.action = "<c:url value='/sec/rnc/CoreRlnmCnfirm.cm'/>";
...
<form name="QustnrManageForm" action="<c:url value='/sec/rnc/CoreRlnmCnfirm.cm'/>" method="post">
<div class="wTableFrm">
		<!-- 타이틀 -->
		<h2>${pageTitle}</h2>
        ...
        <c:if test="${sbscrbTy == 'USR01'}">"/uss/umt/coreMberSbscrbRegist.cm"</c:if>
        <c:if test="${sbscrbTy == 'USR02'}">"/uss/umt/coreEntrprsMberSbscrbRegist.cm"</c:if>
