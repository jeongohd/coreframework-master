...
if(!sConsumerKey.equals("") && !sConsumerSecret.equals("") && !sAt.equals("1")){
	...
	response.sendRedirect("<c:url value='/uss/ion/tir/selectTwitterPopupActor.cm'/>?chkKey=1&at=1&cmd="+sCmds+"&ConsumerKey="+sConsumerKey+"&ConsumerSecret="+sConsumerSecret);
}
%>
<!DOCTYPE html>
<html lang="ko">
...
<form id="twitterInfo" name="twitterInfo" action="<c:url value='/uss/ion/tir/selectTwitterPopupActor.cm'/>" method="post" enctype="multipart/form-data">
