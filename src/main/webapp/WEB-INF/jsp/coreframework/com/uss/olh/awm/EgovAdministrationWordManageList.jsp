...
function fn_egov_select_linkPage(pageNo){
	...
	document.administrationWordForm.action = "<c:url value='/uss/olh/awm/selectAdministrationWordManageList.cm'/>";
...
function fn_egov_inquire_administrationworddetail(administWordId) {
	...
	document.administrationWordForm.administWordId.value = administWordId;
  	document.administrationWordForm.action = "<c:url value='/uss/olh/awm/selectAdministrationWordManageDetail.cm'/>";
  	document.administrationWordForm.submit();
}
</script>
</head>
...
<form name="administrationWordForm" action="<c:url value='/uss/olh/awm/selectAdministrationWordManageList.cm'/>" method="post" onSubmit="fn_egov_search_administrationword(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/olh/awm/insertAdministrationWordView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/uss/olh/awm/selectAdministrationWordManageDetail.cm?administWordId=${resultInfo.administWordId}'/>" onClick="fn_egov_inquire_administrationworddetail('<c:out value="${resultInfo.administWordId}"/>');return false;"><c:out value='${fn:substring(resultInfo.administWordNm, 0, 40)}'/></a></td>
