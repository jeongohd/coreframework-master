 ...
 ******************************************************** */
 function fn_egov_delete_hr(extrlHrId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.tnextrlHrForm.action = "<c:url value='/uss/ion/ecc/deleteTnextrlHr.cm'/>";
...
<form name="tnextrlHrForm" action="<c:url value='/uss/ion/ecc/updateTnextrlHrView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/ecc/deleteTnextrlHr.cm' />" onClick="fn_egov_delete_hr('<c:out value="${result.extrlHrId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/ecc/selectTnextrlHrList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
