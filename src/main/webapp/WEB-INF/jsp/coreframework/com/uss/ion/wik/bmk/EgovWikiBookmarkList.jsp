...
function linkPage(pageNo){
	...
	document.listFormS.action = "<c:url value='/uss/ion/wik/bmk/listWikiBookmark.cm'/>";
...
function fn_egov_search_WikiBookmark(){
	...
	vForm.action = "<c:url value='/uss/ion/wik/bmk/listWikiBookmark.cm'/>";
	vForm.submit();
...
.TopMenuBg {
background-image : url('<c:url value='/images/coreframework/com/cmm/uss/umt/menu_bg.jpg'/>');
...
padding-top : 3px;
padding-left : 50px;
background-image : url('<c:url value='/images/coreframework/com/cmm/uss/umt/left_menu_bg.gif'/>');
}
.LeftMenuBtn {
text-align : center;
padding-top : 5px;
...
padding-top : 3px;
padding-left : 60px;
background-image : url('<c:url value='/images/coreframework/com/cmm/uss/umt/left_bg.gif'/>');
}
.QuickLink {
font-size : 11px;
color : #7794be;
...
font-weight : bold;
padding-left : 45px;
background-image : url('<c:url value='/images/coreframework/com/cmm/uss/umt/page_title.gif'/>');
}
.PageNumber {
text-align : center;
font-family : "돋움";
...
font-weight : bold;
color : #4f657d;
background : url('<c:url value='/images/coreframework/com/cmm/uss/umt/bg_list_th.gif'/>');
}
.table_listA tbody {
height : 35px;
font : 11px Dotum;
...
top : 3px;
background-color : transparent;
background-image : url('<c:url value='/images/coreframework/com/cmm/uss/umt/icon/icon_prevend.gif'/>');
border-style : none;
}
.page_prev {
width : 13px;
...
top : 3px;
background-color : transparent;
background-image : url('<c:url value='/images/coreframework/com/cmm/uss/umt/icon/icon_prev.gif'/>');
border-style : none;
}
.page_nextend {
width : 13px;
...
top : 3px;
background-color : transparent;
background-image : url('<c:url value='/images/coreframework/com/cmm/uss/umt/icon/icon_nextend.gif'/>');
border-style : none;
}
.page_next {
width : 13px;
...
top : 3px;
background-color : transparent;
background-image : url('<c:url value='/images/coreframework/com/cmm/uss/umt/icon/icon_next.gif'/>');
border-style : none;
}
.page_no {
width : 30px;
...
.btnBackground {
background-image : url('<c:url value='/images/coreframework/com/cmm/uss/umt/button/bu2_bg.gif'/>');
}
...
<div class="board">
<form name="listFormS" action="<c:url value='/uss/ion/wik/bmk/listWikiBookmark.cm'/>" method="post">
