...
function fn_egov_select_linkPage(pageNo){
	...
	document.CnsltAnswerListForm.action = "<c:url value='/uss/olp/cnm/CnsltAnswerListInqire.cm'/>";
...
function fn_egov_regist_cnsltanswercn(){
	...
	document.CnsltAnswerListForm.action = "<c:url value='/uss/olp/cnm/CnsltAnswerCnRegistView.cm'/>";
	document.CnsltAnswerListForm.submit();
...
function fn_egov_inquire_cnsltanswerdetail(cnsltId) {
    ...
    document.CnsltAnswerListForm.action = "<c:url value='/uss/olp/cnm/CnsltAnswerDetailInqire.cm'/>";
  	document.CnsltAnswerListForm.submit();
...
<div class="board">
	...
	<!-- 검색영역 -->
	<form name="CnsltAnswerListForm" action="<c:url value='/uss/olp/cnm/CnsltAnswerListInqire.cm'/>" method="post" onSubmit="fn_egov_search_cnsltdtlsanswer(); return false;">
	...
	<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	  <tr>
		...
		<td class="left">
		<form name="linkForm" method="post" action="<c:url value='/uss/olp/cnm/CnsltAnswerDetailInqire.cm'/>">
