...
<form:form modelAttribute="faqVO" action="${pageContext.request.contextPath}/uss/olh/faq/insertFaq.cm" method="post" onSubmit="fn_egov_regist_faq(document.forms[0]); return false;" enctype="multipart/form-data">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/faq/selectFaqList.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
