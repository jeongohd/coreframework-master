<%
/**
 * @Class Name : CoreDeptManageList.java
 * @Description : CoreDeptManageList jsp
...
function fncSelectDeptManageList(pageNo){
    ...
    document.listForm.action = "<c:url value='/uss/umt/dpt/coreDeptManageList.cm'/>";
    document.listForm.submit();
}

function fncSelectDeptManage(bannerId) {
    document.listForm.bannerId.value = bannerId;
    document.listForm.action = "<c:url value='/uss/umt/dpt/coreDeptManage.cm'/>";
    document.listForm.submit();
}
...
function fncAddDeptManageInsert() {
    ...
    document.listForm.action = "<c:url value='/uss/umt/dpt/coreDeptManageRegist.cm'/>";
    document.listForm.submit();
}
...
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/umt/dpt/coreDeptManageRegist.cm'/>" onClick="fncAddDeptManageInsert(); return false;"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
	...
	<tr>
		<td><a href="<c:url value='/uss/umt/dpt/coreDeptManage.cm'/>?pageIndex=${deptManageVO.pageIndex}&searchKeyword=${deptManageVO.searchKeyword}&orgnztId=${deptManage.orgnztId}"><c:out value="${deptManage.orgnztId}"/></a></td>
		<td class="left"><a href="<c:url value='/uss/umt/dpt/coreDeptManage.cm'/>?pageIndex=${deptManageVO.pageIndex}&searchKeyword=${deptManageVO.searchKeyword}&orgnztId=${deptManage.orgnztId}"><c:out value="${deptManage.orgnztNm}"/></a></td>
