...
function fncEventRceptManageList(){
	location.href = "<c:url value='/uss/ion/evt/EgovEventRcrptManageList.cm'/>";
}
...
function fncInsertEventRceptManage() {
	    ...
	    varFrom.action = "<c:url value='/uss/ion/evt/insertEventAtdrn.cm'/>";
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/evt/selectEventRceptList.cm'/>?searchCondition=1" onclick="fncEventRceptManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
