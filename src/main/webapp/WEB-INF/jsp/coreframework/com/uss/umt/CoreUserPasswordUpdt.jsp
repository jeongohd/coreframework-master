<%
 /**
  * @Class Name : CorePasswordUpdt.jsp
...
function fnListPage(){
    document.passwordChgVO.action = "<c:url value='/uss/umt/coreUserManageList.cm'/>";
...
<body>
<form name="passwordChgVO" method="post"  action="<c:url value="${'/uss/umt/CoreUserPasswordModify.cm'}"/>" onsubmit="fnUpdate(document.forms[0]); return false;">
