...
function fncSelectLoginScrinImageList() {
    ...
    varFrom.action = "<c:url value='/uss/ion/lsi/selectLoginScrinImageList.cm'/>";
    varFrom.submit();
}
...
function fncLoginScrinImageInsert() {
    ...
    var varFrom = document.getElementById("loginScrinImage");
    varFrom.action = "<c:url value='/uss/ion/lsi/addLoginScrinImage.cm'/>";
...
function fncLoginScrinImageUpdate() {
    var varFrom = document.getElementById("loginScrinImage");
    varFrom.action = "<c:url value='/uss/ion/lsi/updtLoginScrinImage.cm'/>";
...
function fncLoginScrinImageDelete() {
    var varFrom = document.getElementById("loginScrinImage");
    varFrom.action = "<c:url value='/uss/ion/lsi/removeLoginScrinImage.cm'/>";
...
<!-- 등록폼 -->
<form:form modelAttribute="loginScrinImage" method="post" action="${pageContext.request.contextPath}/uss/ion/lsi/updtLoginScrinImage.cm' />" enctype="multipart/form-data">
<div class="wTableFrm">
	<!-- 타이틀 -->
...
<input type="hidden" name="posblAtchFileNumber" value="1" >
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/lsi/removeLoginScrinImage.cm'/>?imageId=<c:out value='${loginScrinImageVO.imageId}'/>" onclick="fncLoginScrinImageDelete(); return false;"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/lsi/selectLoginScrinImageList.cm'/>?pageIndex=<c:out value='${loginScrinImageVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${loginScrinImageVO.searchKeyword}"/>&amp;searchCondition=1" onclick="fncSelectLoginScrinImageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
