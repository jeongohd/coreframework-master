...
function fn_egov_list_PopupManage(){
	location.href = "<c:url value='/uss/ion/pwm/listPopup.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_modify_PopupManage(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/uss/ion/pwm/updtPopup.cm' />";;
	vFrom.submit();
...
<div class="wTableFrm">
	...
	<form name="PopupManageForm" action="<c:url value='/uss/ion/pwm/detailPopup.cm'/>" method="post">
	...
	<!-- 하단 버튼 -->
	<div class="btn">		
		<form name="formUpdt" action="<c:url value='/uss/ion/pwm/updtPopup.cm'/>" method="post" style="display:inline">
		...
		<form name="formDelete" action="<c:url value='/uss/ion/pwm/detailPopup.cm'/>" method="post" style="display:inline">
		...
		<form name="formList" action="<c:url value='/uss/ion/pwm/listPopup.cm'/>" method="post" style="display:inline">
