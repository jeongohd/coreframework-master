<%
 /**
  * @Class Name : CoreEntrprsMberSbscrb.jsp
...
<!-- content start -->
 <form:form modelAttribute="entrprsManageVO" action="${pageContext.request.contextPath}/uss/umt/coreEntrprsMberSbscrbAdd.cm" name="entrprsManageVO" method="post" onSubmit="fnInsert(document.forms[0]); return false;">
