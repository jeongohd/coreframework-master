...
function fn_egov_save_NoteManage(){
	...
	if(confirm("<spring:message code="common.save.msg"/>")){
		vFrom.action = "<c:url value='/uss/ion/ntm/registEgovNoteManageActor.cm'/>";
...
function  fn_egov_recptnEmpSearchPupup(){
	...
	var url = "<c:url value='/uss/ion/ntm/listEgovNoteEmpListPopup.cm'/>";
...
<form:form modelAttribute="noteManage"  name="noteManage"  action="/uss/ion/ntm/registEgovNoteManage.cm" method="post" enctype="multipart/form-data" >
...
<div class="wTableFrm">
	<h2>${pageTitle}</h2>
		...
		<tbody>
				<tr>
					<th><img src="<c:url value='/images/coreframework/com/uss/ion/ntm/check.png'/>" alt="check"/><label for="noteSj"><spring:message code="comUssIonNtm.NoteMange.subject"/></label></th><!-- 제목 -->
					<!-- 제목 -->
				...
				<tr>
					<th><img src="<c:url value='/images/coreframework/com/uss/ion/ntm/check.png'/>" alt="check"/> <spring:message code="comUssIonNtm.NoteMange.receiver"/></th>
					<td>
						<div style="clear:both;"></div>
				   		<div style="text-align: left;">		
							...
							<!-- 수신/참조자 선택 목록 팝업창 열기 -->
							<a href="<c:url value='/uss/ion/ntm/listEgovNoteEmpListPopup.cm'/>" onClick="fn_egov_recptnEmpSearchPupup();return false;"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px;margin-right:10px;" alt="${recptnEmnpList}" title="${recptnEmnpList}"></a>
							<!-- 수신자 목록 리스트 제외 -->
				...
				<tr>
					<!-- 쪽지 내용 입력 -->
					<th><img src="<c:url value='/images/coreframework/com/uss/ion/ntm/check.png'/>" alt="check"/> <spring:message code="comUssIonNtm.NoteMange.content"/></th>
					<td>
						<!-- 쪽지내용 -->
