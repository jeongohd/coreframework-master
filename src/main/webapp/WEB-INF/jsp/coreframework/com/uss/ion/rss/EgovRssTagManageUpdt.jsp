...
function fn_egov_save_RssTagManage(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		...
		vFrom.action = "<c:url value='/uss/ion/rss/updtRssTagManage.cm'/>";
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a href="#LINK" onclick="document.getElementById('bdtLink').value='';"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_delete.gif'/>" alt="컬럼명삭제" title="컬럼명삭제"></a>
		...
		<tr>
			...
			<td class="left">
				...
				<a href="#LINK" onclick="document.getElementById('bdtDescription').value='';"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_delete.gif'/>" alt="컬럼명삭제" title="컬럼명삭제"></a>
		...
		<tr>
			...
			<td class="left">
				...
				<a href="#LINK" onclick="document.getElementById('bdtTag').value='';"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_delete.gif'/>" alt="컬럼명삭제" title="컬럼명삭제"></a>
