 ...
 ******************************************************** */	
	function fn_egov_regist_notification(){
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {/* 등록하겠습니까? */
			...
			form.action = "<c:url value='/uss/ion/noi/insertNotification.cm'/>";
 ...
 ******************************************************** */	
	function fn_egov_select_notification(){
		form = document.notification;
		form.action = "<c:url value='/uss/ion/noi/selectNotificationList.cm'/>";
		form.submit();
	}
/* ********************************************************
 * 달력
...
<form:form modelAttribute="notification" name="notification" method="post" action="${pageContext.request.contextPath}/uss/ion/noi/insertNotification.cm' />">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/noi/selectNotificationList.cm'/>?pageIndex=<c:out value='${searchVO.pageIndex}'/>" onclick="fn_egov_select_notification(); return false;"><spring:message code="button.list" /></a></span>
	</div>
