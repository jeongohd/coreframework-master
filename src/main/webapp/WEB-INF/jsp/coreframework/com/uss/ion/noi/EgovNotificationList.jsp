...
var noi_url = "<c:url value='/uss/ion/noi/getNotifications.cm'/>";
</script>
<script type="text/javascript" language="javaScript" src="<c:url value='/js/coreframework/com/uss/ion/noi/EgovNotification.js'/>" ></script>
...
<script type="text/javascript">
	...
	function fn_egov_insert_notification() {
		document.frm.action = "<c:url value='/uss/ion/noi/addNotification.cm'/>";
		document.frm.submit();
	}
	...
	function fn_egov_select_notification(pageNo) {
		...
		document.frm.action = "<c:url value='/uss/ion/noi/selectNotificationList.cm'/>";
		document.frm.submit();
	}

	function fn_egov_inqire_notification(ntfcNo) {
		document.frm.ntfcNo.value = ntfcNo;
		document.frm.action = "<c:url value='/uss/ion/noi/selectNotification.cm'/>";
		document.frm.submit();
	}
</script>
</head>
...
<div class="board">
	...
	<form name="frm" method="post" action="<c:url value='/uss/ion/noi/selectNotificationList.cm'/>">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg"/>"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/noi/addNotification.cm'/>?pageIndex=<c:out value='${searchVO.pageIndex}'/>" onclick="fn_egov_insert_notification(); return false;" title="<spring:message code="button.create"/>"><spring:message code="button.create"/></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
	</form>
		...
		<tbody>
			<c:forEach var="result" items="${resultList}" varStatus="status">
				<tr>
					...
					<td class="left">
						<form name="item" method="post" action="<c:url value='/uss/ion/noi/selectNotification.cm'/>">
							<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
