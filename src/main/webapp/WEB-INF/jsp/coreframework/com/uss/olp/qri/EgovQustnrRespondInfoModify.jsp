...
function fn_egov_save_QustnrRespondInfo(){
	...
	if(confirm("<spring:message code='common.save.msg' />")){
		varFrom.action =  "<c:url value='/uss/olp/qri/EgovQustnrRespondInfoModify.cm' />";
...
<div class="wTableFrm">
<!-- 상단타이틀 -->
<form:form modelAttribute="qustnrRespondInfoVO" name="qustnrRespondInfoVO" action="${pageContext.request.contextPath}/uss/olp/qri/EgovQustnrRespondInfoModify.cm" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrRespondInfo(document.forms[0]); return false;">
