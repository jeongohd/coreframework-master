...
function fn_egov_save_QustnrRespondManage(){
	...
	if(confirm("<spring:message code='common.save.msg'/>")){
		...
		//varFrom.action =  "<c:url value='/uss/olp/qrm/EgovQustnrRespondManageRegist.cm'/>";
		//varFrom.action =  "${pageContext.request.contextPath}/uss/olp/qrm/EgovQustnrRespondManageRegist.cm";
		document.getElementById("qustnrRespondManageVO").action = "${pageContext.request.contextPath}/uss/olp/qrm/EgovQustnrRespondManageRegist.cm";
	...
	<tbody >
		...
		<tr>
			...
			<td class="left">
				...
				<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" onClick=""align="middle" style="border:0px" alt="<spring:message code='comUssOlpQrm.regist.qestnrCn' /><spring:message code='input.input' />" title="<spring:message code='comUssOlpQrm.regist.qestnrCn' /><spring:message code='input.input' />"><!-- alt="설문관리정보" title="설문관리정보" -->
				</a>
