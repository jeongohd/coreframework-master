...
<script type="text/javaScript" language="javascript">
	 ...
	 ******************************************************** */
	 ...
	 function linkPage(pageNo){
		...
		varForm.action            = "<c:url value='/uss/ion/evt/selectEventRceptConfmList.cm'/>";
	...
	function modalDialogCallback(retVal) {
		if(retVal != null){
		    ...
		    varForm.action = "<c:url value='/uss/ion/evt/updtEventAtdrn.cm'/>";
	...
	function layerPopUp(){
		...
		var varForm	= document.all["listForm"];
           ...
           if(popUpCode == 0){
				page = "<c:url value='/uss/ion/ism/EgovConfmPopupNew.cm'/>";
           }else if(popUpCode == 1){
        	  	page = "<c:url value='/uss/ion/ism/EgovReturnPopupNew.cm'/>";
           }else{
        	   alert("page Null")
           }
...
<div class="board">
	<h1><spring:message code="comUssIonEvt.eventRceptConfm.eventRcptMngList"/></h1><!-- 행사접수승인관리 목록 -->
		<form name="listFormPop" action="<c:url value='/uss/ion/evt/selectEventRceptConfmList.cm'/>" method="post">
