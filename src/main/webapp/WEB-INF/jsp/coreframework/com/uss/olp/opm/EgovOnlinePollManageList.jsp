...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/olp/opm/listOnlinePollManage.cm'/>";
...
function fn_egov_regist_OnlinePollManage(){
	location.href = "<c:url value='/uss/olp/opm/registOnlinePollManage.cm' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_OnlinePollManage(pollId){
	...
	vFrom.action = "<c:url value='/uss/olp/opm/detailOnlinePollManage.cm' />";
	vFrom.submit();
}
...
function fn_egov_search_OnlinePollManage(){
	...
	vFrom.action = "<c:url value='/uss/olp/opm/listOnlinePollManage.cm' />";
	vFrom.submit();
...
<form name="listForm" action="<c:url value='/uss/olp/opm/listOnlinePollManage.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/olp/opm/registOnlinePollManage.cm' />?pageIndex=${searchVO.pageIndex}"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
...
<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>">
	...
	<tr>
		...
		<td class="leftElli">
 		...
 		<form name="subForm" method="post" action="<c:url value='/uss/olp/opm/detailOnlinePollManage.cm'/>">
		...
		<td>
		<form name="subFormStatistics" method="post" action="<c:url value='/uss/olp/opp/statisticsOnlinePollPartcptn.cm'/>">
			<input name="pollId" type="hidden" value="<c:out value="${resultInfo.pollId}"/>">
		...
		<td>
		<form name="subFormPollResult" method="post" action="<c:url value='/uss/olp/opr/listOnlinePollResult.cm'/>">
			<input name="pollId" type="hidden" value="<c:out value="${resultInfo.pollId}"/>">
			<input name="linkType" type="hidden" value="1">
	    	<input type="submit" class="btn_submit" value="<spring:message code="comUssOlpOpm.btn.view" />" />
	    </form>
