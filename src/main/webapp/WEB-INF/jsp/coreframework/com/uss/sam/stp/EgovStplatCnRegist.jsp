...
<form:form modelAttribute="stplatManageVO" action="${pageContext.request.contextPath}/uss/sam/stp/StplatCnRegist.cm" method="post" onSubmit="fn_egov_regist_stplatcn(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
