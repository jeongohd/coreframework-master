...
function fncMainImageInsert() {
    ...
    var varFrom = document.getElementById("mainImage");
    varFrom.action = "<c:url value='/uss/ion/msi/addMainImage.cm'/>";
...
<div class="wTableFrm">
	...
	<!-- 등록폼 -->
<form:form modelAttribute="mainImage" method="post" action="${pageContext.request.contextPath}/uss/ion/msi/addMainImage.cm' />" enctype="multipart/form-data">
