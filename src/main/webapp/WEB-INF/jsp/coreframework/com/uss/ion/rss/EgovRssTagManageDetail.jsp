...
<form name="RssTagManageForm" action="<c:url value='/uss/ion/rss/detailRssTagManage.cm'/>" method="post">
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<form name="formUpdt" action="<c:url value='/uss/ion/rss/updtRssTagManage.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		...
		<form name="formDelete" action="<c:url value='/uss/ion/rss/detailRssTagManage.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		...
		<form name="formList" action="<c:url value='/uss/ion/rss/listRssTagManage.cm'/>" method="post" style="display:inline-block; vertical-align:top">
