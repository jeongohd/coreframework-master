...
function fncSelectMtgPlaceManageList(pageNo){
    ...
    document.listForm.action = "<c:url value='/uss/ion/mtg/selectMtgPlaceManageList.cm'/>";
...
function fncSelectMtgPlaceManage(mtgPlaceId) {
    ...
    document.listForm.action = "<c:url value='/uss/ion/mtg/selectMtgPlaceManage.cm'/>";
    document.listForm.submit();   
}
/*설명 : 회의실 신규등록 화면 호출 */
function fncInsertMtgPlace() {
    ...
    document.listForm.action = "<c:url value='/uss/ion/mtg/insertViewMtgPlace.cm'/>";
    document.listForm.submit(); 
}
/*설명 : 회의실 목록 페이지 조회 */
...
<div class="board">
<form name="listForm" action="<c:url value='/uss/ion/mtg/selectMtgPlaceManageList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/mtg/insertViewMtgPlace.cm'/>?searchCondition=1" onclick="fncInsertMtgPlace(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td class="left">
					<form name="item" method="post" action="<c:url value='/uss/ion/mtg/selectMtgPlaceManage.cm'/>">
