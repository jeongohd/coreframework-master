 ...
 ******************************************************** */
 function fn_egov_delete_onlinemanual(onlineMnlId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.onlineManualForm.action = "<c:url value='/uss/olh/omm/deleteOnlineManual.cm'/>";
...
<form name="onlineManualForm" action="<c:url value='/uss/olh/omm/updateOnlineManualView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/omm/deleteOnlineManual.cm' />" onClick="fn_egov_delete_onlinemanual('<c:out value="${result.onlineMnlId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/olh/omm/selectOnlineManualList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
