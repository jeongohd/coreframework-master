...
<script type="text/javaScript" language="javascript">
	...
	<c:if test="${mtgPlaceManageVO.resveManId eq mtgPlaceManageVO.usidTemp}">
		...
		function fncSelectMtgPlaceResveManage() {
			...
			varFrom.action = "<c:url value='/uss/ion/mtg/selectMtgPlaceResveManageDetail.cm'/>";
			varFrom.submit();   
		}
...
<input type="hidden" name="resveId"    value ="<c:out value='${mtgPlaceManageVO.resveId   }'/>"/>
	...
	<div class="btn">
		<c:if test="${mtgPlaceManageVO.resveManId eq mtgPlaceManageVO.usidTemp}">
			<span class="btn_s"><a href="<c:url value='/uss/ion/mtg/selectMtgPlaceResveManage.cm'/>?searchCondition=1" onclick="fncSelectMtgPlaceResveManage(); return false;"><spring:message code="button.update" /></a></span>
			<span class="btn_s"><a href="<c:url value='/uss/ion/mtg/deleteMtgPlaceResve.cm'/>?searchCondition=1" onclick="fncDeleteMtgPlaceResve(); return false;"><spring:message code="button.delete" /></a></span>
		</c:if>
