...
function fncBndtCeckManageList(){
	location.href = "<c:url value='/uss/ion/bnt/EgovBndtCeckManageList.cm'/>";
}
 ...
 ******************************************************** */
 function fncInsertBndtCeckManage() {
	    var varFrom = document.getElementById("bndtCeckManage");
	    varFrom.action = "<c:url value='/uss/ion/bnt/insertBndtCeckManage.cm'/>";
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/bnt/EgovBndtCeckManageList.cm'/>?searchCondition=1" onclick="fncBndtCeckManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
