...
<script type="text/javaScript" language="javascript">
	...
	function fncInsertEgovRwardManage() {
	    ...
	    varFrom.action = "<c:url value='/uss/ion/rwd/insertRwardManage.cm'/>";
	...
	* ******************************************************** */
	function modalDialogCallback(retVal) {
		if(retVal != null){
			...
			document.rwardManage.action = "<c:url value='/uss/ion/rwd/EgovRwardRegist.cm'/>";
	...
	<table class="wTable mb20">
		...
		<tr>
			...
			<td class="left">
			    ...
			    <span class="link">
			    <a id="RwardRegist" title="<spring:message code="comUssIonRwd.common.searchNm"/>" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />"
