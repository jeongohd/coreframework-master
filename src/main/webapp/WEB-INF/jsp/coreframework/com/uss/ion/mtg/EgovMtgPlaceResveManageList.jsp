...
function fncSelectMtgPlaceResveManageList(pageNo){
    ...
    document.listForm.action = "<c:url value='/uss/ion/mtg/selectMtgPlaceResveManageList.cm'/>";
...
function fncInsertMtgPlaceResve() {	
    ...
    document.listForm.action = "<c:url value='/uss/ion/mtg/selectMtgPlaceResveManage.cm'/>";
    document.listForm.submit(); 
}
-->
</script>
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/uss/ion/mtg/selectMtgPlaceResveManageList.cm'/>" method="post">
	...
	<caption class="blind"><spring:message code="comUssIonMtg.mtgPlaceResveManageList.title" /></caption>
	 ...
	 <c:forEach var="mtgPlaceResveManage" items="${mtgPlaceManageList}" varStatus="status">
	  <tr>
	    ...
	    <td   bgcolor="#431508"  >
	        <form name="item" method="post" action="<c:url value='/uss/ion/mtg/selectMtgPlaceResveManageDetail.cm'/>">
	    ...
	    <c:if test="${mtgPlaceResveManage.resveTemp0800=='0' }">
	    <td   bgcolor="#FFFFFF"  >
	        <form name="item" method="post" action="<c:url value='/uss/ion/mtg/selectMtgPlaceResveManage.cm'/>">
	            <input type="hidden" name="mtgPlaceId" value="<c:out value='${mtgPlaceResveManage.mtgPlaceId}'/>">
