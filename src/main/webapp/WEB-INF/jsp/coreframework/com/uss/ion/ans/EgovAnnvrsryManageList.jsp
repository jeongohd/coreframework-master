...
<script type="text/javaScript" language="javascript" defer="defer">
	...
	function fncSelectAnnvrsryManageList(pageNo){
	    ...
	    document.listForm.action = "<c:url value='/uss/ion/ans/selectAnnvrsryManageList.cm'/>";
	...
	function fncSelectAnnvrsryManage(annId) {
	    ...
	    document.listForm.action = "<c:url value='/uss/ion/ans/selectAnnvrsryManage.cm'/>";
	    document.listForm.submit();   
	}
	...
	function fncInsertAnnvrsry() {
	    ...
	    document.listForm.action = "<c:url value='/uss/ion/ans/insertViewAnnvrsry.cm'/>";
	    document.listForm.submit(); 
	}
    ...
    $(document).ready(function () {
        $('#excelPopUp').click(function (e) {
            ...
            var page = "<c:url value='/uss/ion/ans/EgovAnnvrsryManageListPop.cm'/>";
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/uss/ion/ans/selectAnnvrsryManageList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/ans/insertViewAnnvrsry.cm'/>?searchCondition=1" onclick="fncInsertAnnvrsry(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<form name="item" method="post" action="<c:url value='/uss/ion/ans/selectAnnvrsryManage.cm'/>">
