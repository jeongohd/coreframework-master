 ...
 ******************************************************** */
 function fn_egov_delete_news(newsId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.newsForm.action = "<c:url value='/uss/ion/nws/deleteNews.cm'/>";
...
<form name="newsForm" action="<c:url value='/uss/ion/nws/updateNewsView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/nws/deleteNews.cm' />" onClick="fn_egov_delete_news('<c:out value="${result.newsId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/nws/selectNewsList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
