...
function fn_egov_select_linkPage(pageNo){
	...
	document.indvdlPgeForm.action = "<c:url value='/uss/mpe/selectIndvdlPgeList.cm'/>";
...
function fn_egov_inquire_pgedetail(cntntsId) {
	...
	document.indvdlPgeForm.cntntsId.value = cntntsId;
  	document.indvdlPgeForm.action = "<c:url value='/uss/mpe/selectIndvdlPgeDetail.cm'/>";
  	document.indvdlPgeForm.submit();
}
</script>
</head>
...
<form name=indvdlPgeForm action="<c:url value='/uss/mpe/selectIndvdlPgeList.cm'/>" method="post" onSubmit="fn_egov_search_pge(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/mpe/insertIndvdlPgeView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/uss/mpe/selectIndvdlPgeDetail.cm?cntntsId=${resultInfo.cntntsId}'/>" onClick="fn_egov_inquire_pgedetail('<c:out value="${resultInfo.cntntsId}"/>');return false;"><c:out value='${fn:substring(resultInfo.cntntsNm, 0, 40)}'/></a></td>
