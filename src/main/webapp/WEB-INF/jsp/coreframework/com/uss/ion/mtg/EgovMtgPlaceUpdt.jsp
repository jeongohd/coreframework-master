...
function fncUpdtMtgPlace() {
     ...
     varFrom.action = "<c:url value='/uss/ion/mtg/updtMtgPlace.cm'/>";
...
<form:form modelAttribute="mtgPlaceManage" name="mtgPlaceManage" method="post" action="${pageContext.request.contextPath}/uss/ion/mtg/updtMtgPlace.cm"  enctype="multipart/form-data">
<input type="hidden" name="returnUrl"           value="/uss/ion/mtg/selectMtgPlaceManage.cm" />
...
<!--  첨부파일 테이블 레이아웃 End. /cmm/fms/selectImageFileInfs.cm -->
