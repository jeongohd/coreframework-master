...
function fn_egov_regist_cpyrhtprtcpolicycn(form){
	...
	// 서버사이드 테스트용
	/*
		form.action = "<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyCnRegist.cm'/>";
		form.submit();
		return;
	*/
...
function fn_egov_inqire_cpyrhtprtcpolicylist() {
	...
	cpyrhtPrtcPolicyVO.action = "<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyListInqire.cm'/>";
...
<form:form modelAttribute="cpyrhtPrtcPolicyVO" action="${pageContext.request.contextPath}/uss/sam/cpy/CpyrhtPrtcPolicyCnRegist.cm" method="post">
