...
function fn_egov_save_UnityLink(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/uss/ion/ulm/registUnityLink.cm' />";
...
<form:form modelAttribute="unityLink" name="unityLink" action="${pageContext.request.contextPath}/uss/ion/ulm/registUnityLink.cm" enctype="multipart/form-data" >
