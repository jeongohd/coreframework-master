...
<script type="text/javaScript" language="javascript">
	...
	function fn_egov_select_linkPage(pageNo){
	    ...
	    document.RoughMapForm.action = "<c:url value='/com/uss/ion/rmm/selectRoughMapList.cm'/>";
	...
	function fn_egov_inquire_roughmapdetail(roughMapId) {       
	    ...
	    document.RoughMapForm.action = "<c:url value='/com/uss/ion/rmm/selectRoughMapDetail.cm'/>";
	    document.RoughMapForm.submit(); 
	}
	...
	function fn_egov_regist_roughmap(){
	    document.RoughMapForm.action = "<c:url value='/com/uss/ion/rmm/registRoughMap.cm'/>";
	    document.RoughMapForm.submit(); 
	}
	...
	function fn_egov_updt_roughmap(){
	    document.RoughMapForm.action = "<c:url value='/com/uss/ion/rmm/updateRoughMapView.cm'/>";
	    document.RoughMapForm.submit(); 
	}
...
<div class="board">
	...
	<form name="searchVO" action="<c:url value='/com/uss/ion/rmm/selectRoughMapList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/com/uss/ion/rmm/registRoughMap.cm'/>" onclick="fn_egov_regist_roughmap(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
		...
		<tbody>
			...
			<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
				<tr>
					...
					<td>
						<form name="roughMap" method="post" action="<c:url value='/com/uss/ion/rmm/selectRoughMapDetail.cm'/>">
