...
function fncDeleteEventRcept() {
	    ...
	    varFrom.action = "<c:url value='/uss/ion/evt/deleteEventAtdrn.cm'/>";
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/evt/EgovEventRcrptManageList.cm'/>?searchCondition=1" onclick="fncEventRceptManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
