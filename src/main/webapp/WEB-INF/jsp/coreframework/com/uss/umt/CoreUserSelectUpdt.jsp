<%
 /**
  * @Class Name : CoreUserSelectUpdt.jsp
...
function fnDeleteUser(checkedIds) {
	if(confirm("<spring:message code="common.delete.msg" />")){
	    ...
	    document.userManageVO.action = "<c:url value='/uss/umt/coreUserManageRemove.cm'/>";
	    document.userManageVO.submit();
	}
}
function fnPasswordMove(){
	document.userManageVO.action = "<c:url value='/uss/umt/coreUserPasswordUpdt.cm'/>";
    document.userManageVO.submit();
}
...
function fnLockIncorrect(){
	if(confirm("<spring:message code="comUssUmt.common.lockAtConfirm" />")){
	    document.userManageVO.action = "<c:url value='/uss/umt/coreUserLockIncorrect'/>";
...
<body>
<!-- content start -->
<form:form modelAttribute="userManageVO" action="${pageContext.request.contextPath}/uss/umt/coreUserManageModify.cm" name="userManageVO" method="post" onSubmit="fnUpdate(document.forms[0]); return false;">
<div class="wTableFrm">
