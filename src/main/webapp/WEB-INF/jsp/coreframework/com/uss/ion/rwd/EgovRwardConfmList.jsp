 ...
 ******************************************************** */
 ...
 function linkPage(pageNo){
	...
	varForm.action = "<c:url value='/uss/ion/rwd/EgovRwardConfmList.cm'/>";
	varForm.submit();
 }
...
function fncRwardManageConfm(rwardId,infrmlSanctnId){
	...
	varForm.action           = "<c:url value='/uss/ion/rwd/EgovRwardConfm.cm'/>";
	varForm.submit();
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/uss/ion/rwd/EgovRwardConfmList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
				<form name="item" method="post" action="<c:url value='/uss/ion/rwd/EgovRwardConfm.cm'/>">
