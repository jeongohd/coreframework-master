...
<script type="text/javaScript" language="javascript">
	 ...
	 ******************************************************** */
	 ...
	 function linkPage(pageNo){
		...
		varForm.action = "<c:url value='/uss/ion/ctn/EgovCtsnnConfmList.cm'/>";
		varForm.submit();
	 }
	...
	function fncCtsnnManageConfm(ctsnnId,infrmlSanctnId){
		...
		varForm.action = "<c:url value='/uss/ion/ctn/EgovCtsnnConfm.cm'/>";
		varForm.submit();
	}
</script>
</head>
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/uss/ion/ctn/EgovCtsnnConfmList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
				<form name="item" method="post" action="<c:url value='/uss/ion/ctn/EgovCtsnnConfm.cm'/>">
