...
function fncSelectMainImageList() {
    ...
    varFrom.action = "<c:url value='/uss/ion/msi/selectMainImageList.cm'/>";
    varFrom.submit();       
}

function fncMainImageUpdate() {
    var varFrom = document.getElementById("mainImage");
    varFrom.action = "<c:url value='/uss/ion/msi/updtMainImage.cm'/>";
...
function fncMainImageDelete() {
    var varFrom = document.getElementById("mainImage");
    varFrom.action = "<c:url value='/uss/ion/msi/removeMainImage.cm'/>";
...
<div class="wTableFrm">
	...
	<!-- 등록폼 -->
<form:form modelAttribute="mainImage" method="post" action="${pageContext.request.contextPath}/uss/ion/msi/updtMainImage.cm' />" enctype="multipart/form-data">
<input type="hidden" name="posblAtchFileNumber" value="1" >
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/msi/removeMainImage.cm'/>?imageId=<c:out value='${mainImageVO.imageId}'/>" onclick="fncMainImageDelete(); return false;"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/msi/selectMainImageList.cm'/>?pageIndex=<c:out value='${mainImageVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${mainImageVO.searchKeyword}"/>&amp;searchCondition=1" onclick="fncSelectMainImageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
