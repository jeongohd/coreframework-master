...
function fn_egov_updt_cpyrhtprtcpolicycn(form, cpyrhtId){
	...
	// 서버사이드 테스트용
	/*
		form.action = "<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyCnUpdt.cm'/>";
		form.submit();
		return;
	*/
...
<form:form modelAttribute="cpyrhtPrtcPolicyVO" action="${pageContext.request.contextPath}/uss/sam/cpy/CpyrhtPrtcPolicyCnUpdt.cm" method="post">
