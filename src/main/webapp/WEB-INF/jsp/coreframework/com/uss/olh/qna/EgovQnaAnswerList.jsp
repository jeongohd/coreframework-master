...
function fn_egov_select_linkPage(pageNo){
	...
	document.qnaForm.action = "<c:url value='/uss/olh/qna/selectQnaAnswerList.cm'/>";
...
function fn_egov_inquire_qnadetail(qaId) {
	...
	document.qnaForm.qaId.value = qaId;
  	document.qnaForm.action = "<c:url value='/uss/olh/qna/selectQnaAnswerDetail.cm'/>";
  	document.qnaForm.submit();
}
</script>
</head>
...
<form name="qnaForm" action="<c:url value='/uss/olh/qna/selectQnaAnswerList.cm'/>" method="post" onSubmit="fn_egov_search_qna(); return false;">
<div class="board">
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/uss/olh/qna/selectQnaAnswerDetail.cm?qaId=${resultInfo.qaId}'/>" onClick="fn_egov_inquire_qnadetail('<c:out value="${resultInfo.qaId}"/>');return false;"><c:out value='${fn:substring(resultInfo.qestnSj, 0, 40)}'/></a></td>
