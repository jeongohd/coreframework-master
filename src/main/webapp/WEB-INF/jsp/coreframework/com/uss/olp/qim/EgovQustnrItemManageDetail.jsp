...
function fn_egov_modify_QustnrItemManage(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/uss/olp/qim/EgovQustnrItemManageModify.cm' />";;
	vFrom.submit();
...
<div class="wTableFrm">
<form name="QustnrItemManageForm" id="QustnrItemManageForm" action="<c:url value='/uss/olp/qim/EgovQustnrItemManageModify.cm'/>" method="post">
	<!-- 타이틀 -->
	...
	<div class="btn">
		<!-- 수정 버튼 -->
		<form name="formUpdt" action="<c:url value='/uss/olp/qim/EgovQustnrItemManageModify.cm'/>" method="post" onsubmit="fn_egov_modify_QustnrItemManage(); return false;" style="float:left;">
			<input type="submit" class="s_submit" value="<spring:message code='button.update' />" title="<spring:message code='title.update' /> <spring:message code='input.button' />" />
			<input name="qestnrTmplatId" type="hidden" value="${resultList[0].qustnrIemId}">
		</form>
		<!-- 삭제 버튼 -->
		<form name="formDelete" action="<c:url value='/uss/olp/qim/EgovQustnrItemManageDetail.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<!-- 목록 버튼 -->
		<form name="formList" action="<c:url value='/uss/olp/qim/EgovQustnrItemManageList.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
