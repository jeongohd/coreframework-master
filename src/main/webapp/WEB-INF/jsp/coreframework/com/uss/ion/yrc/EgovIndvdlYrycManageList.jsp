...
function fncIndvdlYrycRegist(){
	location.href = "<c:url value='/uss/ion/yrc/EgovIndvdlYrycRegist.cm'/>";
}
...
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			<li>			
				<span class="btn_b">
					<a href="<c:url value='/uss/ion/yrc/EgovIndvdlYrycRegist.cm'/>" onclick="fncIndvdlYrycRegist(); return false;" title="">
