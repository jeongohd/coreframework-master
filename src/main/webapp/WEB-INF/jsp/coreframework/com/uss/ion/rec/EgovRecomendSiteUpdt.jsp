...
function fn_egov_inqire_list() {
	recomendSiteVO.action = "<c:url value='/uss/ion/rec/selectRecomendSiteList.cm'/>";
...
<!-- 상단타이틀 -->
<form:form modelAttribute="recomendSiteVO" action="${pageContext.request.contextPath}/uss/ion/rec/updateRecomendSite.cm" method="post" onSubmit="fn_egov_updt_site(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/rec/selectRecomendSiteList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
