...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<form name="formUpdt" action="<c:url value='/uss/sam/stp/StplatCnUpdtView.cm'/>" method="post" style="float:left;">
		...
		<form name="formDelete" action="<c:url value='/uss/sam/stp/StplatCnDelete.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<form name="formList" action="<c:url value='/uss/sam/stp/StplatListInqire.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
