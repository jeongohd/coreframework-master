...
function fncUserAbsnceInsert() {
    ...
    var varFrom = document.getElementById("userAbsnce");
    varFrom.action = "<c:url value='/uss/ion/uas/addUserAbsnce.cm'/>";
...
<div class="wTableFrm">
<form:form modelAttribute="userAbsnce" action="${pageContext.request.contextPath}/uss/ion/uas/addUserAbsnce.cm' />" method="post">
