...
function fn_egov_select_linkPage(pageNo){
	...
	document.siteForm.action = "<c:url value='/uss/ion/sit/selectSiteList.cm'/>";
...
function fn_egov_inquire_sitedetail(siteId) {
	...
	document.siteForm.siteId.value = siteId;
  	document.siteForm.action = "<c:url value='/uss/ion/sit/selectSiteDetail.cm'/>";
  	document.siteForm.submit();
}
</script>
</head>
...
<form name="siteForm" action="<c:url value='/uss/ion/sit/selectSiteList.cm'/>" method="post" onSubmit="fn_egov_search_site(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/sit/insertSiteView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td><a href="<c:url value='/uss/ion/sit/selectSiteDetail.cm?siteId=${resultInfo.siteId}'/>" onClick="fn_egov_inquire_sitedetail('<c:out value="${resultInfo.siteId}"/>');return false;"><c:out value='${fn:substring(resultInfo.siteNm, 0, 40)}'/></a></td>
