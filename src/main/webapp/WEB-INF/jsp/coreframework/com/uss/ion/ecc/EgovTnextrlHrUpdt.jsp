...
function fn_egov_inqire_eventlist() {
	tnextrlHrVO.action = "<c:url value='/uss/ion/ecc/selectTnextrlHrList.cm'/>";
	tnextrlHrVO.submit();
}
...
<!-- 상단타이틀 -->
<form:form modelAttribute="tnextrlHrVO" action="${pageContext.request.contextPath}/uss/ion/ecc/updateTnextrlHr.cm" method="post" onSubmit="fn_egov_updt_hr(document.forms[0]); return false;" >
	<div class="wTableFrm">
	...
	<span class="btn_s"><a href="<c:url value='/uss/ion/ecc/selectTnextrlHrList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span></div>
