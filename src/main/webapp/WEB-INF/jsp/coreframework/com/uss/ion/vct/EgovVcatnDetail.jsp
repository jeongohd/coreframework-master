...
function fncEgovVcatnManageList(){
	location.href = "<c:url value='/uss/ion/vct/EgovVcatnManageList.cm'/>";
}
<c:if test="${vcatnManageVO.confmAt eq 'A' }">
	...
	******************************************************** */
	function fncEgovVcatnManage() {
			...
			varFrom.action = "<c:url value='/uss/ion/vct/EgovVcatnManageDetail.cm'/>";
			varFrom.submit();   
	}
	/* ********************************************************
	* 삭제처리화면
	******************************************************** */
	function fncDeleteVcatnManage() {
		    var varFrom = document.getElementById("vcatnManage");
		    varFrom.action = "<c:url value='/uss/ion/vct/deleteVcatnManage.cm'/>";
...
<div class="wTableFrm">
	...
	<div class="btn">
		<c:if test="${vcatnManageVO.confmAt eq 'A' }">
		<form id="updtForm" name="updtForm" action="<c:url value='/uss/ion/vct/EgovVcatnManageDetail.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		<input type="hidden" name="cmd"       value="updt"/>
		<input type="hidden" name="applcntId" value="<c:out value='${vcatnManageVO.applcntId}'/>"/>
		<input type="hidden" name="vcatnSe"   value="<c:out value='${vcatnManageVO.vcatnSe}'/>"/>
		<input type="hidden" name="bgnde"     value="<c:out value='${vcatnManageVO.bgnde}'/>"/>
		...
		<form id="deleteForm" name="deleteForm" action="<c:url value='/uss/ion/vct/deleteVcatnManage.cm'/>" method="post" style="display:inline-block; vertical-align:top">
		<input type="hidden" name="applcntId" value="<c:out value='${vcatnManageVO.applcntId}'/>"/>
		<input type="hidden" name="vcatnSe"   value="<c:out value='${vcatnManageVO.vcatnSe}'/>"/>
		<input type="hidden" name="bgnde"     value="<c:out value='${vcatnManageVO.bgnde}'/>"/>
		<input type="hidden" name="endde"     value="<c:out value='${vcatnManageVO.endde}'/>"/>
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/vct/EgovVcatnManageList.cm'/>?searchCondition=1" onclick="fncEgovVcatnManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
