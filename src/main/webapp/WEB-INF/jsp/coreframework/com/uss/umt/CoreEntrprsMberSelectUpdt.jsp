<%
 /**
  * @Class Name : CoreEntrprsMberSelectUpdt.jsp
...
function fnDeleteEntrprs(checkedIds) {
	if(confirm("<spring:message code="common.delete.msg" />")){
	    ...
	    document.entrprsManageVO.action = "<c:url value='/uss/umt/coreEntrprsMberRemove.cm'/>";
	    document.entrprsManageVO.submit();
	}
}
function fnPasswordMove(){
    document.entrprsManageVO.action = "<c:url value='/uss/umt/CoreEntrprsPasswordUpdtView.cm'/>";
    document.entrprsManageVO.submit();
}

function fnLockIncorrect(){
	if(confirm("<spring:message code="comUssUmt.common.lockAtConfirm" />")){
	    document.entrprsManageVO.action = "<c:url value='/uss/umt/CoreEntrprsMberLockIncorrect.cm'/>";
	    document.entrprsManageVO.submit();
	}
}
...
function onepassCancel() {
	if (confirm("디지털원패스 연동해지를 진행하시겠습니까?")) { 
		document.onepassForm.action = "<c:url value='/uat/uia/onepass/onepassCancel.cm'/>";
...
<body>
<!-- content start -->
<form:form modelAttribute="entrprsManageVO" action="${pageContext.request.contextPath}/uss/umt/coreEntrprsMberModify.cm" name="entrprsManageVO" method="post" onSubmit="fnUpdate(document.forms[0]); return false;">
<!-- <div class="wTableFrm"> -->
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/umt/coreEntrprsMberManageList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
