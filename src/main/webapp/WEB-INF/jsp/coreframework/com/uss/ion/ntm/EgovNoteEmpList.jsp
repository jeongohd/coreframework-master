...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/ion/ntm/listEgovNoteEmpListPopup.cm'/>";
...
function fn_egov_regist_NoteEmp(){
	location.href = "<c:url value='/uss/olp/mgt/EgovNoteEmpRegist.cm'/>";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
function fn_egov_modify_NoteEmp(){
	location.href = "<c:url value='/uss/olp/mgt/EgovNoteEmpModify.cm'/>";
}
/* ********************************************************
 * 상세화면 처리 함수
 ******************************************************** */
function fn_egov_detail_NoteEmp(mtgId){
	...
	vFrom.action = "<c:url value='/uss/olp/mgt/EgovNoteEmpDetail.cm'/>";
	vFrom.submit();
}
/* ********************************************************
 * 삭제 처리 함수
...
function fn_egov_delete_NoteEmp(mtgId){
	...
	if(confirm("<spring:message code="common.delete.msg"/>?")){
		vFrom.mtgId.value = mtgId;
		vFrom.cmd.value = 'del';
		vFrom.action = "<c:url value='/uss/olp/mgt/EgovNoteEmpList.cm'/>";
		vFrom.submit();
	}else{
		vFrom.cmd.value = '';
	}
...
/* 	vFrom.pageIndex.value = "1"; */
	vFrom.action = "<c:url value='/uss/ion/ntm/listEgovNoteEmpListPopup.cm'/>";
	vFrom.submit();
...
<div class="popup">
<form name="listForm" id="listForm" action="<c:url value='/uss/ion/ntm/listEgovNoteEmpListPopup.cm'/>" method="post">
...
<!--  목록  -->
<form name="contentForm" id="contentForm" action="<c:url value='/uss/ion/ntm/listEgovNoteEmpListPopup.cm'/>" method="post">
