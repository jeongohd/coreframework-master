...
function fn_egov_inqire_list() {
	onlineManualVO.action = "<c:url value='/uss/olh/omm/selectOnlineManualList.cm'/>";
...
<!-- 상단타이틀 -->
<form:form modelAttribute="onlineManualVO" action="${pageContext.request.contextPath}/uss/olh/omm/updateOnlineManual.cm" method="post" onSubmit="fn_egov_updt_onlinemanual(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<tbody>
		...
		<tr>
			...
			<td class="nopd" colspan="3">
				...
				<ckeditor:replace replace="onlineMnlDc" basePath="${pageContext.request.contextPath}/html/coreframework/com/cmm/utl/ckeditor/" />
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/omm/selectOnlineManualList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
