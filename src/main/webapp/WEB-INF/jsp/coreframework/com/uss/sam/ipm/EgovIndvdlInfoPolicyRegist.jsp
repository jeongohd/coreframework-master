...
<c:set var="ImgUrl" value="/images/coreframework/com/uss/sam/ipm/"/>
<c:set var="CssUrl" value="/css/coreframework/com/uss/sam/ipm/"/>
<!DOCTYPE html>
<html lang="ko">
<head>
...
function fn_egov_list_IndvdlInfoPolicy(){
	location.href = "<c:url value='/uss/sam/ipm/listIndvdlInfoPolicy.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_save_IndvdlInfoPolicy(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/uss/sam/ipm/registIndvdlInfoPolicy.cm' />";
...
<form:form modelAttribute="indvdlInfoPolicy" name="indvdlInfoPolicy" action="${pageContext.request.contextPath}/uss/sam/ipm/registIndvdlInfoPolicy.cm" method="post" enctype="multipart/form-data" >
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/sam/ipm/listIndvdlInfoPolicy.cm' />"><spring:message code="button.list" /></a></span>
	</div>
</div>
...
<ckeditor:replace replace="indvdlInfoDc" basePath="${pageContext.request.contextPath}/html/coreframework/com/cmm/utl/ckeditor/" />
</body>
</html>
