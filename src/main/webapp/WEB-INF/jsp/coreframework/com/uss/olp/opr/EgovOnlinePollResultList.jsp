...
<script type="text/javaScript" language="javascript">
	...
	function fn_egov_del_OnlinePollResult(pollResultId){
		...
		if(confirm("삭제 하시겠습니까?")){
			...
			vFrom.action = "<c:url value='/uss/olp/opr/delOnlinePollResult.cm' />";
			vFrom.submit();
		}
...
<div class="board">
	...
	<tr>
		...
		<td>
		<form name="subForm" method="post" action="<c:url value='/uss/olp/opr/delOnlinePollResult.cm'/>">
	...
	<!--  목록버튼  -->
	<form name="listForm" action="<c:url value='/uss/olp/opr/delOnlinePollResult.cm'/>" method="post">
