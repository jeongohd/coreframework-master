...
<script type="text/javascript" src="<c:url value='/js/coreframework/com/cmm/jquery.js'/>"></script>
...
function linkPage(pageNo){
	...
	document.twitterInfo.action = "<c:url value='/uss/rss/rss/listRssTagManage.cm'/>";
...
function fn_egov_tableColumn_RssTagManage(){
	...
	$.ajax({
		   type:"GET",
		   url:"<c:url value='/uss/ion/rss/listRssTagManageTableColumnList.cm?tableName='/>"+tableName,
		   dataType:"json",
...
function fn_egov_tableColumn_RssTagManageIFrame(){
	var tableName = $("#trgetSvcTable option:selected").val();
	document.getElementById("iframeTableColumnView").src = "<c:url value='/uss/ion/rss/listRssTagManageTableColumnView.cm?tableName='/>" + tableName;
}
...
function fn_egov_save_RssTagManage(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		...
		vFrom.action = "<c:url value='/uss/ion/rss/registRssTagManage.cm'/>";
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
			    <a href="#LINK" onclick="fn_egov_ColumnSetting_RssTagManage('bdtTitle')"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_add.gif'/>" alt="컬럼명추가" title="컬럼명추가"></a>
				...
				<a href="#LINK" onclick="document.getElementById('bdtTitle').value='';"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_delete.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
		...
		<tr>
			...
			<td class="left">
			    <a href="#LINK" onclick="fn_egov_ColumnSetting_RssTagManage('bdtLink')"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_add.gif'/>" alt="컬럼명추가" title="컬럼명추가"></a>
				...
				<a href="#LINK" onclick="document.getElementById('bdtLink').value='';"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_delete.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
		...
		<tr>
			...
			<td class="left">
			    <a href="#LINK" onclick="fn_egov_ColumnSetting_RssTagManage('bdtDescription')"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_add.gif'/>" alt="컬럼명추가" title="컬럼명추가"></a>
				...
				<a href="#LINK" onclick="document.getElementById('bdtDescription').value='';"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_delete.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
		...
		<tr>
			...
			<td class="left">
			    <a href="#LINK" onClick="fn_egov_ColumnSetting_RssTagManage('bdtTag')"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_add.gif'/>"alt="컬럼명추가" title="컬럼명추가"></a>
				...
				<a href="#LINK" onClick="document.getElementById('bdtTag').value='';"><img src="<c:url value='/images/coreframework/com/cmm/icon/action_delete.gif'/>" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/rss/listRssTagManage.cm'/>" onclick=""><spring:message code="button.list" /></a></span>
	</div>
