...
function fn_egov_modify_IndvdlInfoPolicy(){
	...
	vFrom.action = "<c:url value='/uss/sam/ipm/updtIndvdlInfoPolicy.cm' />";;
	vFrom.submit();
...
<form name="IndvdlInfoPolicyForm" action="<c:url value=''/>" method="post">
	...
	<!-- 하단 버튼 -->
	<div class="btn">		
		<form name="formUpdt" action="<c:url value='/uss/sam/ipm/updtIndvdlInfoPolicy.cm'/>" method="post" style="display:inline">
		...
		<form name="formDelete" action="<c:url value='/uss/sam/ipm/detailIndvdlInfoPolicy.cm'/>" method="post" style="display:inline">
		...
		<form name="formList" action="<c:url value='/uss/sam/ipm/listIndvdlInfoPolicy.cm'/>" method="post" style="display:inline">
