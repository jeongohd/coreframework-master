...
function fn_egov_list_QustnrRespondInfo(){
	location.href = "<c:url value='/uss/olp/qri/EgovQustnrRespondInfoList.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_save_QustnrRespondInfo(){
	...
	if(confirm("<spring:message code='common.save.msg'/>")){
		...
		varFrom.action =  "<c:url value='/uss/olp/qri/EgovQustnrRespondInfoRegist.cm' />";
 ...
 ******************************************************** */
 function fn_egov_QustnrManageListPopup_QustnrItemManage(){
 	...
 	window.showModalDialog("<c:url value='/uss/olp/qmc/EgovQustnrManageListPopup.cm' />", self,"dialogWidth:800px;dialogHeight:500px;resizable:yes;center:yes");
  ...
  ******************************************************** */
  function fn_egov_QustnrQestnManageListPopup_QustnrItemManage(){
	...
	sParam = sParam + "&searchKeyword=" + document.getElementById("qestnrId").value;
  	...
  	window.showModalDialog("<c:url value='/uss/olp/qqm/EgovQustnrQestnManageListPopup.cm' />?" + sParam, self,"dialogWidth:800px;dialogHeight:500px;resizable:yes;center:yes");
...
function fn_egov_QustnrItemManageListPopup_QustnrItemManage(){
	...
	sParam = sParam + "&searchKeyword=" + document.getElementById("qestnrQesitmId").value;
  	...
  	window.showModalDialog("<c:url value='/uss/olp/qim/EgovQustnrItemManageListPopup.cm' />?" + sParam, self,"dialogWidth:800px;dialogHeight:500px;resizable:yes;center:yes");
...
<form:form modelAttribute="qustnrRespondInfoVO" action="${pageContext.request.contextPath}/uss/olp/qri/EgovQustnrRespondInfoRegist.cm" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrRespondInfo(document.forms[0]); return false;">
...
<div class="wTableFrm">
	...
	<tbody >
		...
		<tr>
			...
			<td class="left">
				...
				<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt="<spring:message code='comUssOlpQri.regist.qestnrCn'/>" title="<spring:message code='comUssOlpQri.regist.qestnrCn'/>"><!-- alt="설문관리정보" title="설문관리정보" -->
				</a>
		...
		<tr>
			...
			<div>
				...
				<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt="<spring:message code='comUssOlpQri.regist.qestnrQesitmCn'/>" title="<spring:message code='comUssOlpQri.regist.qestnrQesitmCn'/>"><!-- alt="설문문항정보" title="설문문항정보" -->
				</a>
		...
		<tr>
			...
			<td class="left">
				...
				<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt="<spring:message code='comUssOlpQri.regist.qustnrIemCn'/>" title="<spring:message code='comUssOlpQri.regist.newWindow'/>"><!-- alt="설문항목정보" title="새창" -->
				</a>
	...
	<div class="btn">
		...
		<!-- 목록버튼 -->
		<span class="btn_s"><a href="<c:url value='/uss/olp/qri/EgovQustnrRespondInfoList.cm' />"  title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
