...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/ion/ulm/listUnityLink.cm'/>";
...
function fn_egov_search_UnityLink(){
	...
	vFrom.action = "<c:url value='/uss/ion/ulm/listUnityLink.cm' />";
	vFrom.submit();
...
<form name="listForm" action="<c:url value='/uss/ion/ulm/listUnityLink.cm'/>" method="post">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보에 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/ulm/registUnityLink.cm' />?pageIndex=<c:out value='${searchVO.pageIndex}' />" onclick="" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
			    ...
			    <td>
			    	<form name="subForm" method="post" action="<c:url value='/uss/ion/ulm/detailUnityLink.cm'/>">
