...
function fn_egov_modify_QustnrQestnManage(){
	var vFrom = document.QustnrQestnManageForm;
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/uss/olp/qqm/EgovQustnrQestnManageModify.cm' />";;
	vFrom.submit();
...
<div class="wTableFrm">
<form name="QustnrTmplatManageForm" id="QustnrTmplatManageForm" action="<c:url value='/uss/olp/qqm/EgovQustnrQestnManageModify.cm'/>" method="post">
	<!-- 타이틀 -->
	...
	<div class="btn">
		<!-- 수정 버튼 -->
		<form name="formUpdt" action="<c:url value='/uss/olp/qqm/EgovQustnrQestnManageModify.cm'/>" method="post" onsubmit="fn_egov_modify_QustnrQestnManage(); return false;" style="float:left;">
		...
		<!-- 삭제 버튼 -->
		<form name="formDelete" action="<c:url value='/uss/olp/qqm/EgovQustnrQestnManageDetail.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<!-- 목록 버튼 -->
		<form name="formList" action="<c:url value='/uss/olp/qqm/EgovQustnrQestnManageList.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
