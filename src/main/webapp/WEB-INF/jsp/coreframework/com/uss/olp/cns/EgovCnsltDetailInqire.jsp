...
function fn_egov_inqire_cnsltlist() {
	...
	document.CnsltManageForm.action = "<c:url value='/uss/olp/cns/CnsltListInqire.cm'/>";
...
function fn_egov_updt_cnsltdtls(cnsltId){
	...
	var url 	= "<c:url value='/uss/olp/cns/CnsltPasswordConfirmView.cm'/>";
	...
	// 결과값을 받아. 결과를 Submit한다.
 	if	(returnValue)	{
 		...
 		document.CnsltManageForm.action = "<c:url value='/uss/olp/cns/CnsltPasswordConfirm.cm'/>";
 		document.CnsltManageForm.submit();
...
function fn_egov_delete_cnsltdtls(cnsltId){
	...
	if	(confirm("<spring:message code="common.delete.msg" />"))	{
		...
		// Delete하기 위한 키값을 셋팅
		document.CnsltManageForm.cnsltId.value = cnsltId;
		document.CnsltManageForm.action = "<c:url value='/uss/olp/cns/CnsltDtlsDelete.cm'/>";
		document.CnsltManageForm.submit();
...
<c:if test="${result.qnaProcessSttusCode == '3'}">
	...
	<div class="btn">
		...
		<form name="CnsltManageForm" action="<c:url value='/uss/olp/cns/CnsltPasswordConfirm.cm'/>" method="post" onsubmit="fn_egov_updt_cnsltdtls('<c:out value="${result.cnsltId}"/>'); return false;" style="float:left;">
		...
		<form name="formDelete" action="<c:url value='/uss/olp/cns/CnsltDtlsDelete.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<form name="formList" action="<c:url value='/uss/olp/cns/CnsltListInqire.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
