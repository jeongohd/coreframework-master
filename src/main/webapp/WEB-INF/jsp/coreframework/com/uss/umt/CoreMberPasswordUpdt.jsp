<%
 /**
  * @Class Name : CoreMberPasswordUpdt.jsp
...
function fnListPage(){
    document.passwordChgVO.action = "<c:url value='/uss/umt/coreMberManageList.cm'/>";
...
<form name="passwordChgVO" method="post" action="<c:url value="/uss/umt/CoreMberPasswordUpdt.cm"/>" onsubmit="fnUpdate(document.forms[0]); return false;">
