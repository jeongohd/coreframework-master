 ...
 ******************************************************** */
 function fn_egov_delete_worddicary(wordId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.wordDicaryForm.action = "<c:url value='/uss/olh/wor/deleteWordDicary.cm'/>";
...
<form name="wordDicaryForm" action="<c:url value='/uss/olh/wor/updateWordDicaryView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/wor/deleteWordDicary.cm' />" onClick="fn_egov_delete_worddicary('<c:out value="${result.wordId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/olh/wor/selectWordDicaryList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
