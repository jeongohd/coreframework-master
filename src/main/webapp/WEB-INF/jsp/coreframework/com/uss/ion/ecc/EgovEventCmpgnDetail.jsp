 ...
 ******************************************************** */
 function fn_egov_delete_event(eventId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.eventCmpgnForm.action = "<c:url value='/uss/ion/ecc/deleteEventCmpgn.cm'/>";
...
<form name="eventCmpgnForm" action="<c:url value='/uss/ion/ecc/updateEventCmpgnView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<tbody>
		...
		<tr>
			...
			<td class="left"><a href="<c:url value='/uss/ion/ecc/selectTnextrlHrList.cm?eventId=${result.eventId}' />" title="<spring:message code="comUssIonEcc.tnextrlHrVO.title" /> <spring:message code="title.inquire" />"><spring:message code="comUssIonEcc.tnextrlHrVO.title" /> <spring:message code="title.inquire" /></a></td>
		</tr>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/ecc/deleteEventCmpgn.cm' />" onClick="fn_egov_delete_event('<c:out value="${result.eventId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/ecc/selectEventCmpgnList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
