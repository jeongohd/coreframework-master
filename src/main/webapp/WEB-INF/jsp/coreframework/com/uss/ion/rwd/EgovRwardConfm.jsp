...
<script type="text/javaScript" language="javascript">
	...
	function fncEgovRwardConfmList(){
		location.href = "<c:url value='/uss/ion/rwd/EgovRwardConfmList.cm'/>";
	}
	...
	function modalDialogCallback(retVal) {
		if(retVal != null){
		    ...
		    varForm.action = "<c:url value='/uss/ion/rwd/updtRwardConfm.cm'/>";
...
<form:form modelAttribute="rwardManage" name="rwardManage" method="post" action="<c:url value='/uss/ion/rwd/EgovRwardConfm.cm'/>">
...
<div class="wTableFrm">
	...
	<div class="btn">		
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/rwd/EgovRwardConfmList.cm'/>?searchCondition=1" onclick="fncEgovRwardConfmList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
