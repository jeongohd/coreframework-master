...
<form name="MeetingManageForm"  id="MeetingManageForm" action="<c:url value='/uss/olp/mgt/EgovMeetingManageDetail.cm' />" method="post">
...
<div style="visibility:hidden;display:none;"><input name="iptSubmit" type="submit" value="전송" title="전송"></div>
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<form name="formUpdt" action="<c:url value='/uss/olp/mgt/EgovMeetingManageModify.cm'/>" method="post" style="display:inline">
		...
		<form name="formDelete" action="<c:url value='/uss/olp/mgt/EgovMeetingManageDetail.cm'/>" method="post" style="display:inline">
		...
		<form name="formList" action="<c:url value='/uss/olp/mgt/EgovMeetingManageList.cm'/>" method="post" style="display:inline">
