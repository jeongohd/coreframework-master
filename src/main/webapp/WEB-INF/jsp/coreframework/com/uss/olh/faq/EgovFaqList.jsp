...
function fn_egov_select_linkPage(pageNo){
	...
	document.faqForm.action = "<c:url value='/uss/olh/faq/selectFaqList.cm'/>";
...
function fn_egov_inquire_faqdetail(faqId) {
	...
	document.faqForm.faqId.value = faqId;
  	document.faqForm.action = "<c:url value='/uss/olh/faq/selectFaqDetail.cm'/>";
  	document.faqForm.submit();
}
</script>
</head>
...
<form name="faqForm" action="<c:url value='/uss/olh/faq/selectFaqList.cm'/>" method="post" onSubmit="fn_egov_search_faq(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/olh/faq/insertFaqView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/uss/olh/faq/selectFaqDetail.cm?faqId=${resultInfo.faqId}'/>" onClick="fn_egov_inquire_faqdetail('<c:out value="${resultInfo.faqId}"/>');return false;"><c:out value='${fn:substring(resultInfo.qestnSj, 0, 40)}'/></a></td>
