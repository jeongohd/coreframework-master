...
function fncEventReqstManageList(){
	location.href = "<c:url value='/uss/ion/evt/EgovEventReqstManageList.cm'/>";
}
...
function fncEventReqstManage() {
		...
		varFrom.action = "<c:url value='/uss/ion/evt/EgovEventReqstDetail.cm'/>";
		varFrom.submit();   
}
/* ********************************************************
* 삭제처리화면
...
function fncDeleteEventReqstManage() {
   var varFrom = document.getElementById("eventManage");
   varFrom.action = "<c:url value='/uss/ion/evt/EgovEventReqstDelete.cm'/>";
	...
	<div class="btn">		
		...
		<c:if test="${empty check_popup}">
			<c:if test="${eventManageVO.eventAtdrnCount == 0 && eventManageVO.eventDayCount >= 0}">
				...
				<span class="btn_s"><a href="<c:url value='/uss/ion/evt/EgovEventReqstDelete.cm'/>?eventId=<c:out value='${eventManageVO.eventId}'/>" onclick="fncDeleteEventReqstManage(); return false;"><spring:message code="button.delete" /></a></span>
			</c:if>
			
			<span class="btn_s"><a href="<c:url value='/uss/ion/evt/EgovEventReqstManageList.cm'/>" onclick="fncEventReqstManageList(); return false;"><spring:message code="button.list" /></a></span>
		</c:if>
	</div>
