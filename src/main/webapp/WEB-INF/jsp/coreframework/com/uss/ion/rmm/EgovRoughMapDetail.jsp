...
<script type="text/javaScript" language="javascript">
	...
	function fn_egov_inqire_roughmaplist() {
		document.roughMap.action = "<c:url value='/com/uss/ion/rmm/selectRoughMapList.cm'/>";
	...
	function fn_egov_updt_roughmap(roughMapId){
		document.roughMap.action = "<c:url value='/com/uss/ion/rmm/updateRoughMapView.cm'/>";
		document.roughMap.submit();
	}
	...
	function fn_egov_delete_roughmap(roughMapId){
		...
		if	(confirm("<spring:message code="common.delete.msg" />"))	{
			...
			document.roughMap.action = "<c:url value='/com/uss/ion/rmm/deleteRoughMap.cm'/>";
			document.roughMap.submit();
		}
	}
</script>
...
<form id="roughMap" name="roughMap" method="post">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/com/uss/ion/rmm/deleteRoughMap.cm'/>?roughMapId=<c:out value='${roughMap.roughMapId}'/>" onclick="fn_egov_delete_roughmap('<c:out value="${roughMap.roughMapId}"/>'); return false;"><spring:message code="button.delete" /></a></span>
		
		<span class="btn_s"><a href="<c:url value='/com/uss/ion/rmm/selectRoughMapList.cm'/>" onclick="fn_egov_inqire_roughmaplist(); return false;"><spring:message code="button.list" /></a></span>
	</div>
