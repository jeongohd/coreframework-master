...
<script type="text/javaScript" language="javascript">
	...
	function fncEgovCtsnnConfmList(){
		location.href = "<c:url value='/uss/ion/ctn/EgovCtsnnConfmList.cm'/>";
	}
	...
	function modalDialogCallback(retVal) {
		if(retVal != null){
		    ...
		    varForm.action = "<c:url value='/uss/ion/ctn/updtCtsnnConfm.cm'/>";
...
<div class="wTableFrm">
	...
	<div class="btn">
	    ...
	    <span class="btn_s"><a href="<c:url value='/uss/ion/ctn/EgovCtsnnConfmList.cm'/>?searchCondition=1" onclick="fncEgovCtsnnConfmList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
