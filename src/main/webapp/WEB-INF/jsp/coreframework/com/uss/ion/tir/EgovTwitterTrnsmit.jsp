...
function linkPage(pageNo){
	...
	document.twitterInfo.action = "<c:url value='/uss/tir/rss/listTwitterRecptn.cm'/>";
...
function fn_egov_save_Twitter(){
	...
	if(confirm("<spring:message code="ussIonTir.twitterTrnsmit.validate.send"/>")){/* 작성된 Twitter를 전송 하시겠습니까? */
		...
		vFrom.action = "<c:url value='/uss/ion/tir/registTwitterTrnsmit.cm'/>";
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/tir/listTwitterRecptn.cm'/>" onclick=""><spring:message code="button.list"/></a></span><!-- 목록 -->
	</div>
