...
function fn_egov_inqire_list() {
	siteVO.action = "<c:url value='/uss/ion/sit/selectSiteList.cm'/>";
	siteVO.submit();	
}
</script>
</head>
...
<!-- 상단타이틀 -->
<form:form modelAttribute="siteVO" action="${pageContext.request.contextPath}/uss/ion/sit/updateSite.cm" method="post" onSubmit="fn_egov_updt_site(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/sit/selectSiteList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
