...
function fn_egov_list_QustnrRespondInfo(){
	location.href = "/uss/olp/qnn/EgovQustnrRespondInfoManageList.cm";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_save_QustnrRespondInfo(){
	...
	if(confirm("<spring:message code='common.save.msg'/>")){
		...
		//varFrom.action =  "${pageContext.request.contextPath}/uss/olp/qnn/EgovQustnrRespondInfoManageRegist.cm";
		varFrom.action =  "<c:url value='/uss/olp/qnn/EgovQustnrRespondInfoManageRegist.cm'/>";
		varFrom.submit();
...
<form:form name="qustnrRespondInfoManage" id="qustnrRespondInfoManage" action="${pageContext.request.contextPath}/uss/olp/qnn/EgovQustnrRespondInfoManageRegist.cm" method="post">
...
<div class="wTableFrm">
	...
	<tbody >	
		...
		<c:import charEncoding="utf-8" url="/uss/olp/qri/template/template.cm" >
	...
	<div class="btn">
		...
		<!-- 목록버튼 -->
		<span class="btn_s"><a href="<c:url value='/uss/olp/qnn/EgovQustnrRespondInfoManageList.cm' />"  title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
