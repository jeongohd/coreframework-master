...
function fncSelectLoginScrinImageList(pageNo){
    ...
    document.listForm.action = "<c:url value='/uss/ion/lsi/selectLoginScrinImageList.cm'/>";
    document.listForm.submit();
}

function fncSelectLoginScrinImage(imageId) {
    document.listForm.imageId.value = imageId;
    document.listForm.action = "<c:url value='/uss/ion/lsi/getLoginScrinImage.cm'/>";
    document.listForm.submit();
}
...
function fncAddLoginScrinImageInsert() {
    ...
    document.listForm.action = "<c:url value='/uss/ion/lsi/addViewLoginScrinImage.cm'/>";
    document.listForm.submit();
}
...
function fncLoginScrinImageListDelete() {
	if(fncManageChecked()) {
        if(confirm("<spring:message code="ussIonLsi.loginScrinImageList.deleteImage"/>")) {/* 삭제하시겠습니까? */
            document.listForm.action = "<c:url value='/uss/ion/lsi/removeLoginScrinImageList.cm'/>";
            document.listForm.submit();
        }
    }
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/uss/ion/lsi/selectLoginScrinImageList.cm'/>" method="post">
	...
	<div class="search_box" title=<spring:message code="common.searchCondition.msg"/>><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/lsi/addViewLoginScrinImage.cm'/>?pageIndex=<c:out value='${loginScrinImageVO.pageIndex}'/>&amp;searchKeyword=<c:out value="${loginScrinImageVO.searchKeyword}"/>&amp;searchCondition=1" onclick="fncAddLoginScrinImageInsert(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				<td>
					<form name="item" method="post" action="<c:url value='/uss/ion/lsi/getLoginScrinImage.cm'/>">
