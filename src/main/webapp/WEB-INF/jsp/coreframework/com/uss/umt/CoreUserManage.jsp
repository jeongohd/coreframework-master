...
function fnDeleteUser() {
    ...
    if(checkedIds.length > 0) {
        if(confirm("<spring:message code="common.delete.msg" />")){
            ...
            document.listForm.action = "<c:url value='/uss/umt/coreUserManageRemove.cm'/>";
...
function fnSelectUser(id) {
    ...
    document.listForm.action = "<c:url value='/uss/umt/coreUserManage.cm'/>";
    document.listForm.submit();

}
function fnAddUserView() {
    document.listForm.action = "<c:url value='/uss/umt/coreUserManageRegist.cm'/>";
    document.listForm.submit();
}
function fnLinkPage(pageNo){
    document.listForm.pageIndex.value = pageNo;
    document.listForm.action = "<c:url value='/uss/umt/coreUserManageList.cm'/>";
    document.listForm.submit();
}
function fnSearch(){
...
<form name="listForm" action="<c:url value='/uss/umt/coreUserManageList.cm'/>" method="post">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/umt/coreUserManageRegist.cm'/>" onClick="fnAddUserView(); return false;"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
	    ...
	    <td><a href="<c:url value='/uss/umt/coreMberManage.cm'/>?selectedId=<c:out value="${result.uniqId}"/>"  onclick="javascript:fnSelectUser('<c:out value="${result.userTy}"/>:<c:out value="${result.uniqId}"/>'); return false;"><c:out value="${result.userId}"/></a></td>
