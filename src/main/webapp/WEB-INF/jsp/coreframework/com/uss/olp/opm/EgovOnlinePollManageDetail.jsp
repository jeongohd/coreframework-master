...
<script type="text/javaScript" language="javascript">
	...
	function fn_egov_init_OnlinePollManage(){
		document.getElementById('PollIemView').src="<c:url value='/uss/olp/opm/listOnlinePollItem.cm' />?pollId=${onlinePollManage.pollId}";
	}
	/* ********************************************************
	 * 목록 으로 가기
	 ******************************************************** */
	function fn_egov_list_OnlinePollManage(){
		location.href = "<c:url value='/uss/olp/opm/listOnlinePollManage.cm' />";
	}
	/* ********************************************************
	 * 수정처리화면
	 ******************************************************** */
	function fn_egov_modify_OnlinePollManage(){
		...
		vFrom.cmd.value = '';
		vFrom.action = "<c:url value='/uss/olp/opm/updtOnlinePollManage.cm' />";;
		vFrom.submit();
...
<!-- 하단 버튼 -->
<div class="btn">
	<form name="formUpdt" action="<c:url value='/uss/olp/opm/updtOnlinePollManage.cm'/>" method="post" style="float:left;">
	...
	<form name="formDelete" action="<c:url value='/uss/olp/opm/detailOnlinePollManage.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
	...
	<form name="formList" action="<c:url value='/uss/olp/opm/listOnlinePollManage.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
