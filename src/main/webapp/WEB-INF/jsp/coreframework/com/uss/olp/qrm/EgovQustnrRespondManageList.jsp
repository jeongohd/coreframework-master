...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/olp/qrm/EgovQustnrRespondManageList.cm'/>";
   	document.listForm.submit();
   	
   	/*
   	document.getElementById("pageIndex").value=pageNo;
   	document.getElementById("listForm").action = "<c:url value='/uss/olp/qrm/EgovQustnrRespondManageList.cm'/>";
...
function fn_egov_regist_QustnrRespondManage(){
	location.href = "<c:url value='/uss/olp/qrm/EgovQustnrRespondManageRegist.cm' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_QustnrRespondManage(qestnrRespondId){
	...
	//vFrom.action = "<c:url value='/uss/olp/qrm/EgovQustnrRespondManageDetail.cm' />";
	document.getElementById("listForm").action="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageDetail.cm' />";
	//vFrom.submit();
	document.getElementById("listForm").submit();
}
...
function fn_egov_search_QustnrRespondManage(){
	...
	vFrom.action = "<c:url value='/uss/olp/qrm/EgovQustnrRespondManageList.cm' />";
	vFrom.submit();
...
<form name="listForm" id="listForm" action="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			...
			<li>
				...
				<!-- 등록버튼 -->
				<span class="btn_b"><a href="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageRegist.cm' />"  title="<spring:message code='button.create' /> <spring:message code='input.button' />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
...
<input name="searchMode" type="hidden" value=""> --%>	
	...
	<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	  <tr>
		...
		<!-- 설문지정보(제목) -->
		<td class="lt_text3L">
			<a href="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageDetail.cm'/>?qestnrRespondId=${resultInfo.qestnrRespondId}" onClick="fn_egov_detail_QustnrRespondInfo('<c:out value="${resultInfo.qestnrRespondId}"/>');return false;"><c:out value='${resultInfo.qestnrSj}'/></a>
		</td>
		<!-- 응답자명 -->
