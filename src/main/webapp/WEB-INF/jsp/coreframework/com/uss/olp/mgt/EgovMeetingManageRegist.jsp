...
function fn_egov_save_MeetingManage(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){/* 저장 하시겠습니까? */
		varFrom.action =  "<c:url value='/uss/olp/mgt/EgovMeetingManageRegist.cm' />";
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a href="<c:url value='/uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopup.cm' />" target="_blank" title="팝업 새창으로" onclick="fn_egov_mngtDeptNm_MeetingManage();return false">
					<img alt="주관부서 찾기버튼" src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />" title="주관부서 찾기버튼" />
				</a>
		...
		<tr>
			...
			<td class="left">
				...
				<a href="<c:url value='/uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopup.cm' />" target="_blank" title="주관자부서 선택  팝업 새창으로" onclick="fn_egov_mnaerDept_MeetingManage();return false">
					<img alt="주관자부서 찾기버튼" src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />" title="주관자부서 찾기 버튼" />
				</a>
