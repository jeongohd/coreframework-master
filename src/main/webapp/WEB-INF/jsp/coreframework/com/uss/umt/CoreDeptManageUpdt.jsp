...
function fncDeptManageUpdate() {
    var varFrom = document.getElementById("deptManage");
    varFrom.action = "<c:url value='/uss/umt/dpt/coreDeptManageModify.cm'/>";
...
function fncDeptManageDelete() {
    var varFrom = document.getElementById("deptManage");
    varFrom.action = "<c:url value='/uss/umt/dpt/coreDeptManageRemove.cm'/>";
...
<form:form modelAttribute="deptManage" method="post" action="${pageContext.request.contextPath}/uss/umt/dpt/coreDeptManageModify.cm' />" onSubmit="fncDeptManageUpdate(); return false;" enctype="multipart/form-data">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/uss/umt/dpt/coreDeptManageList.cm'/>"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
