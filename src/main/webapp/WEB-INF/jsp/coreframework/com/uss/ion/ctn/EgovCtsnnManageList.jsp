...
<script type="text/javaScript" language="javascript">	
	...
	function linkPage(pageNo){
		...
		varForm.action = "<c:url value='/uss/ion/ctn/selectCtsnnManageList.cm'/>";
		varForm.submit();
	}
	...
	function fncCtsnnRegist(){
		location.href = "<c:url value='/uss/ion/ctn/EgovCtsnnRegist.cm'/>";
	}
	...
	function fncCtsnnManageDetail(ctsnnId){
		...
		varForm.action           = "<c:url value='/uss/ion/ctn/EgovCtsnnManageDetail.cm'/>";
		varForm.submit();
	}
</script>
</head>
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/uss/ion/ctn/selectCtsnnManageList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		...
		<div class="bt_a">
			...
			<span class="btn_b"><a href="<c:url value='/uss/ion/ctn/EgovCtsnnRegist.cm'/>" onclick="fncCtsnnRegist(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
		</div>
	</div>
	</form>	
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
				  <form name="item" method="post" action="<c:url value='/uss/ion/ctn/EgovCtsnnManageDetail.cm'/>">
