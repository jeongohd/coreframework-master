...
<script type="text/javaScript" language="javascript">
	...
	function fncAnnvrsryManageBndeRegist(){
		...
		varFrom.action = "<c:url value='/uss/ion/ans/insertAnnvrsryManageBnde.cm'/>";
	...
	function fncAnnvrsryManageBndeCheck(){
	   var varFrom = document.getElementById("listForm");
	   if(checkFile()){
		   varFrom.action ="<c:url value='/uss/ion/ans/EgovAnnvrsryManageListPopAction.cm'/>";
...
<div class="board">
	...
	<span>※Excel example file Location : ../WEB-INF/jsp/coreframework/com/uss/ion/ans/example/excelAnniversay.xls</span>
	<form name="listForm" id="listForm" action="<c:url value='/uss/ion/ans/EgovAnnvrsryManageListPopAction.cm'/>" method="post" enctype="multipart/form-data">
