 ...
 ******************************************************** */
 function fn_egov_delete_hpcm(hpcmId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.hpcmForm.action = "<c:url value='/uss/olh/hpc/deleteHpcm.cm'/>";
...
<form name="hpcmForm" action="<c:url value='/uss/olh/hpc/updateHpcmView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/hpc/deleteHpcm.cm' />" onClick="fn_egov_delete_hpcm('<c:out value="${result.hpcmId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/olh/hpc/selectHpcmList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
