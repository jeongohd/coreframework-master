...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/ion/nts/listNoteTrnsmit.cm'/>";
...
function fn_egov_detail_NoteTrnsmit(noteId,noteTrnsmitId){
	...
	vFrom.action = "<c:url value='/uss/ion/nts/detailNoteTrnsmit.cm'/>";
	vFrom.submit();
}
...
function fn_egov_search_NoteTrnsmit(){
	...
	vFrom.action = "<c:url value='/uss/ion/nts/listNoteTrnsmit.cm'/>";
	vFrom.submit();
...
function fn_egov_cnfirm_NoteTrnsmit(noteId){
	...
	var url = "<c:url value='/uss/ion/nts/selectNoteTrnsmitCnfirm.cm'/>?noteId=" + noteId;
	var name = "";
	var width = 800;
	var height = 700;
...
<div class="board">
	...
	<form name="listForm" id="listForm" action="<c:url value='/uss/ion/nts/listNoteTrnsmit.cm'/>" method="post" onSubmit="fn_egov_search_NoteRecptn(); return false;">
	<!-- 검색영역 -->
	...
	<tr>
		...
		<td class="left">
			<a href="<c:url value='/uss/ion/nts/detailNoteTrnsmit.cm'/>?pageIndex=${searchVO.pageIndex}&amp;noteId=${resultInfo.noteId}&amp;noteTrnsmitId=${resultInfo.noteTrnsmitId}"><c:out value='${fn:substring(resultInfo.noteSj, 0, 40)}'/></a>
		</td>
		<td><c:out value="${resultInfo.rcverNm}"/><c:if test="${resultInfo.rcverCnt ne '0'}">&nbsp;외&nbsp; ${resultInfo.rcverCnt}명</c:if></td>
		<td>
			<span class="btn_s"><a href="<c:url value='/uss/ion/nts/selectNoteTrnsmitCnfirm.cm'/>?noteId=${resultInfo.noteId}" onClick="fn_egov_cnfirm_NoteTrnsmit('${resultInfo.noteId}');return false;"  title="<spring:message code="comUssIonNts.list.openAt" /> <spring:message code="input.button" />">${resultInfo.openY}/${resultInfo.openN}</a></span>
		</td>
