...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/coreframework/com/uss/olp/opp/online_poll.css' />">
...
function fn_egov_list_OnlinePollPartcptn(){
	location.href = "<c:url value='/uss/olp/opm/listOnlinePollPartcptn.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_save_OnlinePollPartcptn(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){ 
		varFrom.action =  "<c:url value='/uss/olp/opp/registOnlinePollPartcptn.cm' />";
		return true;
	}else{
		return false;
	}
...
<!--  상단타이틀 -->
<form id="OnlinePollPartcptn" name="OnlinePollPartcptn" action="<c:url value='/uss/olp/opp/registOnlinePollPartcptn.cm' />" onsubmit="return fn_egov_save_OnlinePollPartcptn()" method="post">
<!-- 타이틀 -->
...
<div class="btn">
	...
	<span class="btn_s"><a href="<c:url value='/uss/olp/opp/listOnlinePollPartcptn.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
