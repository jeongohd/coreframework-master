...
function linkPage(pageNo){
	...
	document.twitterInfo.action = "<c:url value='/uss/ion/tir/listTwitterRecptn.cm'/>";
...
<div class="board">
<form id="twitterInfo" name="twitterInfo" action="<c:url value='/uss/ion/tir/listTwitterRecptn.cm'/>" method="post" enctype="multipart/form-data">
	<h1><spring:message code="ussIonTir.twitterRecptn.twitterRecptn"/></h1><!-- 트위터 수신(목록) -->

	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				<span class="btn_b"><a href="<c:url value='/uss/ion/tir/registTwitterTrnsmit.cm'/>" onclick="" title="등록 버튼"><spring:message code="button.create"/></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
