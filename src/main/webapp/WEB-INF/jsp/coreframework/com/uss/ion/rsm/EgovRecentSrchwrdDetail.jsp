...
function fn_egov_list_RecentSrchwrd(){
	location.href = "<c:url value='/uss/ion/rsm/listRecentSrchwrd.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_modify_RecentSrchwrd(){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/uss/ion/rsm/updtRecentSrchwrd.cm' />";;
	vFrom.submit();
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<form name="formUpdt" action="<c:url value='/uss/ion/rsm/updtRecentSrchwrd.cm'/>" method="post" style="display:inline-block">
		...
		<form name="formDelete" action="<c:url value='/uss/ion/rsm/detailRecentSrchwrd.cm'/>" method="post" style="display:inline-block">
		...
		<form name="formList" action="<c:url value='/uss/ion/rsm/listRecentSrchwrd.cm'/>" method="post" style="display:inline-block">
