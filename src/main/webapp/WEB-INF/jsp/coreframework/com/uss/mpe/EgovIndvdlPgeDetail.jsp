...
<form name="indvdlPgeForm" action="<c:url value='/uss/mpe/updateIndvdlPgeView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/mpe/selectIndvdlPgeList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
