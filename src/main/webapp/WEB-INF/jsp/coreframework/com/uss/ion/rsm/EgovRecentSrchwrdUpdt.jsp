...
function fn_egov_save_RecentSrchwrd(){
	...
	varFrom.action =  "<c:url value='/uss/ion/rsm/updtRecentSrchwrd.cm' />";
...
<form:form modelAttribute="recentSrchwrd" name="recentSrchwrd" action="${pageContext.request.contextPath}/uss/ion/rsm/updtRecentSrchwrd.cm" method="post">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/rsm/listRecentSrchwrd.cm' />" onclick=""><spring:message code="button.list" /></a></span>
	</div>
