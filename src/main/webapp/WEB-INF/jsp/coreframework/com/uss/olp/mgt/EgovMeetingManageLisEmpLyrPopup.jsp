...
function fn_egov_search_MeetingManage(){
	...
	vFrom.action = "<c:url value='/uss/olp/mgt/EgovMeetingManageLisEmpLyrPopup.cm' />";
	vFrom.submit();
...
<div class="board">
<form name="listForm" id="listForm" action="<c:url value='/uss/olp/mgt/EgovMeetingManageLisEmpLyrPopup.cm'/>" method="post">
