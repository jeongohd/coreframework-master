...
<form:form name="template" id="template" action="/uss/olp/qri/template.cm" method="post">
...
<tr>
    <td colspan="2">
    	...
    	<tr>
    		...
    		<img src="<c:url value='/images/coreframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="<spring:message code='comUssOlpQri.alt.compulsoryInput'/>">${status1.count}. <c:out value="${fn:replace(QestmInfo.qestnCn , crlf , '<br/>')}" escapeXml="false" /><!-- alt="필수입력표시" -->
