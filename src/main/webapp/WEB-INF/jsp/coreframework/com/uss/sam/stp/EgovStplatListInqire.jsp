...
function fn_egov_select_linkPage(pageNo){
	...
	document.StplatListForm.action = "<c:url value='/uss/sam/stp/StplatListInqire.cm'/>";
...
function fn_egov_inquire_stplatdetail(useStplatId) {
	...
	document.StplatListForm.useStplatId.value = useStplatId;
  	document.StplatListForm.action = "<c:url value='/uss/sam/stp/StplatDetailInqire.cm'/>";
  	document.StplatListForm.submit();
}
</script>
</head>
...
<div class="board">
	...
	<form name="StplatListForm" action="<c:url value='/uss/sam/stp/StplatListInqire.cm'/>" method="post" onSubmit="fn_egov_search_stplatcn(); return false;">
	<!-- 검색영역 -->
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/sam/stp/StplatCnRegistView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<form name="subForm" method="post" action="<c:url value='/uss/sam/stp/StplatDetailInqire.cm'/>">
	...
	<!-- 
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/uss/sam/stp/StplatCnRegistView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
	</div>
	 -->
