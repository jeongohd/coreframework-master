...
function fn_egov_inqire_newslist() {
	newsVO.action = "<c:url value='/uss/ion/nws/selectNewsList.cm'/>";
	newsVO.submit();
}
</script>
</head>
...
<!-- 상단타이틀 -->
<form:form modelAttribute="newsVO" action="${pageContext.request.contextPath}/uss/ion/nws/updateNews.cm" method="post" onSubmit="fn_egov_updt_news(document.forms[0]); return false;" enctype="multipart/form-data">
...
<!--  첨부파일 테이블 레이아웃 -->
	...
	<span class="btn_s"><a href="<c:url value='/uss/ion/nws/selectNewsList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span></div>
