...
<!--
	...
	function fncSelectMtgPlaceManageList(){
		...
		varFrom.action = "<c:url value='/uss/ion/mtg/selectMtgPlaceManageList.cm'/>";
		varFrom.submit();
	}
	...
	function fncSelectMtgPlaceManage() {
		...
		varFrom.action = "<c:url value='/uss/ion/mtg/selectMtgPlaceManage.cm'/>";
		varFrom.submit();   
	}
	...
	function fncDeleteMtgPlace() {
	    var varFrom = document.getElementById("mtgPlaceManage");
	    varFrom.action = "<c:url value='/uss/ion/mtg/deleteMtgPlaceManage.cm'/>";
...
<div class="wTableFrm">
	...
	<table class="wTable mb10">
		...
		<tr>
			<th height="23" class="required_text" scope="row"><spring:message code="comUssIonMtg.mtgPlaceDetail.imgFileList" /><img src="<c:url value='/images/coreframework/com/cmm/icon/no_required.gif'/>" width="15" height="15" alt=""></th><!-- 이미지 파일목록 -->
			<td class="left" colspan="3">
		...
		<!--  첨부파일 테이블 레이아웃 End. /cmm/fms/selectFileInfs.cm -->
	</table>
	
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/uss/ion/mtg/selectMtgPlaceManage.cm'/>?searchCondition=1" onclick="fncSelectMtgPlaceManage(); return false;"><spring:message code="button.update" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/mtg/deleteMtgPlaceManage.cm'/>?searchCondition=1" onclick="fncDeleteMtgPlace(); return false;"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/mtg/selectMtgPlaceManageList.cm'/>?searchCondition=1" onclick="fncSelectMtgPlaceManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
