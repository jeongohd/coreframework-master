...
<ul class="vertical">
	...
	<li>
		<a href="<c:out value="${fileVO.linkUrl}"/>" target="_blank"  title="새 창으로 이동" ><img alt="배너 이미지" src='<c:url value='/cmm/fms/getImage.cm'/>?atchFileId=<c:out value="${fileVO.bannerImageFile}"/>'></a>
    </li>
    </c:forEach>
</ul>
</c:if>
