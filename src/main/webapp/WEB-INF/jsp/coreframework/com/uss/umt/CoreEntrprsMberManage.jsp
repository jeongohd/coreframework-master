<%
 /**
  * @Class Name : CoreEntrprsMberManage.jsp
...
function fnDeleteUser() {
    ...
    if(checkedIds.length > 0) {
        if(confirm("<spring:message code="common.delete.msg" />")){
            ...
            document.listForm.action = "<c:url value='/uss/umt/coreEntrprsMberRemove.cm'/>";
...
function fnSelectUser(id) {
    ...
    document.listForm.action = "<c:url value='/uss/umt/coreEntrprsMberUpdt.cm'/>";
    document.listForm.submit();

}
function fnAddUserView() {
	document.listForm.action = "<c:url value='/uss/umt/coreEntrprsMberRegist.cm'/>";
    document.listForm.submit();
}
function fnLinkPage(pageNo){
    document.listForm.pageIndex.value = pageNo;
    document.listForm.action = "<c:url value='/uss/umt/coreEntrprsMberManageList.cm'/>";
    document.listForm.submit();
}
function fnSearch(){
...
<form name="listForm" action="<c:url value='/uss/umt/coreEntrprsMberManageList.cm'/>" method="post">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/umt/coreEntrprsMberRegist.cm'/>" onClick="fnAddUserView(); return false;"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span><!-- 등록 -->
			</li>
		</ul>
	</div>
	...
	<tr>
	    ...
	    <td><a href="<c:url value='/uss/umt/coreEntrprsMberUpdt.cm'/>?selectedId=<c:out value="${result.uniqId}"/>"  onclick="javascript:fnSelectUser('<c:out value="${result.userTy}"/>:<c:out value="${result.uniqId}"/>'); return false;"><c:out value="${result.userId}"/></a></td>
