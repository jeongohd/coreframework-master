...
<form:form modelAttribute="indvdlPgeVO" action="${pageContext.request.contextPath}/uss/mpe/insertIndvdlPge.cm" method="post" onSubmit="fn_egov_regist_pge(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
