...
<table>
  <tr>
    <c:forEach var="fileVO" items="${fileList}" varStatus="status">
       <td>
            <img alt="<spring:message code="ussIonLsi.loginScrinImageView.loginScrinImageView" />" src='<c:url value='/cmm/fms/getImage.cm'/>?atchFileId=<c:out value="${fileVO.imageFile}"/>' />
       </td>
    </c:forEach>
    <td></td>
  </tr>
