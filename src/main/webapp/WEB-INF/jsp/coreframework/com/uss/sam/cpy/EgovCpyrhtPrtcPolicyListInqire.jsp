...
function fn_egov_select_linkPage(pageNo){
	...
	document.CpyrhtPrtcPolicyForm.action = "<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyListInqire.cm'/>";
...
function fn_egov_regist_cpyrhtprtcpolicycn(){
	...
	document.CpyrhtPrtcPolicyForm.action = "<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyCnRegistView.cm'/>";
	document.CpyrhtPrtcPolicyForm.submit();	
...
function fn_egov_inquire_cpyrhtprtcpolicydetail(cpyrhtId) {		
	...
	document.CpyrhtPrtcPolicyForm.cpyrhtId.value = cpyrhtId;
  	document.CpyrhtPrtcPolicyForm.action = "<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyDetailInqire.cm'/>";
  	document.CpyrhtPrtcPolicyForm.submit();	
...
<form name="CpyrhtPrtcPolicyForm" action="<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyListInqire.cm'/>" method="post">
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyCnRegistView.cm'/>" onclick="fn_egov_regist_cpyrhtprtcpolicycn(); return false;"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href="<c:url value='/uss/sam/cpy/CpyrhtPrtcPolicyDetailInqire.cm'/>?cpyrhtId=${resultInfo.cpyrhtId}&pageIndex=${searchVO.pageIndex}" onClick="fn_egov_inquire_cpyrhtprtcpolicydetail('<c:out value="${resultInfo.cpyrhtId}"/>');return false;"><c:out value='${fn:substring(resultInfo.cpyrhtPrtcPolicyCn, 0, 40)}'/></a>
				</td>		
