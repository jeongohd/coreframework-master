...
function fn_egov_inqire_list() {
	wordDicaryVO.action = "<c:url value='/uss/olh/wor/selectWordDicaryList.cm'/>";
	wordDicaryVO.submit();	
}
</script>
</head>
...
<!-- 상단타이틀 -->
<form:form modelAttribute="wordDicaryVO" action="${pageContext.request.contextPath}/uss/olh/wor/updateWordDicary.cm" method="post" onSubmit="fn_egov_updt_worddicary(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/wor/selectWordDicaryList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
