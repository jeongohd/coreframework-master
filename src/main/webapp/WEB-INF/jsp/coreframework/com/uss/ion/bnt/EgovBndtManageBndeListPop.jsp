...
<script type="text/javascript">
	...
	function fncBndtManageBndeRegist(){
		...
		varFrom.action = "<c:url value='/uss/ion/bnt/insertBndtManageBnde.cm'/>";
	...
	function fncBndtManageBndeCheck(){
	    if(checkFile()){
		   document.listForm.action ="<c:url value='/uss/ion/bnt/EgovBndtManageListPopAction.cm'/>";
...
<div class="board">
	...
	<span>※Excel example files Location : ../WEB-INF/jsp/coreframework/com/uss/ion/bnt/example</span>
	
	<form name="listForm" id="listForm" action="<c:url value='/uss/ion/bnt/EgovBndtManageListPopAction.cm'/>" method="post" enctype="multipart/form-data">
