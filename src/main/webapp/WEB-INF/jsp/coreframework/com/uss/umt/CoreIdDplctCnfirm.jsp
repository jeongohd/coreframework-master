...
<%
 /**
  * @Class Name : CoreIdDplctCnfirm.jsp
  * @Description : 아이디중복확인
...
<body>
    <form name="checkForm" action ="<c:url value='/uss/umt/coreIdDplctCnfirmCheck.cm'/>">

    <table border="0" cellspacing="0" cellpadding="0" width="300">
        <tr><td height="20" colspan="2"></td></tr>
        <tr>
            <td colspan="2" ><img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">
            &nbsp;아이디 중복확인</td>
        </tr>
        <tr><td height="20" colspan="2"></td></tr>
        <tr>
