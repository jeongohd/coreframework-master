...
function fn_egov_select_linkPage(pageNo){
	...
	document.tnextrlHrForm.action = "<c:url value='/uss/ion/ecc/selectTnextrlHrList.cm'/>";
...
function fn_egov_inquire_hrdetail(extrlHrId) {
	...
	document.eventCmpgnForm.extrlHrId.value = extrlHrId;
  	document.eventCmpgnForm.action = "<c:url value='/uss/ion/ecc/selectTnextrlHrDetail.cm'/>";
...
<form name="eventCmpgnForm" action="<c:url value='/uss/ion/ecc/selectTnextrlHrList.cm'/>" method="post" onSubmit="fn_egov_search_hr(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/ecc/insertTnextrlHrView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td><a href="<c:url value='/uss/ion/ecc/selectTnextrlHrDetail.cm?extrlHrId=${resultInfo.extrlHrId}'/>" onClick="fn_egov_inquire_hrdetail('<c:out value="${resultInfo.extrlHrId}"/>');return false;"><c:out value='${fn:substring(resultInfo.extrlHrNm, 0, 40)}'/></a></td>
