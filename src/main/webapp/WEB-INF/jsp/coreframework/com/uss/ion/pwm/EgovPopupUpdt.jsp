...
function fn_egov_save_PopupManage(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/uss/ion/pwm/updtPopup.cm' />";
...
<form:form modelAttribute="popupManageVO" name="popupManageVO" action="${pageContext.request.contextPath}/uss/ion/pwm/updtPopup.cm" method="post" >
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/pwm/listPopup.cm' />" onclick=""><spring:message code="button.list" /></a></span>
	</div>
