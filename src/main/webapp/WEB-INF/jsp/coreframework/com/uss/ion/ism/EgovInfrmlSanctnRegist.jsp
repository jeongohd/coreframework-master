...
<script type="text/javascript" src="<c:url value="/js/coreframework/com/uss/ion/ism/EgovInfrmlSanction.js"/>"></script>
<table class="wTable">
	<colgroup>
		<col style="width:16%" />
		<col style="" />
	...
	<tr>
		...
		<td class="left">
			...
			<a href="<c:url value='/uss/ion/ism/selectSanctnerListPopup.cm'/>" target="_blank"  title="<spring:message code="comUssIonIsm.infrmlSanctnRegist.contractor" />"  onclick="fn_egov_sanctner('<spring:message code="comUssIonIsm.infrmlSanctnRegist.sanctnDtNm" />', 'sanctnerId', '', 'sanctnDtNm', 'orgnztNm', '<c:url value='/uss/ion/ism/selectSanctnerListPopup.cm'/>');return false;"><img alt="" src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" /></a><!-- 결재자지정 -->
		</td>
