...
function fn_egov_select_linkPage(pageNo){
	...
	document.hpcmForm.action = "<c:url value='/uss/olh/hpc/selectHpcmList.cm'/>";
...
function fn_egov_inquire_hpcmdetail(hpcmId) {
	...
	document.hpcmForm.hpcmId.value = hpcmId;
  	document.hpcmForm.action = "<c:url value='/uss/olh/hpc/selectHpcmDetail.cm'/>";
  	document.hpcmForm.submit();
}
</script>
</head>
...
<form name="hpcmForm" action="<c:url value='/uss/olh/hpc/selectHpcmList.cm'/>" method="post" onSubmit="fn_egov_search_hpcm(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/olh/hpc/insertHpcmView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/uss/olh/hpc/selectHpcmDetail.cm?bbsId=${resultInfo.hpcmId}'/>" onClick="fn_egov_inquire_hpcmdetail('<c:out value="${resultInfo.hpcmId}"/>');return false;"><c:out value='${fn:substring(resultInfo.hpcmDf, 0, 40)}'/></a></td>
