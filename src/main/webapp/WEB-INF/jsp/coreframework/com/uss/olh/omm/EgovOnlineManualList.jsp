...
function fn_egov_select_linkPage(pageNo){
	...
	document.onlineManualForm.action = "<c:url value='/uss/olh/omm/selectOnlineManualList.cm'/>";
...
function fn_egov_inquire_onlinemanualdetail(onlineMnlId) {
	...
	document.onlineManualForm.onlineMnlId.value = onlineMnlId;
  	document.onlineManualForm.action = "<c:url value='/uss/olh/omm/selectOnlineManualDetail.cm'/>";
  	document.onlineManualForm.submit();
}
</script>
</head>
...
<form name="onlineManualForm" action="<c:url value='/uss/olh/omm/selectOnlineManualList.cm'/>" method="post" onSubmit="fn_egov_search_onlinemanual(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/olh/omm/insertOnlineManualView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/uss/olh/omm/selectOnlineManualDetail.cm?onlineMnlId=${resultInfo.onlineMnlId}'/>" onClick="fn_egov_inquire_onlinemanualdetail('<c:out value="${resultInfo.onlineMnlId}"/>');return false;"><c:out value='${fn:substring(resultInfo.onlineMnlNm, 0, 40)}'/></a></td>
