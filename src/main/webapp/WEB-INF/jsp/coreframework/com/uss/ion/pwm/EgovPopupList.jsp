...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/ion/pwm/listPopup.cm'/>";
...
function fn_egov_regist_PopupManage(){
	location.href = "<c:url value='/uss/ion/pwm/registPopup.cm' />";
}
/* ********************************************************
 * 상세화면 처리 함수
 ******************************************************** */
function fn_egov_detail_PopupManage(popupId){
	...
	vFrom.action = "<c:url value='/uss/ion/pwm/detailPopup.cm' />";
	vFrom.submit();
}
...
function fn_egov_search_PopupManage(){
	...
	vFrom.action = "<c:url value='/uss/ion/pwm/listPopup.cm' />";
	vFrom.submit();
...
function fn_egov_ajaxPopupInfo_PopupManage(popupIds){
	var ajaxUrl = "<c:url value='/uss/ion/pwm/ajaxPopupManageInfo.cm' />";
...
function fn_egov_popupOpen_PopupManage(popupId,fileUrl,width,height,top,left,stopVewAt){
	...
	var url = "<c:url value='/uss/ion/pwm/openPopupManage.cm' />?";
...
<div class="board">
<form name="listForm" action="<c:url value='/uss/ion/pwm/listPopup.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.noScriptTitle.msg"/>"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/pwm/registPopup.cm'/>" onclick="" title="<spring:message code="button.create" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<form name="subForm" method="post" action="<c:url value='/uss/ion/pwm/detailPopup.cm'/>">
