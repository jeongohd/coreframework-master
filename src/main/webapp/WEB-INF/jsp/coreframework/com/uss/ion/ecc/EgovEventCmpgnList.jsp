...
function fn_egov_select_linkPage(pageNo){
	...
	document.eventCmpgnForm.action = "<c:url value='/uss/ion/ecc/selectEventCmpgnList.cm'/>";
...
function fn_egov_inquire_eventdetail(eventId) {
	...
	document.eventCmpgnForm.eventId.value = eventId;
  	document.eventCmpgnForm.action = "<c:url value='/uss/ion/ecc/selectEventCmpgnDetail.cm'/>";
  	document.eventCmpgnForm.submit();
}
</script>
</head>
...
<form name="eventCmpgnForm" action="<c:url value='/uss/ion/ecc/selectEventCmpgnList.cm'/>" method="post" onSubmit="fn_egov_search_event(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/ecc/insertEventCmpgnView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/uss/ion/ecc/selectEventCmpgnDetail.cm?eventId=${resultInfo.eventId}'/>" onClick="fn_egov_inquire_eventdetail('<c:out value="${resultInfo.eventId}"/>');return false;"><c:out value='${fn:substring(resultInfo.eventCn, 0, 40)}'/></a></td>
