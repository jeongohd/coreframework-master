...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/olp/opp/listOnlinePollPartcptn.cm'/>";
...
function fn_egov_regist_OnlinePollPartcptn(pollId,sDate,eDate){
	...
	if(iToDate >= iBeginDate && iToDate <= iEndDate){
		...
		vFrom.action = "<c:url value='/uss/olp/opp/registOnlinePollPartcptn.cm' />";
		vFrom.submit();
	}else{
...
function fn_egov_search_OnlinePollPartcptn(){
	...
	vFrom.action = "<c:url value='/uss/olp/opp/listOnlinePollPartcptn.cm' />";
	vFrom.submit();
...
<form name="listForm" action="<c:url value='/uss/olp/opp/listOnlinePollPartcptn.cm'/>" method="post">
...
<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>
	...
	<tr>
		...
		<td class="leftElli"> 
		<form name="subForm" method="post" action="<c:url value='/uss/olp/opp/registOnlinePollPartcptn.cm'/>">
