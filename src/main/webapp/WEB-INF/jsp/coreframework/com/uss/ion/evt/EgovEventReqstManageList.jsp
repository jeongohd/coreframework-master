...
<%@ page import="coreframework.com.utl.fcc.service.EgovDateUtil" %>
 ...
 ******************************************************** */
 ...
 function linkPage(pageNo){
	...
	varForm.action             = "<c:url value='/uss/ion/evt/EgovEventReqstManageList.cm'/>";
...
function fncEventReqstRegist(){
	location.href = "<c:url value='/uss/ion/evt/EgovEventReqstRegist.cm'/>";
}
...
function fncEventManageDetail(eventId){
	...
	varForm.action           = "<c:url value='/uss/ion/evt/EgovEventReqstDetail.cm'/>";
	varForm.target           ="_self";
	varForm.submit();
}
...
function fncEventReqstAtdrnList(eventId){
	...
	varForm.method ="post";
	varForm.action = "<c:url value='/uss/ion/evt/EgovEventReqstAtdrnList.cm'/>";
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/uss/ion/evt/EgovEventReqstManageList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/evt/EgovEventReqstRegist.cm'/>?searchCondition=1" onclick="fncEventReqstRegist(); return false;" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	</form>
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
		        <form name="item" method="post" action="<c:url value='/uss/ion/evt/EgovEventReqstDetail.cm'/>">
				...
				<td>
		        <form name="item" method="post" action="<c:url value='/uss/ion/evt/EgovEventReqstAtdrnList.cm'/>"  target="_blank">
		        	<input type=hidden name="eventId" value="<c:out value="${resultInfo.eventId      }"/>">
