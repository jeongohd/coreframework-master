 ...
 ******************************************************** */
 function fn_egov_delete_site(siteId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.siteForm.action = "<c:url value='/uss/ion/sit/deleteSite.cm'/>";
...
<form name="siteForm" action="<c:url value='/uss/ion/sit/updateSiteView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/sit/deleteSite.cm' />" onClick="fn_egov_delete_site('<c:out value="${result.siteId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/sit/selectSiteList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
