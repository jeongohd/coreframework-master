 ...
 ******************************************************** */
 ...
 function fncSelectCmtManageList(pageNo){
	 ...
	 //varForm.searchCondition.value = "1";
	 varForm.pageIndex.value = pageNo;
	 varForm.action = "<c:url value='/uss/cmt/EgovCmtManageList.cm'/>";
	 varForm.submit();
 }
...
function fncCmtWrkStartInsert(){
	location.href = "<c:url value='/uss/cmt/EgovCmtWrkStartInsert.cm' />";
...
function fncCmtWrkEndInsert(){
	location.href = "<c:url value='/uss/cmt/EgovCmtWrkEndInsert.cm' />";
...
<div class="board">
<form name="listForm" action="<c:url value='/uss/cmt/EgovCmtManageList.cm'/>" method="post">
