...
function fncBndtManageList(){
	location.href = "<c:url value='/uss/ion/bnt/EgovBndtManageList.cm'/>";
}
...
function fncEgovBndtDiary() {
		...
		varFrom.action = "<c:url value='/uss/ion/bnt/selectBndtDiary.cm'/>";
		varFrom.submit();   
}
...
function fncDeleteBndtDiary() {
    var varFrom = document.getElementById("bndtDiary");
    varFrom.action = "<c:url value='/uss/ion/bnt/deleteBndtDiary.cm'/>";
...
<form:form modelAttribute="bndtDiary" name="bndtDiary" method="post" action="${pageContext.request.contextPath}/uss/ion/bnt/selectBndtDiary.cm">
...
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				<span class="btn_b"><a href="<c:url value='/uss/ion/bnt/selectBndtDiary.cm'/>?cmd=updt&bndtId=<c:out value='${bndtDiaryVO.bndtId}'/>&bndtDe=<c:out value='${bndtCeckManageVO.bndtDe}'/>" onclick="fncEgovBndtDiary(); return false;"><spring:message code="button.update" /></a></span>
				<span class="btn_b"><a href="<c:url value='/uss/ion/bnt/deleteBndtDiary.cm'/>?bndtId=<c:out value='${bndtDiaryVO.bndtId}'/>&bndtDe=<c:out value='${bndtDiaryVO.bndtDe}'/>" onclick="fncDeleteBndtDiary(); return false;"><spring:message code="button.delete" /></a></span>
				<span class="btn_b"><a href="<c:url value='/uss/ion/bnt/EgovBndtManageList.cm'/>" onclick="fncBndtManageList(); return false;"><spring:message code="button.list" /></a></span>
			</li>
		</ul>
	</div>
