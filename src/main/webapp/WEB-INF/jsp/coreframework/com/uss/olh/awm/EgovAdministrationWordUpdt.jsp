...
function fn_egov_inqire_list() {
	administrationWordVO.action = "<c:url value='/uss/olh/awm/selectAdministrationWordManageList.cm'/>";
...
<!-- 상단타이틀 -->
<form:form modelAttribute="administrationWordVO" action="${pageContext.request.contextPath}/uss/olh/awm/updateAdministrationWord.cm" method="post" onSubmit="fn_egov_updt_administrationword(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/awm/selectAdministrationWordManageList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
