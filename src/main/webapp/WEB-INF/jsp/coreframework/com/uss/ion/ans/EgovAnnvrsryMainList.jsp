...
function fncSelectAnnvrsryGdcc(annId) {
    ...
    document.gdccForm.action = "<c:url value='/uss/ion/ans/selectAnnvrsryGdcc.cm'/>";
...
<body>
	<div class="board">
		...
		<form name="gdccForm" method="post" action="<c:url value='/uss/ion/ans/selectAnnvrsryGdcc.cm'/>">
