...
function fn_egov_save_OnlinePollManage(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/uss/olp/opm/registOnlinePollManage.cm' />";
...
<h2>${pageTitle} <spring:message code="title.create" /></h2>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olp/opm/listOnlinePollManage.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
