...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/ion/ntr/listNoteRecptn.cm'/>";
...
function fn_egov_detail_NoteRecptn(noteId,noteTrnsmitId){
	...
	vFrom.action = "<c:url value='/uss/ion/ntr/detailNoteRecptn.cm'/>";
	vFrom.submit();
}
...
function fn_egov_search_NoteRecptn(){
	...
	vFrom.action = "<c:url value='/uss/ion/ntr/listNoteRecptn.cm'/>";
	vFrom.submit();
...
<div class="board">
	...
	<form name="listForm" id="listForm" action="<c:url value='/uss/ion/ntr/listNoteRecptn.cm'/>" method="post" onSubmit="fn_egov_search_NoteRecptn(); return false;">
	<!-- 검색영역 -->
	...
	<tr>
		...
		<td class="left">
			<a href="<c:url value='/uss/ion/ntr/detailNoteRecptn.cm'/>?pageIndex=${searchVO.pageIndex}&amp;noteId=${resultInfo.noteId}&amp;noteTrnsmitId=${resultInfo.noteTrnsmitId}&amp;noteRecptnId=${resultInfo.noteRecptnId}"><c:out value='${fn:substring(resultInfo.noteSj, 0, 40)}'/></a>
		</td>
