...
<div class="popup">
	...
	<!-- 타이틀 -->
	<h1>${pageTitle}</h1>
	<form name="frm"  method="post" action = "<c:url value='/cop/adb/selectManList.cm'/>">
	...
	<tr>
		...
		<td><%-- 미개봉만 삭제가능하게  --%>
			...
			<form name="formUpdt" action="<c:url value='/uss/ion/nts/selectNoteTrnsmitCnfirm.cm?noteId='/>${resultInfo.noteId}"  method="post">
