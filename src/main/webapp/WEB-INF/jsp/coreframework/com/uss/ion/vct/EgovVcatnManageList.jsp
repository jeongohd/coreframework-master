 ...
 ******************************************************** */
 ...
 function linkPage(pageNo){
	...
	varForm.action = "<c:url value='/uss/ion/vct/EgovVcatnManageList.cm'/>";
	varForm.submit();
 }
...
function fncVcatnRegist(){
	...
	if(!occrncYrycCo){
		...
		location.href = "<c:url value='/uss/ion/yrc/EgovIndvdlYrycManageList.cm'/>";
	}else{
		location.href = "<c:url value='/uss/ion/vct/EgovVcatnRegist.cm'/>";
	}
}
...
function fncVcatnManageDetail(applcntId,vcatnSe,bgnde,endde){
	...
	varForm.action           = "<c:url value='/uss/ion/vct/EgovVcatnManageDetail.cm'/>";
	varForm.submit();
	}
}
-->
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/uss/ion/vct/EgovVcatnManageList.cm'/>" method="post">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/vct/EgovVcatnRegist.cm'/>" onclick="fncVcatnRegist();" title="<spring:message code="button.create" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
</form>
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<form name="item" method="post" action="<c:url value='/uss/ion/vct/EgovVcatnManageDetail.cm'/>">
