...
function fn_egov_select_linkPage(pageNo){
	...
	document.qnaForm.action = "<c:url value='/uss/olh/qna/selectQnaList.cm'/>";
...
function fn_egov_inquire_qnadetail(qaId) {
	...
	document.qnaForm.qaId.value = qaId;
  	document.qnaForm.action = "<c:url value='/uss/olh/qna/selectQnaDetail.cm'/>";
  	document.qnaForm.submit();
}
</script>
</head>
...
<form name="qnaForm" action="<c:url value='/uss/olh/qna/selectQnaList.cm'/>" method="post" onSubmit="fn_egov_search_qna(); return false;">
<div class="board">
	...
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul>
			...
			<li>
				...
				<span class="btn_b"><a href="<c:url value='/uss/olh/qna/insertQnaView.cm' />"  title="<spring:message code="button.create" /> <spring:message code="input.button" />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	</form>
	...
	<tr>
		...
		<td>
			<form name="subForm" method="post" action="<c:url value='/uss/olh/qna/selectQnaDetail.cm'/>">
