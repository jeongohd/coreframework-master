...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/ion/rsm/listRecentSrchwrd.cm'/>";
...
function fn_egov_detail_RecentSrchwrd(srchwrdManageId){
	...
	vFrom.action = "<c:url value='/uss/ion/rsm/detailRecentSrchwrd.cm' />";
	vFrom.submit();
}
...
function fn_egov_search_RecentSrchwrd(){
	...
	vFrom.action = "<c:url value='/uss/ion/rsm/listRecentSrchwrd.cm' />";
	vFrom.submit();
...
$(document).ready(function(){
	...
	var ajaxUrl = "<c:url value='/uss/ion/rsm/listRecentSrchwrdResultSerach.cm' />";
	var ajaxParam = {
	...
	<div class="search_box" title="<spring:message code="common.noScriptTitle.msg"/>"><!-- 이 레이아웃은 하단 정보를 대한 검색 정보로 구성되어 있습니다. -->
		<ul>
			<li>
				...
				<!--Ajax Tags 등록 -->				
				<input type="hidden" name="rsm_url" id="rsm_url" value="<c:url value='/uss/ion/rsm/registRecentSrchwrdResult.cm'/>" >
				...
				<span class="btn_b"><a href="<c:url value='/uss/ion/rsm/registRecentSrchwrd.cm' />" onclick="" title='<spring:message code="button.create" />'><spring:message code="button.create" /></a></span>
				<!--Ajax Tags 끝 -->
			</li>
		</ul>
	</div>
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<form name="subForm" method="post" action="<c:url value='/uss/ion/rsm/detailRecentSrchwrd.cm'/>">
				...
				<td>
					<form name="subFormSrchwrdResult" method="post" action="<c:url value='/uss/ion/rsm/listRecentSrchwrdResult.cm'/>">
						<input name="srchwrdManageId" type="hidden" value="${resultInfo.srchwrdManageId}">
