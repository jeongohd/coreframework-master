<%
 /**
  * @Class Name : CoreEntrprsPasswordUpdt.jsp
...
function fnListPage(){
    document.passwordChgVO.action = "<c:url value='/uss/umt/coreEntrprsMberManageList.cm'/>";
...
<body>
        <!-- content start -->
        <form name="passwordChgVO" method="post"  action="<c:url value="${'/uss/umt/coreEntrprsPasswordModify.cm'}"/>" onsubmit="fnUpdate(document.forms[0]); return false;">
        ...
        <!-- 우편번호검색 -->
        <input type="hidden" name="url" value="<c:url value='/sym/ccm/zip/CoreCcmZipSearchPopup.cm'/>" />
