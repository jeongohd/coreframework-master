...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/olp/qri/EgovQustnrRespondInfoList.cm'/>";
...
function fn_egov_regist_QustnrRespondInfo(){
	location.href = "<c:url value='/uss/olp/qri/EgovQustnrRespondInfoRegist.cm' />";
}
/* ********************************************************
 * 수정 처리 함수
 ******************************************************** */
function fn_egov_modify_QustnrRespondInfo(){
	location.href = "<c:url value='/uss/olp/qri/EgovQustnrRespondInfoModify.cm' />";
}
/* ********************************************************
 * 상세회면 처리 함수
 ******************************************************** */
function fn_egov_detail_QustnrRespondInfo(qestnrQesrspnsId){ 
	...
	vFrom.action = "<c:url value='/uss/olp/qri/EgovQustnrRespondInfoDetail.cm' />";
	vFrom.submit();
}
/* ********************************************************
 * 삭제 처리 함수
...
function fn_egov_delete_QustnrRespondInfo(qestnrId){
	...
	if(confirm("<spring:message code='title.list' />")){ // 삭제 하시겠습니까?
		...
		vFrom.cmd.value = 'del';
		vFrom.action = "<c:url value='/uss/olp/qri/EgovQustnrRespondInfoList.cm' />";
		vFrom.submit();
	}else{
		vFrom.cmd.value = '';
	}
...
<form name="listForm" action="<c:url value='/uss/olp/qri/EgovQustnrRespondInfoList.cm'/>" method="post" onSubmit="fn_egov_search_QustnrRespondInfo(); return false;">
	...
	<div class="search_box" title="<spring:message code='common.searchCondition.msg' />">
		<ul>
			...
			<li>
				...
				<!-- 등록버튼 -->
				<span class="btn_b"><a href="<c:url value='/uss/olp/qri/EgovQustnrRespondInfoRegist.cm' />"  title="<spring:message code='button.create' /> <spring:message code='input.button' />"><spring:message code="button.create" /></a></span>
			</li>
		</ul>
	</div>
	...
	<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
	  <tr>
		...
		<!-- 설문문항 -->
		<td class="lt_text3">
			<a href="<c:url value='/uss/olp/qri/EgovQustnrRespondInfoDetail.cm'/>?qestnrQesrspnsId=${resultInfo.qestnrQesrspnsId}" onClick="fn_egov_detail_QustnrRespondInfo('<c:out value="${resultInfo.qestnrQesrspnsId}"/>');return false;"><c:out value='${resultInfo.qestnCn}'/></a>
		</td>
