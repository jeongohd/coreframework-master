...
<div class="wTableFrm">
<form:form modelAttribute="qustnrTmplatManageVO" action="${pageContext.request.contextPath}/uss/olp/qtm/EgovQustnrTmplatManageRegistActor.cm" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrTmplatManage(document.forms[0]); return false;">
...
<!-- <input name="managtCn" type="hidden" value="Testing..."> -->
	...
	<tbody >
		...
		<tr>
			<th>${title}<span class="pilsu">*</span></th>
			<td class="left">
  				<form:input type="text" path="qestnrTmplatCours" size="73" cssClass="txaIpt" maxlength="100" value="/coreframework/com/uss/olp/qri/template/template" title="<spring:message code='comUssOlpQtm.regist.qestnrTmplatCours'/><spring:message code='input.input'/>"/><!-- title="템플릿파일(경로) 입력" -->
	...
	<div class="btn">
		...
		<!-- 목록버튼 -->
		<span class="btn_s"><a href="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageList.cm' />"  title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
