...
<script type="text/javaScript" language="javascript">
	...
	function fncSelectMtgPlaceResveManageList() {
	    ...
	    varFrom.action = "<c:url value='/uss/ion/mtg/selectMtgPlaceResveManageList.cm'/>";
	    varFrom.submit();
	}
	
	function fncUpdtMtgPlaceResve() {
	     var varFrom = document.getElementById("mtgPlaceResve");
	     varFrom.action = "<c:url value='/uss/ion/mtg/updtMtgPlaceResve.cm'/>";
	...
	function fncDeleteMtgPlaceResve() {
	    var varFrom = document.getElementById("mtgPlaceResve");
	    varFrom.action = "<c:url value='/uss/ion/mtg/deleteMtgPlaceResve.cm'/>";
	...
	function fn_egov_dplact_ceck(){
		...
		if((endTm-beginTm) > 0){
		    ...
		    sTempValue = "sTmResveDe="+varFrom.resveDe.value+"&sTmResveBeginTm="+varFrom.resveBeginTm.value+"&sTmResveEndTm="+varFrom.resveEndTm.value+"&sTmMtgPlaceId="+varFrom.mtgPlaceId.value+"&sTmResveId="+varFrom.resveId.value;
		 	window.showModalDialog("<c:url value='/uss/ion/mtg/mtgPlaceResveDplactCeck.cm'/>?"+sTempValue, arrParam,"dialogWidth=450px;dialogHeight=150px;resizable=yes;center=yes");
	   }
	...
	* ******************************************************** */
	function fn_mtgPlace_image(){
	    ...
	    sTempValue = "sTmMtgPlaceId="+varFrom.mtgPlaceId.value;
	 	window.showModalDialog("<c:url value='/uss/ion/mtg/selectMtgPlaceImage.cm'/>?"+sTempValue, arrParam,"dialogWidth=720px;dialogHeight=400px;resizable=yes;center=yes");
	}
</script>
</head>
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/mtg/selectMtgPlaceResveManageList.cm'/>?searchCondition=1" onclick="fncSelectMtgPlaceResveManageList(); return false;"><spring:message code="button.list" /></a></span>
	</div>
