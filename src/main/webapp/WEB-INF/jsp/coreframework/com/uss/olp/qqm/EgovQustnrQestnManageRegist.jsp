...
function fn_egov_list_QustnrQestnManage(){
	...
	varFrom.action =  "<c:url value='/uss/olp/qqm/EgovQustnrQestnManageList.cm' />";
	varFrom.submit();
...
<form modelAttribute="qustnrQestnManageVO" id="qustnrQestnManageVO" action="<c:url value='/uss/olp/qqm/EgovQustnrQestnManageRegist.cm' />" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrQestnManage(document.forms[0]); return false;">
...
<div class="wTableFrm">
	...
	<tbody >
		...
		<tr>
			...
			<td class="left">
      			...
      			<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt="<spring:message code='comUssOlpQqm.regist.qestnrCn'/>" title="<spring:message code='comUssOlpQqm.regist.qestnrCn'/>"><!-- alt="설문지정보(제목)" title="설문지정보(제목)" -->
      			</a>
	...
	<div class="btn">
		...
		<!-- 목록버튼 -->
		<span class="btn_s"><a href="<c:url value='/uss/olp/qqm/EgovQustnrQestnManageList.cm' />"  title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
