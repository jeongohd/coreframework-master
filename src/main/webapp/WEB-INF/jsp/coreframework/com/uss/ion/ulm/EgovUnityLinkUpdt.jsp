...
function fn_egov_save_UnityLink(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/uss/ion/ulm/updtUnityLink.cm' />";
...
<form:form modelAttribute="unityLink" name="unityLink" action="${pageContext.request.contextPath}/uss/ion/ulm/updtUnityLink.cm" method="post" enctype="multipart/form-data" >
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/ulm/listUnityLink.cm' />" onclick=""><spring:message code="button.list" /></a></span>
	</div>
