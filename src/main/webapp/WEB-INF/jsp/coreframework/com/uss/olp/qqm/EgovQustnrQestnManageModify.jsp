...
function fn_egov_save_QustnrQestnManage(){
	...
	if(confirm("<spring:message code='common.save.msg' />")){
		//varFrom.action =  "<c:url value='/uss/olp/qqm/EgovQustnrQestnManageModify.cm' />";
...
<div class="wTableFrm">
<!-- 상단타이틀 -->
<form:form modelAttribute="qustnrQestnManageVO" name="qustnrQestnManageVO" action="${pageContext.request.contextPath}/uss/olp/qqm/EgovQustnrQestnManageModify.cm" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrQestnManage(document.forms[0]); return false;">
