 ...
 ******************************************************** */
 ...
 function linkPage(pageNo){
	...
	varForm.action = "<c:url value='/uss/ion/vct/EgovVcatnConfmList.cm'/>";
	varForm.submit();
 }
...
function fncVcatnManageDetail(applcntId,vcatnSe,bgnde,endde,infrmlSanctnId){
	...
	varForm.action           = "<c:url value='/uss/ion/vct/EgovVcatnConfm.cm'/>";
	varForm.submit();
}
...
<div class="board">
	...
	<form name="listForm" action="<c:url value='/uss/ion/vct/EgovVcatnConfmList.cm'/>" method="post">
	...
	<table class="board_list">
		...
		<tbody>
			...
			<tr>
				...
				<td>
		        <form name="item" method="post" action="<c:url value='/uss/ion/vct/EgovVcatnConfm.cm'/>">
