...
function fn_egov_select_linkPage(pageNo){
	...
	document.eventCmpgnForm.action = "<c:url value='/uss/ion/ecc/selectEventCmpgnListPopup.cm'/>";
...
<form name="eventCmpgnForm" action="<c:url value='/uss/ion/ecc/selectEventCmpgnListPopup.cm'/>" method="post" onSubmit="fn_egov_search_event(); return false;">
<div class="popup">
	...
	<tr>
		...
		<td><a href="<c:url value='/uss/ion/ecc/selectEventCmpgnDetail.cm?eventId=${resultInfo.eventId}'/>" onClick="fn_egov_inquire_eventdetail('<c:out value="${resultInfo.eventId}"/>');return false;"><c:out value='${fn:substring(resultInfo.eventCn, 0, 40)}'/></a></td>
