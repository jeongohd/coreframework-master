...
<link href="<c:url value="/css/coreframework/com/cmm/jqueryui.css"/>" rel="stylesheet" type="text/css">
<script type="text/javascript" src="<c:url value='/js/coreframework/com/cmm/showModalDialog.js'/>"></script>
<script type="text/javascript" src="<c:url value='/js/coreframework/com/cmm/uss/olp/mgt/EgovUtilMeetingManage.js' />"></script>
...
function fn_egov_list_MeetingManage(){
	location.href = "<c:url value='/uss/olp/mgt/EgovMeetingManageList.cm' />";
}
/* ********************************************************
 * 저장처리화면
 ******************************************************** */
function fn_egov_save_MeetingManage(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){/* 저장 하시겠습니까? */
		varFrom.action =  "<c:url value='/uss/olp/mgt/EgovMeetingManageModify.cm' />";
...
function fn_egov_mnaerDept_MeetingManage(){
	...
	arrParam[1] = "typeMeeting1";
 	...
 	window.showModalDialog("<c:url value='/uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopup.cm' />", arrParam ,"dialogWidth:800px;dialogHeight:500px;resizable:yes;cente:yes");
 }
/* ********************************************************
 * 주관 부서 팝업창열기
 ******************************************************** */
function fn_egov_mngtDeptNm_MeetingManage(){
	...
	arrParam[1] = "typeMeeting2";
 	...
 	window.showModalDialog("<c:url value='/uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopup.cm' />", arrParam ,"dialogWidth:800px;dialogHeight:500px;resizable:yes;center:yes");
 }
...
function fn_egov_mnaer_MeetingManage(){
	...
	arrParam[1] = "typeMeeting";
  	...
  	window.showModalDialog("<c:url value='/uss/olp/mgt/EgovMeetingManageLisEmpLyrPopup.cm' />", arrParam,"dialogWidth:800px;dialogHeight:500px;resizable:yes;center:yes");
}
/* ********************************************************
 * 달력
 ******************************************************** */
function fn_egov_init_date(){
	...
	$("#mtgDe").datepicker(  
	        {dateFormat:'yy-mm-dd'
	         , showOn: 'button'
	         , buttonImage: '<c:url value='/images/coreframework/com/cmm/icon/bu_icon_carlendar.gif'/>'
...
<div class="wTableFrm">
	...
	<table class="wTable">
		...
		<tr>
			...
			<td class="left">
				...
				<a href="<c:url value='/uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopup.cm' />" target="_blank" title="주관부서 선택  팝업 새창으로" onclick="fn_egov_mngtDeptNm_MeetingManage();return false">
					<img alt="<spring:message code="ussOlpMgt.meetingManageModify.mngtDeptNm"/>" src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />" title="<spring:message code="ussOlpMgt.meetingManageModify.mngtDeptNm"/>" />
				</a>
		...
		<tr>
			...
			<td class="left">
				...
				<a href="<c:url value='/uss/olp/mgt/EgovMeetingManageLisEmpLyrPopup.cm' />" target="_blank" title="주관자ID 선택  팝업 새창으로" onclick="fn_egov_mnaer_MeetingManage();return false">
					<img alt="주관자ID 찾기버튼" src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />" title="주관자ID 찾기 버튼" />
				</a>
		...
		<tr>
			...
			<td class="left">
				...
				<a href="<c:url value='/uss/olp/mgt/EgovMeetingManageLisAuthorGroupPopup.cm' />" target="_blank" title="주관자부서 선택  팝업 새창으로" onclick="fn_egov_mnaerDept_MeetingManage();return false">
					<img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif' />" align="middle" style="border:0px" alt="주관자부서 찾기버튼" title="주관자부서 찾기 버튼">
				</a>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olp/mgt/EgovMeetingManageList.cm' />" onclick=""><spring:message code="button.list"/></a></span>
	</div>
