...
/*	
	var url 	= "<c:url value='/uss/umt/cmm/EgovRlnmCnfirm.cm?nextUrlName=Q&A&nextUrl=/uss/olp/cns/CnsltDtlsRegistView.cm'/>";
	...
	if	(returnValue)	{
	 	...
	 	document.LoginRealnmForm.action = "<c:url value='/uss/olp/cns/CnsltDtlsRegistView.cm'/>";
...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="<c:url value='/images/coreframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;로그인 &amp; 실명확인 선택</h1></td>
 </tr>
</table>
