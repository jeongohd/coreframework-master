 ...
 ******************************************************** */
	function fn_egov_update_notification(){
		...
		if (confirm('<spring:message code="common.update.msg" />')) {
			...
			form.action = "<c:url value='/uss/ion/noi/updateNotification.cm'/>";
...
<form:form modelAttribute="notification" name="notification" method="post" action="${pageContext.request.contextPath}/uss/ion/noi/updateNotification.cm' />">
...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/noi/selectNotificationList.cm'/>?pageIndex=1" onclick="fn_egov_select_notification(); return false;"><spring:message code="button.list" /></a></span>
	</div>
