...
function fn_egov_modify_QustnrRespondInfo(qestnrQesrspnsId){
	...
	vFrom.cmd.value = '';
	vFrom.action = "<c:url value='/uss/olp/qri/EgovQustnrRespondInfoModify.cm' />";;
	vFrom.submit();
...
<div class="wTableFrm">
<form name="QustnrRespondInfoForm" id="QustnrRespondInfoForm" action="<c:url value='/uss/olp/qri/EgovQustnrRespondInfoModify.cm'/>" method="post">
	<!-- 타이틀 -->
	...
	<div class="btn">
		<!-- 수정 버튼 -->
		<form name="formUpdt" action="<c:url value='/uss/olp/qri/EgovQustnrRespondInfoModify.cm'/>" method="post" onsubmit="fn_egov_modify_QustnrRespondInfo('${resultList[0].qestnrQesrspnsId}'); return false;" style="float:left;">
		<input type="submit" class="s_submit" value="<spring:message code='button.update' />" title="<spring:message code='title.update' /> <spring:message code='input.button' />" />
		<input name="qestnrQesrspnsId" type="hidden" value="${resultList[0].qestnrQesrspnsId}">
		</form>
		<!-- 삭제 버튼 -->
		<form name="formDelete" action="<c:url value='/uss/olp/qri/EgovQustnrRespondInfoDetail.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
		...
		<!-- 목록 버튼 -->
		<form name="formList" action="<c:url value='/uss/olp/qri/EgovQustnrRespondInfoList.cm'/>" method="post" style="float:left; margin:0 0 0 3px;">
