...
<link type="text/css" rel="stylesheet" href="<c:url value='/css/coreframework/com/button.css'/>">
...
<form id="twitterInfo" name="twitterInfo" action="/uss/ion/tir/selectTwitterAccount.cm" method="post" enctype="multipart/form-data">
<!--  타이틀  -->
<div class="title_left" style="width:100%;margin:0 0 0 0;">
	<h1><img src="<c:url value="/images/coreframework/com/cmm/icon/tit_icon.gif"/>" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt=" ">&nbsp;트위터 인증키(ConsumerKey/ConsumerSecret) 관리</h1>
</div>
...
<tr> 
	<th scope="row" width="20%" height="23" class="required_text"><label for="ConsumerKey">Consumer key</label><img src="<c:url value="/images/coreframework/com/cmm/icon/required.gif"/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td width="80%">
...
<tr> 
	<th scope="row" width="20%" height="23" class="required_text"><label for="ConsumerSecret">Consumer secret</label><img src="<c:url value="/images/coreframework/com/cmm/icon/required.gif"/>" alt="필수입력" title="필수입력" width="15" height="15"></th>
	<td width="80%">
...
<tr> 
	<th scope="row"> </th>	
	<td><img src="<c:url value="/images/coreframework/com/cmm/btn/bu2_left.gif"/>"  width="8" height="20" alt="버튼이미지"></td>
	...
	<td><img src="<c:url value="/images/coreframework/com/cmm/btn/bu2_right.gif"/>"  width="8" height="20" alt="버튼이미지"></td>
</tr>
</table>
</center>
...
<div class="title_left" style="width:100%;margin:0 0 0 0;">
	<img src="<c:url value="/images/coreframework/com/cmm/icon/tit_icon.gif"/>" width="7" hspace="3" style="vertical-align:middle; display:inline-block;" alt=" ">&nbsp;트위터 OAuth 인증키 발급절차
</div>
...
<tr>
	...
	<img src="<c:url value="/images/coreframework/com/uss/ion/tir/twitter_regist.jpg"/>" alt="트위터 어플 등록 이미지" title="트위터 어플 등록 이미지">
	<br>※ Callback URL: http://common.egovframe.go.kr/uss/ion/tir/selectTwitterPopupProcess.cm
...
<tr>
	...
	<img src="<c:url value="/images/coreframework/com/uss/ion/tir/twitter_regist_detail.jpg"/>" alt="트위터 어플 등록 완료 이미지" title="트위터 어플 등록 완료 이미지">
	</td>
</tr>
</table>
