...
function fncSelectAnnvrsryManageList() {
    var varFrom = document.getElementById("annvrsryManage");
    varFrom.action = "<c:url value='/uss/ion/ans/selectAnnvrsryManageList.cm'/>";
    varFrom.submit();       
}
...
function fncInsertAnnvrsry() {
    var varFrom = document.getElementById("annvrsryManage");
    varFrom.action = "<c:url value='/uss/ion/ans/insertAnnvrsry.cm'/>";
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/uss/ion/ans/insertViewAnnvrsry.cm'/>?searchCondition=1" onclick="fncAnnvrsryClear(); return false;"><spring:message code="comUssIonAns.common.init"/></a></span><!-- 초기화 -->
