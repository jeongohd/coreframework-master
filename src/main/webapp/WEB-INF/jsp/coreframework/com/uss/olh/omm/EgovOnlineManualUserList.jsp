...
function fn_egov_select_linkPage(pageNo){
	...
	document.onlineManualForm.action = "<c:url value='/uss/olh/omn/selectOnlineManualList.cm'/>";
...
function fn_egov_inquire_onlinemanualdetail(onlineMnlId) {
	...
	document.onlineManualForm.onlineMnlId.value = onlineMnlId;
  	document.onlineManualForm.action = "<c:url value='/uss/olh/omn/selectOnlineManualDetail.cm'/>";
  	document.onlineManualForm.submit();
}
</script>
</head>
...
<form name="onlineManualForm" action="<c:url value='/uss/olh/omn/selectOnlineManualList.cm'/>" method="post" onSubmit="fn_egov_search_onlinemanual(); return false;">
<div class="board">
	...
	<tr>
		...
		<td>
			<form name="subForm" method="post" action="<c:url value='/uss/olh/omn/selectOnlineManualDetail.cm'/>">
