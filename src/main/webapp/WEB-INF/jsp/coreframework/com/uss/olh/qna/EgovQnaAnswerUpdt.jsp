...
function fn_egov_inqire_list() {
	qnaVO.action = "<c:url value='/uss/olh/qna/selectQnaAnswerList.cm'/>";
	qnaVO.submit();	
}
</script>
</head>
...
<!-- 상단타이틀 -->
<form:form modelAttribute="qnaVO" action="${pageContext.request.contextPath}/uss/olh/qna/updateQnaAnswer.cm" method="post" onSubmit="fn_egov_updt_qna(document.forms[0]); return false;">
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/olh/qna/selectQnaAnswerList.cm' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
