...
function fncUpdtVcatnManage() {
    ...
    varForm.action = "<c:url value='/uss/ion/vct/updtVcatnManage.cm'/>";
...
<form:form modelAttribute="vcatnManage" name="vcatnManage" method="post" action="${pageContext.request.contextPath}/uss/ion/vct/updtVcatnManage.cm">
