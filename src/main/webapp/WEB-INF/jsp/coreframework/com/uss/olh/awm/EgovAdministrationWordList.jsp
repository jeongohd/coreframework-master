...
function fn_egov_select_linkPage(pageNo){
	...
	document.administrationWordForm.action = "<c:url value='/uss/olh/awm/selectAdministrationWordList.cm'/>";
...
function fn_egov_inquire_administrationworddetail(administWordId) {
	...
	document.administrationWordForm.administWordId.value = administWordId;
  	document.administrationWordForm.action = "<c:url value='/uss/olh/awm/selectAdministrationWordDetail.cm'/>";
  	document.administrationWordForm.submit();
}
</script>
</head>
...
<form name="administrationWordForm" action="<c:url value='/uss/olh/awm/selectAdministrationWordList.cm'/>" method="post" onSubmit="fn_egov_search_administrationword(); return false;">
<div class="board">
	...
	<tr>
		...
		<td>
			<form name="subForm" method="post" action="<c:url value='/uss/olh/awm/selectAdministrationWordDetail.cm'/>">
