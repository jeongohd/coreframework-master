...
<form:form modelAttribute="siteVO" action="${pageContext.request.contextPath}/uss/ion/sit/insertSite.cm" method="post" onSubmit="fn_egov_regist_site(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
