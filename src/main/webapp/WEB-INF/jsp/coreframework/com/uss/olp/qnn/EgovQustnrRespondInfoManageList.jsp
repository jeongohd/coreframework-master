...
function linkPage(pageNo){
	...
	document.listForm.action = "<c:url value='/uss/olp/qnn/EgovQustnrRespondInfoManageList.cm'/>";
...
function fn_egov_search_QustnrManage(){
	...
	vFrom.action = "<c:url value='/uss/olp/qnn/EgovQustnrRespondInfoManageList.cm'/>";
	vFrom.submit();
 ...
 ******************************************************** */
 ...
 function fn_egov_regist_QustnrRespondInfoManage(qestnrId, qestnrTmplatId){
 	 ...
 	 //document.listForm.action = "<c:url value='${pageContext.request.contextPath}/uss/olp/qnn/EgovQustnrRespondInfoManageRegist.cm'/>";
 	 document.listForm.action = "<c:url value='/uss/olp/qnn/EgovQustnrRespondInfoManageRegist.cm'/>";
 	 document.listForm.submit();
 }
...
function fn_egov_statistics_QustnrRespondInfoManage(qestnrId, qestnrTmplatId){
 	 ...
 	 document.getElementById("qestnrId").value = qestnrId;
 	 document.getElementById("qestnrTmplatId").value = qestnrTmplatId;
 	 document.listForm.action = "<c:url value='/uss/olp/qnn/EgovQustnrRespondInfoManageStatistics.cm'/>";
 	 document.listForm.submit();
}
</script>
</head>
...
<form name="listForm" id="listForm" action="<c:url value='/uss/olp/qnn/EgovQustnrRespondInfoManageList.cm'/>" method="post" >
