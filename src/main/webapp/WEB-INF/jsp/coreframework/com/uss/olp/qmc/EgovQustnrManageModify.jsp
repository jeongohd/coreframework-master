...
<div class="wTableFrm">
<!-- 상단타이틀 -->
<form:form modelAttribute="qustnrManageVO" name="qustnrManageVO" action="${pageContext.request.contextPath}/uss/olp/qmc/EgovQustnrManageModify.cm" method="post" enctype="multipart/form-data" onSubmit="fn_egov_save_QustnrTmplatManage(document.forms[0]); return false;">
...
<div class="btn">
	...
	<!-- 목록버튼 -->	
	<span class="btn_s"><a href="<c:url value='/uss/olp/qmc/EgovQustnrManageList.cm' />"   title="<spring:message code='button.list' />  <spring:message code='input.button' />"><spring:message code="button.list" /></a></span>
