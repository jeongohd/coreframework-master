 ...
 ******************************************************** */
 function fn_egov_popup_event(){
	...
	fn_egov_popup("eventPopup","<c:url value='/uss/ion/ecc/selectEventCmpgnListPopup.cm' />",800,580);
...
<form:form modelAttribute="tnextrlHrVO" action="${pageContext.request.contextPath}/uss/ion/ecc/insertTnextrlHr.cm" method="post" onSubmit="fn_egov_regist_hr(document.forms[0]); return false;">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<tbody>
		...
		<tr>
			...
			<td class="left">
			    ...
			    <a href="#" onClick="fn_egov_popup_event()"><img src="<c:url value='/images/coreframework/com/cmm/btn/btn_search.gif'/>" align="middle" style="border:0px" alt=<spring:message code="comUssIonEcc.eventCmpgnVO.findEv"/> title="<spring:message code="comUssIonEcc.eventCmpgnVO.findEv"/>"></a>
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/ecc/selectTnextrlHrList.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
