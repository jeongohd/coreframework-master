...
function fncSelectUserAbsnceList() {
    ...
    varFrom.action = "<c:url value='/uss/ion/uas/selectUserAbsnceList.cm'/>";
    varFrom.submit();       
}
/* ********************************************************
 * 수정
...
function fncUserAbsnceUpdate() {
    ...
    var varFrom = document.getElementById("userAbsnce");
    varFrom.action = "<c:url value='/uss/ion/uas/updtUserAbsnce.cm'/>";
...
function fncUserAbsnceDelete() {
    var varFrom = document.getElementById("userAbsnce");
    varFrom.action = "<c:url value='/uss/ion/uas/removeUserAbsnce.cm'/>";
...
<div class="wTableFrm">
<form:form modelAttribute="userAbsnce" action="${pageContext.request.contextPath}/uss/ion/uas/updtUserAbsnce.cm' />" method="post">
	<!-- 타이틀 -->
