 ...
 ******************************************************** */
 function fn_egov_delete_site(recomendSiteId){
	if(confirm("<spring:message code="common.delete.msg" />")){	
		...
		document.recomendSiteForm.action = "<c:url value='/uss/ion/rec/deleteRecomendSite.cm'/>";
...
<form name="recomendSiteForm" action="<c:url value='/uss/ion/rec/updateRecomendSiteView.cm'/>" method="post">
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/uss/ion/rec/deleteRecomendSite.cm' />" onClick="fn_egov_delete_site('<c:out value="${result.recomendSiteId}"/>'); return false;"  title="<spring:message code="button.delete" /> <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span>
		<span class="btn_s"><a href="<c:url value='/uss/ion/rec/selectRecomendSiteList.cm' />"  title="<spring:message code="title.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span>
