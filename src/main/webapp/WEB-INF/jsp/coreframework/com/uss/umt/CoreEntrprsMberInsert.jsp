<%
 /**
  * @Class Name : CoreEntrprsMberInsert.jsp
...
function fnListPage(){
    document.entrprsManageVO.action = "<c:url value='/uss/umt/coreEntrprsMberManageList.cm'/>";
...
<!-- content start -->
<form:form modelAttribute="entrprsManageVO" action="${pageContext.request.contextPath}/uss/umt/coreEntrprsMberAdd.cm" name="entrprsManageVO" method="post" onSubmit="fnInsert(document.forms[0]); return false;">
...
<div class="wTableFrm">
	...
	<!-- 하단 버튼 --> 
	<div class="btn">
		<span class="btn_s"><a href="<c:url value='/uss/umt/coreEntrprsMberManageList.cm' />"  title="<spring:message code="button.list" />  <spring:message code="input.button" />"><spring:message code="button.list" /></a></span><!-- 목록 -->
